# arc56-generated-lathi-aayush-pay-per-usage-ai-api-access-system-using-algorand

Auto-generated typed Algorand smart-contract clients for **[lathi-aayush/pay-per-usage-ai-api-access-system-using-algorand](https://github.com/lathi-aayush/pay-per-usage-ai-api-access-system-using-algorand)**,
...
```bash
npm install arc56-generated-lathi-aayush-pay-per-usage-ai-api-access-system-using-algorand @algorandfoundation/algokit-utils algosdk
```
...
import { SentinelContract_677d7a81 } from "arc56-generated-lathi-aayush-pay-per-usage-ai-api-access-system-using-algorand";

const algorand = AlgorandClient.mainNet();
const client = new SentinelContract_677d7a81.SentinelContractClient({
  algorand,
  appId: 123456789n,
});
...
| --- | --- | --- |
| `SentinelContract_677d7a81` | `SentinelContractClient` | [https://raw.githubusercontent.com/lathi-aayush/pay-per-usage-ai-api-access-system-using-algorand/HEAD/contract/artifacts/SentinelContract.arc56.json](https://raw.githubusercontent.com/lathi-aayush/pay-per-usage-ai-api-access-system-using-algorand/HEAD/contract/artifacts/SentinelContract.arc56.json) |
