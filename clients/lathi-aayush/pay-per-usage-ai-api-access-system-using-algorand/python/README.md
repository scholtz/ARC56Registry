...
```bash
pip install arc56-generated-lathi-aayush-pay-per-usage-ai-api-access-system-using-algorand
```
...
from arc56_generated_lathi_aayush_pay_per_usage_ai_api_access_system_using_algorand import SentinelContract_677d7a81

algorand = AlgorandClient.mainnet()
client = SentinelContract_677d7a81.SentinelContractClient(
    algorand=algorand,
    app_id=123456789,
)
