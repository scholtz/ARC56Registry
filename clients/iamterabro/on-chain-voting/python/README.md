...
```bash
pip install arc56-generated-iamterabro-on-chain-voting
```
...
from arc56_generated_iamterabro_on_chain_voting import OnChainVoting_b2cd70a9

algorand = AlgorandClient.mainnet()
client = OnChainVoting_b2cd70a9.OnChainVotingClient(
    algorand=algorand,
    app_id=123456789,
)
