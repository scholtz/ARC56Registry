...
```bash
npm install arc56-generated-iamterabro-on-chain-voting @algorandfoundation/algokit-utils algosdk
```
...
import { OnChainVoting_b2cd70a9 } from "arc56-generated-iamterabro-on-chain-voting";

const algorand = AlgorandClient.mainNet();
const client = new OnChainVoting_b2cd70a9.OnChainVotingClient({
  algorand,
  appId: 123456789n,
});
...
| --- | --- | --- |
| `OnChainVoting_b2cd70a9` | `OnChainVotingClient` | [https://raw.githubusercontent.com/iamterabro/on-chain-voting/HEAD/contracts/artifacts/OnChainVoting.arc56.json](https://raw.githubusercontent.com/iamterabro/on-chain-voting/HEAD/contracts/artifacts/OnChainVoting.arc56.json) |
