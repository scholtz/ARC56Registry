...
```bash
pip install arc56-generated-pranayvaddanam-algoflow
```
...
from arc56_generated_pranayvaddanam_algoflow import PayrollStream_3e195b38

algorand = AlgorandClient.mainnet()
client = PayrollStream_3e195b38.PayrollStreamClient(
    algorand=algorand,
    app_id=123456789,
)
