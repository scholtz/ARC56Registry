...
```bash
pip install arc56-generated-naveen-2111-dev-algod
```
...
from arc56_generated_naveen_2111_dev_algod import HelloWorld_e3769621

algorand = AlgorandClient.mainnet()
client = HelloWorld_e3769621.HelloWorldClient(
    algorand=algorand,
    app_id=123456789,
)
