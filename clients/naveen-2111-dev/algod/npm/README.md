...
```bash
npm install arc56-generated-naveen-2111-dev-algod @algorandfoundation/algokit-utils algosdk
```
...
import { HelloWorld_e3769621 } from "arc56-generated-naveen-2111-dev-algod";

const algorand = AlgorandClient.mainNet();
const client = new HelloWorld_e3769621.HelloWorldClient({
  algorand,
  appId: 123456789n,
});
