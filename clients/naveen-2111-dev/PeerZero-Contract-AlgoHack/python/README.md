...
```bash
pip install arc56-generated-naveen-2111-dev-peerzero-contract-algohack
```
...
from arc56_generated_naveen_2111_dev_peerzero_contract_algohack import MechanicRegistry_bf706c12

algorand = AlgorandClient.mainnet()
client = MechanicRegistry_bf706c12.MechanicRegistryClient(
    algorand=algorand,
    app_id=123456789,
)
