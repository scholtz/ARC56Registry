...
```bash
npm install arc56-generated-omairdev-aiagentmarketplace @algorandfoundation/algokit-utils algosdk
```
...
import { AiApiMarketplace_db7e6ebe } from "arc56-generated-omairdev-aiagentmarketplace";

const algorand = AlgorandClient.mainNet();
const client = new AiApiMarketplace_db7e6ebe.AiApiMarketplaceClient({
  algorand,
  appId: 123456789n,
});
