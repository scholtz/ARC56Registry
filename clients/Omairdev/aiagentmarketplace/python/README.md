...
```bash
pip install arc56-generated-omairdev-aiagentmarketplace
```
...
from arc56_generated_omairdev_aiagentmarketplace import AiApiMarketplace_db7e6ebe

algorand = AlgorandClient.mainnet()
client = AiApiMarketplace_db7e6ebe.AiApiMarketplaceClient(
    algorand=algorand,
    app_id=123456789,
)
