...
```bash
pip install arc56-generated-munavathvijay00-spec-tokenizerwatemplate-main
```
...
from arc56_generated_munavathvijay00_spec_tokenizerwatemplate_main import HelloWorld_8193a295

algorand = AlgorandClient.mainnet()
client = HelloWorld_8193a295.HelloWorldClient(
    algorand=algorand,
    app_id=123456789,
)
