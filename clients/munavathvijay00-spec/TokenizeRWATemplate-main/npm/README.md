...
```bash
npm install arc56-generated-munavathvijay00-spec-tokenizerwatemplate-main @algorandfoundation/algokit-utils algosdk
```
...
import { HelloWorld_8193a295 } from "arc56-generated-munavathvijay00-spec-tokenizerwatemplate-main";

const algorand = AlgorandClient.mainNet();
const client = new HelloWorld_8193a295.HelloWorldClient({
  algorand,
  appId: 123456789n,
});
