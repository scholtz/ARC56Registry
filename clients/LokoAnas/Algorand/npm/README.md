...
```bash
npm install arc56-generated-lokoanas-algorand @algorandfoundation/algokit-utils algosdk
```
...
import { AgentIDContract_44547838 } from "arc56-generated-lokoanas-algorand";

const algorand = AlgorandClient.mainNet();
const client = new AgentIDContract_44547838.AgentIdContractClient({
  algorand,
  appId: 123456789n,
});
...
| --- | --- | --- |
| `AgentIDContract_44547838` | `AgentIdContractClient` | [https://raw.githubusercontent.com/LokoAnas/Algorand/HEAD/agentid/contracts/artifacts/AgentIDContract.arc56.json](https://raw.githubusercontent.com/LokoAnas/Algorand/HEAD/agentid/contracts/artifacts/AgentIDContract.arc56.json) |
| `AgentIDContract_2fbd1157` | `AgentIdContractClient` | [https://raw.githubusercontent.com/LokoAnas/Algorand/HEAD/agentid/contracts/contracts/artifacts/AgentIDContract.arc56.json](https://raw.githubusercontent.com/LokoAnas/Algorand/HEAD/agentid/contracts/contracts/artifacts/AgentIDContract.arc56.json) |
