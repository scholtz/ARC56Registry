...
```bash
npm install arc56-generated-nikhil-r0-checklist @algorandfoundation/algokit-utils algosdk
```
...
import { Checklist_2783ced4 } from "arc56-generated-nikhil-r0-checklist";

const algorand = AlgorandClient.mainNet();
const client = new Checklist_2783ced4.ChecklistClient({
  algorand,
  appId: 123456789n,
});
...
| --- | --- | --- |
| `Checklist_2783ced4` | `ChecklistClient` | [https://raw.githubusercontent.com/nikhil-r0/checklist/HEAD/projects/checklist/smart_contracts/artifacts/checklist/Checklist.arc56.json](https://raw.githubusercontent.com/nikhil-r0/checklist/HEAD/projects/checklist/smart_contracts/artifacts/checklist/Checklist.arc56.json) |
