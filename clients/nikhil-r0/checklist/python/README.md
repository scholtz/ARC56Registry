...
```bash
pip install arc56-generated-nikhil-r0-checklist
```
...
from arc56_generated_nikhil_r0_checklist import Checklist_2783ced4

algorand = AlgorandClient.mainnet()
client = Checklist_2783ced4.ChecklistClient(
    algorand=algorand,
    app_id=123456789,
)
