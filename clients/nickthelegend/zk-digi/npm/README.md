...
```bash
npm install arc56-generated-nickthelegend-zk-digi @algorandfoundation/algokit-utils algosdk
```
...
import { Vault_6da31009 } from "arc56-generated-nickthelegend-zk-digi";

const algorand = AlgorandClient.mainNet();
const client = new Vault_6da31009.VaultClient({
  algorand,
  appId: 123456789n,
});
...
| --- | --- | --- |
| `Vault_6da31009` | `VaultClient` | [https://raw.githubusercontent.com/nickthelegend/zk-digi/HEAD/zk-digi/src/contracts/Vault.arc56.json](https://raw.githubusercontent.com/nickthelegend/zk-digi/HEAD/zk-digi/src/contracts/Vault.arc56.json) |
| `ZkVerifier_d9294c0c` | `ZkVerifierClient` | [https://raw.githubusercontent.com/nickthelegend/zk-digi/HEAD/zk-digi/src/contracts/ZkVerifier.arc56.json](https://raw.githubusercontent.com/nickthelegend/zk-digi/HEAD/zk-digi/src/contracts/ZkVerifier.arc56.json) |
