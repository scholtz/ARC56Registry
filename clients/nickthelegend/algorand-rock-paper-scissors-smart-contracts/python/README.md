...
```bash
pip install arc56-generated-nickthelegend-algorand-rock-paper-scissors-smart-contracts
```
...
from arc56_generated_nickthelegend_algorand_rock_paper_scissors_smart_contracts import Fight_361bb204

algorand = AlgorandClient.mainnet()
client = Fight_361bb204.FightClient(
    algorand=algorand,
    app_id=123456789,
)
