...
```bash
pip install arc56-generated-nickthelegend-polaris-initia
```
...
from arc56_generated_nickthelegend_polaris_initia import MainSmartContract_313d0ec7

algorand = AlgorandClient.mainnet()
client = MainSmartContract_313d0ec7.MainSmartContractClient(
    algorand=algorand,
    app_id=123456789,
)
