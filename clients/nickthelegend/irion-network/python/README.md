...
```bash
pip install arc56-generated-nickthelegend-irion-network
```
...
from arc56_generated_nickthelegend_irion_network import MainSmartContract_7c408b51

algorand = AlgorandClient.mainnet()
client = MainSmartContract_7c408b51.MainSmartContractClient(
    algorand=algorand,
    app_id=123456789,
)
