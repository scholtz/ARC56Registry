...
```bash
pip install arc56-generated-nickthelegend-polaris-pay
```
...
from arc56_generated_nickthelegend_polaris_pay import MainSmartContract_fdd5b6f9

algorand = AlgorandClient.mainnet()
client = MainSmartContract_fdd5b6f9.MainSmartContractClient(
    algorand=algorand,
    app_id=123456789,
)
