...
```bash
pip install arc56-generated-nickthelegend-meridian-bnpl
```
...
from arc56_generated_nickthelegend_meridian_bnpl import MainSmartContract_e705d2f7

algorand = AlgorandClient.mainnet()
client = MainSmartContract_e705d2f7.MainSmartContractClient(
    algorand=algorand,
    app_id=123456789,
)
