# Arc56.Generated.initlabsai.vibekit

Auto-generated typed Algorand smart-contract clients for **[initlabsai/vibekit](https://github.com/initlabsai/vibekit)**,
...
```bash
dotnet add package Arc56.Generated.initlabsai.vibekit
```
