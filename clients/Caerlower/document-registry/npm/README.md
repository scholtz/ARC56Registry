...
```bash
npm install arc56-generated-caerlower-document-registry @algorandfoundation/algokit-utils algosdk
```
...
import { DocumentRegistry_2b8aefae } from "arc56-generated-caerlower-document-registry";

const algorand = AlgorandClient.mainNet();
const client = new DocumentRegistry_2b8aefae.DocumentRegistryClient({
  algorand,
  appId: 123456789n,
});
