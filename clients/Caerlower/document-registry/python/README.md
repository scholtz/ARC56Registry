...
```bash
pip install arc56-generated-caerlower-document-registry
```
...
from arc56_generated_caerlower_document_registry import DocumentRegistry_2b8aefae

algorand = AlgorandClient.mainnet()
client = DocumentRegistry_2b8aefae.DocumentRegistryClient(
    algorand=algorand,
    app_id=123456789,
)
