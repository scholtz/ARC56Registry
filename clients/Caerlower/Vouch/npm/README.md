...
```bash
npm install arc56-generated-caerlower-vouch @algorandfoundation/algokit-utils algosdk
```
...
import { VouchEscrow_574452e0 } from "arc56-generated-caerlower-vouch";

const algorand = AlgorandClient.mainNet();
const client = new VouchEscrow_574452e0.VouchEscrowClient({
  algorand,
  appId: 123456789n,
});
...
| --- | --- | --- |
| `VouchEscrow_574452e0` | `VouchEscrowClient` | [https://raw.githubusercontent.com/Caerlower/Vouch/HEAD/contracts/escrow/out/VouchEscrow.arc56.json](https://raw.githubusercontent.com/Caerlower/Vouch/HEAD/contracts/escrow/out/VouchEscrow.arc56.json) |
