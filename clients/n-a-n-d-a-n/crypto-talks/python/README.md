...
```bash
pip install arc56-generated-n-a-n-d-a-n-crypto-talks
```
...
from arc56_generated_n_a_n_d_a_n_crypto_talks import ScholarStream_f618c1eb

algorand = AlgorandClient.mainnet()
client = ScholarStream_f618c1eb.ScholarStreamClient(
    algorand=algorand,
    app_id=123456789,
)
