...
```bash
npm install arc56-generated-n-a-n-d-a-n-crypto-talks @algorandfoundation/algokit-utils algosdk
```
...
import { ScholarStream_f618c1eb } from "arc56-generated-n-a-n-d-a-n-crypto-talks";

const algorand = AlgorandClient.mainNet();
const client = new ScholarStream_f618c1eb.ScholarStreamClient({
  algorand,
  appId: 123456789n,
});
