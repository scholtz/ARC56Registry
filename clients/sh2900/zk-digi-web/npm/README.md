...
```bash
npm install arc56-generated-sh2900-zk-digi-web @algorandfoundation/algokit-utils algosdk
```
...
import { Vault_95a84c67 } from "arc56-generated-sh2900-zk-digi-web";

const algorand = AlgorandClient.mainNet();
const client = new Vault_95a84c67.VaultClient({
  algorand,
  appId: 123456789n,
});
...
| --- | --- | --- |
| `Vault_95a84c67` | `VaultClient` | [https://raw.githubusercontent.com/sh2900/zk-digi-web/HEAD/src/contracts/Vault.arc56.json](https://raw.githubusercontent.com/sh2900/zk-digi-web/HEAD/src/contracts/Vault.arc56.json) |
| `ZkVerifier_a5c508ec` | `ZkVerifierClient` | [https://raw.githubusercontent.com/sh2900/zk-digi-web/HEAD/src/contracts/ZkVerifier.arc56.json](https://raw.githubusercontent.com/sh2900/zk-digi-web/HEAD/src/contracts/ZkVerifier.arc56.json) |
