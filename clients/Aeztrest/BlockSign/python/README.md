...
```bash
pip install arc56-generated-aeztrest-blocksign
```
...
from arc56_generated_aeztrest_blocksign import Blocksign_e8098e7b

algorand = AlgorandClient.mainnet()
client = Blocksign_e8098e7b.BlocksignClient(
    algorand=algorand,
    app_id=123456789,
)
