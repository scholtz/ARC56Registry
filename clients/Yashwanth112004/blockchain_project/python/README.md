...
```bash
pip install arc56-generated-yashwanth112004-blockchain-project
```
...
from arc56_generated_yashwanth112004_blockchain_project import companyID_f3400646

algorand = AlgorandClient.mainnet()
client = companyID_f3400646.CompanyIdClient(
    algorand=algorand,
    app_id=123456789,
)
