...
```bash
npm install arc56-generated-vishalsomaraju-agent-market @algorandfoundation/algokit-utils algosdk
```
...
import { AgentMarketRegistry_76d680f6 } from "arc56-generated-vishalsomaraju-agent-market";

const algorand = AlgorandClient.mainNet();
const client = new AgentMarketRegistry_76d680f6.AgentMarketRegistryClient({
  algorand,
  appId: 123456789n,
});
