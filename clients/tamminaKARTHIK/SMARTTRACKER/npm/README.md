...
```bash
npm install arc56-generated-tamminakarthik-smarttracker @algorandfoundation/algokit-utils algosdk
```
...
import { BusTracker_b7688da4 } from "arc56-generated-tamminakarthik-smarttracker";

const algorand = AlgorandClient.mainNet();
const client = new BusTracker_b7688da4.BusTrackerClient({
  algorand,
  appId: 123456789n,
});
