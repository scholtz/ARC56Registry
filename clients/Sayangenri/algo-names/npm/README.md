...
```bash
npm install arc56-generated-sayangenri-algo-names @algorandfoundation/algokit-utils algosdk
```
...
import { AlgoNames_4fbfdfce } from "arc56-generated-sayangenri-algo-names";

const algorand = AlgorandClient.mainNet();
const client = new AlgoNames_4fbfdfce.AlgoNamesClient({
  algorand,
  appId: 123456789n,
});
