...
```bash
pip install arc56-generated-sayangenri-awesomealgorand
```
...
from arc56_generated_sayangenri_awesomealgorand import Counter_437a3d0c

algorand = AlgorandClient.mainnet()
client = Counter_437a3d0c.CounterClient(
    algorand=algorand,
    app_id=123456789,
)
