...
```bash
npm install arc56-generated-sayangenri-awesomealgorand @algorandfoundation/algokit-utils algosdk
```
...
import { Counter_437a3d0c } from "arc56-generated-sayangenri-awesomealgorand";

const algorand = AlgorandClient.mainNet();
const client = new Counter_437a3d0c.CounterClient({
  algorand,
  appId: 123456789n,
});
