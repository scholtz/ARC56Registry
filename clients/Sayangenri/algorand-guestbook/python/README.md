...
```bash
pip install arc56-generated-sayangenri-algorand-guestbook
```
...
from arc56_generated_sayangenri_algorand_guestbook import GuestbookAppContract_f6c91757

algorand = AlgorandClient.mainnet()
client = GuestbookAppContract_f6c91757.GuestbookAppContractClient(
    algorand=algorand,
    app_id=123456789,
)
