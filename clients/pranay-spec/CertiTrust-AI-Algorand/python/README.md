...
```bash
pip install arc56-generated-pranay-spec-certitrust-ai-algorand
```
...
from arc56_generated_pranay_spec_certitrust_ai_algorand import Bank_4e714736

algorand = AlgorandClient.mainnet()
client = Bank_4e714736.BankClient(
    algorand=algorand,
    app_id=123456789,
)
