...
```bash
pip install arc56-generated-digvijay-12345-grant-go-hackspiration
```
...
from arc56_generated_digvijay_12345_grant_go_hackspiration import Bank_27c79ca4

algorand = AlgorandClient.mainnet()
client = Bank_27c79ca4.BankClient(
    algorand=algorand,
    app_id=123456789,
)
