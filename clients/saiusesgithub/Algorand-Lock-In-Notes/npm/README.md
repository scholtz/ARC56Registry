...
```bash
npm install arc56-generated-saiusesgithub-algorand-lock-in-notes @algorandfoundation/algokit-utils algosdk
```
...
import { ContractName_hash } from "arc56-generated-saiusesgithub-algorand-lock-in-notes";
