...
```bash
pip install arc56-generated-rbeyzas-payroll-cross-border-microlending
```
...
from arc56_generated_rbeyzas_payroll_cross_border_microlending import FileSharingApp_6c5cd344

algorand = AlgorandClient.mainnet()
client = FileSharingApp_6c5cd344.FileSharingAppClient(
    algorand=algorand,
    app_id=123456789,
)
