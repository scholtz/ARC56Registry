...
```bash
npm install arc56-generated-rbeyzas-payroll-cross-border-microlending @algorandfoundation/algokit-utils algosdk
```
...
import { FileSharingApp_6c5cd344 } from "arc56-generated-rbeyzas-payroll-cross-border-microlending";

const algorand = AlgorandClient.mainNet();
const client = new FileSharingApp_6c5cd344.FileSharingAppClient({
  algorand,
  appId: 123456789n,
});
