...
```bash
npm install arc56-generated-palakaggarwal27-algorandsmartcontract @algorandfoundation/algokit-utils algosdk
```
...
import { GroceryList_522ad1a4 } from "arc56-generated-palakaggarwal27-algorandsmartcontract";

const algorand = AlgorandClient.mainNet();
const client = new GroceryList_522ad1a4.GroceryListClient({
  algorand,
  appId: 123456789n,
});
