...
```bash
npm install arc56-generated-ishankulkarni13-studentia @algorandfoundation/algokit-utils algosdk
```
...
import { ConsentApp_3033df3d } from "arc56-generated-ishankulkarni13-studentia";

const algorand = AlgorandClient.mainNet();
const client = new ConsentApp_3033df3d.ConsentAppClient({
  algorand,
  appId: 123456789n,
});
