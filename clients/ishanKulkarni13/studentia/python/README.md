...
```bash
pip install arc56-generated-ishankulkarni13-studentia
```
...
from arc56_generated_ishankulkarni13_studentia import ConsentApp_3033df3d

algorand = AlgorandClient.mainnet()
client = ConsentApp_3033df3d.ConsentAppClient(
    algorand=algorand,
    app_id=123456789,
)
