...
```bash
pip install arc56-generated-compx-labs-governance-contracts
```
...
from arc56_generated_compx_labs_governance_contracts import CompxGovernance_46f65b60

algorand = AlgorandClient.mainnet()
client = CompxGovernance_46f65b60.CompxGovernanceClient(
    algorand=algorand,
    app_id=123456789,
)
