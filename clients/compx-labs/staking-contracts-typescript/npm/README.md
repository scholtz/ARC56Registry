...
```bash
npm install arc56-generated-compx-labs-staking-contracts-typescript @algorandfoundation/algokit-utils algosdk
```
...
import { irpfg_147a38a1 } from "arc56-generated-compx-labs-staking-contracts-typescript";

const algorand = AlgorandClient.mainNet();
const client = new irpfg_147a38a1.IrpfgClient({
  algorand,
  appId: 123456789n,
});
