...
```bash
pip install arc56-generated-compx-labs-staking-contracts-typescript
```
...
from arc56_generated_compx_labs_staking_contracts_typescript import irpfg_147a38a1

algorand = AlgorandClient.mainnet()
client = irpfg_147a38a1.IrpfgClient(
    algorand=algorand,
    app_id=123456789,
)
