...
```bash
npm install arc56-generated-compx-labs-flux-access-controls @algorandfoundation/algokit-utils algosdk
```
...
import { flux_gate_9fada13f } from "arc56-generated-compx-labs-flux-access-controls";

const algorand = AlgorandClient.mainNet();
const client = new flux_gate_9fada13f.FluxGateClient({
  algorand,
  appId: 123456789n,
});
