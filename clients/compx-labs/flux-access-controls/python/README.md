...
```bash
pip install arc56-generated-compx-labs-flux-access-controls
```
...
from arc56_generated_compx_labs_flux_access_controls import flux_gate_9fada13f

algorand = AlgorandClient.mainnet()
client = flux_gate_9fada13f.FluxGateClient(
    algorand=algorand,
    app_id=123456789,
)
