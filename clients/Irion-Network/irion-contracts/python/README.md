...
```bash
pip install arc56-generated-irion-network-irion-contracts
```
...
from arc56_generated_irion_network_irion_contracts import HelloWorld_3941998f

algorand = AlgorandClient.mainnet()
client = HelloWorld_3941998f.HelloWorldClient(
    algorand=algorand,
    app_id=123456789,
)
