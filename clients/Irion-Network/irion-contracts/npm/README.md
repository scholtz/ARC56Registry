...
```bash
npm install arc56-generated-irion-network-irion-contracts @algorandfoundation/algokit-utils algosdk
```
...
import { HelloWorld_3941998f } from "arc56-generated-irion-network-irion-contracts";

const algorand = AlgorandClient.mainNet();
const client = new HelloWorld_3941998f.HelloWorldClient({
  algorand,
  appId: 123456789n,
});
