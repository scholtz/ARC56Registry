...
```bash
npm install arc56-generated-sonucodes40-ourvault @algorandfoundation/algokit-utils algosdk
```
...
import { SavingVault_98da5c46 } from "arc56-generated-sonucodes40-ourvault";

const algorand = AlgorandClient.mainNet();
const client = new SavingVault_98da5c46.SavingVaultClient({
  algorand,
  appId: 123456789n,
});
