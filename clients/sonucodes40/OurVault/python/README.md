...
```bash
pip install arc56-generated-sonucodes40-ourvault
```
...
from arc56_generated_sonucodes40_ourvault import SavingVault_98da5c46

algorand = AlgorandClient.mainnet()
client = SavingVault_98da5c46.SavingVaultClient(
    algorand=algorand,
    app_id=123456789,
)
