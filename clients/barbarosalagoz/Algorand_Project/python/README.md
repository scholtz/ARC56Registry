...
```bash
pip install arc56-generated-barbarosalagoz-algorand-project
```
...
from arc56_generated_barbarosalagoz_algorand_project import EventTicketing_362d8b60

algorand = AlgorandClient.mainnet()
client = EventTicketing_362d8b60.EventTicketingClient(
    algorand=algorand,
    app_id=123456789,
)
