...
```bash
pip install arc56-generated-iskysun96-algokit-utils-personal-bank
```
...
from arc56_generated_iskysun96_algokit_utils_personal_bank import PersonalBank_2d4c66da

algorand = AlgorandClient.mainnet()
client = PersonalBank_2d4c66da.PersonalBankClient(
    algorand=algorand,
    app_id=123456789,
)
