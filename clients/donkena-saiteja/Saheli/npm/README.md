...
```bash
npm install arc56-generated-donkena-saiteja-saheli @algorandfoundation/algokit-utils algosdk
```
...
import { DsbtRegistry_3f074ad1 } from "arc56-generated-donkena-saiteja-saheli";

const algorand = AlgorandClient.mainNet();
const client = new DsbtRegistry_3f074ad1.DsbtRegistryClient({
  algorand,
  appId: 123456789n,
});
