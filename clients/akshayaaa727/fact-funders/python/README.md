...
```bash
pip install arc56-generated-akshayaaa727-fact-funders
```
...
from arc56_generated_akshayaaa727_fact_funders import ProposalContract_ac239d26

algorand = AlgorandClient.mainnet()
client = ProposalContract_ac239d26.ProposalContractClient(
    algorand=algorand,
    app_id=123456789,
)
