...
```bash
pip install arc56-generated-nvds888-rarefialphacontracts
```
...
from arc56_generated_nvds888_rarefialphacontracts import MockTinymanPool_8671b734

algorand = AlgorandClient.mainnet()
client = MockTinymanPool_8671b734.MockTinymanPoolClient(
    algorand=algorand,
    app_id=123456789,
)
