...
```bash
npm install arc56-generated-nvds888-rarefialphacontracts @algorandfoundation/algokit-utils algosdk
```
...
import { MockTinymanPool_8671b734 } from "arc56-generated-nvds888-rarefialphacontracts";

const algorand = AlgorandClient.mainNet();
const client = new MockTinymanPool_8671b734.MockTinymanPoolClient({
  algorand,
  appId: 123456789n,
});
...
| --- | --- | --- |
| `MockTinymanPool_8671b734` | `MockTinymanPoolClient` | [https://raw.githubusercontent.com/nvds888/RareFiAlphaContracts/HEAD/contracts/artifacts/MockTinymanPool.arc56.json](https://raw.githubusercontent.com/nvds888/RareFiAlphaContracts/HEAD/contracts/artifacts/MockTinymanPool.arc56.json) |
| `RareFiAlphaCompoundingVault_a882c610` | `RareFiAlphaCompoundingVaultClient` | [https://raw.githubusercontent.com/nvds888/RareFiAlphaContracts/HEAD/contracts/artifacts/RareFiAlphaCompoundingVault.arc56.json](https://raw.githubusercontent.com/nvds888/RareFiAlphaContracts/HEAD/contracts/artifacts/RareFiAlphaCompoundingVault.arc56.json) |
| `RareFiVault_c25f8644` | `RareFiVaultClient` | [https://raw.githubusercontent.com/nvds888/RareFiAlphaContracts/HEAD/contracts/artifacts/RareFiVault.arc56.json](https://raw.githubusercontent.com/nvds888/RareFiAlphaContracts/HEAD/contracts/artifacts/RareFiVault.arc56.json) |
