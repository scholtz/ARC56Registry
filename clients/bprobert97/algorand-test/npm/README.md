...
```bash
npm install arc56-generated-bprobert97-algorand-test @algorandfoundation/algokit-utils algosdk
```
...
import { HelloWorld_74f47eaf } from "arc56-generated-bprobert97-algorand-test";

const algorand = AlgorandClient.mainNet();
const client = new HelloWorld_74f47eaf.HelloWorldClient({
  algorand,
  appId: 123456789n,
});
