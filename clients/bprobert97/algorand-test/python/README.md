...
```bash
pip install arc56-generated-bprobert97-algorand-test
```
...
from arc56_generated_bprobert97_algorand_test import HelloWorld_74f47eaf

algorand = AlgorandClient.mainnet()
client = HelloWorld_74f47eaf.HelloWorldClient(
    algorand=algorand,
    app_id=123456789,
)
