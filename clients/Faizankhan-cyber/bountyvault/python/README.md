...
```bash
pip install arc56-generated-faizankhan-cyber-bountyvault
```
...
from arc56_generated_faizankhan_cyber_bountyvault import BountyEscrow_92ee1ce1

algorand = AlgorandClient.mainnet()
client = BountyEscrow_92ee1ce1.BountyEscrowClient(
    algorand=algorand,
    app_id=123456789,
)
