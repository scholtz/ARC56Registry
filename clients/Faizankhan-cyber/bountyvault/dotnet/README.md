...
```bash
dotnet add package Arc56.Generated.Faizankhan-cyber.bountyvault
```
...
using Arc56.Generated.Faizankhan_cyber.bountyvault.BountyEscrow_92ee1ce1;
