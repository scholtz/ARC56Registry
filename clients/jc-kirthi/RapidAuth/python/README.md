...
```bash
pip install arc56-generated-jc-kirthi-rapidauth
```
...
from arc56_generated_jc_kirthi_rapidauth import PlacementVerify_8f2f85c7

algorand = AlgorandClient.mainnet()
client = PlacementVerify_8f2f85c7.PlacementVerifyClient(
    algorand=algorand,
    app_id=123456789,
)
