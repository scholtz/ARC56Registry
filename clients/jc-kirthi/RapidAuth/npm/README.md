...
```bash
npm install arc56-generated-jc-kirthi-rapidauth @algorandfoundation/algokit-utils algosdk
```
...
import { PlacementVerify_8f2f85c7 } from "arc56-generated-jc-kirthi-rapidauth";

const algorand = AlgorandClient.mainNet();
const client = new PlacementVerify_8f2f85c7.PlacementVerifyClient({
  algorand,
  appId: 123456789n,
});
...
| --- | --- | --- |
| `PlacementVerify_8f2f85c7` | `PlacementVerifyClient` | [https://raw.githubusercontent.com/jc-kirthi/RapidAuth/HEAD/contracts/artifacts/PlacementVerify.arc56.json](https://raw.githubusercontent.com/jc-kirthi/RapidAuth/HEAD/contracts/artifacts/PlacementVerify.arc56.json) |
