...
export type AlgodiceComposer<TReturns extends [...any[]] = []> = {
   ...
   */
  simulate(): Promise<AlgodiceComposerResults<TReturns> & { simulateResponse: modelsv2.SimulateResponse }>
  simulate(options: SkipSignaturesSimulateOptions): Promise<AlgodiceComposerResults<TReturns> & { simulateResponse: modelsv2.SimulateResponse }>
  simulate(options: RawSimulateOptions): Promise<AlgodiceComposerResults<TReturns> & { simulateResponse: modelsv2.SimulateResponse }>
  /**
