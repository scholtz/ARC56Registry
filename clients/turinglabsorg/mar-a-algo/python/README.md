...
```bash
pip install arc56-generated-turinglabsorg-mar-a-algo
```
...
from arc56_generated_turinglabsorg_mar_a_algo import HelloWorld_a6543ca5

algorand = AlgorandClient.mainnet()
client = HelloWorld_a6543ca5.HelloWorldClient(
    algorand=algorand,
    app_id=123456789,
)
...
| `MAGA20_6087cc18` | _(fails to compile - excluded, see state.json)_ | [https://raw.githubusercontent.com/turinglabsorg/mar-a-algo/HEAD/contracts/artifacts/MAGA20.arc56.json](https://raw.githubusercontent.com/turinglabsorg/mar-a-algo/HEAD/contracts/artifacts/MAGA20.arc56.json) |
