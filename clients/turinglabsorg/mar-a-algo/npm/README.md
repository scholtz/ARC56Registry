...
```bash
npm install arc56-generated-turinglabsorg-mar-a-algo @algorandfoundation/algokit-utils algosdk
```
...
import { HelloWorld_a6543ca5 } from "arc56-generated-turinglabsorg-mar-a-algo";

const algorand = AlgorandClient.mainNet();
const client = new HelloWorld_a6543ca5.HelloWorldClient({
  algorand,
  appId: 123456789n,
});
...
| --- | --- | --- |
| `HelloWorld_a6543ca5` | `HelloWorldClient` | [https://raw.githubusercontent.com/turinglabsorg/mar-a-algo/HEAD/contracts/artifacts/HelloWorld.arc56.json](https://raw.githubusercontent.com/turinglabsorg/mar-a-algo/HEAD/contracts/artifacts/HelloWorld.arc56.json) |
| `MAGA20_6087cc18` | `Maga20Client` | [https://raw.githubusercontent.com/turinglabsorg/mar-a-algo/HEAD/contracts/artifacts/MAGA20.arc56.json](https://raw.githubusercontent.com/turinglabsorg/mar-a-algo/HEAD/contracts/artifacts/MAGA20.arc56.json) |
