...
```bash
pip install arc56-generated-aorumbayev-arcontextify
```
...
from arc56_generated_aorumbayev_arcontextify import HelloWorld_563a5276

algorand = AlgorandClient.mainnet()
client = HelloWorld_563a5276.HelloWorldClient(
    algorand=algorand,
    app_id=123456789,
)
