...
export const APP_SPEC: Arc56Contract = {"name":"MerkleTree","structs":{},"methods":[{"name":"create","args":[{"type":"byte[32]","name":"root"}],"returns":{"type":"void"},"actions":{"create":["NoOp"],"call":[]},"readonly":false,"events":[],"recommendations":{}},{"name":"verify","args":[{"type":"byte[32][]","name":"proof"},{"type":"byte[32]","name":"leaf"}],"returns":{"type":"bool"},"actions":{"create":[],"call":["NoOp"]},"readonly":false,"events":[],"recommendations":{}}],"arcs":[22,28],"networks":{},"state":{"schema":{"global":{"ints":0,"bytes":1},"local":{"ints":0,"bytes":0}},"keys":{"global":{"root":{"keyType":"AVMString","valueType":"AVMBytes","key":"cm9vdA=="}},"local":{},"box":{}},"maps":{"global":{},"local":{},"box":{}}},"bareActions":{"create":[],"call":[]},"sourceInfo":{"approval":{"sourceInfo":[{"pc":[131],"errorMessage":"Index access is out of bounds"},{"pc":[44,78],"errorMessage":"OnCompletion is not NoOp"},{"pc":[82],"errorMessage":"can only call when creating"},{"pc":[47],"errorMessage":"can only call when not creating"},{"pc":[105],"errorMessage":"check self.root exists"}],"pcOffsetMethod":"none"},"clear":{"sourceInfo":[],"pcOffsetMethod":"none"}},"events":[]} as unknown as Arc56Contract
