...
export type VotingRoundAppTypes = {
  ...
  state: {
    ...
    box: {
      ...
      maps: {
        votesByAccount: Map<Uint8Array | string, number[]>
      }
    }
  }
}
  ...
  state = {
    ...
    box: {
      ...
      votesByAccount: {
         ...
         */
        getMap: async (): Promise<Map<Uint8Array, number[]>> => { return (await this.appClient.state.box.getMap("votes_by_account")) as Map<Uint8Array, number[]> },
        /**
         * Get a current value of the votes_by_account map by key from box state
         */
        value: async (key: Uint8Array | string): Promise<number[] | undefined> => { return await this.appClient.state.box.getMapValue("votes_by_account", key) as number[] | undefined },
      },
    },
  }
