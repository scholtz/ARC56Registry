...
_APP_SPEC_JSON = r"""{"arcs": [22, 28], "bareActions": {"call": [], "create": []}, "methods": [{"actions": {"call": [], "create": ["NoOp"]}, "args": [{"type": "string", "name": "vote_id"}, {"type": "byte[]", "name": "snapshot_public_key"}, {"type": "string", "name": "metadata_ipfs_cid"}, {"type": "uint64", "name": "start_time"}, {"type": "uint64", "name": "end_time"}, {"type": "uint8[]", "name": "option_counts"}, {"type": "uint64", "name": "quorum"}, {"type": "string", "name": "nft_image_url"}], "name": "create", "returns": {"type": "void"}, "events": [], "readonly": false, "recommendations": {}}, {"actions": {"call": ["NoOp"], "create": []}, "args": [{"type": "pay", "name": "fund_min_bal_req"}], "name": "bootstrap", "returns": {"type": "void"}, "events": [], "readonly": false, "recommendations": {}}, {"actions": {"call": ["NoOp"], "create": []}, "args": [], "name": "close", "returns": {"type": "void"}, "events": [], "readonly": false, "recommendations": {}}, {"actions": {"call": ["NoOp"], "create": []}, "args": [{"type": "byte[]", "name": "signature"}], "name": "get_preconditions", "returns": {"type": "(uint64,uint64,uint64,uint64)", "struct": "VotingPreconditions"}, "events": [], "readonly": true, "recommendations": {}}, {"actions": {"call": ["NoOp"], "create": []}, "args": [{"type": "pay", "name": "fund_min_bal_req"}, {"type": "byte[]", "name": "signature"}, {"type": "uint8[]", "name": "answer_ids"}], "name": "vote", "returns": {"type": "void"}, "events": [], "readonly": false, "recommendations": {}}], "name": "VotingRoundApp", "state": {"keys": {"box": {"tally_box": {"key": "Vg==", "keyType": "AVMString", "valueType": "AVMBytes"}}, "global": {"is_bootstrapped": {"key": "aXNfYm9vdHN0cmFwcGVk", "keyType": "AVMString", "valueType": "AVMUint64"}, "voter_count": {"key": "dm90ZXJfY291bnQ=", "keyType": "AVMString", "valueType": "AVMUint64"}, "close_time": {"key": "Y2xvc2VfdGltZQ==", "keyType": "AVMString", "valueType": "AVMUint64"}, "vote_id": {"key": "dm90ZV9pZA==", "keyType": "AVMString", "valueType": "AVMString"}, "snapshot_public_key": {"key": "c25hcHNob3RfcHVibGljX2tleQ==", "keyType": "AVMString", "valueType": "AVMBytes"}, "metadata_ipfs_cid": {"key": "bWV0YWRhdGFfaXBmc19jaWQ=", "keyType": "AVMString", "valueType": "AVMString"}, "start_time": {"key": "c3RhcnRfdGltZQ==", "keyType": "AVMString", "valueType": "AVMUint64"}, "end_time": {"key": "ZW5kX3RpbWU=", "keyType": "AVMString", "valueType": "AVMUint64"}, "quorum": {"key": "cXVvcnVt", "keyType": "AVMString", "valueType": "AVMUint64"}, "nft_image_url": {"key": "bmZ0X2ltYWdlX3VybA==", "keyType": "AVMString", "valueType": "AVMString"}, "nft_asset_id": {"key": "bmZ0X2Fzc2V0X2lk", "keyType": "AVMString", "valueType": "AVMUint64"}, "option_counts": {"key": "b3B0aW9uX2NvdW50cw==", "keyType": "AVMString", "valueType": "uint8[]"}, "total_options": {"key": "dG90YWxfb3B0aW9ucw==", "keyType": "AVMString", "valueType": "AVMUint64"}}, "local": {}}, "maps": {"box": {"votes_by_account": {"keyType": "AVMBytes", "valueType": "uint8[]", "prefix": ""}}, "global": {}, "local": {}}, "schema": {"global": {"bytes": 5, "ints": 8}, "local": {"bytes": 0, "ints": 0}}}, "structs": {"VotingPreconditions": [{"name": "is_voting_open", "type": "uint64"}, {"name": "is_allowed_to_vote", "type": "uint64"}, {"name": "has_already_voted", "type": "uint64"}, {"name": "current_time", "type": "uint64"}]}, "events": [], "networks": {}, "sourceInfo": {"approval": {"pcOffsetMethod": "none", "sourceInfo": [{"pc": [664], "errorMessage": "Already closed"}, {"pc": [1217], "errorMessage": "Already voted"}, {"pc": [1295], "errorMessage": "Answer option index invalid"}, {"pc": [536], "errorMessage": "Can't have more than 112 questions"}, {"pc": [577], "errorMessage": "Can't have more than 128 vote options"}, {"pc": [485], "errorMessage": "End time should be after start time"}, {"pc": [491], "errorMessage": "End time should be in the future"}, {"pc": [924], "errorMessage": "Index access is out of bounds"}, {"pc": [595], "errorMessage": "Must not be already bootstrapped"}, {"pc": [1206], "errorMessage": "Not allowed to vote"}, {"pc": [1233], "errorMessage": "Number of answers incorrect"}, {"pc": [243, 274, 301, 313, 335], "errorMessage": "OnCompletion is not NoOp"}, {"pc": [632], "errorMessage": "Payment must be for the exact min balance requirement"}, {"pc": [1261], "errorMessage": "Payment must be the exact min balance"}, {"pc": [606, 1252], "errorMessage": "Payment must be to app address"}, {"pc": [1210], "errorMessage": "Voting not open"}, {"pc": [339], "errorMessage": "can only call when creating"}, {"pc": [246, 277, 304, 316], "errorMessage": "can only call when not creating"}, {"pc": [1386], "errorMessage": "check self.end_time exists"}, {"pc": [593, 1355], "errorMessage": "check self.is_bootstrapped exists"}, {"pc": [809], "errorMessage": "check self.metadata_ipfs_cid exists"}, {"pc": [1103], "errorMessage": "check self.nft_image_url exists"}, {"pc": [898, 1221, 1286], "errorMessage": "check self.option_counts exists"}, {"pc": [845], "errorMessage": "check self.quorum exists"}, {"pc": [1416], "errorMessage": "check self.snapshot_public_key exists"}, {"pc": [1372], "errorMessage": "check self.start_time exists"}, {"pc": [611], "errorMessage": "check self.total_options exists"}, {"pc": [673, 825, 1080], "errorMessage": "check self.vote_id exists"}, {"pc": [870, 1333], "errorMessage": "check self.voter_count exists"}, {"pc": [532], "errorMessage": "option_counts should be non-empty"}, {"pc": [256, 326], "errorMessage": "transaction type is pay"}]}, "clear": {"pcOffsetMethod": "none", "sourceInfo": []}}}"""
...
class _BoxState:
    ...
    @property
    def votes_by_account(self) -> "_MapState[bytes, list[int]]":
