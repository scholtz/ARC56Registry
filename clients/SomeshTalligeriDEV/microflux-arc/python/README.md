...
```bash
pip install arc56-generated-someshtalligeridev-microflux-arc
```
...
from arc56_generated_someshtalligeridev_microflux_arc import WorkflowExecutor_ce5c4b0d

algorand = AlgorandClient.mainnet()
client = WorkflowExecutor_ce5c4b0d.WorkflowExecutorClient(
    algorand=algorand,
    app_id=123456789,
)
