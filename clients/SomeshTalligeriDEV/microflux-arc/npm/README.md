...
```bash
npm install arc56-generated-someshtalligeridev-microflux-arc @algorandfoundation/algokit-utils algosdk
```
...
import { WorkflowExecutor_ce5c4b0d } from "arc56-generated-someshtalligeridev-microflux-arc";

const algorand = AlgorandClient.mainNet();
const client = new WorkflowExecutor_ce5c4b0d.WorkflowExecutorClient({
  algorand,
  appId: 123456789n,
});
