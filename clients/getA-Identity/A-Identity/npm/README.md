...
```bash
npm install arc56-generated-geta-identity-a-identity @algorandfoundation/algokit-utils algosdk
```
...
import { AgentSpendPolicy_26db1a97 } from "arc56-generated-geta-identity-a-identity";

const algorand = AlgorandClient.mainNet();
const client = new AgentSpendPolicy_26db1a97.AgentSpendPolicyClient({
  algorand,
  appId: 123456789n,
});
