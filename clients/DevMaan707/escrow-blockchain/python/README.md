...
```bash
pip install arc56-generated-devmaan707-escrow-blockchain
```
...
from arc56_generated_devmaan707_escrow_blockchain import HelloWorld_000577fb

algorand = AlgorandClient.mainnet()
client = HelloWorld_000577fb.HelloWorldClient(
    algorand=algorand,
    app_id=123456789,
)
