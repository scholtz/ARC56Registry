...
```bash
pip install arc56-generated-lucasucal-event-organiser-scanner
```
...
from arc56_generated_lucasucal_event_organiser_scanner import HelloWorld_e9ae8d43

algorand = AlgorandClient.mainnet()
client = HelloWorld_e9ae8d43.HelloWorldClient(
    algorand=algorand,
    app_id=123456789,
)
