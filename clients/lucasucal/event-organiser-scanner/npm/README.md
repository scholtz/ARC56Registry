...
```bash
npm install arc56-generated-lucasucal-event-organiser-scanner @algorandfoundation/algokit-utils algosdk
```
...
import { HelloWorld_e9ae8d43 } from "arc56-generated-lucasucal-event-organiser-scanner";

const algorand = AlgorandClient.mainNet();
const client = new HelloWorld_e9ae8d43.HelloWorldClient({
  algorand,
  appId: 123456789n,
});
