...
```bash
pip install arc56-generated-panacea-icono-panas-token
```
...
from arc56_generated_panacea_icono_panas_token import HelloWorld_141f8c51

algorand = AlgorandClient.mainnet()
client = HelloWorld_141f8c51.HelloWorldClient(
    algorand=algorand,
    app_id=123456789,
)
