...
```bash
npm install arc56-generated-panacea-icono-panas-token @algorandfoundation/algokit-utils algosdk
```
...
import { HelloWorld_141f8c51 } from "arc56-generated-panacea-icono-panas-token";

const algorand = AlgorandClient.mainNet();
const client = new HelloWorld_141f8c51.HelloWorldClient({
  algorand,
  appId: 123456789n,
});
