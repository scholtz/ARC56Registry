...
```bash
pip install arc56-generated-prithvirajjadhav2266-lumaaaa
```
...
from arc56_generated_prithvirajjadhav2266_lumaaaa import EventTicketing_948fa82c

algorand = AlgorandClient.mainnet()
client = EventTicketing_948fa82c.EventTicketingClient(
    algorand=algorand,
    app_id=123456789,
)
