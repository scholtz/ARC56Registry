...
```bash
pip install arc56-generated-kudbeezero-frintier-on-solana
```
...
from arc56_generated_kudbeezero_frintier_on_solana import GrowPodEmpire_9de6e076

algorand = AlgorandClient.mainnet()
client = GrowPodEmpire_9de6e076.GrowPodEmpireClient(
    algorand=algorand,
    app_id=123456789,
)
