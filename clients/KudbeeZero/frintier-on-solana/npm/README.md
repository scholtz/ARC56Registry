...
```bash
npm install arc56-generated-kudbeezero-frintier-on-solana @algorandfoundation/algokit-utils algosdk
```
...
import { GrowPodEmpire_9de6e076 } from "arc56-generated-kudbeezero-frintier-on-solana";

const algorand = AlgorandClient.mainNet();
const client = new GrowPodEmpire_9de6e076.GrowPodEmpireClient({
  algorand,
  appId: 123456789n,
});
