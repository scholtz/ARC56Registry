...
```bash
npm install arc56-generated-kudbeezero-algo-unify-dev @algorandfoundation/algokit-utils algosdk
```
...
import { GrowPodEmpire_55e75d8c } from "arc56-generated-kudbeezero-algo-unify-dev";

const algorand = AlgorandClient.mainNet();
const client = new GrowPodEmpire_55e75d8c.GrowPodEmpireClient({
  algorand,
  appId: 123456789n,
});
