...
```bash
pip install arc56-generated-kudbeezero-growpodempirev1-0
```
...
from arc56_generated_kudbeezero_growpodempirev1_0 import GrowPodEmpire_a6359ac5

algorand = AlgorandClient.mainnet()
client = GrowPodEmpire_a6359ac5.GrowPodEmpireClient(
    algorand=algorand,
    app_id=123456789,
)
