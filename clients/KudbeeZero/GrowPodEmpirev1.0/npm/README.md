...
```bash
npm install arc56-generated-kudbeezero-growpodempirev1-0 @algorandfoundation/algokit-utils algosdk
```
...
import { GrowPodEmpire_a6359ac5 } from "arc56-generated-kudbeezero-growpodempirev1-0";

const algorand = AlgorandClient.mainNet();
const client = new GrowPodEmpire_a6359ac5.GrowPodEmpireClient({
  algorand,
  appId: 123456789n,
});
...
| --- | --- | --- |
| `GrowPodEmpire_a6359ac5` | `GrowPodEmpireClient` | [https://raw.githubusercontent.com/KudbeeZero/GrowPodEmpirev1.0/HEAD/contracts/artifacts/GrowPodEmpire.arc56.json](https://raw.githubusercontent.com/KudbeeZero/GrowPodEmpirev1.0/HEAD/contracts/artifacts/GrowPodEmpire.arc56.json) |
