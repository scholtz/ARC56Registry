...
```bash
npm install arc56-generated-rahulscripts-livehack @algorandfoundation/algokit-utils algosdk
```
...
import { CarbonCreditContract_155ab92e } from "arc56-generated-rahulscripts-livehack";

const algorand = AlgorandClient.mainNet();
const client = new CarbonCreditContract_155ab92e.CarbonCreditContractClient({
  algorand,
  appId: 123456789n,
});
