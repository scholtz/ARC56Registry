...
class _Arc56StructOperationsOptIn:
...
class Arc56StructOperationsParams:
    def __init__(self, app_client: algokit_utils.AppClient):
        self.app_client = app_client

    @property
    def opt_in(self) -> "_Arc56StructOperationsOptIn":
        return _Arc56StructOperationsOptIn(self.app_client)
...
class _Arc56StructOperationsOptInTransaction:
    def __init__(self, app_client: algokit_utils.AppClient):
        self.app_client = app_client
...
class Arc56StructOperationsCreateTransactionParams:
    def __init__(self, app_client: algokit_utils.AppClient):
        self.app_client = app_client

    @property
    def opt_in(self) -> "_Arc56StructOperationsOptInTransaction":
        return _Arc56StructOperationsOptInTransaction(self.app_client)
...
class _Arc56StructOperationsOptInSend:
    def __init__(self, app_client: algokit_utils.AppClient):
        self.app_client = app_client
...
class Arc56StructOperationsSend:
    def __init__(self, app_client: algokit_utils.AppClient):
        self.app_client = app_client

    @property
    def opt_in(self) -> "_Arc56StructOperationsOptInSend":
        return _Arc56StructOperationsOptInSend(self.app_client)
...
class Arc56StructOperationsState:
...
class Arc56StructOperationsClient:
    """Client for interacting with Arc56StructOperations smart contract"""
    ...
    def __init__(
        ...
        *,
        ...
        self.params = Arc56StructOperationsParams(self.app_client)
        self.create_transaction = Arc56StructOperationsCreateTransactionParams(self.app_client)
        self.send = Arc56StructOperationsSend(self.app_client)
        self.state = Arc56StructOperationsState(self.app_client)
    ...
    ) -> "Arc56StructOperationsClient":
        return Arc56StructOperationsClient(
    ...
    def new_group(self) -> "Arc56StructOperationsComposer":
        return Arc56StructOperationsComposer(self)
...
class _Arc56StructOperationsOptInComposer:
    def __init__(self, composer: "Arc56StructOperationsComposer"):
        self.composer = composer
    def opt_in_to_application(
        self,
        params: algokit_utils.CommonAppCallParams | None = None
    ) -> "Arc56StructOperationsComposer":
...
class Arc56StructOperationsComposer:
    """Composer for creating transaction groups for Arc56StructOperations contract calls"""

    def __init__(self, client: "Arc56StructOperationsClient"):
        self.client = client
        self._composer = client.algorand.new_group()
        self._result_mappers: list[typing.Callable[[algokit_utils.ABIReturn | None], object] | None] = []

    @property
    def opt_in(self) -> "_Arc56StructOperationsOptInComposer":
        return _Arc56StructOperationsOptInComposer(self)
