...
class NestedContractCallsParams:
...
class NestedContractCallsCreateTransactionParams:
    def __init__(self, app_client: algokit_utils.AppClient):
        self.app_client = app_client
...
class NestedContractCallsState:
    """Methods to access state for the current NestedContractCalls app"""

    def __init__(self, app_client: algokit_utils.AppClient):
        self.app_client = app_client

class NestedContractCallsClient:
    """Client for interacting with NestedContractCalls smart contract"""
    ...
    def __init__(
        ...
        *,
        ...
        self.params = NestedContractCallsParams(self.app_client)
        self.create_transaction = NestedContractCallsCreateTransactionParams(self.app_client)
        self.send = NestedContractCallsSend(self.app_client)
        self.state = NestedContractCallsState(self.app_client)
    ...
    ) -> "NestedContractCallsClient":
        return NestedContractCallsClient(
    ...
    def new_group(self) -> "NestedContractCallsComposer":
        return NestedContractCallsComposer(self)
...
class NestedContractCallsComposer:
    """Composer for creating transaction groups for NestedContractCalls contract calls"""

    def __init__(self, client: "NestedContractCallsClient"):
        self.client = client
