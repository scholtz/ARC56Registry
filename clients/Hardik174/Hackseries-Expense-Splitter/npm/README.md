...
```bash
npm install arc56-generated-hardik174-hackseries-expense-splitter @algorandfoundation/algokit-utils algosdk
```
...
import { ExpensePoolContract_22752c29 } from "arc56-generated-hardik174-hackseries-expense-splitter";

const algorand = AlgorandClient.mainNet();
const client = new ExpensePoolContract_22752c29.ExpensePoolContractClient({
  algorand,
  appId: 123456789n,
});
