...
```bash
npm install arc56-generated-protiusprotocol-augurion-predictive-markets @algorandfoundation/algokit-utils algosdk
```
...
import { ProjectRegistry_fc0d6c45 } from "arc56-generated-protiusprotocol-augurion-predictive-markets";

const algorand = AlgorandClient.mainNet();
const client = new ProjectRegistry_fc0d6c45.ProjectRegistryClient({
  algorand,
  appId: 123456789n,
});
