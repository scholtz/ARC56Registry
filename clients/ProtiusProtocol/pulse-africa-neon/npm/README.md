# arc56-generated-protiusprotocol-pulse-africa-neon

Auto-generated typed Algorand smart-contract clients for **[ProtiusProtocol/pulse-africa-neon](https://github.com/ProtiusProtocol/pulse-africa-neon)**,
...
```bash
npm install arc56-generated-protiusprotocol-pulse-africa-neon @algorandfoundation/algokit-utils algosdk
```
...
import { AugurionMarketV4_d967d5b9 } from "arc56-generated-protiusprotocol-pulse-africa-neon";

const algorand = AlgorandClient.mainNet();
const client = new AugurionMarketV4_d967d5b9.AugurionMarketV4Client({
  algorand,
  appId: 123456789n,
});
...
| --- | --- | --- |
| `AugurionMarketV4_d967d5b9` | `AugurionMarketV4Client` | [https://raw.githubusercontent.com/ProtiusProtocol/pulse-africa-neon/HEAD/src/contracts/AugurionMarketV4.arc56.json](https://raw.githubusercontent.com/ProtiusProtocol/pulse-africa-neon/HEAD/src/contracts/AugurionMarketV4.arc56.json) |
| `AugurionMarketV4_ed187e58` | `AugurionMarketV4Client` | [https://raw.githubusercontent.com/ProtiusProtocol/pulse-africa-neon/HEAD/supabase/functions/deploy-market/AugurionMarketV4.arc56.json](https://raw.githubusercontent.com/ProtiusProtocol/pulse-africa-neon/HEAD/supabase/functions/deploy-market/AugurionMarketV4.arc56.json) |
