...
```bash
pip install arc56-generated-protiusprotocol-pulse-africa-neon
```
...
from arc56_generated_protiusprotocol_pulse_africa_neon import AugurionMarketV4_d967d5b9

algorand = AlgorandClient.mainnet()
client = AugurionMarketV4_d967d5b9.AugurionMarketV4Client(
    algorand=algorand,
    app_id=123456789,
)
