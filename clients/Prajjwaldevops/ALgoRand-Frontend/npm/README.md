...
```bash
npm install arc56-generated-prajjwaldevops-algorand-frontend @algorandfoundation/algokit-utils algosdk
```
...
import { BountyEscrow_e42785bd } from "arc56-generated-prajjwaldevops-algorand-frontend";

const algorand = AlgorandClient.mainNet();
const client = new BountyEscrow_e42785bd.BountyEscrowClient({
  algorand,
  appId: 123456789n,
});
...
| --- | --- | --- |
| `BountyEscrow_e42785bd` | `BountyEscrowClient` | [https://raw.githubusercontent.com/Prajjwaldevops/ALgoRand-Frontend/HEAD/public/BountyEscrow.arc56.json](https://raw.githubusercontent.com/Prajjwaldevops/ALgoRand-Frontend/HEAD/public/BountyEscrow.arc56.json) |
