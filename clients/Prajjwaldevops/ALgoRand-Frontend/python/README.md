...
```bash
pip install arc56-generated-prajjwaldevops-algorand-frontend
```
...
from arc56_generated_prajjwaldevops_algorand_frontend import BountyEscrow_e42785bd

algorand = AlgorandClient.mainnet()
client = BountyEscrow_e42785bd.BountyEscrowClient(
    algorand=algorand,
    app_id=123456789,
)
