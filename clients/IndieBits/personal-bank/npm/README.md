...
```bash
npm install arc56-generated-indiebits-personal-bank @algorandfoundation/algokit-utils algosdk
```
...
import { PersonalBank_151dde7d } from "arc56-generated-indiebits-personal-bank";

const algorand = AlgorandClient.mainNet();
const client = new PersonalBank_151dde7d.PersonalBankClient({
  algorand,
  appId: 123456789n,
});
...
| --- | --- | --- |
| `PersonalBank_151dde7d` | `PersonalBankClient` | [https://raw.githubusercontent.com/IndieBits/personal-bank/HEAD/smart_contracts/artifacts/personal_bank/PersonalBank.arc56.json](https://raw.githubusercontent.com/IndieBits/personal-bank/HEAD/smart_contracts/artifacts/personal_bank/PersonalBank.arc56.json) |
