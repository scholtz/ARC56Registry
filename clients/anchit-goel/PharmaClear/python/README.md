...
```bash
pip install arc56-generated-anchit-goel-pharmaclear
```
...
from arc56_generated_anchit_goel_pharmaclear import PharmaClear_c850fb71

algorand = AlgorandClient.mainnet()
client = PharmaClear_c850fb71.PharmaClearClient(
    algorand=algorand,
    app_id=123456789,
)
