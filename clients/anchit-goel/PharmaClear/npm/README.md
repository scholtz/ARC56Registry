...
```bash
npm install arc56-generated-anchit-goel-pharmaclear @algorandfoundation/algokit-utils algosdk
```
...
import { PharmaClear_c850fb71 } from "arc56-generated-anchit-goel-pharmaclear";

const algorand = AlgorandClient.mainNet();
const client = new PharmaClear_c850fb71.PharmaClearClient({
  algorand,
  appId: 123456789n,
});
