...
```bash
dotnet add package Arc56.Generated.DedMoroz38.AI-assisted-NFT-deployment
```
...
| --- | --- | --- |
| `Arc56.Generated.DedMoroz38.AI_assisted_NFT_deployment.NFTPromptRegistry_26752953` | _(fails to compile - excluded, see state.json)_ | [https://raw.githubusercontent.com/DedMoroz38/AI-assisted-NFT-deployment/HEAD/front/lib/NFTPromptRegistry.arc56.json](https://raw.githubusercontent.com/DedMoroz38/AI-assisted-NFT-deployment/HEAD/front/lib/NFTPromptRegistry.arc56.json) |
| `Arc56.Generated.DedMoroz38.AI_assisted_NFT_deployment.NFTPromptRegistry_a25c5376` | _(fails to compile - excluded, see state.json)_ | [https://raw.githubusercontent.com/DedMoroz38/AI-assisted-NFT-deployment/HEAD/smar-contract/smart_contracts/nft_prompt_registry/NFTPromptRegistry.arc56.json](https://raw.githubusercontent.com/DedMoroz38/AI-assisted-NFT-deployment/HEAD/smar-contract/smart_contracts/nft_prompt_registry/NFTPromptRegistry.arc56.json) |
