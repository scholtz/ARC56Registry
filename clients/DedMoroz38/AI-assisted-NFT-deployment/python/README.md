...
```bash
pip install arc56-generated-dedmoroz38-ai-assisted-nft-deployment
```
...
from arc56_generated_dedmoroz38_ai_assisted_nft_deployment import NFTPromptRegistry_26752953

algorand = AlgorandClient.mainnet()
client = NFTPromptRegistry_26752953.NftPromptRegistryClient(
    algorand=algorand,
    app_id=123456789,
)
