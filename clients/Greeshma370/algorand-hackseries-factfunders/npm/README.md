...
```bash
npm install arc56-generated-greeshma370-algorand-hackseries-factfunders @algorandfoundation/algokit-utils algosdk
```
...
import { ProposalContract_81c12b63 } from "arc56-generated-greeshma370-algorand-hackseries-factfunders";

const algorand = AlgorandClient.mainNet();
const client = new ProposalContract_81c12b63.ProposalContractClient({
  algorand,
  appId: 123456789n,
});
