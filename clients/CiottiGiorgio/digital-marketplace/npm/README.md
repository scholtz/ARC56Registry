...
```bash
npm install arc56-generated-ciottigiorgio-digital-marketplace @algorandfoundation/algokit-utils algosdk
```
...
import { DigitalMarketplace_35481574 } from "arc56-generated-ciottigiorgio-digital-marketplace";

const algorand = AlgorandClient.mainNet();
const client = new DigitalMarketplace_35481574.DigitalMarketplaceClient({
  algorand,
  appId: 123456789n,
});
