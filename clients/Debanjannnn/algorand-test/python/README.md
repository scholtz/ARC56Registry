...
```bash
pip install arc56-generated-debanjannnn-algorand-test
```
...
from arc56_generated_debanjannnn_algorand_test import Todo_bc642d26

algorand = AlgorandClient.mainnet()
client = Todo_bc642d26.TodoClient(
    algorand=algorand,
    app_id=123456789,
)
