...
```bash
npm install arc56-generated-debanjannnn-blahabkad @algorandfoundation/algokit-utils algosdk
```
...
import { Attendance_6c80d9f7 } from "arc56-generated-debanjannnn-blahabkad";

const algorand = AlgorandClient.mainNet();
const client = new Attendance_6c80d9f7.AttendanceClient({
  algorand,
  appId: 123456789n,
});
