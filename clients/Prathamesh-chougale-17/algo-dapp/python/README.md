...
```bash
pip install arc56-generated-prathamesh-chougale-17-algo-dapp
```
...
from arc56_generated_prathamesh_chougale_17_algo_dapp import AlgoRealmGameManager_72381719

algorand = AlgorandClient.mainnet()
client = AlgoRealmGameManager_72381719.AlgoRealmGameManagerClient(
    algorand=algorand,
    app_id=123456789,
)
