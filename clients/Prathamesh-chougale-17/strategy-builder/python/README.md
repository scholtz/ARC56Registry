...
```bash
pip install arc56-generated-prathamesh-chougale-17-strategy-builder
```
...
from arc56_generated_prathamesh_chougale_17_strategy_builder import HelloWorld_a9af6b0f

algorand = AlgorandClient.mainnet()
client = HelloWorld_a9af6b0f.HelloWorldClient(
    algorand=algorand,
    app_id=123456789,
)
