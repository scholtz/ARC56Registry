...
```bash
npm install arc56-generated-prathamesh-chougale-17-strategy-builder @algorandfoundation/algokit-utils algosdk
```
...
import { HelloWorld_a9af6b0f } from "arc56-generated-prathamesh-chougale-17-strategy-builder";

const algorand = AlgorandClient.mainNet();
const client = new HelloWorld_a9af6b0f.HelloWorldClient({
  algorand,
  appId: 123456789n,
});
