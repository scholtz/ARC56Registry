...
```bash
pip install arc56-generated-ghynmo-decentralized-todo-list
```
...
from arc56_generated_ghynmo_decentralized_todo_list import TodoApp_f8e3fdb1

algorand = AlgorandClient.mainnet()
client = TodoApp_f8e3fdb1.TodoAppClient(
    algorand=algorand,
    app_id=123456789,
)
