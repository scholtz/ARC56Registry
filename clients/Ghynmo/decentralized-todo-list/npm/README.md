...
```bash
npm install arc56-generated-ghynmo-decentralized-todo-list @algorandfoundation/algokit-utils algosdk
```
...
import { TodoApp_f8e3fdb1 } from "arc56-generated-ghynmo-decentralized-todo-list";

const algorand = AlgorandClient.mainNet();
const client = new TodoApp_f8e3fdb1.TodoAppClient({
  algorand,
  appId: 123456789n,
});
...
| --- | --- | --- |
| `TodoApp_f8e3fdb1` | `TodoAppClient` | [https://raw.githubusercontent.com/Ghynmo/decentralized-todo-list/HEAD/smart_contracts/artifacts/todo_app/TodoApp.arc56.json](https://raw.githubusercontent.com/Ghynmo/decentralized-todo-list/HEAD/smart_contracts/artifacts/todo_app/TodoApp.arc56.json) |
