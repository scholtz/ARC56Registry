...
```bash
pip install arc56-generated-hashmapsdata2value-leakswap
```
...
from arc56_generated_hashmapsdata2value_leakswap import LeakSwap_53ed141c

algorand = AlgorandClient.mainnet()
client = LeakSwap_53ed141c.LeakSwapClient(
    algorand=algorand,
    app_id=123456789,
)
