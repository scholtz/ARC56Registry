...
```bash
npm install arc56-generated-hashmapsdata2value-leakswap @algorandfoundation/algokit-utils algosdk
```
...
import { LeakSwap_53ed141c } from "arc56-generated-hashmapsdata2value-leakswap";

const algorand = AlgorandClient.mainNet();
const client = new LeakSwap_53ed141c.LeakSwapClient({
  algorand,
  appId: 123456789n,
});
