...
```bash
npm install arc56-generated-hashmapsdata2value-leakswap-protocol @algorandfoundation/algokit-utils algosdk
```
...
import { LeakSwap_542de581 } from "arc56-generated-hashmapsdata2value-leakswap-protocol";

const algorand = AlgorandClient.mainNet();
const client = new LeakSwap_542de581.LeakSwapClient({
  algorand,
  appId: 123456789n,
});
