...
```bash
pip install arc56-generated-rcd-env-trueroots
```
...
from arc56_generated_rcd_env_trueroots import TrueRoots_cdf321b4

algorand = AlgorandClient.mainnet()
client = TrueRoots_cdf321b4.TrueRootsClient(
    algorand=algorand,
    app_id=123456789,
)
