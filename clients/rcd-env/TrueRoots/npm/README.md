...
```bash
npm install arc56-generated-rcd-env-trueroots @algorandfoundation/algokit-utils algosdk
```
...
import { TrueRoots_cdf321b4 } from "arc56-generated-rcd-env-trueroots";

const algorand = AlgorandClient.mainNet();
const client = new TrueRoots_cdf321b4.TrueRootsClient({
  algorand,
  appId: 123456789n,
});
