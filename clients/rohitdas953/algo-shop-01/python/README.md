...
```bash
pip install arc56-generated-rohitdas953-algo-shop-01
```
...
from arc56_generated_rohitdas953_algo_shop_01 import AgentScore_161ed0e9

algorand = AlgorandClient.mainnet()
client = AgentScore_161ed0e9.AgentScoreClient(
    algorand=algorand,
    app_id=123456789,
)
