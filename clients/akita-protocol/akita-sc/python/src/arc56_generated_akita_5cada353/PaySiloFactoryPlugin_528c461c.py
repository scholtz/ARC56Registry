...
class MintArgs:
    ...
    def abi_method_signature(self) -> str:
        return "mint(uint64,bool,address)uint64"


class PaySiloFactoryPluginParams:
...
class PaySiloFactoryPluginCreateTransactionParams:
    def __init__(self, app_client: algokit_utils.AppClient):
        self.app_client = app_client
...
class PaySiloFactoryPluginSend:
    def __init__(self, app_client: algokit_utils.AppClient):
        self.app_client = app_client
...
class PaySiloFactoryPluginState:
    """Methods to access state for the current PaySiloFactoryPlugin app"""

    def __init__(self, app_client: algokit_utils.AppClient):
        self.app_client = app_client

class PaySiloFactoryPluginClient:
    """Client for interacting with PaySiloFactoryPlugin smart contract"""
    ...
    def __init__(
        ...
        *,
        ...
        self.params = PaySiloFactoryPluginParams(self.app_client)
        self.create_transaction = PaySiloFactoryPluginCreateTransactionParams(self.app_client)
        self.send = PaySiloFactoryPluginSend(self.app_client)
        self.state = PaySiloFactoryPluginState(self.app_client)
    ...
    def new_group(self) -> "PaySiloFactoryPluginComposer":
        return PaySiloFactoryPluginComposer(self)

    @typing.overload
    def decode_return_value(
        self,
        method: typing.Literal["mint(uint64,bool,address)uint64"],
...
class PaySiloFactoryPluginComposer:
    """Composer for creating transaction groups for PaySiloFactoryPlugin contract calls"""

    def __init__(self, client: "PaySiloFactoryPluginClient"):
        self.client = client
    ...
    def mint(
        ...
        self._result_mappers.append(
            lambda v: self.client.decode_return_value(
                "mint(uint64,bool,address)uint64", v
            )
        )
        return self
