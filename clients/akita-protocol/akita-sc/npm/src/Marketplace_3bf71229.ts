...
export type MarketplaceCreateCallParams =
  | Expand<CallParams<MarketplaceArgs['obj']['create(string,string,uint64,(string,uint64))void'] | MarketplaceArgs['tuple']['create(string,string,uint64,(string,uint64))void']> & {method: 'create'} & {onComplete?: OnApplicationComplete.NoOpOC} & CreateSchema>
  | Expand<CallParams<MarketplaceArgs['obj']['create(string,string,uint64,(string,uint64))void'] | MarketplaceArgs['tuple']['create(string,string,uint64,(string,uint64))void']> & {method: 'create(string,string,uint64,(string,uint64))void'} & {onComplete?: OnApplicationComplete.NoOpOC} & CreateSchema>
/**
...
export class MarketplaceFactory {
  ...
  readonly params = {
    ...
    create: {
       ...
       */
      create: (params: CallParams<MarketplaceArgs['obj']['create(string,string,uint64,(string,uint64))void'] | MarketplaceArgs['tuple']['create(string,string,uint64,(string,uint64))void']> & AppClientCompilationParams & CreateSchema & {onComplete?: OnApplicationComplete.NoOpOC}) => {
  ...
  readonly send = {
    ...
    create: {
       ...
       */
      create: async (params: CallParams<MarketplaceArgs['obj']['create(string,string,uint64,(string,uint64))void'] | MarketplaceArgs['tuple']['create(string,string,uint64,(string,uint64))void']> & AppClientCompilationParams & CreateSchema & SendParams & {onComplete?: OnApplicationComplete.NoOpOC}) => {
        const result = await this.appFactory.send.create(MarketplaceParamsFactory.create.create(params))
        return { result: { ...result.result, return: result.result.return as unknown as (undefined | MarketplaceReturns['create(string,string,uint64,(string,uint64))void']) }, appClient: new MarketplaceClient(result.appClient) }
      },
    },
