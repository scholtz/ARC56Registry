...
export type PollCreateCallParams =
  | Expand<CallParams<PollArgs['obj']['create(uint64,uint8,uint64,uint64,(address,uint64),string,string[],uint64)void'] | PollArgs['tuple']['create(uint64,uint8,uint64,uint64,(address,uint64),string,string[],uint64)void']> & {method: 'create'} & {onComplete?: OnApplicationComplete.NoOpOC} & CreateSchema>
  | Expand<CallParams<PollArgs['obj']['create(uint64,uint8,uint64,uint64,(address,uint64),string,string[],uint64)void'] | PollArgs['tuple']['create(uint64,uint8,uint64,uint64,(address,uint64),string,string[],uint64)void']> & {method: 'create(uint64,uint8,uint64,uint64,(address,uint64),string,string[],uint64)void'} & {onComplete?: OnApplicationComplete.NoOpOC} & CreateSchema>
/**
 * Defines supported delete method params for this smart contract
 */
export type PollDeleteCallParams =
  | Expand<CallParams<PollArgs['obj']['deleteApplication()void'] | PollArgs['tuple']['deleteApplication()void']> & {method: 'deleteApplication'}>
  | Expand<CallParams<PollArgs['obj']['deleteApplication()void'] | PollArgs['tuple']['deleteApplication()void']> & {method: 'deleteApplication()void'}>
/**
...
export abstract class PollParamsFactory {
  ...
  static get create() {
    return {
       ...
       */
      create(params: CallParams<PollArgs['obj']['create(uint64,uint8,uint64,uint64,(address,uint64),string,string[],uint64)void'] | PollArgs['tuple']['create(uint64,uint8,uint64,uint64,(address,uint64),string,string[],uint64)void']> & AppClientCompilationParams & {onComplete?: OnApplicationComplete.NoOpOC}): AppClientMethodCallParams & AppClientCompilationParams & {onComplete?: OnApplicationComplete.NoOpOC} {
        return {
          ...params,
          method: 'create(uint64,uint8,uint64,uint64,(address,uint64),string,string[],uint64)void' as const,
  ...
  static get delete() {
    return {
      _resolveByMethod<TParams extends PollDeleteCallParams & {method: string}>(params: TParams) {
        switch(params.method) {
          case 'deleteApplication':
          case 'deleteApplication()void':
            return PollParamsFactory.delete.deleteApplication(params)
        }
        throw new Error(`Unknown ' + verb + ' method`)
      },
...
export class PollFactory {
  ...
  public async deploy(params: PollDeployParams = {}) {
    const result = await this.appFactory.deploy({
      ...
      deleteParams: params.deleteParams?.method ? PollParamsFactory.delete._resolveByMethod(params.deleteParams) : params.deleteParams ? params.deleteParams as (PollDeleteCallParams & { args: Uint8Array[] }) : undefined,
    })
  ...
  readonly params = {
    ...
    create: {
       ...
       */
      create: (params: CallParams<PollArgs['obj']['create(uint64,uint8,uint64,uint64,(address,uint64),string,string[],uint64)void'] | PollArgs['tuple']['create(uint64,uint8,uint64,uint64,(address,uint64),string,string[],uint64)void']> & AppClientCompilationParams & CreateSchema & {onComplete?: OnApplicationComplete.NoOpOC}) => {
    ...
    deployDelete: {
       ...
       */
      deleteApplication: (params: CallParams<PollArgs['obj']['deleteApplication()void'] | PollArgs['tuple']['deleteApplication()void']> = {args: []}) => {
  ...
  readonly send = {
    ...
    create: {
       ...
       */
      create: async (params: CallParams<PollArgs['obj']['create(uint64,uint8,uint64,uint64,(address,uint64),string,string[],uint64)void'] | PollArgs['tuple']['create(uint64,uint8,uint64,uint64,(address,uint64),string,string[],uint64)void']> & AppClientCompilationParams & CreateSchema & SendParams & {onComplete?: OnApplicationComplete.NoOpOC}) => {
        const result = await this.appFactory.send.create(PollParamsFactory.create.create(params))
        return { result: { ...result.result, return: result.result.return as unknown as (undefined | PollReturns['create(uint64,uint8,uint64,uint64,(address,uint64),string,string[],uint64)void']) }, appClient: new PollClient(result.appClient) }
      },
    },
...
export class PollClient {
  ...
  readonly send = {
    ...
    delete: {
       ...
       */
      deleteApplication: async (params: CallParams<PollArgs['obj']['deleteApplication()void'] | PollArgs['tuple']['deleteApplication()void']> & SendParams = {args: []}) => {
        const result = await this.appClient.send.delete(PollParamsFactory.delete.deleteApplication(params))
        return {...result, return: result.return as unknown as (undefined | PollReturns['deleteApplication()void'])}
      },
