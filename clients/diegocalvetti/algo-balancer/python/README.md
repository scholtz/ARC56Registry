...
```bash
pip install arc56-generated-diegocalvetti-algo-balancer
```
...
from arc56_generated_diegocalvetti_algo_balancer import Factory_45fe36a6

algorand = AlgorandClient.mainnet()
client = Factory_45fe36a6.FactoryClient(
    algorand=algorand,
    app_id=123456789,
)
