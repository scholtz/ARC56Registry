...
export type HelloWorldContractTypes = {
  ...
  methods:
    & Record<'hello(string)string' | 'hello', {
      argsObj: HelloWorldContractArgs['obj']['hello(string)string']
      argsTuple: HelloWorldContractArgs['tuple']['hello(string)string']
      returns: HelloWorldContractReturns['hello(string)string']
    }>
}
...
export abstract class HelloWorldContractParamsFactory {
   ...
   */
  static hello(params: CallParams<HelloWorldContractArgs['obj']['hello(string)string'] | HelloWorldContractArgs['tuple']['hello(string)string']> & CallOnComplete): AppClientMethodCallParams & CallOnComplete {
    return {
      ...params,
...
export class HelloWorldContractClient {
  ...
  readonly params = {
    ...
    /**
     * Makes a call to the HelloWorldContract smart contract using the `hello(string)string` ABI method.
     *
     * @param params The params for the smart contract call
     * @returns The call params
     */
    hello: (params: CallParams<HelloWorldContractArgs['obj']['hello(string)string'] | HelloWorldContractArgs['tuple']['hello(string)string']> & {onComplete?: OnApplicationComplete.NoOpOC}) => {
      return this.appClient.params.call(HelloWorldContractParamsFactory.hello(params))
    },
  ...
  readonly createTransaction = {
     ...
     */
    hello: (params: CallParams<HelloWorldContractArgs['obj']['hello(string)string'] | HelloWorldContractArgs['tuple']['hello(string)string']> & {onComplete?: OnApplicationComplete.NoOpOC}) => {
      return this.appClient.createTransaction.call(HelloWorldContractParamsFactory.hello(params))
    },
  ...
  readonly send = {
     ...
     */
    hello: async (params: CallParams<HelloWorldContractArgs['obj']['hello(string)string'] | HelloWorldContractArgs['tuple']['hello(string)string']> & SendParams & {onComplete?: OnApplicationComplete.NoOpOC}) => {
      const result = await this.appClient.send.call(HelloWorldContractParamsFactory.hello(params))
      return {...result, return: result.return as unknown as (undefined | HelloWorldContractReturns['hello(string)string'])}
    },
  ...
  public newGroup(): HelloWorldContractComposer {
    ...
    return {
      /**
       * Add a hello(string)string method call against the HelloWorldContract contract
       */
      hello(params: CallParams<HelloWorldContractArgs['obj']['hello(string)string'] | HelloWorldContractArgs['tuple']['hello(string)string']> & {onComplete?: OnApplicationComplete.NoOpOC}) {
...
export type HelloWorldContractComposer<TReturns extends [...any[]] = []> = {
   ...
   */
  hello(params?: CallParams<HelloWorldContractArgs['obj']['hello(string)string'] | HelloWorldContractArgs['tuple']['hello(string)string']>): HelloWorldContractComposer<[...TReturns, HelloWorldContractReturns['hello(string)string'] | undefined]>
