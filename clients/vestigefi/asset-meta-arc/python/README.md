...
```bash
pip install arc56-generated-vestigefi-asset-meta-arc
```
...
from arc56_generated_vestigefi_asset_meta_arc import AsaMetadataManager_bd2fd56f

algorand = AlgorandClient.mainnet()
client = AsaMetadataManager_bd2fd56f.AsaMetadataManagerClient(
    algorand=algorand,
    app_id=123456789,
)
