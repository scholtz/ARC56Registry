...
```bash
npm install arc56-generated-vestigefi-asset-meta-arc @algorandfoundation/algokit-utils algosdk
```
...
import { AsaMetadataManager_bd2fd56f } from "arc56-generated-vestigefi-asset-meta-arc";

const algorand = AlgorandClient.mainNet();
const client = new AsaMetadataManager_bd2fd56f.AsaMetadataManagerClient({
  algorand,
  appId: 123456789n,
});
...
| --- | --- | --- |
| `AsaMetadataManager_bd2fd56f` | `AsaMetadataManagerClient` | [https://raw.githubusercontent.com/vestigefi/asset-meta-arc/HEAD/artifacts/AsaMetadataManager.arc56.json](https://raw.githubusercontent.com/vestigefi/asset-meta-arc/HEAD/artifacts/AsaMetadataManager.arc56.json) |
