...
```bash
pip install arc56-generated-kastedo-personal-bank
```
...
from arc56_generated_kastedo_personal_bank import PersonalBank_a9bb20a9

algorand = AlgorandClient.mainnet()
client = PersonalBank_a9bb20a9.PersonalBankClient(
    algorand=algorand,
    app_id=123456789,
)
