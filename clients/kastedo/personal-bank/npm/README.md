...
```bash
npm install arc56-generated-kastedo-personal-bank @algorandfoundation/algokit-utils algosdk
```
...
import { PersonalBank_a9bb20a9 } from "arc56-generated-kastedo-personal-bank";

const algorand = AlgorandClient.mainNet();
const client = new PersonalBank_a9bb20a9.PersonalBankClient({
  algorand,
  appId: 123456789n,
});
...
| --- | --- | --- |
| `PersonalBank_a9bb20a9` | `PersonalBankClient` | [https://raw.githubusercontent.com/kastedo/personal-bank/HEAD/smart_contracts/artifacts/personal_bank/PersonalBank.arc56.json](https://raw.githubusercontent.com/kastedo/personal-bank/HEAD/smart_contracts/artifacts/personal_bank/PersonalBank.arc56.json) |
