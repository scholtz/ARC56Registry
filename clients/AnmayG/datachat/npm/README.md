...
```bash
npm install arc56-generated-anmayg-datachat @algorandfoundation/algokit-utils algosdk
```
...
import { HandshakeApp_2fd9d395 } from "arc56-generated-anmayg-datachat";

const algorand = AlgorandClient.mainNet();
const client = new HandshakeApp_2fd9d395.HandshakeAppClient({
  algorand,
  appId: 123456789n,
});
...
| --- | --- | --- |
| `HandshakeApp_2fd9d395` | `HandshakeAppClient` | [https://raw.githubusercontent.com/AnmayG/datachat/HEAD/src/smartcontract/HandshakeApp.arc56.json](https://raw.githubusercontent.com/AnmayG/datachat/HEAD/src/smartcontract/HandshakeApp.arc56.json) |
