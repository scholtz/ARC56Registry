...
```bash
pip install arc56-generated-anmayg-datachat
```
...
from arc56_generated_anmayg_datachat import HandshakeApp_2fd9d395

algorand = AlgorandClient.mainnet()
client = HandshakeApp_2fd9d395.HandshakeAppClient(
    algorand=algorand,
    app_id=123456789,
)
