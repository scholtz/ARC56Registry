# Arc56.Generated.chv-sneha.TenderVault

Auto-generated typed Algorand smart-contract clients for **[chv-sneha/TenderVault](https://github.com/chv-sneha/TenderVault)**,
...
```bash
dotnet add package Arc56.Generated.chv-sneha.TenderVault
```
