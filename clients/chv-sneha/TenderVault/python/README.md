...
```bash
pip install arc56-generated-chv-sneha-tendervault
```
...
from arc56_generated_chv_sneha_tendervault import HelloWorld_aba6b132

algorand = AlgorandClient.mainnet()
client = HelloWorld_aba6b132.HelloWorldClient(
    algorand=algorand,
    app_id=123456789,
)
