...
```bash
npm install arc56-generated-chv-sneha-tendervault @algorandfoundation/algokit-utils algosdk
```
...
import { HelloWorld_aba6b132 } from "arc56-generated-chv-sneha-tendervault";

const algorand = AlgorandClient.mainNet();
const client = new HelloWorld_aba6b132.HelloWorldClient({
  algorand,
  appId: 123456789n,
});
