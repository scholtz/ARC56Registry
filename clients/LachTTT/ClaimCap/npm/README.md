...
```bash
npm install arc56-generated-lachttt-claimcap @algorandfoundation/algokit-utils algosdk
```
...
import { ClaimCap_2de92bf9 } from "arc56-generated-lachttt-claimcap";

const algorand = AlgorandClient.mainNet();
const client = new ClaimCap_2de92bf9.ClaimCapClient({
  algorand,
  appId: 123456789n,
});
