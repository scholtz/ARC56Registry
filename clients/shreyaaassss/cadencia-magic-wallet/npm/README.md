...
```bash
npm install arc56-generated-shreyaaassss-cadencia-magic-wallet @algorandfoundation/algokit-utils algosdk
```
...
import { ContractName_hash } from "arc56-generated-shreyaaassss-cadencia-magic-wallet";
...
| --- | --- | --- |
| `CadenciaEscrow_4599f3fd` | _(generation failed - see state.json)_ | [https://raw.githubusercontent.com/shreyaaassss/cadencia-magic-wallet/HEAD/backend/artifacts/CadenciaEscrow.arc56.json](https://raw.githubusercontent.com/shreyaaassss/cadencia-magic-wallet/HEAD/backend/artifacts/CadenciaEscrow.arc56.json) |
