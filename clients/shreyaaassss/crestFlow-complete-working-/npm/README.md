...
```bash
npm install arc56-generated-shreyaaassss-crestflow-complete-working @algorandfoundation/algokit-utils algosdk
```
...
import { CadenciaEscrow_f24c6d83 } from "arc56-generated-shreyaaassss-crestflow-complete-working";

const algorand = AlgorandClient.mainNet();
const client = new CadenciaEscrow_f24c6d83.CadenciaEscrowClient({
  algorand,
  appId: 123456789n,
});
