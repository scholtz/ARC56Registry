...
```bash
npm install arc56-generated-shreyaaassss-cadencia-working-fine @algorandfoundation/algokit-utils algosdk
```
...
import { ContractName_hash } from "arc56-generated-shreyaaassss-cadencia-working-fine";
...
| --- | --- | --- |
| `CadenciaEscrow_40a2c69e` | _(generation failed - see state.json)_ | [https://raw.githubusercontent.com/shreyaaassss/cadencia-working-fine/HEAD/backend/artifacts/CadenciaEscrow.arc56.json](https://raw.githubusercontent.com/shreyaaassss/cadencia-working-fine/HEAD/backend/artifacts/CadenciaEscrow.arc56.json) |
