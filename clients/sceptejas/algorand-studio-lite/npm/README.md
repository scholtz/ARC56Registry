...
```bash
npm install arc56-generated-sceptejas-algorand-studio-lite @algorandfoundation/algokit-utils algosdk
```
...
import { HelloWorld_477244b4 } from "arc56-generated-sceptejas-algorand-studio-lite";

const algorand = AlgorandClient.mainNet();
const client = new HelloWorld_477244b4.HelloWorldClient({
  algorand,
  appId: 123456789n,
});
