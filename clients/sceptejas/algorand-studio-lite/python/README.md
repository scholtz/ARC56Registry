...
```bash
pip install arc56-generated-sceptejas-algorand-studio-lite
```
...
from arc56_generated_sceptejas_algorand_studio_lite import HelloWorld_477244b4

algorand = AlgorandClient.mainnet()
client = HelloWorld_477244b4.HelloWorldClient(
    algorand=algorand,
    app_id=123456789,
)
