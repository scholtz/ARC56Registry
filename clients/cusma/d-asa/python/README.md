...
```bash
pip install arc56-generated-cusma-d-asa
```
...
from arc56_generated_cusma_d_asa import MockRbacModule_a50dacd6

algorand = AlgorandClient.mainnet()
client = MockRbacModule_a50dacd6.MockRbacModuleClient(
    algorand=algorand,
    app_id=123456789,
)
