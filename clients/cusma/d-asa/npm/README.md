...
```bash
npm install arc56-generated-cusma-d-asa @algorandfoundation/algokit-utils algosdk
```
...
import { MockRbacModule_a50dacd6 } from "arc56-generated-cusma-d-asa";

const algorand = AlgorandClient.mainNet();
const client = new MockRbacModule_a50dacd6.MockRbacModuleClient({
  algorand,
  appId: 123456789n,
});
...
| --- | --- | --- |
| `MockRbacModule_a50dacd6` | `MockRbacModuleClient` | [https://raw.githubusercontent.com/cusma/d-asa/HEAD/smart_contracts/artifacts/mock_module_rbac/MockRbacModule.arc56.json](https://raw.githubusercontent.com/cusma/d-asa/HEAD/smart_contracts/artifacts/mock_module_rbac/MockRbacModule.arc56.json) |
