...
```bash
npm install arc56-generated-rajshekar1206-algosplit @algorandfoundation/algokit-utils algosdk
```
...
import { Algosplit_20064be4 } from "arc56-generated-rajshekar1206-algosplit";

const algorand = AlgorandClient.mainNet();
const client = new Algosplit_20064be4.AlgosplitClient({
  algorand,
  appId: 123456789n,
});
