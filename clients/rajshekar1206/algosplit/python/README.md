...
```bash
pip install arc56-generated-rajshekar1206-algosplit
```
...
from arc56_generated_rajshekar1206_algosplit import Algosplit_20064be4

algorand = AlgorandClient.mainnet()
client = Algosplit_20064be4.AlgosplitClient(
    algorand=algorand,
    app_id=123456789,
)
