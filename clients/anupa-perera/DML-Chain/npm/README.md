...
```bash
npm install arc56-generated-anupa-perera-dml-chain @algorandfoundation/algokit-utils algosdk
```
...
import { DMLChain_249d4830 } from "arc56-generated-anupa-perera-dml-chain";

const algorand = AlgorandClient.mainNet();
const client = new DMLChain_249d4830.DmlChainClient({
  algorand,
  appId: 123456789n,
});
...
| --- | --- | --- |
| `DMLChain_249d4830` | `DmlChainClient` | [https://raw.githubusercontent.com/anupa-perera/DML-Chain/HEAD/projects/DML-contracts/contracts/artifacts/DMLChain.arc56.json](https://raw.githubusercontent.com/anupa-perera/DML-Chain/HEAD/projects/DML-contracts/contracts/artifacts/DMLChain.arc56.json) |
