...
```bash
pip install arc56-generated-anupa-perera-dml-chain
```
...
from arc56_generated_anupa_perera_dml_chain import DMLChain_249d4830

algorand = AlgorandClient.mainnet()
client = DMLChain_249d4830.DmlChainClient(
    algorand=algorand,
    app_id=123456789,
)
