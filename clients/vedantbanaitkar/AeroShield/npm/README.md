...
```bash
npm install arc56-generated-vedantbanaitkar-aeroshield @algorandfoundation/algokit-utils algosdk
```
...
import { HelloWorld_737d45b7 } from "arc56-generated-vedantbanaitkar-aeroshield";

const algorand = AlgorandClient.mainNet();
const client = new HelloWorld_737d45b7.HelloWorldClient({
  algorand,
  appId: 123456789n,
});
