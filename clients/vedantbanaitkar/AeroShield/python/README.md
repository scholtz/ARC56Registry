...
```bash
pip install arc56-generated-vedantbanaitkar-aeroshield
```
...
from arc56_generated_vedantbanaitkar_aeroshield import HelloWorld_737d45b7

algorand = AlgorandClient.mainnet()
client = HelloWorld_737d45b7.HelloWorldClient(
    algorand=algorand,
    app_id=123456789,
)
