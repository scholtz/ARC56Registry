...
```bash
npm install arc56-generated-m3xplosi0n-eterleaves-backend @algorandfoundation/algokit-utils algosdk
```
...
import { EterLeaves_c610a05e } from "arc56-generated-m3xplosi0n-eterleaves-backend";

const algorand = AlgorandClient.mainNet();
const client = new EterLeaves_c610a05e.EterLeavesClient({
  algorand,
  appId: 123456789n,
});
...
| --- | --- | --- |
| `EterLeaves_c610a05e` | `EterLeavesClient` | [https://raw.githubusercontent.com/M3xplosi0n/eterleaves-backend/HEAD/smart_contracts/artifacts/eterleaves/EterLeaves.arc56.json](https://raw.githubusercontent.com/M3xplosi0n/eterleaves-backend/HEAD/smart_contracts/artifacts/eterleaves/EterLeaves.arc56.json) |
