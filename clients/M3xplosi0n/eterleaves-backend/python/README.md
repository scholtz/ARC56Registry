...
```bash
pip install arc56-generated-m3xplosi0n-eterleaves-backend
```
...
from arc56_generated_m3xplosi0n_eterleaves_backend import EterLeaves_c610a05e

algorand = AlgorandClient.mainnet()
client = EterLeaves_c610a05e.EterLeavesClient(
    algorand=algorand,
    app_id=123456789,
)
