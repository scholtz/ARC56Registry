...
```bash
npm install arc56-generated-knonode-signzero @algorandfoundation/algokit-utils algosdk
```
...
import { SignZero_18b1e02b } from "arc56-generated-knonode-signzero";

const algorand = AlgorandClient.mainNet();
const client = new SignZero_18b1e02b.SignZeroClient({
  algorand,
  appId: 123456789n,
});
