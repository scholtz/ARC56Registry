...
```bash
npm install arc56-generated-knonode-algokit3-ts-workshop-personal-bank @algorandfoundation/algokit-utils algosdk
```
...
import { PersonalBank_df1c21c0 } from "arc56-generated-knonode-algokit3-ts-workshop-personal-bank";

const algorand = AlgorandClient.mainNet();
const client = new PersonalBank_df1c21c0.PersonalBankClient({
  algorand,
  appId: 123456789n,
});
