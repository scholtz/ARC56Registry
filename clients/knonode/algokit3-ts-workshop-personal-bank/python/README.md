...
```bash
pip install arc56-generated-knonode-algokit3-ts-workshop-personal-bank
```
...
from arc56_generated_knonode_algokit3_ts_workshop_personal_bank import PersonalBank_df1c21c0

algorand = AlgorandClient.mainnet()
client = PersonalBank_df1c21c0.PersonalBankClient(
    algorand=algorand,
    app_id=123456789,
)
