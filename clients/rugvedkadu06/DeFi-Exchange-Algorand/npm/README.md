...
```bash
npm install arc56-generated-rugvedkadu06-defi-exchange-algorand @algorandfoundation/algokit-utils algosdk
```
...
import { AmmPool_7ca11118 } from "arc56-generated-rugvedkadu06-defi-exchange-algorand";

const algorand = AlgorandClient.mainNet();
const client = new AmmPool_7ca11118.AmmPoolClient({
  algorand,
  appId: 123456789n,
});
