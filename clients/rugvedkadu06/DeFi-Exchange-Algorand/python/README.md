...
```bash
pip install arc56-generated-rugvedkadu06-defi-exchange-algorand
```
...
from arc56_generated_rugvedkadu06_defi_exchange_algorand import AmmPool_7ca11118

algorand = AlgorandClient.mainnet()
client = AmmPool_7ca11118.AmmPoolClient(
    algorand=algorand,
    app_id=123456789,
)
