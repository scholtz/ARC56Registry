...
```bash
pip install arc56-generated-srujan-07-calculator
```
...
from arc56_generated_srujan_07_calculator import HelloWorld_e040d7a2

algorand = AlgorandClient.mainnet()
client = HelloWorld_e040d7a2.HelloWorldClient(
    algorand=algorand,
    app_id=123456789,
)
