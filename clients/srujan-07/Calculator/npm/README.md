...
```bash
npm install arc56-generated-srujan-07-calculator @algorandfoundation/algokit-utils algosdk
```
...
import { HelloWorld_e040d7a2 } from "arc56-generated-srujan-07-calculator";

const algorand = AlgorandClient.mainNet();
const client = new HelloWorld_e040d7a2.HelloWorldClient({
  algorand,
  appId: 123456789n,
});
