...
```bash
npm install arc56-generated-syamkumar2005-resume @algorandfoundation/algokit-utils algosdk
```
...
import { HelloWorld_858a5dd5 } from "arc56-generated-syamkumar2005-resume";

const algorand = AlgorandClient.mainNet();
const client = new HelloWorld_858a5dd5.HelloWorldClient({
  algorand,
  appId: 123456789n,
});
