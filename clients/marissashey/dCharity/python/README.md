...
```bash
pip install arc56-generated-marissashey-dcharity
```
...
from arc56_generated_marissashey_dcharity import ResponsiveDonation_1394e2ca

algorand = AlgorandClient.mainnet()
client = ResponsiveDonation_1394e2ca.ResponsiveDonationClient(
    algorand=algorand,
    app_id=123456789,
)
