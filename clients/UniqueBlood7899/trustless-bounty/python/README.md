...
```bash
pip install arc56-generated-uniqueblood7899-trustless-bounty
```
...
from arc56_generated_uniqueblood7899_trustless_bounty import BountyEscrow_68a0af47

algorand = AlgorandClient.mainnet()
client = BountyEscrow_68a0af47.BountyEscrowClient(
    algorand=algorand,
    app_id=123456789,
)
