...
```bash
npm install arc56-generated-uniqueblood7899-trustless-bounty @algorandfoundation/algokit-utils algosdk
```
...
import { BountyEscrow_68a0af47 } from "arc56-generated-uniqueblood7899-trustless-bounty";

const algorand = AlgorandClient.mainNet();
const client = new BountyEscrow_68a0af47.BountyEscrowClient({
  algorand,
  appId: 123456789n,
});
