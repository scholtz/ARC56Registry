...
```bash
npm install arc56-generated-divyanshudx-civitas @algorandfoundation/algokit-utils algosdk
```
...
import { Dx_29465bbb } from "arc56-generated-divyanshudx-civitas";

const algorand = AlgorandClient.mainNet();
const client = new Dx_29465bbb.DxClient({
  algorand,
  appId: 123456789n,
});
