...
```bash
pip install arc56-generated-antxnrx-codex-nutrigrade
```
...
from arc56_generated_antxnrx_codex_nutrigrade import NutriGradeSimple_74d3d873

algorand = AlgorandClient.mainnet()
client = NutriGradeSimple_74d3d873.NutriGradeSimpleClient(
    algorand=algorand,
    app_id=123456789,
)
