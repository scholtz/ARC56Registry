...
```bash
npm install arc56-generated-antxnrx-codex-nutrigrade @algorandfoundation/algokit-utils algosdk
```
...
import { NutriGradeSimple_74d3d873 } from "arc56-generated-antxnrx-codex-nutrigrade";

const algorand = AlgorandClient.mainNet();
const client = new NutriGradeSimple_74d3d873.NutriGradeSimpleClient({
  algorand,
  appId: 123456789n,
});
