...
```bash
npm install arc56-generated-anuragaj25-basecase-web3-algorand @algorandfoundation/algokit-utils algosdk
```
...
import { BountyEscrowContract_0ac88497 } from "arc56-generated-anuragaj25-basecase-web3-algorand";

const algorand = AlgorandClient.mainNet();
const client = new BountyEscrowContract_0ac88497.BountyEscrowContractClient({
  algorand,
  appId: 123456789n,
});
