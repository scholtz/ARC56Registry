...
```bash
npm install arc56-generated-aarushchaudhary-afterlife @algorandfoundation/algokit-utils algosdk
```
...
import { AfterlifeVault_6f5d3388 } from "arc56-generated-aarushchaudhary-afterlife";

const algorand = AlgorandClient.mainNet();
const client = new AfterlifeVault_6f5d3388.AfterlifeVaultClient({
  algorand,
  appId: 123456789n,
});
