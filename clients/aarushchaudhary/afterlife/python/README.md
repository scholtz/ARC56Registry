...
```bash
pip install arc56-generated-aarushchaudhary-afterlife
```
...
from arc56_generated_aarushchaudhary_afterlife import AfterlifeVault_6f5d3388

algorand = AlgorandClient.mainnet()
client = AfterlifeVault_6f5d3388.AfterlifeVaultClient(
    algorand=algorand,
    app_id=123456789,
)
