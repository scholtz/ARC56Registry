...
```bash
pip install arc56-generated-purvacode-80-integrikey-algorand
```
...
from arc56_generated_purvacode_80_integrikey_algorand import ZKPVault_92eec5ab

algorand = AlgorandClient.mainnet()
client = ZKPVault_92eec5ab.ZkpVaultClient(
    algorand=algorand,
    app_id=123456789,
)
