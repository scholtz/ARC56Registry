...
```bash
npm install arc56-generated-purvacode-80-integrikey-algorand @algorandfoundation/algokit-utils algosdk
```
...
import { ZKPVault_92eec5ab } from "arc56-generated-purvacode-80-integrikey-algorand";

const algorand = AlgorandClient.mainNet();
const client = new ZKPVault_92eec5ab.ZkpVaultClient({
  algorand,
  appId: 123456789n,
});
