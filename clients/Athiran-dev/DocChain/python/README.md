...
```bash
pip install arc56-generated-athiran-dev-docchain
```
...
from arc56_generated_athiran_dev_docchain import DocumentVerification_9bf244f4

algorand = AlgorandClient.mainnet()
client = DocumentVerification_9bf244f4.DocumentVerificationClient(
    algorand=algorand,
    app_id=123456789,
)
