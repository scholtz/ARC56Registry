...
```bash
npm install arc56-generated-athiran-dev-docchain @algorandfoundation/algokit-utils algosdk
```
...
import { DocumentVerification_9bf244f4 } from "arc56-generated-athiran-dev-docchain";

const algorand = AlgorandClient.mainNet();
const client = new DocumentVerification_9bf244f4.DocumentVerificationClient({
  algorand,
  appId: 123456789n,
});
