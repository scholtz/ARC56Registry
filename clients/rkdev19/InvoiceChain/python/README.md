...
```bash
pip install arc56-generated-rkdev19-invoicechain
```
...
from arc56_generated_rkdev19_invoicechain import Invoice_fe5ea3e2

algorand = AlgorandClient.mainnet()
client = Invoice_fe5ea3e2.InvoiceClient(
    algorand=algorand,
    app_id=123456789,
)
