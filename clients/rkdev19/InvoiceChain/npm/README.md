...
```bash
npm install arc56-generated-rkdev19-invoicechain @algorandfoundation/algokit-utils algosdk
```
...
import { Invoice_fe5ea3e2 } from "arc56-generated-rkdev19-invoicechain";

const algorand = AlgorandClient.mainNet();
const client = new Invoice_fe5ea3e2.InvoiceClient({
  algorand,
  appId: 123456789n,
});
