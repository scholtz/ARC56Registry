...
```bash
npm install arc56-generated-vedkalantri-escrow-service @algorandfoundation/algokit-utils algosdk
```
...
import { HelloWorld_8e71aa24 } from "arc56-generated-vedkalantri-escrow-service";

const algorand = AlgorandClient.mainNet();
const client = new HelloWorld_8e71aa24.HelloWorldClient({
  algorand,
  appId: 123456789n,
});
