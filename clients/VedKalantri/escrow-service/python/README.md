...
```bash
pip install arc56-generated-vedkalantri-escrow-service
```
...
from arc56_generated_vedkalantri_escrow_service import HelloWorld_8e71aa24

algorand = AlgorandClient.mainnet()
client = HelloWorld_8e71aa24.HelloWorldClient(
    algorand=algorand,
    app_id=123456789,
)
