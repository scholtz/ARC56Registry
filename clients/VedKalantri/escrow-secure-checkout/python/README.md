...
```bash
pip install arc56-generated-vedkalantri-escrow-secure-checkout
```
...
from arc56_generated_vedkalantri_escrow_secure_checkout import Escrow_552e0bf7

algorand = AlgorandClient.mainnet()
client = Escrow_552e0bf7.EscrowClient(
    algorand=algorand,
    app_id=123456789,
)
