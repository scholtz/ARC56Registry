...
```bash
npm install arc56-generated-vedkalantri-escrow-secure-checkout @algorandfoundation/algokit-utils algosdk
```
...
import { Escrow_552e0bf7 } from "arc56-generated-vedkalantri-escrow-secure-checkout";

const algorand = AlgorandClient.mainNet();
const client = new Escrow_552e0bf7.EscrowClient({
  algorand,
  appId: 123456789n,
});
