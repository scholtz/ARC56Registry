...
```bash
pip install arc56-generated-monojitgoswami69-fundmyskill
```
...
from arc56_generated_monojitgoswami69_fundmyskill import EducateChainVault_d973b16d

algorand = AlgorandClient.mainnet()
client = EducateChainVault_d973b16d.EducateChainVaultClient(
    algorand=algorand,
    app_id=123456789,
)
