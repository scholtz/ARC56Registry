...
```bash
npm install arc56-generated-monojitgoswami69-fundmyskill @algorandfoundation/algokit-utils algosdk
```
...
import { EducateChainVault_d973b16d } from "arc56-generated-monojitgoswami69-fundmyskill";

const algorand = AlgorandClient.mainNet();
const client = new EducateChainVault_d973b16d.EducateChainVaultClient({
  algorand,
  appId: 123456789n,
});
...
| --- | --- | --- |
| `EducateChainVault_d973b16d` | `EducateChainVaultClient` | [https://raw.githubusercontent.com/monojitgoswami69/FundMySkill/HEAD/contracts/out/EducateChainVault.arc56.json](https://raw.githubusercontent.com/monojitgoswami69/FundMySkill/HEAD/contracts/out/EducateChainVault.arc56.json) |
