...
```bash
pip install arc56-generated-filippofalleroni-trait-swap-and-loot-box
```
...
from arc56_generated_filippofalleroni_trait_swap_and_loot_box import LootBoxCommitReveal_0ff11f56

algorand = AlgorandClient.mainnet()
client = LootBoxCommitReveal_0ff11f56.LootBoxCommitRevealClient(
    algorand=algorand,
    app_id=123456789,
)
