...
```bash
npm install arc56-generated-filippofalleroni-trait-swap-and-loot-box @algorandfoundation/algokit-utils algosdk
```
...
import { LootBoxCommitReveal_0ff11f56 } from "arc56-generated-filippofalleroni-trait-swap-and-loot-box";

const algorand = AlgorandClient.mainNet();
const client = new LootBoxCommitReveal_0ff11f56.LootBoxCommitRevealClient({
  algorand,
  appId: 123456789n,
});
