...
```bash
npm install arc56-generated-tkhan04-easya @algorandfoundation/algokit-utils algosdk
```
...
import { FractionalPlaneOwnership_1cb787ef } from "arc56-generated-tkhan04-easya";

const algorand = AlgorandClient.mainNet();
const client = new FractionalPlaneOwnership_1cb787ef.FractionalPlaneOwnershipClient({
  algorand,
  appId: 123456789n,
});
