...
```bash
pip install arc56-generated-tkhan04-easya
```
...
from arc56_generated_tkhan04_easya import FractionalPlaneOwnership_1cb787ef

algorand = AlgorandClient.mainnet()
client = FractionalPlaneOwnership_1cb787ef.FractionalPlaneOwnershipClient(
    algorand=algorand,
    app_id=123456789,
)
