...
```bash
npm install arc56-generated-mtank0205-money-muling-detection @algorandfoundation/algokit-utils algosdk
```
...
import { AmlRegistry_6cd150d1 } from "arc56-generated-mtank0205-money-muling-detection";

const algorand = AlgorandClient.mainNet();
const client = new AmlRegistry_6cd150d1.AmlRegistryClient({
  algorand,
  appId: 123456789n,
});
