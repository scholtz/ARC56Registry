...
```bash
npm install arc56-generated-add183-algo-farmar @algorandfoundation/algokit-utils algosdk
```
...
import { FarmerContract_74baae8c } from "arc56-generated-add183-algo-farmar";

const algorand = AlgorandClient.mainNet();
const client = new FarmerContract_74baae8c.FarmerContractClient({
  algorand,
  appId: 123456789n,
});
