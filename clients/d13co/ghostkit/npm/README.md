...
```bash
npm install arc56-generated-d13co-ghostkit @algorandfoundation/algokit-utils algosdk
```
...
import { Ghostofavm_a552bf7f } from "arc56-generated-d13co-ghostkit";

const algorand = AlgorandClient.mainNet();
const client = new Ghostofavm_a552bf7f.GhostofavmClient({
  algorand,
  appId: 123456789n,
});
...
| --- | --- | --- |
| `Ghostofavm_a552bf7f` | `GhostofavmClient` | [https://raw.githubusercontent.com/d13co/ghostkit/HEAD/examples/Ghostofavm.arc56.json](https://raw.githubusercontent.com/d13co/ghostkit/HEAD/examples/Ghostofavm.arc56.json) |
