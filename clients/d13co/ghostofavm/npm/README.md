...
```bash
npm install arc56-generated-d13co-ghostofavm @algorandfoundation/algokit-utils algosdk
```
...
import { Ghostofavm_e1e1bb27 } from "arc56-generated-d13co-ghostofavm";

const algorand = AlgorandClient.mainNet();
const client = new Ghostofavm_e1e1bb27.GhostofavmClient({
  algorand,
  appId: 123456789n,
});
