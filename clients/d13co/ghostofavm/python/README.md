...
```bash
pip install arc56-generated-d13co-ghostofavm
```
...
from arc56_generated_d13co_ghostofavm import Ghostofavm_e1e1bb27

algorand = AlgorandClient.mainnet()
client = Ghostofavm_e1e1bb27.GhostofavmClient(
    algorand=algorand,
    app_id=123456789,
)
