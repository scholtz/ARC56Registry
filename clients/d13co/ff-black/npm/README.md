...
```bash
npm install arc56-generated-d13co-ff-black @algorandfoundation/algokit-utils algosdk
```
...
import { FfBlack_0c104fcf } from "arc56-generated-d13co-ff-black";

const algorand = AlgorandClient.mainNet();
const client = new FfBlack_0c104fcf.FfBlackClient({
  algorand,
  appId: 123456789n,
});
...
| --- | --- | --- |
| `FfBlack_0c104fcf` | `FfBlackClient` | [https://raw.githubusercontent.com/d13co/ff-black/HEAD/projects/ff-black/smart_contracts/artifacts/ff_black/FfBlack.arc56.json](https://raw.githubusercontent.com/d13co/ff-black/HEAD/projects/ff-black/smart_contracts/artifacts/ff_black/FfBlack.arc56.json) |
