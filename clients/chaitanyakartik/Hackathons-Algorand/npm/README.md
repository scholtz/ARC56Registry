...
```bash
npm install arc56-generated-chaitanyakartik-hackathons-algorand @algorandfoundation/algokit-utils algosdk
```
...
import { HelloWorld_43dcff6b } from "arc56-generated-chaitanyakartik-hackathons-algorand";

const algorand = AlgorandClient.mainNet();
const client = new HelloWorld_43dcff6b.HelloWorldClient({
  algorand,
  appId: 123456789n,
});
