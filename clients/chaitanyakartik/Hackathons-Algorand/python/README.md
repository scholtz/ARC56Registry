...
```bash
pip install arc56-generated-chaitanyakartik-hackathons-algorand
```
...
from arc56_generated_chaitanyakartik_hackathons_algorand import HelloWorld_43dcff6b

algorand = AlgorandClient.mainnet()
client = HelloWorld_43dcff6b.HelloWorldClient(
    algorand=algorand,
    app_id=123456789,
)
