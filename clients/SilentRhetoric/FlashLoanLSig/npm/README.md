...
```bash
npm install arc56-generated-silentrhetoric-flashloanlsig @algorandfoundation/algokit-utils algosdk
```
...
import { HelloWorld_2ea4b6a4 } from "arc56-generated-silentrhetoric-flashloanlsig";

const algorand = AlgorandClient.mainNet();
const client = new HelloWorld_2ea4b6a4.HelloWorldClient({
  algorand,
  appId: 123456789n,
});
...
| --- | --- | --- |
| `HelloWorld_2ea4b6a4` | `HelloWorldClient` | [https://raw.githubusercontent.com/SilentRhetoric/FlashLoanLSig/HEAD/contracts/artifacts/HelloWorld.arc56.json](https://raw.githubusercontent.com/SilentRhetoric/FlashLoanLSig/HEAD/contracts/artifacts/HelloWorld.arc56.json) |
