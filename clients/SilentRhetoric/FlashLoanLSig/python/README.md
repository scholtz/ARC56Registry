...
```bash
pip install arc56-generated-silentrhetoric-flashloanlsig
```
...
from arc56_generated_silentrhetoric_flashloanlsig import HelloWorld_2ea4b6a4

algorand = AlgorandClient.mainnet()
client = HelloWorld_2ea4b6a4.HelloWorldClient(
    algorand=algorand,
    app_id=123456789,
)
