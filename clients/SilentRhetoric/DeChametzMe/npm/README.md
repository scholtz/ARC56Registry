...
```bash
npm install arc56-generated-silentrhetoric-dechametzme @algorandfoundation/algokit-utils algosdk
```
...
import { DeChametz_9d6f0a48 } from "arc56-generated-silentrhetoric-dechametzme";

const algorand = AlgorandClient.mainNet();
const client = new DeChametz_9d6f0a48.DeChametzClient({
  algorand,
  appId: 123456789n,
});
