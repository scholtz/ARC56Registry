...
class _DeChametzCloseOutComposer:
    def __init__(self, composer: "DeChametzComposer"):
        self.composer = composer
    def repurchase_chametz(
        self,
        ...
        self.composer._composer.add_app_call_method_call(
            self.composer.client.params.close_out.repurchase_chametz(
...
class DeChametzComposer:
    ...
    @property
    def opt_in(self) -> "_DeChametzOptInComposer":
        return _DeChametzOptInComposer(self)

    @property
    def close_out(self) -> "_DeChametzCloseOutComposer":
        return _DeChametzCloseOutComposer(self)
