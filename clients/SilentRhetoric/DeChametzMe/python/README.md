...
```bash
pip install arc56-generated-silentrhetoric-dechametzme
```
...
from arc56_generated_silentrhetoric_dechametzme import DeChametz_9d6f0a48

algorand = AlgorandClient.mainnet()
client = DeChametz_9d6f0a48.DeChametzClient(
    algorand=algorand,
    app_id=123456789,
)
