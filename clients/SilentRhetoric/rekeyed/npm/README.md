...
```bash
npm install arc56-generated-silentrhetoric-rekeyed @algorandfoundation/algokit-utils algosdk
```
...
import { HelloWorld_674c6cad } from "arc56-generated-silentrhetoric-rekeyed";

const algorand = AlgorandClient.mainNet();
const client = new HelloWorld_674c6cad.HelloWorldClient({
  algorand,
  appId: 123456789n,
});
...
| --- | --- | --- |
| `HelloWorld_674c6cad` | `HelloWorldClient` | [https://raw.githubusercontent.com/SilentRhetoric/rekeyed/HEAD/projects/rekeyed/contracts/artifacts/HelloWorld.arc56.json](https://raw.githubusercontent.com/SilentRhetoric/rekeyed/HEAD/projects/rekeyed/contracts/artifacts/HelloWorld.arc56.json) |
