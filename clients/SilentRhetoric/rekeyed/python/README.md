...
```bash
pip install arc56-generated-silentrhetoric-rekeyed
```
...
from arc56_generated_silentrhetoric_rekeyed import HelloWorld_674c6cad

algorand = AlgorandClient.mainnet()
client = HelloWorld_674c6cad.HelloWorldClient(
    algorand=algorand,
    app_id=123456789,
)
