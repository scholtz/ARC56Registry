...
```bash
npm install arc56-generated-pavan-hosatti-verichain @algorandfoundation/algokit-utils algosdk
```
...
import { PlacementVerify_9acd1ce1 } from "arc56-generated-pavan-hosatti-verichain";

const algorand = AlgorandClient.mainNet();
const client = new PlacementVerify_9acd1ce1.PlacementVerifyClient({
  algorand,
  appId: 123456789n,
});
...
| --- | --- | --- |
| `PlacementVerify_9acd1ce1` | `PlacementVerifyClient` | [https://raw.githubusercontent.com/Pavan-Hosatti/VeriChain/HEAD/contracts/artifacts/PlacementVerify.arc56.json](https://raw.githubusercontent.com/Pavan-Hosatti/VeriChain/HEAD/contracts/artifacts/PlacementVerify.arc56.json) |
