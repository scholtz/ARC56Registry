...
```bash
pip install arc56-generated-pavan-hosatti-verichain
```
...
from arc56_generated_pavan_hosatti_verichain import PlacementVerify_9acd1ce1

algorand = AlgorandClient.mainnet()
client = PlacementVerify_9acd1ce1.PlacementVerifyClient(
    algorand=algorand,
    app_id=123456789,
)
