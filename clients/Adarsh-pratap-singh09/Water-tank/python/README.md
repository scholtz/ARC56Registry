...
```bash
pip install arc56-generated-adarsh-pratap-singh09-water-tank
```
...
from arc56_generated_adarsh_pratap_singh09_water_tank import HelloWorld_5519f67b

algorand = AlgorandClient.mainnet()
client = HelloWorld_5519f67b.HelloWorldClient(
    algorand=algorand,
    app_id=123456789,
)
