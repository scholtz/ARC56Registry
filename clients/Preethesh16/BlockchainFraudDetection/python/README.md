...
```bash
pip install arc56-generated-preethesh16-blockchainfrauddetection
```
...
from arc56_generated_preethesh16_blockchainfrauddetection import DealEscrow_7b236120

algorand = AlgorandClient.mainnet()
client = DealEscrow_7b236120.DealEscrowClient(
    algorand=algorand,
    app_id=123456789,
)
