...
```bash
npm install arc56-generated-preethesh16-blockchainfrauddetection @algorandfoundation/algokit-utils algosdk
```
...
import { DealEscrow_7b236120 } from "arc56-generated-preethesh16-blockchainfrauddetection";

const algorand = AlgorandClient.mainNet();
const client = new DealEscrow_7b236120.DealEscrowClient({
  algorand,
  appId: 123456789n,
});
