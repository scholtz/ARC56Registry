...
```bash
pip install arc56-generated-preethesh16-trigger
```
...
from arc56_generated_preethesh16_trigger import DealEscrow_0b101fba

algorand = AlgorandClient.mainnet()
client = DealEscrow_0b101fba.DealEscrowClient(
    algorand=algorand,
    app_id=123456789,
)
