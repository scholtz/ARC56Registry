...
```bash
npm install arc56-generated-preethesh16-trigger @algorandfoundation/algokit-utils algosdk
```
...
import { DealEscrow_0b101fba } from "arc56-generated-preethesh16-trigger";

const algorand = AlgorandClient.mainNet();
const client = new DealEscrow_0b101fba.DealEscrowClient({
  algorand,
  appId: 123456789n,
});
...
| --- | --- | --- |
| `DealEscrow_0b101fba` | `DealEscrowClient` | [https://raw.githubusercontent.com/Preethesh16/Trigger/HEAD/accord/contract/smart_contracts/deal_escrow/artifacts/DealEscrow.arc56.json](https://raw.githubusercontent.com/Preethesh16/Trigger/HEAD/accord/contract/smart_contracts/deal_escrow/artifacts/DealEscrow.arc56.json) |
| `DealEscrow_b527b78b` | `DealEscrowClient` | [https://raw.githubusercontent.com/Preethesh16/Trigger/HEAD/accord/contract/smart_contracts/deal_escrow/DealEscrow.arc56.json](https://raw.githubusercontent.com/Preethesh16/Trigger/HEAD/accord/contract/smart_contracts/deal_escrow/DealEscrow.arc56.json) |
