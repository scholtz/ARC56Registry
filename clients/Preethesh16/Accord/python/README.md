...
```bash
pip install arc56-generated-preethesh16-accord
```
...
from arc56_generated_preethesh16_accord import DealEscrow_340a8b00

algorand = AlgorandClient.mainnet()
client = DealEscrow_340a8b00.DealEscrowClient(
    algorand=algorand,
    app_id=123456789,
)
