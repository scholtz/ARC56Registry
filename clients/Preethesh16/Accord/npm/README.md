...
```bash
npm install arc56-generated-preethesh16-accord @algorandfoundation/algokit-utils algosdk
```
...
import { DealEscrow_340a8b00 } from "arc56-generated-preethesh16-accord";

const algorand = AlgorandClient.mainNet();
const client = new DealEscrow_340a8b00.DealEscrowClient({
  algorand,
  appId: 123456789n,
});
...
| --- | --- | --- |
| `DealEscrow_340a8b00` | `DealEscrowClient` | [https://raw.githubusercontent.com/Preethesh16/Accord/HEAD/contract/smart_contracts/deal_escrow/artifacts/DealEscrow.arc56.json](https://raw.githubusercontent.com/Preethesh16/Accord/HEAD/contract/smart_contracts/deal_escrow/artifacts/DealEscrow.arc56.json) |
| `DealEscrow_9ffba5a9` | `DealEscrowClient` | [https://raw.githubusercontent.com/Preethesh16/Accord/HEAD/contract/smart_contracts/deal_escrow/DealEscrow.arc56.json](https://raw.githubusercontent.com/Preethesh16/Accord/HEAD/contract/smart_contracts/deal_escrow/DealEscrow.arc56.json) |
