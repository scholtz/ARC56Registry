...
```bash
pip install arc56-generated-kautilyadevaraj-algorand-hackathon
```
...
from arc56_generated_kautilyadevaraj_algorand_hackathon import TrustMeBro_1583801d

algorand = AlgorandClient.mainnet()
client = TrustMeBro_1583801d.TrustMeBroClient(
    algorand=algorand,
    app_id=123456789,
)
