...
```bash
pip install arc56-generated-ishaan-kkr-algorand
```
...
from arc56_generated_ishaan_kkr_algorand import IdeaVotingApp_d2d36444

algorand = AlgorandClient.mainnet()
client = IdeaVotingApp_d2d36444.IdeaVotingAppClient(
    algorand=algorand,
    app_id=123456789,
)
