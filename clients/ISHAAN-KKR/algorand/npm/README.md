...
```bash
npm install arc56-generated-ishaan-kkr-algorand @algorandfoundation/algokit-utils algosdk
```
...
import { IdeaVotingApp_d2d36444 } from "arc56-generated-ishaan-kkr-algorand";

const algorand = AlgorandClient.mainNet();
const client = new IdeaVotingApp_d2d36444.IdeaVotingAppClient({
  algorand,
  appId: 123456789n,
});
