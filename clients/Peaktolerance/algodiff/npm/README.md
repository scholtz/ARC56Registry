...
```bash
npm install arc56-generated-peaktolerance-algodiff @algorandfoundation/algokit-utils algosdk
```
...
import { DiffRegistry_61ddcc2e } from "arc56-generated-peaktolerance-algodiff";

const algorand = AlgorandClient.mainNet();
const client = new DiffRegistry_61ddcc2e.DiffRegistryClient({
  algorand,
  appId: 123456789n,
});
...
| --- | --- | --- |
| `DiffRegistry_61ddcc2e` | `DiffRegistryClient` | [https://raw.githubusercontent.com/Peaktolerance/algodiff/HEAD/contracts/diff_registry/artifacts/DiffRegistry.arc56.json](https://raw.githubusercontent.com/Peaktolerance/algodiff/HEAD/contracts/diff_registry/artifacts/DiffRegistry.arc56.json) |
