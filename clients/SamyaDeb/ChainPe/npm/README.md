...
```bash
npm install arc56-generated-samyadeb-chainpe @algorandfoundation/algokit-utils algosdk
```
...
import { ChainPeRegistry_dfef2186 } from "arc56-generated-samyadeb-chainpe";

const algorand = AlgorandClient.mainNet();
const client = new ChainPeRegistry_dfef2186.ChainPeRegistryClient({
  algorand,
  appId: 123456789n,
});
...
| --- | --- | --- |
| `ChainPeRegistry_dfef2186` | `ChainPeRegistryClient` | [https://raw.githubusercontent.com/SamyaDeb/ChainPe/HEAD/contracts/src/out/ChainPeRegistry.arc56.json](https://raw.githubusercontent.com/SamyaDeb/ChainPe/HEAD/contracts/src/out/ChainPeRegistry.arc56.json) |
