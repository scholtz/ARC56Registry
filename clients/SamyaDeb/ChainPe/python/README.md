...
```bash
pip install arc56-generated-samyadeb-chainpe
```
...
from arc56_generated_samyadeb_chainpe import ChainPeRegistry_dfef2186

algorand = AlgorandClient.mainnet()
client = ChainPeRegistry_dfef2186.ChainPeRegistryClient(
    algorand=algorand,
    app_id=123456789,
)
