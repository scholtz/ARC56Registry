...
```bash
pip install arc56-generated-samyadeb-chainstrike
```
...
from arc56_generated_samyadeb_chainstrike import PerpetualsMarket_5a0805b2

algorand = AlgorandClient.mainnet()
client = PerpetualsMarket_5a0805b2.PerpetualsMarketClient(
    algorand=algorand,
    app_id=123456789,
)
