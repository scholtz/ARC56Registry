...
```bash
npm install arc56-generated-samyadeb-chainstrike @algorandfoundation/algokit-utils algosdk
```
...
import { PerpetualsMarket_5a0805b2 } from "arc56-generated-samyadeb-chainstrike";

const algorand = AlgorandClient.mainNet();
const client = new PerpetualsMarket_5a0805b2.PerpetualsMarketClient({
  algorand,
  appId: 123456789n,
});
...
| --- | --- | --- |
| `PerpetualsMarket_5a0805b2` | `PerpetualsMarketClient` | [https://raw.githubusercontent.com/SamyaDeb/ChainStrike/HEAD/contracts/PerpetualsMarket.arc56.json](https://raw.githubusercontent.com/SamyaDeb/ChainStrike/HEAD/contracts/PerpetualsMarket.arc56.json) |
