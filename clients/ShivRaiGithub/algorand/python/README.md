...
```bash
pip install arc56-generated-shivraigithub-algorand
```
...
from arc56_generated_shivraigithub_algorand import BetCoin_1ef9c363

algorand = AlgorandClient.mainnet()
client = BetCoin_1ef9c363.BetCoinClient(
    algorand=algorand,
    app_id=123456789,
)
