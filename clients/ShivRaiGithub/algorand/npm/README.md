...
```bash
npm install arc56-generated-shivraigithub-algorand @algorandfoundation/algokit-utils algosdk
```
...
import { BetCoin_1ef9c363 } from "arc56-generated-shivraigithub-algorand";

const algorand = AlgorandClient.mainNet();
const client = new BetCoin_1ef9c363.BetCoinClient({
  algorand,
  appId: 123456789n,
});
