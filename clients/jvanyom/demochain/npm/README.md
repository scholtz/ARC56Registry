...
```bash
npm install arc56-generated-jvanyom-demochain @algorandfoundation/algokit-utils algosdk
```
...
import { Demochain_d81a46aa } from "arc56-generated-jvanyom-demochain";

const algorand = AlgorandClient.mainNet();
const client = new Demochain_d81a46aa.DemochainClient({
  algorand,
  appId: 123456789n,
});
...
| --- | --- | --- |
| `Demochain_d81a46aa` | `DemochainClient` | [https://raw.githubusercontent.com/jvanyom/demochain/HEAD/client/src/algorand/Demochain.arc56.json](https://raw.githubusercontent.com/jvanyom/demochain/HEAD/client/src/algorand/Demochain.arc56.json) |
