...
```bash
pip install arc56-generated-jvanyom-demochain
```
...
from arc56_generated_jvanyom_demochain import Demochain_d81a46aa

algorand = AlgorandClient.mainnet()
client = Demochain_d81a46aa.DemochainClient(
    algorand=algorand,
    app_id=123456789,
)
