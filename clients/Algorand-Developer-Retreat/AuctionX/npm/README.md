...
```bash
npm install arc56-generated-algorand-developer-retreat-auctionx @algorandfoundation/algokit-utils algosdk
```
...
import { AuctionX_a6cf083b } from "arc56-generated-algorand-developer-retreat-auctionx";

const algorand = AlgorandClient.mainNet();
const client = new AuctionX_a6cf083b.AuctionXClient({
  algorand,
  appId: 123456789n,
});
