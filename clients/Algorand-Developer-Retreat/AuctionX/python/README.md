...
```bash
pip install arc56-generated-algorand-developer-retreat-auctionx
```
...
from arc56_generated_algorand_developer_retreat_auctionx import AuctionX_a6cf083b

algorand = AlgorandClient.mainnet()
client = AuctionX_a6cf083b.AuctionXClient(
    algorand=algorand,
    app_id=123456789,
)
