...
```bash
pip install arc56-generated-algorand-developer-retreat-dml-chain
```
...
from arc56_generated_algorand_developer_retreat_dml_chain import DMLChain_23fd873c

algorand = AlgorandClient.mainnet()
client = DMLChain_23fd873c.DmlChainClient(
    algorand=algorand,
    app_id=123456789,
)
