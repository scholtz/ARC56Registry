...
```bash
npm install arc56-generated-algorand-developer-retreat-dml-chain @algorandfoundation/algokit-utils algosdk
```
...
import { DMLChain_23fd873c } from "arc56-generated-algorand-developer-retreat-dml-chain";

const algorand = AlgorandClient.mainNet();
const client = new DMLChain_23fd873c.DmlChainClient({
  algorand,
  appId: 123456789n,
});
