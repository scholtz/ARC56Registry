...
```bash
pip install arc56-generated-algorand-developer-retreat-web-vrf-example
```
...
from arc56_generated_algorand_developer_retreat_web_vrf_example import AppVRF_3d1e2d1c

algorand = AlgorandClient.mainnet()
client = AppVRF_3d1e2d1c.AppVrfClient(
    algorand=algorand,
    app_id=123456789,
)
