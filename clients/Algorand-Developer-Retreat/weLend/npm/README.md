...
```bash
npm install arc56-generated-algorand-developer-retreat-welend @algorandfoundation/algokit-utils algosdk
```
...
import { weLend_a002c739 } from "arc56-generated-algorand-developer-retreat-welend";

const algorand = AlgorandClient.mainNet();
const client = new weLend_a002c739.WeLendClient({
  algorand,
  appId: 123456789n,
});
