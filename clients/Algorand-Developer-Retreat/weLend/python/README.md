...
```bash
pip install arc56-generated-algorand-developer-retreat-welend
```
...
from arc56_generated_algorand_developer_retreat_welend import weLend_a002c739

algorand = AlgorandClient.mainnet()
client = weLend_a002c739.WeLendClient(
    algorand=algorand,
    app_id=123456789,
)
