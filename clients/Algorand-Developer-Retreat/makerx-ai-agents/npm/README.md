...
```bash
npm install arc56-generated-algorand-developer-retreat-makerx-ai-agents @algorandfoundation/algokit-utils algosdk
```
...
import { AiRegistry_b5382e1a } from "arc56-generated-algorand-developer-retreat-makerx-ai-agents";

const algorand = AlgorandClient.mainNet();
const client = new AiRegistry_b5382e1a.AiRegistryClient({
  algorand,
  appId: 123456789n,
});
