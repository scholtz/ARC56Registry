...
```bash
pip install arc56-generated-algorand-developer-retreat-wasm-vrf-example
```
...
from arc56_generated_algorand_developer_retreat_wasm_vrf_example import HeadsOrTails_b08111df

algorand = AlgorandClient.mainnet()
client = HeadsOrTails_b08111df.HeadsOrTailsClient(
    algorand=algorand,
    app_id=123456789,
)
