...
```bash
npm install arc56-generated-algorand-developer-retreat-abel @algorandfoundation/algokit-utils algosdk
```
...
import { AssetLabeling_9d1ec9f4 } from "arc56-generated-algorand-developer-retreat-abel";

const algorand = AlgorandClient.mainNet();
const client = new AssetLabeling_9d1ec9f4.AssetLabelingClient({
  algorand,
  appId: 123456789n,
});
