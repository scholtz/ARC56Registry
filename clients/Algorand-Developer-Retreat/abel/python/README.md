...
```bash
pip install arc56-generated-algorand-developer-retreat-abel
```
...
from arc56_generated_algorand_developer_retreat_abel import AssetLabeling_9d1ec9f4

algorand = AlgorandClient.mainnet()
client = AssetLabeling_9d1ec9f4.AssetLabelingClient(
    algorand=algorand,
    app_id=123456789,
)
