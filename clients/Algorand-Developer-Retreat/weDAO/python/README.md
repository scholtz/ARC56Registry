...
```bash
pip install arc56-generated-algorand-developer-retreat-wedao
```
...
from arc56_generated_algorand_developer_retreat_wedao import YesNoDao_c9fdb393

algorand = AlgorandClient.mainnet()
client = YesNoDao_c9fdb393.YesNoDaoClient(
    algorand=algorand,
    app_id=123456789,
)
