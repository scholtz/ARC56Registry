...
```bash
pip install arc56-generated-premkumar1845-probex
```
...
from arc56_generated_premkumar1845_probex import ProbexContract_636a865c

algorand = AlgorandClient.mainnet()
client = ProbexContract_636a865c.ProbexContractClient(
    algorand=algorand,
    app_id=123456789,
)
