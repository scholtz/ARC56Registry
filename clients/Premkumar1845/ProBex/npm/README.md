...
```bash
npm install arc56-generated-premkumar1845-probex @algorandfoundation/algokit-utils algosdk
```
...
import { ProbexContract_636a865c } from "arc56-generated-premkumar1845-probex";

const algorand = AlgorandClient.mainNet();
const client = new ProbexContract_636a865c.ProbexContractClient({
  algorand,
  appId: 123456789n,
});
