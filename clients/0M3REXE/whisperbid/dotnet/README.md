...
Auto-generated typed Algorand smart-contract clients for **[0M3REXE/whisperbid](https://github.com/0M3REXE/whisperbid)**,
...
```bash
dotnet add package Arc56.Generated.0M3REXE.whisperbid
```
