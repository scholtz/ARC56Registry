...
```bash
npm install arc56-generated-devbugra-algocredit @algorandfoundation/algokit-utils algosdk
```
...
import { AlgoCreditPlatformTestNet_bd2ac49d } from "arc56-generated-devbugra-algocredit";

const algorand = AlgorandClient.mainNet();
const client = new AlgoCreditPlatformTestNet_bd2ac49d.AlgoCreditPlatformTestNetClient({
  algorand,
  appId: 123456789n,
});
