...
```bash
pip install arc56-generated-devbugra-algocredit
```
...
from arc56_generated_devbugra_algocredit import AlgoCreditPlatformTestNet_bd2ac49d

algorand = AlgorandClient.mainnet()
client = AlgoCreditPlatformTestNet_bd2ac49d.AlgoCreditPlatformTestNetClient(
    algorand=algorand,
    app_id=123456789,
)
