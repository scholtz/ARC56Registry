...
```bash
pip install arc56-generated-mohit-1710-algorand-smart-contract
```
...
from arc56_generated_mohit_1710_algorand_smart_contract import PredictionMarketContract_5c16b5a2

algorand = AlgorandClient.mainnet()
client = PredictionMarketContract_5c16b5a2.PredictionMarketContractClient(
    algorand=algorand,
    app_id=123456789,
)
