...
```bash
npm install arc56-generated-ravi7657-resume-to-role-match-scorer @algorandfoundation/algokit-utils algosdk
```
...
import { ResumeVerifier_172b93c0 } from "arc56-generated-ravi7657-resume-to-role-match-scorer";

const algorand = AlgorandClient.mainNet();
const client = new ResumeVerifier_172b93c0.ResumeVerifierClient({
  algorand,
  appId: 123456789n,
});
