...
```bash
npm install arc56-generated-harsh-mogalgiddikar-cadencia-platform @algorandfoundation/algokit-utils algosdk
```
...
import { ContractName_hash } from "arc56-generated-harsh-mogalgiddikar-cadencia-platform";
