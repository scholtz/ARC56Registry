...
```bash
pip install arc56-generated-karthikreddy358-student-ms
```
...
from arc56_generated_karthikreddy358_student_ms import HelloWorld_329b7cdb

algorand = AlgorandClient.mainnet()
client = HelloWorld_329b7cdb.HelloWorldClient(
    algorand=algorand,
    app_id=123456789,
)
