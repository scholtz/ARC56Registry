...
```bash
npm install arc56-generated-tonydalziel-easy-a-hackathon @algorandfoundation/algokit-utils algosdk
```
...
import { ChAiN_ace4e440 } from "arc56-generated-tonydalziel-easy-a-hackathon";

const algorand = AlgorandClient.mainNet();
const client = new ChAiN_ace4e440.ChAiNClient({
  algorand,
  appId: 123456789n,
});
