...
```bash
pip install arc56-generated-tonydalziel-easy-a-hackathon
```
...
from arc56_generated_tonydalziel_easy_a_hackathon import ChAiN_ace4e440

algorand = AlgorandClient.mainnet()
client = ChAiN_ace4e440.ChAiNClient(
    algorand=algorand,
    app_id=123456789,
)
