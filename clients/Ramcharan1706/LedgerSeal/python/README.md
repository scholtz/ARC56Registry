...
```bash
pip install arc56-generated-ramcharan1706-ledgerseal
```
...
from arc56_generated_ramcharan1706_ledgerseal import LedgerSeal_24c95049

algorand = AlgorandClient.mainnet()
client = LedgerSeal_24c95049.LedgerSealClient(
    algorand=algorand,
    app_id=123456789,
)
