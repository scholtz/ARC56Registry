...
```bash
pip install arc56-generated-ramcharan1706-pit-crew
```
...
from arc56_generated_ramcharan1706_pit_crew import Intent_88ae61ca

algorand = AlgorandClient.mainnet()
client = Intent_88ae61ca.IntentClient(
    algorand=algorand,
    app_id=123456789,
)
