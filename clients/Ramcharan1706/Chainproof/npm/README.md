...
```bash
npm install arc56-generated-ramcharan1706-chainproof @algorandfoundation/algokit-utils algosdk
```
...
import { LedgerSeal_26624ccf } from "arc56-generated-ramcharan1706-chainproof";

const algorand = AlgorandClient.mainNet();
const client = new LedgerSeal_26624ccf.LedgerSealClient({
  algorand,
  appId: 123456789n,
});
