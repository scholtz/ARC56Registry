...
```bash
pip install arc56-generated-folks-finance-algorand-wormhole-example
```
...
from arc56_generated_folks_finance_algorand_wormhole_example import PingPong_cdd0fc73

algorand = AlgorandClient.mainnet()
client = PingPong_cdd0fc73.PingPongClient(
    algorand=algorand,
    app_id=123456789,
)
