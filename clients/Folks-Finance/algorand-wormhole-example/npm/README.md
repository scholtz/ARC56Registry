...
```bash
npm install arc56-generated-folks-finance-algorand-wormhole-example @algorandfoundation/algokit-utils algosdk
```
...
import { PingPong_cdd0fc73 } from "arc56-generated-folks-finance-algorand-wormhole-example";

const algorand = AlgorandClient.mainNet();
const client = new PingPong_cdd0fc73.PingPongClient({
  algorand,
  appId: 123456789n,
});
...
| --- | --- | --- |
| `PingPong_cdd0fc73` | `PingPongClient` | [https://raw.githubusercontent.com/Folks-Finance/algorand-wormhole-example/HEAD/avm/specs/arc56/PingPong.arc56.json](https://raw.githubusercontent.com/Folks-Finance/algorand-wormhole-example/HEAD/avm/specs/arc56/PingPong.arc56.json) |
