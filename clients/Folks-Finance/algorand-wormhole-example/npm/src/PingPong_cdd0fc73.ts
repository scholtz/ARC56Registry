...
export type PingPongComposer<TReturns extends [...any[]] = []> = {
   ...
   */
  simulate(): Promise<PingPongComposerResults<TReturns> & { simulateResponse: modelsv2.SimulateResponse }>
  simulate(options: SkipSignaturesSimulateOptions): Promise<PingPongComposerResults<TReturns> & { simulateResponse: modelsv2.SimulateResponse }>
  simulate(options: RawSimulateOptions): Promise<PingPongComposerResults<TReturns> & { simulateResponse: modelsv2.SimulateResponse }>
  /**
