...
```bash
npm install arc56-generated-keshabkjha-lotterycontract @algorandfoundation/algokit-utils algosdk
```
...
import { Lottery_c0f62695 } from "arc56-generated-keshabkjha-lotterycontract";

const algorand = AlgorandClient.mainNet();
const client = new Lottery_c0f62695.LotteryClient({
  algorand,
  appId: 123456789n,
});
...
| --- | --- | --- |
| `Lottery_c0f62695` | `LotteryClient` | [https://raw.githubusercontent.com/Keshabkjha/LotteryContract/HEAD/smart_contracts/artifacts/lottery/Lottery.arc56.json](https://raw.githubusercontent.com/Keshabkjha/LotteryContract/HEAD/smart_contracts/artifacts/lottery/Lottery.arc56.json) |
