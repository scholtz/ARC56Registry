...
```bash
pip install arc56-generated-keshabkjha-lotterycontract
```
...
from arc56_generated_keshabkjha_lotterycontract import Lottery_c0f62695

algorand = AlgorandClient.mainnet()
client = Lottery_c0f62695.LotteryClient(
    algorand=algorand,
    app_id=123456789,
)
