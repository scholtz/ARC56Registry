...
```bash
pip install arc56-generated-zacze-prooffolio
```
...
from arc56_generated_zacze_prooffolio import ContractApp_d1a4ce05

algorand = AlgorandClient.mainnet()
client = ContractApp_d1a4ce05.ContractAppClient(
    algorand=algorand,
    app_id=123456789,
)
