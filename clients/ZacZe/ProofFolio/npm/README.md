...
```bash
npm install arc56-generated-zacze-prooffolio @algorandfoundation/algokit-utils algosdk
```
...
import { ContractApp_d1a4ce05 } from "arc56-generated-zacze-prooffolio";

const algorand = AlgorandClient.mainNet();
const client = new ContractApp_d1a4ce05.ContractAppClient({
  algorand,
  appId: 123456789n,
});
