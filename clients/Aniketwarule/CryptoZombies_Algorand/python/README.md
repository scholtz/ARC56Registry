...
```bash
pip install arc56-generated-aniketwarule-cryptozombies-algorand
```
...
from arc56_generated_aniketwarule_cryptozombies_algorand import AlgoZombiesContract_0b09c6f3

algorand = AlgorandClient.mainnet()
client = AlgoZombiesContract_0b09c6f3.AlgoZombiesContractClient(
    algorand=algorand,
    app_id=123456789,
)
