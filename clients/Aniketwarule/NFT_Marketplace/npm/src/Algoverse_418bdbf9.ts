...
export type AlgoverseComposer<TReturns extends [...any[]] = []> = {
  ...
  * A demonstration method used in the AlgoKit fullstack template.
   ...
   */
  simulate(): Promise<AlgoverseComposerResults<TReturns> & { simulateResponse: modelsv2.SimulateResponse }>
  simulate(options: SkipSignaturesSimulateOptions): Promise<AlgoverseComposerResults<TReturns> & { simulateResponse: modelsv2.SimulateResponse }>
  simulate(options: RawSimulateOptions): Promise<AlgoverseComposerResults<TReturns> & { simulateResponse: modelsv2.SimulateResponse }>
  /**
