...
```bash
pip install arc56-generated-aniketwarule-nft-marketplace
```
...
from arc56_generated_aniketwarule_nft_marketplace import Algoverse_418bdbf9

algorand = AlgorandClient.mainnet()
client = Algoverse_418bdbf9.AlgoverseClient(
    algorand=algorand,
    app_id=123456789,
)
