...
```bash
npm install arc56-generated-aniketwarule-daoship @algorandfoundation/algokit-utils algosdk
```
...
import { Daoship_3664ab4e } from "arc56-generated-aniketwarule-daoship";

const algorand = AlgorandClient.mainNet();
const client = new Daoship_3664ab4e.DaoshipClient({
  algorand,
  appId: 123456789n,
});
