...
```bash
pip install arc56-generated-sautsokreach-firstalgo
```
...
from arc56_generated_sautsokreach_firstalgo import FirstSmartContract_a578912e

algorand = AlgorandClient.mainnet()
client = FirstSmartContract_a578912e.FirstSmartContractClient(
    algorand=algorand,
    app_id=123456789,
)
