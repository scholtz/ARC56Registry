...
```bash
npm install arc56-generated-sautsokreach-firstalgo @algorandfoundation/algokit-utils algosdk
```
...
import { FirstSmartContract_a578912e } from "arc56-generated-sautsokreach-firstalgo";

const algorand = AlgorandClient.mainNet();
const client = new FirstSmartContract_a578912e.FirstSmartContractClient({
  algorand,
  appId: 123456789n,
});
