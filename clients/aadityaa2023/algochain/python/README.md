...
```bash
pip install arc56-generated-aadityaa2023-algochain
```
...
from arc56_generated_aadityaa2023_algochain import ElectionManagement_8619ab7e

algorand = AlgorandClient.mainnet()
client = ElectionManagement_8619ab7e.ElectionManagementClient(
    algorand=algorand,
    app_id=123456789,
)
