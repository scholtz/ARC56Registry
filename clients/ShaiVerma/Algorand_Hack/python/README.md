...
```bash
pip install arc56-generated-shaiverma-algorand-hack
```
...
from arc56_generated_shaiverma_algorand_hack import DecentralizedAiContract_3ab4156a

algorand = AlgorandClient.mainnet()
client = DecentralizedAiContract_3ab4156a.DecentralizedAiContractClient(
    algorand=algorand,
    app_id=123456789,
)
