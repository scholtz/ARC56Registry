...
```bash
npm install arc56-generated-vjlive-algosplit @algorandfoundation/algokit-utils algosdk
```
...
import { Algosplit_daf70951 } from "arc56-generated-vjlive-algosplit";

const algorand = AlgorandClient.mainNet();
const client = new Algosplit_daf70951.AlgosplitClient({
  algorand,
  appId: 123456789n,
});
