...
```bash
npm install arc56-generated-vjlive-agentwallet @algorandfoundation/algokit-utils algosdk
```
...
import { CreditSystem_f1c59a57 } from "arc56-generated-vjlive-agentwallet";

const algorand = AlgorandClient.mainNet();
const client = new CreditSystem_f1c59a57.CreditSystemClient({
  algorand,
  appId: 123456789n,
});
...
| --- | --- | --- |
| `CreditSystem_f1c59a57` | `CreditSystemClient` | [https://raw.githubusercontent.com/VJLIVE/AgentWallet/HEAD/contracts/CreditSystem.arc56.json](https://raw.githubusercontent.com/VJLIVE/AgentWallet/HEAD/contracts/CreditSystem.arc56.json) |
