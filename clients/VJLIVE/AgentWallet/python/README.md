...
```bash
pip install arc56-generated-vjlive-agentwallet
```
...
from arc56_generated_vjlive_agentwallet import CreditSystem_f1c59a57

algorand = AlgorandClient.mainnet()
client = CreditSystem_f1c59a57.CreditSystemClient(
    algorand=algorand,
    app_id=123456789,
)
