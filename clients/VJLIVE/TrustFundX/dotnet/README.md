# Arc56.Generated.VJLIVE.TrustFundX

Auto-generated typed Algorand smart-contract clients for **[VJLIVE/TrustFundX](https://github.com/VJLIVE/TrustFundX)**,
...
```bash
dotnet add package Arc56.Generated.VJLIVE.TrustFundX
```
