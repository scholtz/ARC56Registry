...
```bash
npm install arc56-generated-amitaswal123-rentchain-dapp @algorandfoundation/algokit-utils algosdk
```
...
import { HelloWorld_ac6a4572 } from "arc56-generated-amitaswal123-rentchain-dapp";

const algorand = AlgorandClient.mainNet();
const client = new HelloWorld_ac6a4572.HelloWorldClient({
  algorand,
  appId: 123456789n,
});
