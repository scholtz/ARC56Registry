...
```bash
pip install arc56-generated-upendra512-team-blockbusters
```
...
from arc56_generated_upendra512_team_blockbusters import CommerceEscrow_1d907c34

algorand = AlgorandClient.mainnet()
client = CommerceEscrow_1d907c34.CommerceEscrowClient(
    algorand=algorand,
    app_id=123456789,
)
