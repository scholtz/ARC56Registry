...
```bash
pip install arc56-generated-adeelarifkhan-my-algo-bank
```
...
from arc56_generated_adeelarifkhan_my_algo_bank import PersonalBank_fcaf4e39

algorand = AlgorandClient.mainnet()
client = PersonalBank_fcaf4e39.PersonalBankClient(
    algorand=algorand,
    app_id=123456789,
)
