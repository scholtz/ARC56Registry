...
```bash
npm install arc56-generated-adeelarifkhan-mywallet @algorandfoundation/algokit-utils algosdk
```
...
import { Mywallet_b0cac34e } from "arc56-generated-adeelarifkhan-mywallet";

const algorand = AlgorandClient.mainNet();
const client = new Mywallet_b0cac34e.MywalletClient({
  algorand,
  appId: 123456789n,
});
...
| --- | --- | --- |
| `Mywallet_b0cac34e` | `MywalletClient` | [https://raw.githubusercontent.com/AdeelArifKhan/MyWallet/HEAD/mywallet/Mywallet.arc56.json](https://raw.githubusercontent.com/AdeelArifKhan/MyWallet/HEAD/mywallet/Mywallet.arc56.json) |
