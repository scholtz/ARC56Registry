...
```bash
pip install arc56-generated-adeelarifkhan-mywallet
```
...
from arc56_generated_adeelarifkhan_mywallet import Mywallet_b0cac34e

algorand = AlgorandClient.mainnet()
client = Mywallet_b0cac34e.MywalletClient(
    algorand=algorand,
    app_id=123456789,
)
