...
```bash
pip install arc56-generated-brandonjsellam-releone-trelyan-falcon-inscription
```
...
from arc56_generated_brandonjsellam_releone_trelyan_falcon_inscription import TrelyanInscription_6210053f

algorand = AlgorandClient.mainnet()
client = TrelyanInscription_6210053f.TrelyanInscriptionClient(
    algorand=algorand,
    app_id=123456789,
)
