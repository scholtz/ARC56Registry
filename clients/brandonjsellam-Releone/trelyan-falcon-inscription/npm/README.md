...
```bash
npm install arc56-generated-brandonjsellam-releone-trelyan-falcon-inscription @algorandfoundation/algokit-utils algosdk
```
...
import { TrelyanInscription_6210053f } from "arc56-generated-brandonjsellam-releone-trelyan-falcon-inscription";

const algorand = AlgorandClient.mainNet();
const client = new TrelyanInscription_6210053f.TrelyanInscriptionClient({
  algorand,
  appId: 123456789n,
});
