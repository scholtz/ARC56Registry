...
```bash
pip install arc56-generated-manu-2213-algorand
```
...
from arc56_generated_manu_2213_algorand import HelloWorld_1fd7b9b8

algorand = AlgorandClient.mainnet()
client = HelloWorld_1fd7b9b8.HelloWorldClient(
    algorand=algorand,
    app_id=123456789,
)
