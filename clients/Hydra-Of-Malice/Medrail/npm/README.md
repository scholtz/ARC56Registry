...
```bash
npm install arc56-generated-hydra-of-malice-medrail @algorandfoundation/algokit-utils algosdk
```
...
import { MedRailConsent_bcc58baf } from "arc56-generated-hydra-of-malice-medrail";

const algorand = AlgorandClient.mainNet();
const client = new MedRailConsent_bcc58baf.MedRailConsentClient({
  algorand,
  appId: 123456789n,
});
...
| --- | --- | --- |
| `MedRailConsent_bcc58baf` | `MedRailConsentClient` | [https://raw.githubusercontent.com/Hydra-Of-Malice/Medrail/HEAD/contracts/artifacts/current/MedRailConsent.arc56.json](https://raw.githubusercontent.com/Hydra-Of-Malice/Medrail/HEAD/contracts/artifacts/current/MedRailConsent.arc56.json) |
| `MedRailConsent_054c9dfd` | `MedRailConsentClient` | [https://raw.githubusercontent.com/Hydra-Of-Malice/Medrail/HEAD/contracts/artifacts/MedRailConsent.arc56.json](https://raw.githubusercontent.com/Hydra-Of-Malice/Medrail/HEAD/contracts/artifacts/MedRailConsent.arc56.json) |
