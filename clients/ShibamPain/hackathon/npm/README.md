...
```bash
npm install arc56-generated-shibampain-hackathon @algorandfoundation/algokit-utils algosdk
```
...
import { HelloWorld_16d40631 } from "arc56-generated-shibampain-hackathon";

const algorand = AlgorandClient.mainNet();
const client = new HelloWorld_16d40631.HelloWorldClient({
  algorand,
  appId: 123456789n,
});
...
| --- | --- | --- |
| `HelloWorld_16d40631` | `HelloWorldClient` | [https://raw.githubusercontent.com/ShibamPain/hackathon/HEAD/blockchain/FusionX/artifacts/HelloWorld.arc56.json](https://raw.githubusercontent.com/ShibamPain/hackathon/HEAD/blockchain/FusionX/artifacts/HelloWorld.arc56.json) |
