...
```bash
pip install arc56-generated-whyvaibhav-algorand
```
...
from arc56_generated_whyvaibhav_algorand import HelloWorld_99d5a7f9

algorand = AlgorandClient.mainnet()
client = HelloWorld_99d5a7f9.HelloWorldClient(
    algorand=algorand,
    app_id=123456789,
)
