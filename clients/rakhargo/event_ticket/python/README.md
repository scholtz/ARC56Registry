...
```bash
pip install arc56-generated-rakhargo-event-ticket
```
...
from arc56_generated_rakhargo_event_ticket import EventTicket_bfb88a10

algorand = AlgorandClient.mainnet()
client = EventTicket_bfb88a10.EventTicketClient(
    algorand=algorand,
    app_id=123456789,
)
