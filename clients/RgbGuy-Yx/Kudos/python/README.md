...
```bash
pip install arc56-generated-rgbguy-yx-kudos
```
...
from arc56_generated_rgbguy_yx_kudos import KudosEscrowContract_f747ce88

algorand = AlgorandClient.mainnet()
client = KudosEscrowContract_f747ce88.KudosEscrowContractClient(
    algorand=algorand,
    app_id=123456789,
)
