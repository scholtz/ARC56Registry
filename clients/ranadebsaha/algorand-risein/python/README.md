...
```bash
pip install arc56-generated-ranadebsaha-algorand-risein
```
...
from arc56_generated_ranadebsaha_algorand_risein import CertificateRegistry_8e25c8ba

algorand = AlgorandClient.mainnet()
client = CertificateRegistry_8e25c8ba.CertificateRegistryClient(
    algorand=algorand,
    app_id=123456789,
)
