...
```bash
npm install arc56-generated-ranadebsaha-algorand-risein @algorandfoundation/algokit-utils algosdk
```
...
import { CertificateRegistry_8e25c8ba } from "arc56-generated-ranadebsaha-algorand-risein";

const algorand = AlgorandClient.mainNet();
const client = new CertificateRegistry_8e25c8ba.CertificateRegistryClient({
  algorand,
  appId: 123456789n,
});
