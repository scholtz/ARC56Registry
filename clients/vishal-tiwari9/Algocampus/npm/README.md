...
```bash
npm install arc56-generated-vishal-tiwari9-algocampus @algorandfoundation/algokit-utils algosdk
```
...
import { HelloAlgocampus_69a13988 } from "arc56-generated-vishal-tiwari9-algocampus";

const algorand = AlgorandClient.mainNet();
const client = new HelloAlgocampus_69a13988.HelloAlgocampusClient({
  algorand,
  appId: 123456789n,
});
