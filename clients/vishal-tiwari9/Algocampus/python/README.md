...
```bash
pip install arc56-generated-vishal-tiwari9-algocampus
```
...
from arc56_generated_vishal_tiwari9_algocampus import HelloAlgocampus_69a13988

algorand = AlgorandClient.mainnet()
client = HelloAlgocampus_69a13988.HelloAlgocampusClient(
    algorand=algorand,
    app_id=123456789,
)
