...
```bash
pip install arc56-generated-allthetimeintheworld-my-project
```
...
from arc56_generated_allthetimeintheworld_my_project import FactChecker_09c50348

algorand = AlgorandClient.mainnet()
client = FactChecker_09c50348.FactCheckerClient(
    algorand=algorand,
    app_id=123456789,
)
