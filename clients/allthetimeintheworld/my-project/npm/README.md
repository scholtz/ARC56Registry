...
```bash
npm install arc56-generated-allthetimeintheworld-my-project @algorandfoundation/algokit-utils algosdk
```
...
import { FactChecker_09c50348 } from "arc56-generated-allthetimeintheworld-my-project";

const algorand = AlgorandClient.mainNet();
const client = new FactChecker_09c50348.FactCheckerClient({
  algorand,
  appId: 123456789n,
});
