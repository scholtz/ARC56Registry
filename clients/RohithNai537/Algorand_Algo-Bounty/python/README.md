...
```bash
pip install arc56-generated-rohithnai537-algorand-algo-bounty
```
...
from arc56_generated_rohithnai537_algorand_algo_bounty import TaskBounty_d345ffd9

algorand = AlgorandClient.mainnet()
client = TaskBounty_d345ffd9.TaskBountyClient(
    algorand=algorand,
    app_id=123456789,
)
