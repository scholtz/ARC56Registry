...
```bash
pip install arc56-generated-adityaforgit-algorand-savings-vault
```
...
from arc56_generated_adityaforgit_algorand_savings_vault import AlgoVault_c8a2778e

algorand = AlgorandClient.mainnet()
client = AlgoVault_c8a2778e.AlgoVaultClient(
    algorand=algorand,
    app_id=123456789,
)
