...
```bash
npm install arc56-generated-adityaforgit-algorand-savings-vault @algorandfoundation/algokit-utils algosdk
```
...
import { AlgoVault_c8a2778e } from "arc56-generated-adityaforgit-algorand-savings-vault";

const algorand = AlgorandClient.mainNet();
const client = new AlgoVault_c8a2778e.AlgoVaultClient({
  algorand,
  appId: 123456789n,
});
