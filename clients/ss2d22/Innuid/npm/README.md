...
```bash
npm install arc56-generated-ss2d22-innuid @algorandfoundation/algokit-utils algosdk
```
...
import { Tradeflow_edcde0d4 } from "arc56-generated-ss2d22-innuid";

const algorand = AlgorandClient.mainNet();
const client = new Tradeflow_edcde0d4.TradeflowClient({
  algorand,
  appId: 123456789n,
});
