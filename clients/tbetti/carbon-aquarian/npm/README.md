...
```bash
npm install arc56-generated-tbetti-carbon-aquarian @algorandfoundation/algokit-utils algosdk
```
...
import { Backend_3e19abfb } from "arc56-generated-tbetti-carbon-aquarian";

const algorand = AlgorandClient.mainNet();
const client = new Backend_3e19abfb.BackendClient({
  algorand,
  appId: 123456789n,
});
