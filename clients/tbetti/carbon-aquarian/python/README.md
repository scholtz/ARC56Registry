...
```bash
pip install arc56-generated-tbetti-carbon-aquarian
```
...
from arc56_generated_tbetti_carbon_aquarian import Backend_3e19abfb

algorand = AlgorandClient.mainnet()
client = Backend_3e19abfb.BackendClient(
    algorand=algorand,
    app_id=123456789,
)
