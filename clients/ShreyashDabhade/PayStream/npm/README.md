...
```bash
npm install arc56-generated-shreyashdabhade-paystream @algorandfoundation/algokit-utils algosdk
```
...
import { PayStream_e3c1b65f } from "arc56-generated-shreyashdabhade-paystream";

const algorand = AlgorandClient.mainNet();
const client = new PayStream_e3c1b65f.PayStreamClient({
  algorand,
  appId: 123456789n,
});
