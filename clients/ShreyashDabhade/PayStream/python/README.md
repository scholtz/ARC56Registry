...
```bash
pip install arc56-generated-shreyashdabhade-paystream
```
...
from arc56_generated_shreyashdabhade_paystream import PayStream_e3c1b65f

algorand = AlgorandClient.mainnet()
client = PayStream_e3c1b65f.PayStreamClient(
    algorand=algorand,
    app_id=123456789,
)
