...
```bash
pip install arc56-generated-bhavyapathik-algoweb3
```
...
from arc56_generated_bhavyapathik_algoweb3 import HelloWorld_fc8f57b7

algorand = AlgorandClient.mainnet()
client = HelloWorld_fc8f57b7.HelloWorldClient(
    algorand=algorand,
    app_id=123456789,
)
