...
```bash
npm install arc56-generated-p2arthur-wedev @algorandfoundation/algokit-utils algosdk
```
...
import { YesNoDao_668dd90b } from "arc56-generated-p2arthur-wedev";

const algorand = AlgorandClient.mainNet();
const client = new YesNoDao_668dd90b.YesNoDaoClient({
  algorand,
  appId: 123456789n,
});
