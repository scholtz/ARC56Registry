...
```bash
npm install arc56-generated-p2arthur-wesource-test-bounties @algorandfoundation/algokit-utils algosdk
```
...
import { SourceFactory_843cef72 } from "arc56-generated-p2arthur-wesource-test-bounties";

const algorand = AlgorandClient.mainNet();
const client = new SourceFactory_843cef72.SourceFactoryClient({
  algorand,
  appId: 123456789n,
});
