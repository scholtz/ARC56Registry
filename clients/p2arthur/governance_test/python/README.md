...
```bash
pip install arc56-generated-p2arthur-governance-test
```
...
from arc56_generated_p2arthur_governance_test import CompxGovernance_83d92bf5

algorand = AlgorandClient.mainnet()
client = CompxGovernance_83d92bf5.CompxGovernanceClient(
    algorand=algorand,
    app_id=123456789,
)
