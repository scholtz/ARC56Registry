...
```bash
npm install arc56-generated-ansaria11-hackathon @algorandfoundation/algokit-utils algosdk
```
...
import { HackathonContract_6b34a24a } from "arc56-generated-ansaria11-hackathon";

const algorand = AlgorandClient.mainNet();
const client = new HackathonContract_6b34a24a.HackathonContractClient({
  algorand,
  appId: 123456789n,
});
