# Arc56.Generated.ansaria11.Hackathon
...
```bash
dotnet add package Arc56.Generated.ansaria11.Hackathon
```
...
using Arc56.Generated.ansaria11.Hackathon.HackathonContract_6b34a24a;

var algod = new DefaultApi(httpClient); // configure with your algod endpoint
var client = new HackathonContractProxy(algod, appId: 123456789);
