...
```bash
pip install arc56-generated-kartikeyan-sudo-triviapay-v3
```
...
from arc56_generated_kartikeyan_sudo_triviapay_v3 import TriviaPay_85859da7

algorand = AlgorandClient.mainnet()
client = TriviaPay_85859da7.TriviaPayClient(
    algorand=algorand,
    app_id=123456789,
)
