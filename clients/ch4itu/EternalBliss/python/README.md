...
```bash
pip install arc56-generated-ch4itu-eternalbliss
```
...
from arc56_generated_ch4itu_eternalbliss import UniversalStateMachine_1bcd90b3

algorand = AlgorandClient.mainnet()
client = UniversalStateMachine_1bcd90b3.UniversalStateMachineClient(
    algorand=algorand,
    app_id=123456789,
)
