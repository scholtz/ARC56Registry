...
```bash
npm install arc56-generated-ch4itu-eternalbliss @algorandfoundation/algokit-utils algosdk
```
...
import { UniversalStateMachine_1bcd90b3 } from "arc56-generated-ch4itu-eternalbliss";

const algorand = AlgorandClient.mainNet();
const client = new UniversalStateMachine_1bcd90b3.UniversalStateMachineClient({
  algorand,
  appId: 123456789n,
});
...
| --- | --- | --- |
| `UniversalStateMachine_1bcd90b3` | `UniversalStateMachineClient` | [https://raw.githubusercontent.com/ch4itu/EternalBliss/HEAD/contract/out/UniversalStateMachine.arc56.json](https://raw.githubusercontent.com/ch4itu/EternalBliss/HEAD/contract/out/UniversalStateMachine.arc56.json) |
