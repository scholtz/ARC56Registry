...
```bash
pip install arc56-generated-rohit-debnath24-algoslice
```
...
from arc56_generated_rohit_debnath24_algoslice import EscrowContract_f197658d

algorand = AlgorandClient.mainnet()
client = EscrowContract_f197658d.EscrowContractClient(
    algorand=algorand,
    app_id=123456789,
)
