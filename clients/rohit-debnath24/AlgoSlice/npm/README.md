...
```bash
npm install arc56-generated-rohit-debnath24-algoslice @algorandfoundation/algokit-utils algosdk
```
...
import { EscrowContract_f197658d } from "arc56-generated-rohit-debnath24-algoslice";

const algorand = AlgorandClient.mainNet();
const client = new EscrowContract_f197658d.EscrowContractClient({
  algorand,
  appId: 123456789n,
});
...
| --- | --- | --- |
| `EscrowContract_f197658d` | `EscrowContractClient` | [https://raw.githubusercontent.com/rohit-debnath24/AlgoSlice/HEAD/gpux-escrow/EscrowContract.arc56.json](https://raw.githubusercontent.com/rohit-debnath24/AlgoSlice/HEAD/gpux-escrow/EscrowContract.arc56.json) |
