...
```bash
pip install arc56-generated-credchian-credchain-project
```
...
from arc56_generated_credchian_credchain_project import CredchainContract_23c62a1d

algorand = AlgorandClient.mainnet()
client = CredchainContract_23c62a1d.CredchainContractClient(
    algorand=algorand,
    app_id=123456789,
)
