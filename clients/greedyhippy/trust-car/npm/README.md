...
```bash
npm install arc56-generated-greedyhippy-trust-car @algorandfoundation/algokit-utils algosdk
```
...
import { IrishVehicleRegistry_31d46f86 } from "arc56-generated-greedyhippy-trust-car";

const algorand = AlgorandClient.mainNet();
const client = new IrishVehicleRegistry_31d46f86.IrishVehicleRegistryClient({
  algorand,
  appId: 123456789n,
});
