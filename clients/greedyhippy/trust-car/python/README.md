...
```bash
pip install arc56-generated-greedyhippy-trust-car
```
...
from arc56_generated_greedyhippy_trust_car import IrishVehicleRegistry_31d46f86

algorand = AlgorandClient.mainnet()
client = IrishVehicleRegistry_31d46f86.IrishVehicleRegistryClient(
    algorand=algorand,
    app_id=123456789,
)
