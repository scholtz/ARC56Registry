...
```bash
npm install arc56-generated-vivekgoudadula-procure-ai @algorandfoundation/algokit-utils algosdk
```
...
import { EscrowContract_b983a92d } from "arc56-generated-vivekgoudadula-procure-ai";

const algorand = AlgorandClient.mainNet();
const client = new EscrowContract_b983a92d.EscrowContractClient({
  algorand,
  appId: 123456789n,
});
