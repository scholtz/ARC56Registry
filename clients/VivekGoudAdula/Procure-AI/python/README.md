...
```bash
pip install arc56-generated-vivekgoudadula-procure-ai
```
...
from arc56_generated_vivekgoudadula_procure_ai import EscrowContract_b983a92d

algorand = AlgorandClient.mainnet()
client = EscrowContract_b983a92d.EscrowContractClient(
    algorand=algorand,
    app_id=123456789,
)
