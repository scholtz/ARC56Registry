...
```bash
pip install arc56-generated-compsciinikhil-genmark-ai-content-origin-misuse-detection
```
...
from arc56_generated_compsciinikhil_genmark_ai_content_origin_misuse_detection import GenMark_003b90ec

algorand = AlgorandClient.mainnet()
client = GenMark_003b90ec.GenMarkClient(
    algorand=algorand,
    app_id=123456789,
)
