...
```bash
npm install arc56-generated-compsciinikhil-genmark-ai-content-origin-misuse-detection @algorandfoundation/algokit-utils algosdk
```
...
import { GenMark_003b90ec } from "arc56-generated-compsciinikhil-genmark-ai-content-origin-misuse-detection";

const algorand = AlgorandClient.mainNet();
const client = new GenMark_003b90ec.GenMarkClient({
  algorand,
  appId: 123456789n,
});
