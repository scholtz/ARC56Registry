...
```bash
pip install arc56-generated-kranthi1306-guess-number
```
...
from arc56_generated_kranthi1306_guess_number import GuessNumber_218075de

algorand = AlgorandClient.mainnet()
client = GuessNumber_218075de.GuessNumberClient(
    algorand=algorand,
    app_id=123456789,
)
