...
```bash
npm install arc56-generated-kranthi1306-carbonfootprint @algorandfoundation/algokit-utils algosdk
```
...
import { CarbonFootprintContract_e78b7b91 } from "arc56-generated-kranthi1306-carbonfootprint";

const algorand = AlgorandClient.mainNet();
const client = new CarbonFootprintContract_e78b7b91.CarbonFootprintContractClient({
  algorand,
  appId: 123456789n,
});
