...
```bash
pip install arc56-generated-g30tr1x-tracer
```
...
from arc56_generated_g30tr1x_tracer import SupplyChainTracer_0f5ab3de

algorand = AlgorandClient.mainnet()
client = SupplyChainTracer_0f5ab3de.SupplyChainTracerClient(
    algorand=algorand,
    app_id=123456789,
)
