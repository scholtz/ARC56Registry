...
```bash
npm install arc56-generated-g30tr1x-tracer @algorandfoundation/algokit-utils algosdk
```
...
import { SupplyChainTracer_0f5ab3de } from "arc56-generated-g30tr1x-tracer";

const algorand = AlgorandClient.mainNet();
const client = new SupplyChainTracer_0f5ab3de.SupplyChainTracerClient({
  algorand,
  appId: 123456789n,
});
