...
```bash
npm install arc56-generated-ekupekuai-agentmarketplace @algorandfoundation/algokit-utils algosdk
```
...
import { AgentVerse_97a834e5 } from "arc56-generated-ekupekuai-agentmarketplace";

const algorand = AlgorandClient.mainNet();
const client = new AgentVerse_97a834e5.AgentVerseClient({
  algorand,
  appId: 123456789n,
});
