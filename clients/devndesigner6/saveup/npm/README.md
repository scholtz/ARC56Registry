...
```bash
npm install arc56-generated-devndesigner6-saveup @algorandfoundation/algokit-utils algosdk
```
...
import { SaveUpVault_5231858b } from "arc56-generated-devndesigner6-saveup";

const algorand = AlgorandClient.mainNet();
const client = new SaveUpVault_5231858b.SaveUpVaultClient({
  algorand,
  appId: 123456789n,
});
...
| --- | --- | --- |
| `SaveUpVault_5231858b` | `SaveUpVaultClient` | [https://raw.githubusercontent.com/devndesigner6/saveup/HEAD/smart_contracts/artifacts/SaveUpVault.arc56.json](https://raw.githubusercontent.com/devndesigner6/saveup/HEAD/smart_contracts/artifacts/SaveUpVault.arc56.json) |
