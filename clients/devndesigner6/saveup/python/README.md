...
```bash
pip install arc56-generated-devndesigner6-saveup
```
...
from arc56_generated_devndesigner6_saveup import SaveUpVault_5231858b

algorand = AlgorandClient.mainnet()
client = SaveUpVault_5231858b.SaveUpVaultClient(
    algorand=algorand,
    app_id=123456789,
)
