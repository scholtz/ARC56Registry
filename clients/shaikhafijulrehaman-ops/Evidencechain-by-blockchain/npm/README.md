...
```bash
npm install arc56-generated-shaikhafijulrehaman-ops-evidencechain-by-blockchain @algorandfoundation/algokit-utils algosdk
```
...
import { EvidenceRegistry_deab03aa } from "arc56-generated-shaikhafijulrehaman-ops-evidencechain-by-blockchain";

const algorand = AlgorandClient.mainNet();
const client = new EvidenceRegistry_deab03aa.EvidenceRegistryClient({
  algorand,
  appId: 123456789n,
});
