...
```bash
npm install arc56-generated-hanumagoudabanakar5-hash-pillproof @algorandfoundation/algokit-utils algosdk
```
...
import { CounterfeitAlert_d18c5cd1 } from "arc56-generated-hanumagoudabanakar5-hash-pillproof";

const algorand = AlgorandClient.mainNet();
const client = new CounterfeitAlert_d18c5cd1.CounterfeitAlertClient({
  algorand,
  appId: 123456789n,
});
