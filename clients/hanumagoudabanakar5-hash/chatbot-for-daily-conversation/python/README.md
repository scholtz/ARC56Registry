...
```bash
pip install arc56-generated-hanumagoudabanakar5-hash-chatbot-for-daily-conversation
```
...
from arc56_generated_hanumagoudabanakar5_hash_chatbot_for_daily_conversation import CounterfeitAlert_5fc6ba4f

algorand = AlgorandClient.mainnet()
client = CounterfeitAlert_5fc6ba4f.CounterfeitAlertClient(
    algorand=algorand,
    app_id=123456789,
)
