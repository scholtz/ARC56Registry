...
```bash
npm install arc56-generated-nagasivakumari-algokit-installation @algorandfoundation/algokit-utils algosdk
```
...
import { Calculator_cf9a3b6a } from "arc56-generated-nagasivakumari-algokit-installation";

const algorand = AlgorandClient.mainNet();
const client = new Calculator_cf9a3b6a.CalculatorClient({
  algorand,
  appId: 123456789n,
});
...
| --- | --- | --- |
| `Calculator_cf9a3b6a` | `CalculatorClient` | [https://raw.githubusercontent.com/NagasivaKumari/Algokit-Installation/HEAD/smart_contracts/artifacts/calculator/Calculator.arc56.json](https://raw.githubusercontent.com/NagasivaKumari/Algokit-Installation/HEAD/smart_contracts/artifacts/calculator/Calculator.arc56.json) |
