...
```bash
npm install arc56-generated-nagasivakumari-policytrace @algorandfoundation/algokit-utils algosdk
```
...
import { BlockdAudit_ccac5944 } from "arc56-generated-nagasivakumari-policytrace";

const algorand = AlgorandClient.mainNet();
const client = new BlockdAudit_ccac5944.BlockdAuditClient({
  algorand,
  appId: 123456789n,
});
