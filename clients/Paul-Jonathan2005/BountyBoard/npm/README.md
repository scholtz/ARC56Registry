...
```bash
npm install arc56-generated-paul-jonathan2005-bountyboard @algorandfoundation/algokit-utils algosdk
```
...
import { TaskBountyContract_aca3b7cf } from "arc56-generated-paul-jonathan2005-bountyboard";

const algorand = AlgorandClient.mainNet();
const client = new TaskBountyContract_aca3b7cf.TaskBountyContractClient({
  algorand,
  appId: 123456789n,
});
