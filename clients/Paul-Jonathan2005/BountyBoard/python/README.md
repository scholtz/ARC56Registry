...
```bash
pip install arc56-generated-paul-jonathan2005-bountyboard
```
...
from arc56_generated_paul_jonathan2005_bountyboard import TaskBountyContract_aca3b7cf

algorand = AlgorandClient.mainnet()
client = TaskBountyContract_aca3b7cf.TaskBountyContractClient(
    algorand=algorand,
    app_id=123456789,
)
