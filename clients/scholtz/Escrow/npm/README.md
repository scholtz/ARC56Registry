...
```bash
npm install arc56-generated-scholtz-escrow @algorandfoundation/algokit-utils algosdk
```
...
import { Escrow_ecf46a10 } from "arc56-generated-scholtz-escrow";

const algorand = AlgorandClient.mainNet();
const client = new Escrow_ecf46a10.EscrowClient({
  algorand,
  appId: 123456789n,
});
...
| --- | --- | --- |
| `Escrow_ecf46a10` | `EscrowClient` | [https://raw.githubusercontent.com/scholtz/Escrow/HEAD/projects/Escrow/smart_contracts/artifacts/escrow/Escrow.arc56.json](https://raw.githubusercontent.com/scholtz/Escrow/HEAD/projects/Escrow/smart_contracts/artifacts/escrow/Escrow.arc56.json) |
