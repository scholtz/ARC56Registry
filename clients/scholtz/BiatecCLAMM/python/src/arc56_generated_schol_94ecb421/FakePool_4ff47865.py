...
class BootstrapStep2Args:
    """Dataclass for bootstrap_step_2 arguments"""
    assetA: int
    assetB: int
    ...
    def abi_method_signature(self) -> str:
        return "bootstrapStep2(uint64,uint64,uint64,uint64)void"
...
class FakePoolCreateTransactionParams:
    def __init__(self, app_client: algokit_utils.AppClient):
        self.app_client = app_client
...
class FakePoolClient:
    """Client for interacting with FakePool smart contract"""
    ...
    def __init__(
        ...
        *,
        ...
        self.params = FakePoolParams(self.app_client)
        self.create_transaction = FakePoolCreateTransactionParams(self.app_client)
        self.send = FakePoolSend(self.app_client)
        self.state = FakePoolState(self.app_client)
    ...
    def new_group(self) -> "FakePoolComposer":
        return FakePoolComposer(self)

    @typing.overload
    def decode_return_value(
        self,
        method: typing.Literal["bootstrapStep2(uint64,uint64,uint64,uint64)void"],
...
class FakePoolComposer:
    ...
    def __init__(self, client: "FakePoolClient"):
        self.client = client
