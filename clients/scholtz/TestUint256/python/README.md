...
```bash
pip install arc56-generated-scholtz-testuint256
```
...
from arc56_generated_scholtz_testuint256 import TestUint_792cb349

algorand = AlgorandClient.mainnet()
client = TestUint_792cb349.TestUintClient(
    algorand=algorand,
    app_id=123456789,
)
