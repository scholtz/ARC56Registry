...
```bash
pip install arc56-generated-andaruhp-algorand-smart-contract
```
...
from arc56_generated_andaruhp_algorand_smart_contract import bank_app_82a99cc2

algorand = AlgorandClient.mainnet()
client = bank_app_82a99cc2.BankAppClient(
    algorand=algorand,
    app_id=123456789,
)
