...
```bash
npm install arc56-generated-andaruhp-algorand-smart-contract @algorandfoundation/algokit-utils algosdk
```
...
import { bank_app_82a99cc2 } from "arc56-generated-andaruhp-algorand-smart-contract";

const algorand = AlgorandClient.mainNet();
const client = new bank_app_82a99cc2.BankAppClient({
  algorand,
  appId: 123456789n,
});
