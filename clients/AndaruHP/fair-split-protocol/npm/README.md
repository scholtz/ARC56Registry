...
```bash
npm install arc56-generated-andaruhp-fair-split-protocol @algorandfoundation/algokit-utils algosdk
```
...
import { FairSplit_9fee4d60 } from "arc56-generated-andaruhp-fair-split-protocol";

const algorand = AlgorandClient.mainNet();
const client = new FairSplit_9fee4d60.FairSplitClient({
  algorand,
  appId: 123456789n,
});
