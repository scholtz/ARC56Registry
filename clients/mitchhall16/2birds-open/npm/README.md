...
```bash
npm install arc56-generated-mitchhall16-2birds-open @algorandfoundation/algokit-utils algosdk
```
...
import { ConfidentialAsset_bb1d9d0f } from "arc56-generated-mitchhall16-2birds-open";

const algorand = AlgorandClient.mainNet();
const client = new ConfidentialAsset_bb1d9d0f.ConfidentialAssetClient({
  algorand,
  appId: 123456789n,
});
