...
```bash
npm install arc56-generated-sealed-channel-sealed @algorandfoundation/algokit-utils algosdk
```
...
import { Sealed_v2_d3a92bb7 } from "arc56-generated-sealed-channel-sealed";

const algorand = AlgorandClient.mainNet();
const client = new Sealed_v2_d3a92bb7.SealedClient({
  algorand,
  appId: 123456789n,
});
