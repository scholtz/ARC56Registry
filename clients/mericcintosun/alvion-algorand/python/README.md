...
```bash
pip install arc56-generated-mericcintosun-alvion-algorand
```
...
from arc56_generated_mericcintosun_alvion_algorand import HelloWorld_4b0c5a62

algorand = AlgorandClient.mainnet()
client = HelloWorld_4b0c5a62.HelloWorldClient(
    algorand=algorand,
    app_id=123456789,
)
