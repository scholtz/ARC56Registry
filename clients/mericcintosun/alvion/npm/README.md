...
```bash
npm install arc56-generated-mericcintosun-alvion @algorandfoundation/algokit-utils algosdk
```
...
import { HelloWorld_eb9e2ad2 } from "arc56-generated-mericcintosun-alvion";

const algorand = AlgorandClient.mainNet();
const client = new HelloWorld_eb9e2ad2.HelloWorldClient({
  algorand,
  appId: 123456789n,
});
