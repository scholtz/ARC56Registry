...
```bash
pip install arc56-generated-marotipatre-bidding-marketplace-on-algorand
```
...
from arc56_generated_marotipatre_bidding_marketplace_on_algorand import BiddingMarket_79cc5bf2

algorand = AlgorandClient.mainnet()
client = BiddingMarket_79cc5bf2.BiddingMarketClient(
    algorand=algorand,
    app_id=123456789,
)
