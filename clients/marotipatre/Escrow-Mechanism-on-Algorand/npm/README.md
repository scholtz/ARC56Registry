...
```bash
npm install arc56-generated-marotipatre-escrow-mechanism-on-algorand @algorandfoundation/algokit-utils algosdk
```
...
import { Escrow_3db50017 } from "arc56-generated-marotipatre-escrow-mechanism-on-algorand";

const algorand = AlgorandClient.mainNet();
const client = new Escrow_3db50017.EscrowClient({
  algorand,
  appId: 123456789n,
});
