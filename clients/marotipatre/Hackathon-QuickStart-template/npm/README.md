...
```bash
npm install arc56-generated-marotipatre-hackathon-quickstart-template @algorandfoundation/algokit-utils algosdk
```
...
import { Bank_3ad81aea } from "arc56-generated-marotipatre-hackathon-quickstart-template";

const algorand = AlgorandClient.mainNet();
const client = new Bank_3ad81aea.BankClient({
  algorand,
  appId: 123456789n,
});
