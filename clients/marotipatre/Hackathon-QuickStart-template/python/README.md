...
```bash
pip install arc56-generated-marotipatre-hackathon-quickstart-template
```
...
from arc56_generated_marotipatre_hackathon_quickstart_template import Bank_3ad81aea

algorand = AlgorandClient.mainnet()
client = Bank_3ad81aea.BankClient(
    algorand=algorand,
    app_id=123456789,
)
