...
```bash
npm install arc56-generated-marotipatre-auctionx @algorandfoundation/algokit-utils algosdk
```
...
import { AuctionX_d2d913bd } from "arc56-generated-marotipatre-auctionx";

const algorand = AlgorandClient.mainNet();
const client = new AuctionX_d2d913bd.AuctionXClient({
  algorand,
  appId: 123456789n,
});
