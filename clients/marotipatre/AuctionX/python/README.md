...
```bash
pip install arc56-generated-marotipatre-auctionx
```
...
from arc56_generated_marotipatre_auctionx import AuctionX_d2d913bd

algorand = AlgorandClient.mainnet()
client = AuctionX_d2d913bd.AuctionXClient(
    algorand=algorand,
    app_id=123456789,
)
