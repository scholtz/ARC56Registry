...
```bash
npm install arc56-generated-marotipatre-vibekit-project @algorandfoundation/algokit-utils algosdk
```
...
import { ConstantProductAMM_743d4385 } from "arc56-generated-marotipatre-vibekit-project";

const algorand = AlgorandClient.mainNet();
const client = new ConstantProductAMM_743d4385.ConstantProductAmmClient({
  algorand,
  appId: 123456789n,
});
