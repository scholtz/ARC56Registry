...
```bash
pip install arc56-generated-marotipatre-vibekit-project
```
...
from arc56_generated_marotipatre_vibekit_project import ConstantProductAMM_743d4385

algorand = AlgorandClient.mainnet()
client = ConstantProductAMM_743d4385.ConstantProductAmmClient(
    algorand=algorand,
    app_id=123456789,
)
