...
```bash
npm install arc56-generated-cultsicarias-algobit @algorandfoundation/algokit-utils algosdk
```
...
import { Algobit_490980e1 } from "arc56-generated-cultsicarias-algobit";

const algorand = AlgorandClient.mainNet();
const client = new Algobit_490980e1.AlgobitClient({
  algorand,
  appId: 123456789n,
});
...
| --- | --- | --- |
| `Algobit_490980e1` | `AlgobitClient` | [https://raw.githubusercontent.com/cultsicarias/algobit/HEAD/smart_contracts/artifacts/algobit/Algobit.arc56.json](https://raw.githubusercontent.com/cultsicarias/algobit/HEAD/smart_contracts/artifacts/algobit/Algobit.arc56.json) |
