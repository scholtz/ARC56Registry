...
```bash
pip install arc56-generated-cultsicarias-algobit
```
...
from arc56_generated_cultsicarias_algobit import Algobit_490980e1

algorand = AlgorandClient.mainnet()
client = Algobit_490980e1.AlgobitClient(
    algorand=algorand,
    app_id=123456789,
)
