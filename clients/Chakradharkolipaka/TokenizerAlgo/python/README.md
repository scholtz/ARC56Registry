...
```bash
pip install arc56-generated-chakradharkolipaka-tokenizeralgo
```
...
from arc56_generated_chakradharkolipaka_tokenizeralgo import HelloWorld_bc7c5523

algorand = AlgorandClient.mainnet()
client = HelloWorld_bc7c5523.HelloWorldClient(
    algorand=algorand,
    app_id=123456789,
)
