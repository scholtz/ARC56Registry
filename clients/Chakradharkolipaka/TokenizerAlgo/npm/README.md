...
```bash
npm install arc56-generated-chakradharkolipaka-tokenizeralgo @algorandfoundation/algokit-utils algosdk
```
...
import { HelloWorld_bc7c5523 } from "arc56-generated-chakradharkolipaka-tokenizeralgo";

const algorand = AlgorandClient.mainNet();
const client = new HelloWorld_bc7c5523.HelloWorldClient({
  algorand,
  appId: 123456789n,
});
