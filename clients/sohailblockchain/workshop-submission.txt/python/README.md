...
```bash
pip install arc56-generated-sohailblockchain-workshop-submission-txt
```
...
from arc56_generated_sohailblockchain_workshop_submission_txt import HelloWorld_160486c1

algorand = AlgorandClient.mainnet()
client = HelloWorld_160486c1.HelloWorldClient(
    algorand=algorand,
    app_id=123456789,
)
