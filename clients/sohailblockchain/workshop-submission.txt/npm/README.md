...
```bash
npm install arc56-generated-sohailblockchain-workshop-submission-txt @algorandfoundation/algokit-utils algosdk
```
...
import { HelloWorld_160486c1 } from "arc56-generated-sohailblockchain-workshop-submission-txt";

const algorand = AlgorandClient.mainNet();
const client = new HelloWorld_160486c1.HelloWorldClient({
  algorand,
  appId: 123456789n,
});
