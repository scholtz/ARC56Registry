...
export const APP_SPEC: Arc56Contract = {"name":"HelloWorld","structs":{},"methods":[{"name":"hello","args":[{"type":"string","name":"name"}],"returns":{"type":"string"},"actions":{"create":[],"call":["NoOp"]},"readonly":false,"events":[],"recommendations":{}},{"name":"deposit","args":[{"type":"pay","name":"payment"},{"type":"string","name":"github_handle"}],"returns":{"type":"void"},"actions":{"create":[],"call":["NoOp"]},"readonly":false,"events":[],"recommendations":{}}],"arcs":[22,28],"networks":{},"state":{"schema":{"global":{"ints":0,"bytes":0},"local":{"ints":0,"bytes":0}},"keys":{"global":{},"local":{},"box":{}},"maps":{"global":{},"local":{},"box":{}}},"bareActions":{"create":["NoOp"],"call":[]},"sourceInfo":{"approval":{"sourceInfo":[{"pc":[36,64],"errorMessage":"OnCompletion is not NoOp"},{"pc":[133],"errorMessage":"Payment must be to contract address"},{"pc":[104],"errorMessage":"can only call when creating"},{"pc":[39,67],"errorMessage":"can only call when not creating"},{"pc":[49],"errorMessage":"transaction type is pay"}],"pcOffsetMethod":"none"},"clear":{"sourceInfo":[],"pcOffsetMethod":"none"}},"events":[]} as unknown as Arc56Contract
...
export type HelloWorldArgs = {
  ...
  tuple: {
    ...
    'deposit(pay,string)void': [payment: AppMethodCallTransactionArgument, githubHandle: string]
  }
}
...
export type HelloWorldTypes = {
  ...
  methods:
    ...
    & Record<'deposit(pay,string)void' | 'deposit', {
      argsObj: HelloWorldArgs['obj']['deposit(pay,string)void']
      argsTuple: HelloWorldArgs['tuple']['deposit(pay,string)void']
      returns: HelloWorldReturns['deposit(pay,string)void']
    }>
}
...
export abstract class HelloWorldParamsFactory {
  ...
  /**
   * Constructs a no op call for the deposit(pay,string)void ABI method
   *
   * @param params Parameters for the call
   * @returns An `AppClientMethodCallParams` object for the call
   */
  static deposit(params: CallParams<HelloWorldArgs['obj']['deposit(pay,string)void'] | HelloWorldArgs['tuple']['deposit(pay,string)void']> & CallOnComplete): AppClientMethodCallParams & CallOnComplete {
    return {
      ...params,
      method: 'deposit(pay,string)void' as const,
      args: Array.isArray(params.args) ? params.args : [params.args.payment, params.args.githubHandle],
    }
  }
}
...
export class HelloWorldClient {
  ...
  readonly params = {
    ...
    /**
     * Makes a call to the HelloWorld smart contract using the `deposit(pay,string)void` ABI method.
     *
     * @param params The params for the smart contract call
     * @returns The call params
     */
    deposit: (params: CallParams<HelloWorldArgs['obj']['deposit(pay,string)void'] | HelloWorldArgs['tuple']['deposit(pay,string)void']> & {onComplete?: OnApplicationComplete.NoOpOC}) => {
  ...
  readonly send = {
     ...
     * @returns The call result
     */
    deposit: async (params: CallParams<HelloWorldArgs['obj']['deposit(pay,string)void'] | HelloWorldArgs['tuple']['deposit(pay,string)void']> & SendParams & {onComplete?: OnApplicationComplete.NoOpOC}) => {
      const result = await this.appClient.send.call(HelloWorldParamsFactory.deposit(params))
      return {...result, return: result.return as unknown as (undefined | HelloWorldReturns['deposit(pay,string)void'])}
    },
  ...
  public newGroup(): HelloWorldComposer {
    ...
    return {
      ...
      /**
       * Add a deposit(pay,string)void method call against the HelloWorld contract
       */
      deposit(params: CallParams<HelloWorldArgs['obj']['deposit(pay,string)void'] | HelloWorldArgs['tuple']['deposit(pay,string)void']> & {onComplete?: OnApplicationComplete.NoOpOC}) {
...
export type HelloWorldComposer<TReturns extends [...any[]] = []> = {
  ...
  /**
   * Calls the deposit(pay,string)void ABI method.
   *
   * @param args The arguments for the contract call
   * @param params Any additional parameters for the call
   * @returns The typed transaction composer so you can fluently chain multiple calls or call execute to execute all queued up transactions
   */
  deposit(params?: CallParams<HelloWorldArgs['obj']['deposit(pay,string)void'] | HelloWorldArgs['tuple']['deposit(pay,string)void']>): HelloWorldComposer<[...TReturns, HelloWorldReturns['deposit(pay,string)void'] | undefined]>
