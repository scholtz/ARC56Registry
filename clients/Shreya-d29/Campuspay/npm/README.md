...
```bash
npm install arc56-generated-shreya-d29-campuspay @algorandfoundation/algokit-utils algosdk
```
...
import { CampusPay_33b2a49e } from "arc56-generated-shreya-d29-campuspay";

const algorand = AlgorandClient.mainNet();
const client = new CampusPay_33b2a49e.CampusPayClient({
  algorand,
  appId: 123456789n,
});
...
| --- | --- | --- |
| `CampusPay_33b2a49e` | `CampusPayClient` | [https://raw.githubusercontent.com/Shreya-d29/Campuspay/HEAD/smart_contracts/campuspay/CampusPay.arc56.json](https://raw.githubusercontent.com/Shreya-d29/Campuspay/HEAD/smart_contracts/campuspay/CampusPay.arc56.json) |
