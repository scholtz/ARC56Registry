...
```bash
pip install arc56-generated-shreya-d29-campuspay
```
...
from arc56_generated_shreya_d29_campuspay import CampusPay_33b2a49e

algorand = AlgorandClient.mainnet()
client = CampusPay_33b2a49e.CampusPayClient(
    algorand=algorand,
    app_id=123456789,
)
