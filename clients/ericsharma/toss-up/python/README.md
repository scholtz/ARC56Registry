...
```bash
pip install arc56-generated-ericsharma-toss-up
```
...
from arc56_generated_ericsharma_toss_up import GameMaker_cbd5b454

algorand = AlgorandClient.mainnet()
client = GameMaker_cbd5b454.GameMakerClient(
    algorand=algorand,
    app_id=123456789,
)
