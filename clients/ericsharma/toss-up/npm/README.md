...
```bash
npm install arc56-generated-ericsharma-toss-up @algorandfoundation/algokit-utils algosdk
```
...
import { GameMaker_cbd5b454 } from "arc56-generated-ericsharma-toss-up";

const algorand = AlgorandClient.mainNet();
const client = new GameMaker_cbd5b454.GameMakerClient({
  algorand,
  appId: 123456789n,
});
...
| --- | --- | --- |
| `GameMaker_cbd5b454` | `GameMakerClient` | [https://raw.githubusercontent.com/ericsharma/toss-up/HEAD/projects/toss-up/contracts/artifacts/GameMaker.arc56.json](https://raw.githubusercontent.com/ericsharma/toss-up/HEAD/projects/toss-up/contracts/artifacts/GameMaker.arc56.json) |
| `TossUp_54a87507` | `TossUpClient` | [https://raw.githubusercontent.com/ericsharma/toss-up/HEAD/projects/toss-up/contracts/artifacts/TossUp.arc56.json](https://raw.githubusercontent.com/ericsharma/toss-up/HEAD/projects/toss-up/contracts/artifacts/TossUp.arc56.json) |
