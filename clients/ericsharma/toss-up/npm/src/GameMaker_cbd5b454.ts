...
export type GameMakerComposer<TReturns extends [...any[]] = []> = {
   ...
   */
  simulate(): Promise<GameMakerComposerResults<TReturns> & { simulateResponse: modelsv2.SimulateResponse }>
  simulate(options: SkipSignaturesSimulateOptions): Promise<GameMakerComposerResults<TReturns> & { simulateResponse: modelsv2.SimulateResponse }>
  simulate(options: RawSimulateOptions): Promise<GameMakerComposerResults<TReturns> & { simulateResponse: modelsv2.SimulateResponse }>
  /**
