...
```bash
pip install arc56-generated-ericsharma-algo-potato-frontend
```
...
from arc56_generated_ericsharma_algo_potato_frontend import AlgoPotato_490222d3

algorand = AlgorandClient.mainnet()
client = AlgoPotato_490222d3.AlgoPotatoClient(
    algorand=algorand,
    app_id=123456789,
)
