...
```bash
npm install arc56-generated-ericsharma-algo-potato-frontend @algorandfoundation/algokit-utils algosdk
```
...
import { AlgoPotato_490222d3 } from "arc56-generated-ericsharma-algo-potato-frontend";

const algorand = AlgorandClient.mainNet();
const client = new AlgoPotato_490222d3.AlgoPotatoClient({
  algorand,
  appId: 123456789n,
});
...
| --- | --- | --- |
| `AlgoPotato_490222d3` | `AlgoPotatoClient` | [https://raw.githubusercontent.com/ericsharma/Algo-Potato-Frontend/HEAD/clients/mainnet/AlgoPotato.arc56.json](https://raw.githubusercontent.com/ericsharma/Algo-Potato-Frontend/HEAD/clients/mainnet/AlgoPotato.arc56.json) |
| `AlgoPotato_4baed668` | `AlgoPotatoClient` | [https://raw.githubusercontent.com/ericsharma/Algo-Potato-Frontend/HEAD/clients/testnet/AlgoPotato.arc56.json](https://raw.githubusercontent.com/ericsharma/Algo-Potato-Frontend/HEAD/clients/testnet/AlgoPotato.arc56.json) |
