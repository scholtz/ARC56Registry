...
```bash
pip install arc56-generated-loicdrbx-eclair
```
...
from arc56_generated_loicdrbx_eclair import HelloEclair_24f15ddd

algorand = AlgorandClient.mainnet()
client = HelloEclair_24f15ddd.HelloEclairClient(
    algorand=algorand,
    app_id=123456789,
)
