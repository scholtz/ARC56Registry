...
```bash
npm install arc56-generated-loicdrbx-eclair @algorandfoundation/algokit-utils algosdk
```
...
import { HelloEclair_24f15ddd } from "arc56-generated-loicdrbx-eclair";

const algorand = AlgorandClient.mainNet();
const client = new HelloEclair_24f15ddd.HelloEclairClient({
  algorand,
  appId: 123456789n,
});
