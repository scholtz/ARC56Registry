...
```bash
pip install arc56-generated-shreyashegde0105-demo-algorand
```
...
from arc56_generated_shreyashegde0105_demo_algorand import ProcureEscrowContract_fbd3f152

algorand = AlgorandClient.mainnet()
client = ProcureEscrowContract_fbd3f152.ProcureEscrowContractClient(
    algorand=algorand,
    app_id=123456789,
)
