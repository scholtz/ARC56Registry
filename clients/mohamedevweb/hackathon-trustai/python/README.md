...
```bash
pip install arc56-generated-mohamedevweb-hackathon-trustai
```
...
from arc56_generated_mohamedevweb_hackathon_trustai import HelloWorld_70cfb3cb

algorand = AlgorandClient.mainnet()
client = HelloWorld_70cfb3cb.HelloWorldClient(
    algorand=algorand,
    app_id=123456789,
)
