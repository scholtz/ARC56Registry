...
```bash
npm install arc56-generated-mohamedevweb-hackathon-trustai @algorandfoundation/algokit-utils algosdk
```
...
import { HelloWorld_70cfb3cb } from "arc56-generated-mohamedevweb-hackathon-trustai";

const algorand = AlgorandClient.mainNet();
const client = new HelloWorld_70cfb3cb.HelloWorldClient({
  algorand,
  appId: 123456789n,
});
