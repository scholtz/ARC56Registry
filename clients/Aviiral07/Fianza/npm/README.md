...
```bash
npm install arc56-generated-aviiral07-fianza @algorandfoundation/algokit-utils algosdk
```
...
import { FianzaEscrow_8de96dc8 } from "arc56-generated-aviiral07-fianza";

const algorand = AlgorandClient.mainNet();
const client = new FianzaEscrow_8de96dc8.FianzaEscrowClient({
  algorand,
  appId: 123456789n,
});
