...
```bash
pip install arc56-generated-defruit-micro-amm-contract
```
...
from arc56_generated_defruit_micro_amm_contract import Mamm_4af3b47a

algorand = AlgorandClient.mainnet()
client = Mamm_4af3b47a.MammClient(
    algorand=algorand,
    app_id=123456789,
)
