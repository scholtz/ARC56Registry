...
```bash
npm install arc56-generated-defruit-micro-amm-contract @algorandfoundation/algokit-utils algosdk
```
...
import { Mamm_4af3b47a } from "arc56-generated-defruit-micro-amm-contract";

const algorand = AlgorandClient.mainNet();
const client = new Mamm_4af3b47a.MammClient({
  algorand,
  appId: 123456789n,
});
...
| --- | --- | --- |
| `Mamm_4af3b47a` | `MammClient` | [https://raw.githubusercontent.com/DeFruit/micro-amm-contract/HEAD/micro-amm/projects/micro-amm/contracts/artifacts/Mamm.arc56.json](https://raw.githubusercontent.com/DeFruit/micro-amm-contract/HEAD/micro-amm/projects/micro-amm/contracts/artifacts/Mamm.arc56.json) |
