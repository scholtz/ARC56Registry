...
```bash
pip install arc56-generated-kanishkarathore-mosspay-project
```
...
from arc56_generated_kanishkarathore_mosspay_project import CarbonEngine_42ee811c

algorand = AlgorandClient.mainnet()
client = CarbonEngine_42ee811c.CarbonEngineClient(
    algorand=algorand,
    app_id=123456789,
)
