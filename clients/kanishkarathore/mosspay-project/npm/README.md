...
```bash
npm install arc56-generated-kanishkarathore-mosspay-project @algorandfoundation/algokit-utils algosdk
```
...
import { CarbonEngine_42ee811c } from "arc56-generated-kanishkarathore-mosspay-project";

const algorand = AlgorandClient.mainNet();
const client = new CarbonEngine_42ee811c.CarbonEngineClient({
  algorand,
  appId: 123456789n,
});
