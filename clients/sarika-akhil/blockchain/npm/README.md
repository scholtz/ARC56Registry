...
```bash
npm install arc56-generated-sarika-akhil-blockchain @algorandfoundation/algokit-utils algosdk
```
...
import { AIAnalysisPayment_ffd290b3 } from "arc56-generated-sarika-akhil-blockchain";

const algorand = AlgorandClient.mainNet();
const client = new AIAnalysisPayment_ffd290b3.AiAnalysisPaymentClient({
  algorand,
  appId: 123456789n,
});
