...
```bash
pip install arc56-generated-jackoske-0ktopus-proofofconcept-hackaton
```
...
from arc56_generated_jackoske_0ktopus_proofofconcept_hackaton import WeatherMarketplace_9b586b5a

algorand = AlgorandClient.mainnet()
client = WeatherMarketplace_9b586b5a.WeatherMarketplaceClient(
    algorand=algorand,
    app_id=123456789,
)
