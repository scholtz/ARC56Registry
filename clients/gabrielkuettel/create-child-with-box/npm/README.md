...
```bash
npm install arc56-generated-gabrielkuettel-create-child-with-box @algorandfoundation/algokit-utils algosdk
```
...
import { TestChild_6006ebc0 } from "arc56-generated-gabrielkuettel-create-child-with-box";

const algorand = AlgorandClient.mainNet();
const client = new TestChild_6006ebc0.TestChildClient({
  algorand,
  appId: 123456789n,
});
