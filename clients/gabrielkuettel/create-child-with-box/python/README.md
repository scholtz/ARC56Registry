...
```bash
pip install arc56-generated-gabrielkuettel-create-child-with-box
```
...
from arc56_generated_gabrielkuettel_create_child_with_box import TestChild_6006ebc0

algorand = AlgorandClient.mainnet()
client = TestChild_6006ebc0.TestChildClient(
    algorand=algorand,
    app_id=123456789,
)
