...
_APP_SPEC_JSON = r"""{"arcs": [22, 28], "bareActions": {"call": [], "create": []}, "methods": [{"actions": {"call": [], "create": ["NoOp"]}, "args": [{"type": "uint64", "name": "test_contract_child_app"}], "name": "set_test_contract_child", "returns": {"type": "void"}, "events": [], "readonly": false, "recommendations": {}}, {"actions": {"call": ["NoOp"], "create": []}, "args": [{"type": "pay", "name": "mbr_payment"}], "name": "create_test_contract_child_and_box", "returns": {"type": "uint64"}, "events": [], "readonly": false, "recommendations": {}}], "name": "TestFactory", "state": {"keys": {"box": {}, "global": {"test_contract_child": {"key": "dGVzdF9jb250cmFjdF9jaGlsZA==", "keyType": "AVMString", "valueType": "AVMUint64"}}, "local": {}}, "maps": {"box": {}, "global": {}, "local": {}}, "schema": {"global": {"bytes": 0, "ints": 1}, "local": {"bytes": 0, "ints": 0}}}, "structs": {}, "events": [], "networks": {}, "sourceInfo": {"approval": {"pcOffsetMethod": "none", "sourceInfo": [{"pc": [48], "errorMessage": "OnCompletion must be NoOp"}, {"pc": [113, 219], "errorMessage": "account funded"}, {"pc": [122, 126, 150, 167], "errorMessage": "application exists"}, {"pc": [213], "errorMessage": "application log value is not the result of an ABI return"}, {"pc": [118], "errorMessage": "check self.test_contract_child exists"}, {"pc": [100], "errorMessage": "transaction type is pay"}]}, "clear": {"pcOffsetMethod": "none", "sourceInfo": []}}}"""
...
class CreateTestContractChildAndBoxArgs:
    ...
    def abi_method_signature(self) -> str:
        return "create_test_contract_child_and_box(pay)uint64"
...
class SetTestContractChildArgs:
    ...
    @property
    def abi_method_signature(self) -> str:
        return "set_test_contract_child(uint64)void"
    ...
    def create_test_contract_child_and_box(
        ...
        return self.app_client.params.call(algokit_utils.AppClientMethodCallParams(**{
            **dataclasses.asdict(params),
            "method": "create_test_contract_child_and_box(pay)uint64",
            "args": method_args,
        }))
...
class TestFactoryClient:
    ...
    def decode_return_value(
        self,
        method: typing.Literal["create_test_contract_child_and_box(pay)uint64"],
        return_value: algokit_utils.ABIReturn | None
    ) -> int | None: ...
    @typing.overload
    def decode_return_value(
        self,
        method: typing.Literal["set_test_contract_child(uint64)void"],
        return_value: algokit_utils.ABIReturn | None
    ) -> None: ...
    @typing.overload
    def decode_return_value(
    ...
    def create_test_contract_child_and_box(
        ...
        self._result_mappers.append(
            lambda v: self.client.decode_return_value(
                "create_test_contract_child_and_box(pay)uint64", v
            )
        )
        return self
