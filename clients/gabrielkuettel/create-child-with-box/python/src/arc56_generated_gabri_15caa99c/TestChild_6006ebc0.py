...
_APP_SPEC_JSON = r"""{"arcs": [22, 28], "bareActions": {"call": [], "create": ["NoOp"]}, "methods": [{"actions": {"call": ["UpdateApplication", "DeleteApplication"], "create": []}, "args": [], "name": "update_or_delete", "returns": {"type": "void"}, "events": [], "readonly": false, "recommendations": {}}, {"actions": {"call": ["NoOp"], "create": []}, "args": [{"type": "pay", "name": "mbr_payment"}], "name": "create_box", "returns": {"type": "uint64"}, "events": [], "readonly": false, "recommendations": {}}], "name": "TestChild", "state": {"keys": {"box": {}, "global": {}, "local": {}}, "maps": {"box": {}, "global": {}, "local": {}}, "schema": {"global": {"bytes": 0, "ints": 0}, "local": {"bytes": 0, "ints": 0}}}, "structs": {}, "events": [], "networks": {}, "sourceInfo": {"approval": {"pcOffsetMethod": "none", "sourceInfo": [{"pc": [60], "errorMessage": "OnCompletion must be NoOp && can only call when creating"}, {"pc": [38], "errorMessage": "OnCompletion must be NoOp && can only call when not creating"}, {"pc": [52], "errorMessage": "OnCompletion must be one of UpdateApplication, DeleteApplication && can only call when not creating"}, {"pc": [75, 80, 104], "errorMessage": "account funded"}, {"pc": [70], "errorMessage": "transaction type is pay"}]}, "clear": {"pcOffsetMethod": "none", "sourceInfo": []}}}"""
