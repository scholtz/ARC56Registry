...
```bash
npm install arc56-generated-gabrielkuettel-vibegallery @algorandfoundation/algokit-utils algosdk
```
...
import { HelloWorld_5ab93f67 } from "arc56-generated-gabrielkuettel-vibegallery";

const algorand = AlgorandClient.mainNet();
const client = new HelloWorld_5ab93f67.HelloWorldClient({
  algorand,
  appId: 123456789n,
});
