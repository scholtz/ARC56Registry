...
```bash
pip install arc56-generated-gabrielkuettel-vibegallery
```
...
from arc56_generated_gabrielkuettel_vibegallery import HelloWorld_5ab93f67

algorand = AlgorandClient.mainnet()
client = HelloWorld_5ab93f67.HelloWorldClient(
    algorand=algorand,
    app_id=123456789,
)
