...
```bash
npm install arc56-generated-gabrielkuettel-delfi @algorandfoundation/algokit-utils algosdk
```
...
import { Oracle_7046c6c4 } from "arc56-generated-gabrielkuettel-delfi";

const algorand = AlgorandClient.mainNet();
const client = new Oracle_7046c6c4.OracleClient({
  algorand,
  appId: 123456789n,
});
...
| --- | --- | --- |
| `Oracle_7046c6c4` | `OracleClient` | [https://raw.githubusercontent.com/gabrielkuettel/delfi/HEAD/smart_contracts/artifacts/oracle/Oracle.arc56.json](https://raw.githubusercontent.com/gabrielkuettel/delfi/HEAD/smart_contracts/artifacts/oracle/Oracle.arc56.json) |
