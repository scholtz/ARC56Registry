...
```bash
pip install arc56-generated-gabrielkuettel-turbokit
```
...
from arc56_generated_gabrielkuettel_turbokit import HelloWorld_2a55adb2

algorand = AlgorandClient.mainnet()
client = HelloWorld_2a55adb2.HelloWorldClient(
    algorand=algorand,
    app_id=123456789,
)
