...
```bash
pip install arc56-generated-lempira-utils-ts-371
```
...
from arc56_generated_lempira_utils_ts_371 import CalledContract_9b72cfbe

algorand = AlgorandClient.mainnet()
client = CalledContract_9b72cfbe.CalledContractClient(
    algorand=algorand,
    app_id=123456789,
)
