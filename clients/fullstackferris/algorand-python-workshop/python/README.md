...
```bash
pip install arc56-generated-fullstackferris-algorand-python-workshop
```
...
from arc56_generated_fullstackferris_algorand_python_workshop import PersonalBank_8563dea6

algorand = AlgorandClient.mainnet()
client = PersonalBank_8563dea6.PersonalBankClient(
    algorand=algorand,
    app_id=123456789,
)
