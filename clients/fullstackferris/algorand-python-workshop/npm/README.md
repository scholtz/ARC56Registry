...
```bash
npm install arc56-generated-fullstackferris-algorand-python-workshop @algorandfoundation/algokit-utils algosdk
```
...
import { PersonalBank_8563dea6 } from "arc56-generated-fullstackferris-algorand-python-workshop";

const algorand = AlgorandClient.mainNet();
const client = new PersonalBank_8563dea6.PersonalBankClient({
  algorand,
  appId: 123456789n,
});
