...
```bash
pip install arc56-generated-srikanivas-nft-algonest-hackseries
```
...
from arc56_generated_srikanivas_nft_algonest_hackseries import NftTransfer_696d302a

algorand = AlgorandClient.mainnet()
client = NftTransfer_696d302a.NftTransferClient(
    algorand=algorand,
    app_id=123456789,
)
