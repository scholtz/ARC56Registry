...
```bash
pip install arc56-generated-srikanivas-trezo
```
...
from arc56_generated_srikanivas_trezo import HelloWorld_60ded203

algorand = AlgorandClient.mainnet()
client = HelloWorld_60ded203.HelloWorldClient(
    algorand=algorand,
    app_id=123456789,
)
