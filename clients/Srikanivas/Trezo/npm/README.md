...
```bash
npm install arc56-generated-srikanivas-trezo @algorandfoundation/algokit-utils algosdk
```
...
import { HelloWorld_60ded203 } from "arc56-generated-srikanivas-trezo";

const algorand = AlgorandClient.mainNet();
const client = new HelloWorld_60ded203.HelloWorldClient({
  algorand,
  appId: 123456789n,
});
