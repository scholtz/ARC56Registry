...
```bash
npm install arc56-generated-srikanivas-nftmarketplce @algorandfoundation/algokit-utils algosdk
```
...
import { NFTMarketplaceContract_41fa9e62 } from "arc56-generated-srikanivas-nftmarketplce";

const algorand = AlgorandClient.mainNet();
const client = new NFTMarketplaceContract_41fa9e62.NftMarketplaceContractClient({
  algorand,
  appId: 123456789n,
});
