...
```bash
pip install arc56-generated-srikanivas-nftmarketplce
```
...
from arc56_generated_srikanivas_nftmarketplce import NFTMarketplaceContract_41fa9e62

algorand = AlgorandClient.mainnet()
client = NFTMarketplaceContract_41fa9e62.NftMarketplaceContractClient(
    algorand=algorand,
    app_id=123456789,
)
