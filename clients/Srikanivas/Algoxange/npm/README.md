...
```bash
npm install arc56-generated-srikanivas-algoxange @algorandfoundation/algokit-utils algosdk
```
...
import { Algoxange_dd97c51e } from "arc56-generated-srikanivas-algoxange";

const algorand = AlgorandClient.mainNet();
const client = new Algoxange_dd97c51e.AlgoxangeClient({
  algorand,
  appId: 123456789n,
});
