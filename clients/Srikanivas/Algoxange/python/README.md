...
```bash
pip install arc56-generated-srikanivas-algoxange
```
...
from arc56_generated_srikanivas_algoxange import Algoxange_dd97c51e

algorand = AlgorandClient.mainnet()
client = Algoxange_dd97c51e.AlgoxangeClient(
    algorand=algorand,
    app_id=123456789,
)
