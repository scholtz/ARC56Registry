...
```bash
npm install arc56-generated-srikanivas-givio @algorandfoundation/algokit-utils algosdk
```
...
import { Donation_34190a8a } from "arc56-generated-srikanivas-givio";

const algorand = AlgorandClient.mainNet();
const client = new Donation_34190a8a.DonationClient({
  algorand,
  appId: 123456789n,
});
