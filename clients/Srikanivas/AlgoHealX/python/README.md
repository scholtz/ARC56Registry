...
```bash
pip install arc56-generated-srikanivas-algohealx
```
...
from arc56_generated_srikanivas_algohealx import AlgoHealx_7d193615

algorand = AlgorandClient.mainnet()
client = AlgoHealx_7d193615.AlgoHealxClient(
    algorand=algorand,
    app_id=123456789,
)
