...
```bash
npm install arc56-generated-srikanivas-algohealx @algorandfoundation/algokit-utils algosdk
```
...
import { AlgoHealx_7d193615 } from "arc56-generated-srikanivas-algohealx";

const algorand = AlgorandClient.mainNet();
const client = new AlgoHealx_7d193615.AlgoHealxClient({
  algorand,
  appId: 123456789n,
});
