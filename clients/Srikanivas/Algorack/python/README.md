...
```bash
pip install arc56-generated-srikanivas-algorack
```
...
from arc56_generated_srikanivas_algorack import AlgorackMarket_332d497a

algorand = AlgorandClient.mainnet()
client = AlgorackMarket_332d497a.AlgorackMarketClient(
    algorand=algorand,
    app_id=123456789,
)
