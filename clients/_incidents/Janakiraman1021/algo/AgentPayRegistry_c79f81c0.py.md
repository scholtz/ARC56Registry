# Generator crash: AgentPayRegistry_c79f81c0 (Python)
...
- **Detected**: 2026-08-24T08:01:31.670875+00:00
...
curl -sL https://raw.githubusercontent.com/Janakiraman1021/algo/HEAD/smart-contract/artifacts/AgentPayRegistry.arc56.json -o application.json
...
Traceback (most recent call last):
  ...
  File "/opt/hostedtoolcache/Python/3.12.14/x64/lib/python3.12/site-packages/algokit_utils/applications/app_spec/arc56.py", line 928, in from_json
    return Arc56Contract.from_dict(json.loads(application_spec))
           ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  File "/opt/hostedtoolcache/Python/3.12.14/x64/lib/python3.12/site-packages/algokit_utils/applications/app_spec/arc56.py", line 898, in from_dict
