# Generator crash: CadenciaEscrow_08254c5a (Python)
...
curl -sL https://raw.githubusercontent.com/AdityaWagh19/Cadencia-A2A-Platform/HEAD/backend/artifacts/CadenciaEscrow.arc56.json -o application.json
