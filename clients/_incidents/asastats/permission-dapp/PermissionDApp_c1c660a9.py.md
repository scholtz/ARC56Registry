# Generator crash: PermissionDApp_c1c660a9 (Python)
...
curl -sL https://raw.githubusercontent.com/asastats/permission-dapp/HEAD/dapp/artifacts/PermissionDApp.arc56.json -o application.json
