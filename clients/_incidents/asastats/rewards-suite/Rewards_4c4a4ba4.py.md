# Generator crash: Rewards_4c4a4ba4 (Python)
...
curl -sL https://raw.githubusercontent.com/asastats/rewards-suite/HEAD/rewardsweb/contract/artifacts/Rewards.arc56.json -o application.json
