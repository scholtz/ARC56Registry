# Generator crash: bytecode_bare_076df92f (Python)
...
curl -sL https://raw.githubusercontent.com/manuelmauro/algonaut/HEAD/tests/fixtures/bytecode_bare.arc56.json -o application.json
