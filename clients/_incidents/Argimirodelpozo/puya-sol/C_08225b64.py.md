# Generator crash: C_08225b64 (Python)
...
- **Detected**: 2026-07-18T15:41:16.817299+00:00
...
curl -sL https://raw.githubusercontent.com/Argimirodelpozo/puya-sol/HEAD/tests/solidity-semantic-tests/out/userDefinedValueType/storage_signed/C.arc56.json -o application.json
...
Traceback (most recent call last):
  File "/opt/hostedtoolcache/Python/3.12.13/x64/lib/python3.12/site-packages/algosdk/abi/base_type.py", line 81, in from_string
...
Traceback (most recent call last):
  ...
  File "/opt/hostedtoolcache/Python/3.12.13/x64/lib/python3.12/site-packages/algosdk/abi/method.py", line 231, in __init__
    self.type = abi.ABIType.from_string(arg_type)
                ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  File "/opt/hostedtoolcache/Python/3.12.13/x64/lib/python3.12/site-packages/algosdk/abi/base_type.py", line 84, in from_string
    raise error.ABITypeError(
algosdk.error.ABITypeError: malformed static array string: int16[1]
