# Generator crash: C_cd67b9e6 (Python)
...
- **Detected**: 2026-07-18T17:23:16.474706+00:00
...
curl -sL https://raw.githubusercontent.com/Argimirodelpozo/puya-sol/HEAD/tests/solidity-semantic-tests/out/cleanup/dirty_calldata_dynamic_array/C.arc56.json -o application.json
...
Traceback (most recent call last):
  ...
  File "/opt/hostedtoolcache/Python/3.12.13/x64/lib/python3.12/site-packages/algosdk/abi/method.py", line 182, in __init__
    self.type = abi.ABIType.from_string(arg_type)
                ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
  File "/opt/hostedtoolcache/Python/3.12.13/x64/lib/python3.12/site-packages/algosdk/abi/base_type.py", line 75, in from_string
...
algosdk.error.ABITypeError: cannot convert int16 to an ABI type
