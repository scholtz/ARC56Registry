# Generator crash: CadenciaEscrow_5c7908b1 (Python)
...
curl -sL https://raw.githubusercontent.com/harsh-mogalgiddikar/cadencia-platform/HEAD/cadencia-a2a-phases/artifacts/CadenciaEscrow.arc56.json -o application.json
