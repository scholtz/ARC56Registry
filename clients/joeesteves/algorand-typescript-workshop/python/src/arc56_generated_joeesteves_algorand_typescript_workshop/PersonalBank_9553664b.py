...
_APP_SPEC_JSON = r"""{"arcs": [22, 28], "bareActions": {"call": [], "create": ["NoOp"]}, "methods": [{"actions": {"call": ["NoOp"], "create": []}, "args": [{"type": "pay", "desc": "- The payment transaction containing deposit information", "name": "payTxn"}, {"type": "string", "name": "githubHandle"}], "name": "deposit", "returns": {"type": "uint64", "desc": "The total amount deposited by the sender after this transaction"}, "desc": "Deposits funds into the personal bank.\nThe deposit amount is recorded in the sender's BoxMap.\nIf the sender already has a deposit, the amount is added to their existing balance.", "events": [], "readonly": false, "recommendations": {}}, {"actions": {"call": ["NoOp"], "create": []}, "args": [], "name": "withdraw", "returns": {"type": "uint64", "desc": "The amount withdrawn (as UInt64)"}, "desc": "Withdraws all funds from the sender's account.\nThis method transfers the entire balance of the sender's account back to them,\nand resets their balance to zero. The sender must have a deposit to withdraw.", "events": [], "readonly": false, "recommendations": {}}], "name": "PersonalBank", "state": {"keys": {"box": {}, "global": {}, "local": {}}, "maps": {"box": {"depositors": {"keyType": "address", "valueType": "uint64", "prefix": "ZGVwb3NpdG9ycw=="}, "github": {"keyType": "address", "valueType": "AVMString", "prefix": "Z2l0aHVi"}}, "global": {}, "local": {}}, "schema": {"global": {"bytes": 0, "ints": 0}, "local": {"bytes": 0, "ints": 0}}}, "structs": {}, "events": [], "networks": {}, "sourceInfo": {"approval": {"pcOffsetMethod": "none", "sourceInfo": [{"pc": [151, 163], "errorMessage": "Box must have value"}, {"pc": [128], "errorMessage": "Deposit amount must be greater than zero"}, {"pc": [202], "errorMessage": "No deposits found for this account"}, {"pc": [54, 71], "errorMessage": "OnCompletion is not NoOp"}, {"pc": [122], "errorMessage": "Receiver must be the contract address"}, {"pc": [109], "errorMessage": "can only call when creating"}, {"pc": [57, 74], "errorMessage": "can only call when not creating"}, {"pc": [84], "errorMessage": "transaction type is pay"}]}, "clear": {"pcOffsetMethod": "none", "sourceInfo": []}}}"""
