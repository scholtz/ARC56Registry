...
```bash
pip install arc56-generated-joeesteves-algorand-typescript-workshop
```
...
from arc56_generated_joeesteves_algorand_typescript_workshop import PersonalBank_9553664b

algorand = AlgorandClient.mainnet()
client = PersonalBank_9553664b.PersonalBankClient(
    algorand=algorand,
    app_id=123456789,
)
