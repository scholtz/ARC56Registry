...
```bash
npm install arc56-generated-joeesteves-algorand-typescript-workshop @algorandfoundation/algokit-utils algosdk
```
...
import { PersonalBank_9553664b } from "arc56-generated-joeesteves-algorand-typescript-workshop";

const algorand = AlgorandClient.mainNet();
const client = new PersonalBank_9553664b.PersonalBankClient({
  algorand,
  appId: 123456789n,
});
