...
```bash
npm install arc56-generated-tommasoo0-prediction-market @algorandfoundation/algokit-utils algosdk
```
...
import { PredictionMarket_d8cb0fc3 } from "arc56-generated-tommasoo0-prediction-market";

const algorand = AlgorandClient.mainNet();
const client = new PredictionMarket_d8cb0fc3.PredictionMarketClient({
  algorand,
  appId: 123456789n,
});
