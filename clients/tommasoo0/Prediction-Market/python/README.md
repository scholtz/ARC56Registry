...
```bash
pip install arc56-generated-tommasoo0-prediction-market
```
...
from arc56_generated_tommasoo0_prediction_market import PredictionMarket_d8cb0fc3

algorand = AlgorandClient.mainnet()
client = PredictionMarket_d8cb0fc3.PredictionMarketClient(
    algorand=algorand,
    app_id=123456789,
)
