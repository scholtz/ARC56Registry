...
```bash
npm install arc56-generated-mohith257-ozark-sentinental @algorandfoundation/algokit-utils algosdk
```
...
import { AmlRegistry_67840691 } from "arc56-generated-mohith257-ozark-sentinental";

const algorand = AlgorandClient.mainNet();
const client = new AmlRegistry_67840691.AmlRegistryClient({
  algorand,
  appId: 123456789n,
});
