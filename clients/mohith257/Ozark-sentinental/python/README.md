...
```bash
pip install arc56-generated-mohith257-ozark-sentinental
```
...
from arc56_generated_mohith257_ozark_sentinental import AmlRegistry_67840691

algorand = AlgorandClient.mainnet()
client = AmlRegistry_67840691.AmlRegistryClient(
    algorand=algorand,
    app_id=123456789,
)
