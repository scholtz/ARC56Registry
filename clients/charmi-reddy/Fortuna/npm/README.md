...
Auto-generated typed Algorand smart-contract clients for **[charmi-reddy/Fortuna](https://github.com/charmi-reddy/Fortuna)**,
...
```bash
npm install arc56-generated-charmi-reddy-fortuna @algorandfoundation/algokit-utils algosdk
```
...
import { ContractName_hash } from "arc56-generated-charmi-reddy-fortuna";
