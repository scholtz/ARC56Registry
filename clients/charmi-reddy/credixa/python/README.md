...
```bash
pip install arc56-generated-charmi-reddy-credixa
```
...
from arc56_generated_charmi_reddy_credixa import InvoiceFinancing_ebae2a17

algorand = AlgorandClient.mainnet()
client = InvoiceFinancing_ebae2a17.InvoiceFinancingClient(
    algorand=algorand,
    app_id=123456789,
)
