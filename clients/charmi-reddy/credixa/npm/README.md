...
```bash
npm install arc56-generated-charmi-reddy-credixa @algorandfoundation/algokit-utils algosdk
```
...
import { InvoiceFinancing_ebae2a17 } from "arc56-generated-charmi-reddy-credixa";

const algorand = AlgorandClient.mainNet();
const client = new InvoiceFinancing_ebae2a17.InvoiceFinancingClient({
  algorand,
  appId: 123456789n,
});
...
| --- | --- | --- |
| `InvoiceFinancing_ebae2a17` | `InvoiceFinancingClient` | [https://raw.githubusercontent.com/charmi-reddy/credixa/HEAD/backend/backend/artifacts/InvoiceFinancing.arc56.json](https://raw.githubusercontent.com/charmi-reddy/credixa/HEAD/backend/backend/artifacts/InvoiceFinancing.arc56.json) |
