...
```bash
pip install arc56-generated-srizdebnath-algoagentx
```
...
from arc56_generated_srizdebnath_algoagentx import AlgoAgentGuardian_7fd52972

algorand = AlgorandClient.mainnet()
client = AlgoAgentGuardian_7fd52972.AlgoAgentGuardianClient(
    algorand=algorand,
    app_id=123456789,
)
