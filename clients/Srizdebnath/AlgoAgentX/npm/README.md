...
```bash
npm install arc56-generated-srizdebnath-algoagentx @algorandfoundation/algokit-utils algosdk
```
...
import { AlgoAgentGuardian_7fd52972 } from "arc56-generated-srizdebnath-algoagentx";

const algorand = AlgorandClient.mainNet();
const client = new AlgoAgentGuardian_7fd52972.AlgoAgentGuardianClient({
  algorand,
  appId: 123456789n,
});
...
| --- | --- | --- |
| `AlgoAgentGuardian_7fd52972` | `AlgoAgentGuardianClient` | [https://raw.githubusercontent.com/Srizdebnath/AlgoAgentX/HEAD/AlgoAgentGuardian.arc56.json](https://raw.githubusercontent.com/Srizdebnath/AlgoAgentX/HEAD/AlgoAgentGuardian.arc56.json) |
