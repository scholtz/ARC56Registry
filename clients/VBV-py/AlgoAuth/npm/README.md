...
```bash
npm install arc56-generated-vbv-py-algoauth @algorandfoundation/algokit-utils algosdk
```
...
import { AlgoAuth_4d4f201f } from "arc56-generated-vbv-py-algoauth";

const algorand = AlgorandClient.mainNet();
const client = new AlgoAuth_4d4f201f.AlgoAuthClient({
  algorand,
  appId: 123456789n,
});
