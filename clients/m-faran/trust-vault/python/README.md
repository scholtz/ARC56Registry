...
```bash
pip install arc56-generated-m-faran-trust-vault
```
...
from arc56_generated_m_faran_trust_vault import TrustVault_3ccf51b1

algorand = AlgorandClient.mainnet()
client = TrustVault_3ccf51b1.TrustVaultClient(
    algorand=algorand,
    app_id=123456789,
)
