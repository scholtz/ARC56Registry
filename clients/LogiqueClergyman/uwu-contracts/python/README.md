...
```bash
pip install arc56-generated-logiqueclergyman-uwu-contracts
```
...
from arc56_generated_logiqueclergyman_uwu_contracts import UwUPolymorphicRegistry_8b9dac3b

algorand = AlgorandClient.mainnet()
client = UwUPolymorphicRegistry_8b9dac3b.UwUPolymorphicRegistryClient(
    algorand=algorand,
    app_id=123456789,
)
