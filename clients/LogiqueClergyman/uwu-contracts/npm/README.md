...
```bash
npm install arc56-generated-logiqueclergyman-uwu-contracts @algorandfoundation/algokit-utils algosdk
```
...
import { UwUPolymorphicRegistry_8b9dac3b } from "arc56-generated-logiqueclergyman-uwu-contracts";

const algorand = AlgorandClient.mainNet();
const client = new UwUPolymorphicRegistry_8b9dac3b.UwUPolymorphicRegistryClient({
  algorand,
  appId: 123456789n,
});
