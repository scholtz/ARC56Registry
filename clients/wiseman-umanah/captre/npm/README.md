...
```bash
npm install arc56-generated-wiseman-umanah-captre @algorandfoundation/algokit-utils algosdk
```
...
import { CaptreApp_166648ce } from "arc56-generated-wiseman-umanah-captre";

const algorand = AlgorandClient.mainNet();
const client = new CaptreApp_166648ce.CaptreAppClient({
  algorand,
  appId: 123456789n,
});
