...
```bash
pip install arc56-generated-debuuuuuu-pay-per-usage-ai-api-access-system-using-algorand
```
...
from arc56_generated_debuuuuuu_pay_per_usage_ai_api_access_system_using_algorand import SentinelContract_06dcacff

algorand = AlgorandClient.mainnet()
client = SentinelContract_06dcacff.SentinelContractClient(
    algorand=algorand,
    app_id=123456789,
)
