...
```bash
npm install arc56-generated-sumit-bhagat-2004-neurochain @algorandfoundation/algokit-utils algosdk
```
...
import { DebateStake_069f566d } from "arc56-generated-sumit-bhagat-2004-neurochain";

const algorand = AlgorandClient.mainNet();
const client = new DebateStake_069f566d.DebateStakeClient({
  algorand,
  appId: 123456789n,
});
