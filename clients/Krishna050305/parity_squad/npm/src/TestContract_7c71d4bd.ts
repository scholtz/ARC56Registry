...
export const APP_SPEC: Arc56Contract = {"name":"TestContract","structs":{},"methods":[{"name":"test","args":[{"type":"uint64","name":"asset"}],"returns":{"type":"void"},"actions":{"create":[],"call":["NoOp"]},"readonly":false,"events":[],"recommendations":{}}],"arcs":[22,28],"networks":{},"state":{"schema":{"global":{"ints":0,"bytes":0},"local":{"ints":0,"bytes":0}},"keys":{"global":{},"local":{},"box":{}},"maps":{"global":{},"local":{},"box":{}}},"bareActions":{"create":["NoOp"],"call":[]},"sourceInfo":{"approval":{"sourceInfo":[{"pc":[54],"errorMessage":"No balance"},{"pc":[53],"errorMessage":"Not opted in"},{"pc":[46],"errorMessage":"invalid number of bytes for arc4.uint64"}],"pcOffsetMethod":"none"},"clear":{"sourceInfo":[],"pcOffsetMethod":"none"}},"events":[]} as unknown as Arc56Contract
...
export type TestContractArgs = {
   ...
   */
  tuple: {
    'test(uint64)void': [asset: bigint | number]
  }
}
...
export type TestContractTypes = {
  ...
  methods:
    & Record<'test(uint64)void' | 'test', {
      argsObj: TestContractArgs['obj']['test(uint64)void']
      argsTuple: TestContractArgs['tuple']['test(uint64)void']
      returns: TestContractReturns['test(uint64)void']
    }>
}
...
export abstract class TestContractParamsFactory {
   ...
   */
  static test(params: CallParams<TestContractArgs['obj']['test(uint64)void'] | TestContractArgs['tuple']['test(uint64)void']> & CallOnComplete): AppClientMethodCallParams & CallOnComplete {
    return {
      ...params,
...
export class TestContractClient {
  ...
  readonly params = {
    ...
    /**
     * Makes a call to the TestContract smart contract using the `test(uint64)void` ABI method.
     *
     * @param params The params for the smart contract call
     * @returns The call params
     */
    test: (params: CallParams<TestContractArgs['obj']['test(uint64)void'] | TestContractArgs['tuple']['test(uint64)void']> & {onComplete?: OnApplicationComplete.NoOpOC}) => {
  ...
  readonly send = {
     ...
     */
    test: async (params: CallParams<TestContractArgs['obj']['test(uint64)void'] | TestContractArgs['tuple']['test(uint64)void']> & SendParams & {onComplete?: OnApplicationComplete.NoOpOC}) => {
      const result = await this.appClient.send.call(TestContractParamsFactory.test(params))
      return {...result, return: result.return as unknown as (undefined | TestContractReturns['test(uint64)void'])}
    },
  ...
  public newGroup(): TestContractComposer {
    ...
    return {
      /**
       * Add a test(uint64)void method call against the TestContract contract
       */
      test(params: CallParams<TestContractArgs['obj']['test(uint64)void'] | TestContractArgs['tuple']['test(uint64)void']> & {onComplete?: OnApplicationComplete.NoOpOC}) {
...
export type TestContractComposer<TReturns extends [...any[]] = []> = {
   ...
   */
  test(params?: CallParams<TestContractArgs['obj']['test(uint64)void'] | TestContractArgs['tuple']['test(uint64)void']>): TestContractComposer<[...TReturns, TestContractReturns['test(uint64)void'] | undefined]>
