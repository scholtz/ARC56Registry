...
```bash
pip install arc56-generated-maikoll120-algokit-workshop
```
...
from arc56_generated_maikoll120_algokit_workshop import HelloWorld_f5d2a864

algorand = AlgorandClient.mainnet()
client = HelloWorld_f5d2a864.HelloWorldClient(
    algorand=algorand,
    app_id=123456789,
)
