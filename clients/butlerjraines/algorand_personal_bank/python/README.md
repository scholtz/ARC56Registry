...
```bash
pip install arc56-generated-butlerjraines-algorand-personal-bank
```
...
from arc56_generated_butlerjraines_algorand_personal_bank import PersonalBank_bf10db19

algorand = AlgorandClient.mainnet()
client = PersonalBank_bf10db19.PersonalBankClient(
    algorand=algorand,
    app_id=123456789,
)
