...
```bash
pip install arc56-generated-yashdiwan-16-consent-chain
```
...
from arc56_generated_yashdiwan_16_consent_chain import ConsentRegistry_2f8b45c4

algorand = AlgorandClient.mainnet()
client = ConsentRegistry_2f8b45c4.ConsentRegistryClient(
    algorand=algorand,
    app_id=123456789,
)
