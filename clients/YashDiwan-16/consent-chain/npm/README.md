...
```bash
npm install arc56-generated-yashdiwan-16-consent-chain @algorandfoundation/algokit-utils algosdk
```
...
import { ConsentRegistry_2f8b45c4 } from "arc56-generated-yashdiwan-16-consent-chain";

const algorand = AlgorandClient.mainNet();
const client = new ConsentRegistry_2f8b45c4.ConsentRegistryClient({
  algorand,
  appId: 123456789n,
});
