...
```bash
npm install arc56-generated-yashdiwan-16-hackseries-3-0 @algorandfoundation/algokit-utils algosdk
```
...
import { BackstopVault_3dd95053 } from "arc56-generated-yashdiwan-16-hackseries-3-0";

const algorand = AlgorandClient.mainNet();
const client = new BackstopVault_3dd95053.BackstopVaultClient({
  algorand,
  appId: 123456789n,
});
