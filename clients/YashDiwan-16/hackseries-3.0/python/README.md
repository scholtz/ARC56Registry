...
```bash
pip install arc56-generated-yashdiwan-16-hackseries-3-0
```
...
from arc56_generated_yashdiwan_16_hackseries_3_0 import BackstopVault_3dd95053

algorand = AlgorandClient.mainnet()
client = BackstopVault_3dd95053.BackstopVaultClient(
    algorand=algorand,
    app_id=123456789,
)
