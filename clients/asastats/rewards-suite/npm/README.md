...
```bash
npm install arc56-generated-asastats-rewards-suite @algorandfoundation/algokit-utils algosdk
```
...
import { Rewards_4c4a4ba4 } from "arc56-generated-asastats-rewards-suite";

const algorand = AlgorandClient.mainNet();
const client = new Rewards_4c4a4ba4.RewardsClient({
  algorand,
  appId: 123456789n,
});
...
| --- | --- | --- |
| `Rewards_4c4a4ba4` | `RewardsClient` | [https://raw.githubusercontent.com/asastats/rewards-suite/HEAD/rewardsweb/contract/artifacts/Rewards.arc56.json](https://raw.githubusercontent.com/asastats/rewards-suite/HEAD/rewardsweb/contract/artifacts/Rewards.arc56.json) |
