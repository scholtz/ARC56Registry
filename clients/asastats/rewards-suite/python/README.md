...
```bash
pip install arc56-generated-asastats-rewards-suite
```
...
from arc56_generated_asastats_rewards_suite import contract_name_hash
...
| --- | --- | --- |
| `Rewards_4c4a4ba4` | _(generation failed - see state.json)_ | [https://raw.githubusercontent.com/asastats/rewards-suite/HEAD/rewardsweb/contract/artifacts/Rewards.arc56.json](https://raw.githubusercontent.com/asastats/rewards-suite/HEAD/rewardsweb/contract/artifacts/Rewards.arc56.json) |
