...
```bash
pip install arc56-generated-asastats-permission-dapp
```
...
from arc56_generated_asastats_permission_dapp import contract_name_hash
...
| --- | --- | --- |
| `PermissionDApp_c1c660a9` | _(generation failed - see state.json)_ | [https://raw.githubusercontent.com/asastats/permission-dapp/HEAD/dapp/artifacts/PermissionDApp.arc56.json](https://raw.githubusercontent.com/asastats/permission-dapp/HEAD/dapp/artifacts/PermissionDApp.arc56.json) |
