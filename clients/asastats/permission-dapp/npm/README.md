...
```bash
npm install arc56-generated-asastats-permission-dapp @algorandfoundation/algokit-utils algosdk
```
...
import { PermissionDApp_c1c660a9 } from "arc56-generated-asastats-permission-dapp";

const algorand = AlgorandClient.mainNet();
const client = new PermissionDApp_c1c660a9.PermissionDAppClient({
  algorand,
  appId: 123456789n,
});
...
| --- | --- | --- |
| `PermissionDApp_c1c660a9` | `PermissionDAppClient` | [https://raw.githubusercontent.com/asastats/permission-dapp/HEAD/dapp/artifacts/PermissionDApp.arc56.json](https://raw.githubusercontent.com/asastats/permission-dapp/HEAD/dapp/artifacts/PermissionDApp.arc56.json) |
