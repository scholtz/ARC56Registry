...
```bash
npm install arc56-generated-ranjith-ind-evidence-chain @algorandfoundation/algokit-utils algosdk
```
...
import { EvidenceRegistry_06008427 } from "arc56-generated-ranjith-ind-evidence-chain";

const algorand = AlgorandClient.mainNet();
const client = new EvidenceRegistry_06008427.EvidenceRegistryClient({
  algorand,
  appId: 123456789n,
});
...
| --- | --- | --- |
| `EvidenceRegistry_06008427` | `EvidenceRegistryClient` | [https://raw.githubusercontent.com/ranjith-ind/Evidence-Chain/HEAD/smart_contracts/artifacts/evidence_registry/EvidenceRegistry.arc56.json](https://raw.githubusercontent.com/ranjith-ind/Evidence-Chain/HEAD/smart_contracts/artifacts/evidence_registry/EvidenceRegistry.arc56.json) |
| `HelloWorld_a3d66fbd` | `HelloWorldClient` | [https://raw.githubusercontent.com/ranjith-ind/Evidence-Chain/HEAD/smart_contracts/artifacts/hello_world/HelloWorld.arc56.json](https://raw.githubusercontent.com/ranjith-ind/Evidence-Chain/HEAD/smart_contracts/artifacts/hello_world/HelloWorld.arc56.json) |
