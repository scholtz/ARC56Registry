...
```bash
pip install arc56-generated-mzf11125-stake-sharia-on-algorand
```
...
from arc56_generated_mzf11125_stake_sharia_on_algorand import tawf_sharia_3da97503

algorand = AlgorandClient.mainnet()
client = tawf_sharia_3da97503.TawfShariaClient(
    algorand=algorand,
    app_id=123456789,
)
