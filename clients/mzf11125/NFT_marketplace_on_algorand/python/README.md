...
```bash
pip install arc56-generated-mzf11125-nft-marketplace-on-algorand
```
...
from arc56_generated_mzf11125_nft_marketplace_on_algorand import SimpleNFT_fd38a302

algorand = AlgorandClient.mainnet()
client = SimpleNFT_fd38a302.SimpleNftClient(
    algorand=algorand,
    app_id=123456789,
)
