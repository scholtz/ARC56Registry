...
```bash
pip install arc56-generated-mzf11125-algorand-workshop
```
...
from arc56_generated_mzf11125_algorand_workshop import HelloWorld_79929168

algorand = AlgorandClient.mainnet()
client = HelloWorld_79929168.HelloWorldClient(
    algorand=algorand,
    app_id=123456789,
)
