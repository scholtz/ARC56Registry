...
```bash
npm install arc56-generated-ameen-ansarii-algorand-carpool @algorandfoundation/algokit-utils algosdk
```
...
import { RideEscrow_202703b9 } from "arc56-generated-ameen-ansarii-algorand-carpool";

const algorand = AlgorandClient.mainNet();
const client = new RideEscrow_202703b9.RideEscrowClient({
  algorand,
  appId: 123456789n,
});
...
| --- | --- | --- |
| `RideEscrow_202703b9` | `RideEscrowClient` | [https://raw.githubusercontent.com/ameen-ansarii/Algorand-Carpool/HEAD/ride-contract/smart_contracts/artifacts/ride_escrow/RideEscrow.arc56.json](https://raw.githubusercontent.com/ameen-ansarii/Algorand-Carpool/HEAD/ride-contract/smart_contracts/artifacts/ride_escrow/RideEscrow.arc56.json) |
| `RideEscrow_21e16cbf` | `RideEscrowClient` | [https://raw.githubusercontent.com/ameen-ansarii/Algorand-Carpool/HEAD/web-app/src/lib/RideEscrow.arc56.json](https://raw.githubusercontent.com/ameen-ansarii/Algorand-Carpool/HEAD/web-app/src/lib/RideEscrow.arc56.json) |
