...
```bash
pip install arc56-generated-ameen-ansarii-algorand-carpool
```
...
from arc56_generated_ameen_ansarii_algorand_carpool import RideEscrow_202703b9

algorand = AlgorandClient.mainnet()
client = RideEscrow_202703b9.RideEscrowClient(
    algorand=algorand,
    app_id=123456789,
)
