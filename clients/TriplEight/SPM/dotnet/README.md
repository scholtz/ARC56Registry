...
Auto-generated typed Algorand smart-contract clients for **[TriplEight/SPM](https://github.com/TriplEight/SPM)**,
...
```bash
dotnet add package Arc56.Generated.TriplEight.SPM
```
