...
```bash
npm install arc56-generated-balajibhargav6-algo-nodes @algorandfoundation/algokit-utils algosdk
```
...
import { AlgoSphere_eb4784cd } from "arc56-generated-balajibhargav6-algo-nodes";

const algorand = AlgorandClient.mainNet();
const client = new AlgoSphere_eb4784cd.AlgoSphereClient({
  algorand,
  appId: 123456789n,
});
