...
```bash
pip install arc56-generated-captainram1413-de-shop-sdk
```
...
from arc56_generated_captainram1413_de_shop_sdk import Deshopsdk_c3d5b5d3

algorand = AlgorandClient.mainnet()
client = Deshopsdk_c3d5b5d3.DeshopsdkClient(
    algorand=algorand,
    app_id=123456789,
)
