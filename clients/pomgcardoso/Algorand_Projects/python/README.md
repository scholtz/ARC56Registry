...
```bash
pip install arc56-generated-pomgcardoso-algorand-projects
```
...
from arc56_generated_pomgcardoso_algorand_projects import PersonalBank_e629f4cf

algorand = AlgorandClient.mainnet()
client = PersonalBank_e629f4cf.PersonalBankClient(
    algorand=algorand,
    app_id=123456789,
)
