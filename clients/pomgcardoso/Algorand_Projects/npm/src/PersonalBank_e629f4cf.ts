...
export const APP_SPEC: Arc56Contract = {"name":"PersonalBank","structs":{},"methods":[{"name":"deposit","args":[{"type":"pay","name":"pay_txn","desc":"The payment transaction containing deposit information"},{"type":"string","name":"handle"}],"returns":{"type":"uint64","desc":"The total amount deposited by the sender after this transaction (as UInt64)"},"actions":{"create":[],"call":["NoOp"]},"readonly":false,"desc":"Deposits funds into the personal bank\nThis method accepts a payment transaction and records the deposit amount in the sender's BoxMap. If the sender already has a deposit, the amount is added to their existing balance.","events":[],"recommendations":{}},{"name":"withdraw","args":[],"returns":{"type":"uint64","desc":"The amount withdrawn (as UInt64)"},"actions":{"create":[],"call":["NoOp"]},"readonly":false,"desc":"Withdraws all funds from the sender's account\nThis method transfers the entire balance of the sender's account back to them, and resets their balance to zero. The sender must have a deposit to withdraw.","events":[],"recommendations":{}}],"arcs":[22,28],"networks":{},"state":{"schema":{"global":{"ints":0,"bytes":0},"local":{"ints":0,"bytes":0}},"keys":{"global":{},"local":{},"box":{}},"maps":{"global":{},"local":{},"box":{"depositors":{"keyType":"address","valueType":"uint64","prefix":""},"github":{"keyType":"AVMString","valueType":"AVMString","prefix":"Z2l0aHVi"}}}},"bareActions":{"create":["NoOp"],"call":[]},"sourceInfo":{"approval":{"sourceInfo":[{"pc":[131],"errorMessage":"Deposit amount must be greater than zero"},{"pc":[182],"errorMessage":"No deposits found for this account"},{"pc":[50,67],"errorMessage":"OnCompletion is not NoOp"},{"pc":[125],"errorMessage":"Receiver must be the contract address"},{"pc":[105],"errorMessage":"can only call when creating"},{"pc":[53,70],"errorMessage":"can only call when not creating"},{"pc":[150,162],"errorMessage":"check self.depositors entry exists"},{"pc":[80],"errorMessage":"transaction type is pay"}],"pcOffsetMethod":"none"},"clear":{"sourceInfo":[],"pcOffsetMethod":"none"}},"events":[]} as unknown as Arc56Contract
...
export type PersonalBankArgs = {
   ...
   */
  tuple: {
    'deposit(pay,string)uint64': [payTxn: AppMethodCallTransactionArgument, handle: string]
    'withdraw()uint64': []
  }
}
  ...
  * Deposits funds into the personal bank
  ...
  static deposit(params: CallParams<PersonalBankArgs['obj']['deposit(pay,string)uint64'] | PersonalBankArgs['tuple']['deposit(pay,string)uint64']> & CallOnComplete): AppClientMethodCallParams & CallOnComplete {
    return {
      ...
      args: Array.isArray(params.args) ? params.args : [params.args.payTxn, params.args.handle],
    }
  }
  /**
