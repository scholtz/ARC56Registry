...
```bash
npm install arc56-generated-parthiv307-aura-escrow-protocal @algorandfoundation/algokit-utils algosdk
```
...
import { HelloWorld_e0204eeb } from "arc56-generated-parthiv307-aura-escrow-protocal";

const algorand = AlgorandClient.mainNet();
const client = new HelloWorld_e0204eeb.HelloWorldClient({
  algorand,
  appId: 123456789n,
});
