...
```bash
pip install arc56-generated-parthiv307-aura-escrow-protocal
```
...
from arc56_generated_parthiv307_aura_escrow_protocal import HelloWorld_e0204eeb

algorand = AlgorandClient.mainnet()
client = HelloWorld_e0204eeb.HelloWorldClient(
    algorand=algorand,
    app_id=123456789,
)
