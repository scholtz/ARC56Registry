...
```bash
pip install arc56-generated-bwmx-algorand-casino-roulette
```
...
from arc56_generated_bwmx_algorand_casino_roulette import Managable_b7173e42

algorand = AlgorandClient.mainnet()
client = Managable_b7173e42.ManagableClient(
    algorand=algorand,
    app_id=123456789,
)
