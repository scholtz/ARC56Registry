...
```bash
npm install arc56-generated-bwmx-algorand-casino-roulette @algorandfoundation/algokit-utils algosdk
```
...
import { Managable_b7173e42 } from "arc56-generated-bwmx-algorand-casino-roulette";

const algorand = AlgorandClient.mainNet();
const client = new Managable_b7173e42.ManagableClient({
  algorand,
  appId: 123456789n,
});
