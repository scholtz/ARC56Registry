...
```bash
npm install arc56-generated-bwmx-asset-staking @algorandfoundation/algokit-utils algosdk
```
...
import { AssetStaking_8d218330 } from "arc56-generated-bwmx-asset-staking";

const algorand = AlgorandClient.mainNet();
const client = new AssetStaking_8d218330.AssetStakingClient({
  algorand,
  appId: 123456789n,
});
