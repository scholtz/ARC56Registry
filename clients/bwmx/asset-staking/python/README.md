...
```bash
pip install arc56-generated-bwmx-asset-staking
```
...
from arc56_generated_bwmx_asset_staking import AssetStaking_8d218330

algorand = AlgorandClient.mainnet()
client = AssetStaking_8d218330.AssetStakingClient(
    algorand=algorand,
    app_id=123456789,
)
