...
```bash
pip install arc56-generated-osmndotdev-algorandpollsdapp
```
...
from arc56_generated_osmndotdev_algorandpollsdapp import PollManager_a58643e6

algorand = AlgorandClient.mainnet()
client = PollManager_a58643e6.PollManagerClient(
    algorand=algorand,
    app_id=123456789,
)
