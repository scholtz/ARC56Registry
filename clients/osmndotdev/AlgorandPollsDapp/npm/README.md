...
```bash
npm install arc56-generated-osmndotdev-algorandpollsdapp @algorandfoundation/algokit-utils algosdk
```
...
import { PollManager_a58643e6 } from "arc56-generated-osmndotdev-algorandpollsdapp";

const algorand = AlgorandClient.mainNet();
const client = new PollManager_a58643e6.PollManagerClient({
  algorand,
  appId: 123456789n,
});
