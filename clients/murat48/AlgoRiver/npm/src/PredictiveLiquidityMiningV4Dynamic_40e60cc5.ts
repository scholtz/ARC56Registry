...
export type PredictiveLiquidityMiningV4DynamicComposer<TReturns extends [...any[]] = []> = {
   ...
   */
  simulate(): Promise<PredictiveLiquidityMiningV4DynamicComposerResults<TReturns> & { simulateResponse: modelsv2.SimulateResponse }>
  simulate(options: SkipSignaturesSimulateOptions): Promise<PredictiveLiquidityMiningV4DynamicComposerResults<TReturns> & { simulateResponse: modelsv2.SimulateResponse }>
  simulate(options: RawSimulateOptions): Promise<PredictiveLiquidityMiningV4DynamicComposerResults<TReturns> & { simulateResponse: modelsv2.SimulateResponse }>
  /**
