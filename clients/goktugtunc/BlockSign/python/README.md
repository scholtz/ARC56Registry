...
```bash
pip install arc56-generated-goktugtunc-blocksign
```
...
from arc56_generated_goktugtunc_blocksign import Blocksign_6e825a15

algorand = AlgorandClient.mainnet()
client = Blocksign_6e825a15.BlocksignClient(
    algorand=algorand,
    app_id=123456789,
)
