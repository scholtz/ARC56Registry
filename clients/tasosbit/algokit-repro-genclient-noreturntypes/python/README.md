...
```bash
pip install arc56-generated-tasosbit-algokit-repro-genclient-noreturntypes
```
...
from arc56_generated_tasosbit_algokit_repro_genclient_noreturntypes import HelloWorld_046e24ac

algorand = AlgorandClient.mainnet()
client = HelloWorld_046e24ac.HelloWorldClient(
    algorand=algorand,
    app_id=123456789,
)
