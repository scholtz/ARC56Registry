...
```bash
npm install arc56-generated-tasosbit-algokit-repro-genclient-noreturntypes @algorandfoundation/algokit-utils algosdk
```
...
import { HelloWorld_046e24ac } from "arc56-generated-tasosbit-algokit-repro-genclient-noreturntypes";

const algorand = AlgorandClient.mainNet();
const client = new HelloWorld_046e24ac.HelloWorldClient({
  algorand,
  appId: 123456789n,
});
