...
```bash
pip install arc56-generated-tasosbit-distributor
```
...
from arc56_generated_tasosbit_distributor import Distributor_c742749c

algorand = AlgorandClient.mainnet()
client = Distributor_c742749c.DistributorClient(
    algorand=algorand,
    app_id=123456789,
)
