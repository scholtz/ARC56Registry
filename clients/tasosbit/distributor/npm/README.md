...
```bash
npm install arc56-generated-tasosbit-distributor @algorandfoundation/algokit-utils algosdk
```
...
import { Distributor_c742749c } from "arc56-generated-tasosbit-distributor";

const algorand = AlgorandClient.mainNet();
const client = new Distributor_c742749c.DistributorClient({
  algorand,
  appId: 123456789n,
});
