...
```bash
pip install arc56-generated-tasosbit-test-algokit-big-num-accounts
```
...
from arc56_generated_tasosbit_test_algokit_big_num_accounts import HelloWorld_3639fbac

algorand = AlgorandClient.mainnet()
client = HelloWorld_3639fbac.HelloWorldClient(
    algorand=algorand,
    app_id=123456789,
)
