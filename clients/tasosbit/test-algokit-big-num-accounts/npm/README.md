...
```bash
npm install arc56-generated-tasosbit-test-algokit-big-num-accounts @algorandfoundation/algokit-utils algosdk
```
...
import { HelloWorld_3639fbac } from "arc56-generated-tasosbit-test-algokit-big-num-accounts";

const algorand = AlgorandClient.mainNet();
const client = new HelloWorld_3639fbac.HelloWorldClient({
  algorand,
  appId: 123456789n,
});
