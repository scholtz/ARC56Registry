...
```bash
npm install arc56-generated-tasosbit-usdc-pong @algorandfoundation/algokit-utils algosdk
```
...
import { UsdcPong_fd3dabf4 } from "arc56-generated-tasosbit-usdc-pong";

const algorand = AlgorandClient.mainNet();
const client = new UsdcPong_fd3dabf4.UsdcPongClient({
  algorand,
  appId: 123456789n,
});
