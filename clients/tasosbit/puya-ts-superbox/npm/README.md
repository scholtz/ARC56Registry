...
```bash
npm install arc56-generated-tasosbit-puya-ts-superbox @algorandfoundation/algokit-utils algosdk
```
...
import { Superbox_494da3ef } from "arc56-generated-tasosbit-puya-ts-superbox";

const algorand = AlgorandClient.mainNet();
const client = new Superbox_494da3ef.SuperboxClient({
  algorand,
  appId: 123456789n,
});
