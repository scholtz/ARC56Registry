...
```bash
pip install arc56-generated-ananyaa-08-refugee-identity-system
```
...
from arc56_generated_ananyaa_08_refugee_identity_system import RefugeeContract_92bbcaf9

algorand = AlgorandClient.mainnet()
client = RefugeeContract_92bbcaf9.RefugeeContractClient(
    algorand=algorand,
    app_id=123456789,
)
