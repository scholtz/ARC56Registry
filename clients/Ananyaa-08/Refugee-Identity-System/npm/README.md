...
```bash
npm install arc56-generated-ananyaa-08-refugee-identity-system @algorandfoundation/algokit-utils algosdk
```
...
import { RefugeeContract_92bbcaf9 } from "arc56-generated-ananyaa-08-refugee-identity-system";

const algorand = AlgorandClient.mainNet();
const client = new RefugeeContract_92bbcaf9.RefugeeContractClient({
  algorand,
  appId: 123456789n,
});
