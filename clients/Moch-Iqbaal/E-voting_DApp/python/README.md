...
```bash
pip install arc56-generated-moch-iqbaal-e-voting-dapp
```
...
from arc56_generated_moch_iqbaal_e_voting_dapp import EVoting_a90800dd

algorand = AlgorandClient.mainnet()
client = EVoting_a90800dd.EVotingClient(
    algorand=algorand,
    app_id=123456789,
)
