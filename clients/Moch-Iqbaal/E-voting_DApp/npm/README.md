# arc56-generated-moch-iqbaal-e-voting-dapp
...
```bash
npm install arc56-generated-moch-iqbaal-e-voting-dapp @algorandfoundation/algokit-utils algosdk
```
...
import { EVoting_a90800dd } from "arc56-generated-moch-iqbaal-e-voting-dapp";

const algorand = AlgorandClient.mainNet();
const client = new EVoting_a90800dd.EVotingClient({
  algorand,
  appId: 123456789n,
});
...
| --- | --- | --- |
| `EVoting_a90800dd` | `EVotingClient` | [https://raw.githubusercontent.com/Moch-Iqbaal/E-voting_DApp/HEAD/smart_contracts/artifacts/evoting/EVoting.arc56.json](https://raw.githubusercontent.com/Moch-Iqbaal/E-voting_DApp/HEAD/smart_contracts/artifacts/evoting/EVoting.arc56.json) |
