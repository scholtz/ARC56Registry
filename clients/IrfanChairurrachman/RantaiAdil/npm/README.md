...
```bash
npm install arc56-generated-irfanchairurrachman-rantaiadil @algorandfoundation/algokit-utils algosdk
```
...
import { RantaiAdil_c197d60f } from "arc56-generated-irfanchairurrachman-rantaiadil";

const algorand = AlgorandClient.mainNet();
const client = new RantaiAdil_c197d60f.RantaiAdilClient({
  algorand,
  appId: 123456789n,
});
...
| --- | --- | --- |
| `RantaiAdil_c197d60f` | `RantaiAdilClient` | [https://raw.githubusercontent.com/IrfanChairurrachman/RantaiAdil/HEAD/smart_contracts/artifacts/rantai_adil/RantaiAdil.arc56.json](https://raw.githubusercontent.com/IrfanChairurrachman/RantaiAdil/HEAD/smart_contracts/artifacts/rantai_adil/RantaiAdil.arc56.json) |
