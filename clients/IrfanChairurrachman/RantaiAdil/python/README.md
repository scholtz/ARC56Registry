...
```bash
pip install arc56-generated-irfanchairurrachman-rantaiadil
```
...
from arc56_generated_irfanchairurrachman_rantaiadil import RantaiAdil_c197d60f

algorand = AlgorandClient.mainnet()
client = RantaiAdil_c197d60f.RantaiAdilClient(
    algorand=algorand,
    app_id=123456789,
)
