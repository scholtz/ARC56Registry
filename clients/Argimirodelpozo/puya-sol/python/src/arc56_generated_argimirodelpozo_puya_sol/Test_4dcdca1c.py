...
class TestClient:
    ...
    def decode_return_value(
        self,
        method: typing.Literal["withinArray()uint256"],
...
class TestComposer:
    ...
    def within_array(
        ...
        self._composer.add_app_call_method_call(
            self.client.params.within_array(
