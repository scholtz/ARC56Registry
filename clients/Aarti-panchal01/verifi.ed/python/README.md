...
```bash
pip install arc56-generated-aarti-panchal01-verifi-ed
```
...
from arc56_generated_aarti_panchal01_verifi_ed import VerifiedProtocol_6470122f

algorand = AlgorandClient.mainnet()
client = VerifiedProtocol_6470122f.VerifiedProtocolClient(
    algorand=algorand,
    app_id=123456789,
)
