...
```bash
npm install arc56-generated-amanrajguptaa-ticketer @algorandfoundation/algokit-utils algosdk
```
...
import { TicketerContracts_83db02fa } from "arc56-generated-amanrajguptaa-ticketer";

const algorand = AlgorandClient.mainNet();
const client = new TicketerContracts_83db02fa.TicketerContractsClient({
  algorand,
  appId: 123456789n,
});
