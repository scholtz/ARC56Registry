...
```bash
pip install arc56-generated-amanrajguptaa-ticketer
```
...
from arc56_generated_amanrajguptaa_ticketer import TicketerContracts_83db02fa

algorand = AlgorandClient.mainnet()
client = TicketerContracts_83db02fa.TicketerContractsClient(
    algorand=algorand,
    app_id=123456789,
)
