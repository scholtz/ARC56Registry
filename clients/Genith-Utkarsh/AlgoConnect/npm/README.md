...
```bash
npm install arc56-generated-genith-utkarsh-algoconnect @algorandfoundation/algokit-utils algosdk
```
...
import { Bank_327de8b9 } from "arc56-generated-genith-utkarsh-algoconnect";

const algorand = AlgorandClient.mainNet();
const client = new Bank_327de8b9.BankClient({
  algorand,
  appId: 123456789n,
});
