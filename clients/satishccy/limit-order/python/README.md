...
```bash
pip install arc56-generated-satishccy-limit-order
```
...
from arc56_generated_satishccy_limit_order import LimitOrder_d775e355

algorand = AlgorandClient.mainnet()
client = LimitOrder_d775e355.LimitOrderClient(
    algorand=algorand,
    app_id=123456789,
)
