...
```bash
npm install arc56-generated-satishccy-limit-order @algorandfoundation/algokit-utils algosdk
```
...
import { LimitOrder_d775e355 } from "arc56-generated-satishccy-limit-order";

const algorand = AlgorandClient.mainNet();
const client = new LimitOrder_d775e355.LimitOrderClient({
  algorand,
  appId: 123456789n,
});
...
| --- | --- | --- |
| `LimitOrder_d775e355` | `LimitOrderClient` | [https://raw.githubusercontent.com/satishccy/limit-order/HEAD/projects/limit-order-contracts/contracts/artifacts/LimitOrder.arc56.json](https://raw.githubusercontent.com/satishccy/limit-order/HEAD/projects/limit-order-contracts/contracts/artifacts/LimitOrder.arc56.json) |
