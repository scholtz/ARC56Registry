...
```bash
pip install arc56-generated-satishccy-splitrix-algorand
```
...
from arc56_generated_satishccy_splitrix_algorand import Splitrix_3cd23c2b

algorand = AlgorandClient.mainnet()
client = Splitrix_3cd23c2b.SplitrixClient(
    algorand=algorand,
    app_id=123456789,
)
