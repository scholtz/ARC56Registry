...
_APP_SPEC_JSON = r"""{"arcs": [22, 28], "bareActions": {"call": [], "create": ["NoOp"]}, "methods": [{"actions": {"call": ["NoOp"], "create": []}, "args": [{"type": "string", "name": "name"}], "name": "hello", "returns": {"type": "string"}, "events": [], "readonly": false, "recommendations": {}}, {"actions": {"call": ["NoOp"], "create": []}, "args": [], "name": "get_last_greeting", "returns": {"type": "string"}, "events": [], "readonly": true, "recommendations": {}}], "name": "HelloWorld", "state": {"keys": {"box": {"greeting_box": {"key": "R1JFRVRJTkdfQk9Y", "keyType": "AVMBytes", "valueType": "AVMString"}}, "global": {}, "local": {}}, "maps": {"box": {}, "global": {}, "local": {}}, "schema": {"global": {"bytes": 0, "ints": 0}, "local": {"bytes": 0, "ints": 0}}}, "structs": {}, "events": [], "networks": {}, "sourceInfo": {"approval": {"pcOffsetMethod": "none", "sourceInfo": [{"pc": [116], "errorMessage": "check self.greeting_box exists"}, {"pc": [69], "errorMessage": "invalid array length header"}, {"pc": [77], "errorMessage": "invalid number of bytes for arc4.dynamic_array<arc4.uint8>"}]}, "clear": {"pcOffsetMethod": "none", "sourceInfo": []}}}"""
...
class HelloWorldParams:
    ...
    def get_last_greeting(
        ...
        return self.app_client.params.call(algokit_utils.AppClientMethodCallParams(**{
            **dataclasses.asdict(params),
            "method": "get_last_greeting()string",
        }))
...
class _BoxState:
    ...
    @property
    def greeting_box(self) -> str:
        """Get the current value of the greeting_box key in box state"""
        value = self.app_client.state.box.get_value("greeting_box")
...
class HelloWorldClient:
    ...
    def decode_return_value(
        self,
        method: typing.Literal["get_last_greeting()string"],
        return_value: algokit_utils.ABIReturn | None
    ) -> str | None: ...
    @typing.overload
    def decode_return_value(
...
class HelloWorldComposer:
    ...
    def get_last_greeting(
        ...
        self._composer.add_app_call_method_call(
            self.client.params.get_last_greeting(
