...
```bash
pip install arc56-generated-satishccy-blockchain-dev-assessment
```
...
from arc56_generated_satishccy_blockchain_dev_assessment import HelloWorld_51166c11

algorand = AlgorandClient.mainnet()
client = HelloWorld_51166c11.HelloWorldClient(
    algorand=algorand,
    app_id=123456789,
)
