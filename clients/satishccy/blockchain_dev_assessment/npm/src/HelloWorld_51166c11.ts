...
export const APP_SPEC: Arc56Contract = {"name":"HelloWorld","structs":{},"methods":[{"name":"hello","args":[{"type":"string","name":"name"}],"returns":{"type":"string"},"actions":{"create":[],"call":["NoOp"]},"readonly":false,"events":[],"recommendations":{}},{"name":"get_last_greeting","args":[],"returns":{"type":"string"},"actions":{"create":[],"call":["NoOp"]},"readonly":true,"events":[],"recommendations":{}}],"arcs":[22,28],"networks":{},"state":{"schema":{"global":{"ints":0,"bytes":0},"local":{"ints":0,"bytes":0}},"keys":{"global":{},"local":{},"box":{"greeting_box":{"keyType":"AVMBytes","valueType":"AVMString","key":"R1JFRVRJTkdfQk9Y"}}},"maps":{"global":{},"local":{},"box":{}}},"bareActions":{"create":["NoOp"],"call":[]},"sourceInfo":{"approval":{"sourceInfo":[{"pc":[116],"errorMessage":"check self.greeting_box exists"},{"pc":[69],"errorMessage":"invalid array length header"},{"pc":[77],"errorMessage":"invalid number of bytes for arc4.dynamic_array<arc4.uint8>"}],"pcOffsetMethod":"none"},"clear":{"sourceInfo":[],"pcOffsetMethod":"none"}},"events":[]} as unknown as Arc56Contract
...
export type HelloWorldArgs = {
  ...
  obj: {
    ...
    'get_last_greeting()string': Record<string, never>
  }
  /**
...
export type HelloWorldReturns = {
  ...
  'get_last_greeting()string': string
}
...
export type HelloWorldTypes = {
  ...
  methods:
    ...
    & Record<'get_last_greeting()string' | 'get_last_greeting', {
      argsObj: HelloWorldArgs['obj']['get_last_greeting()string']
      argsTuple: HelloWorldArgs['tuple']['get_last_greeting()string']
      returns: HelloWorldReturns['get_last_greeting()string']
    }>
  /**
...
export abstract class HelloWorldParamsFactory {
  ...
  /**
   * Constructs a no op call for the get_last_greeting()string ABI method
   *
   * @param params Parameters for the call
   * @returns An `AppClientMethodCallParams` object for the call
   */
  static getLastGreeting(params: CallParams<HelloWorldArgs['obj']['get_last_greeting()string'] | HelloWorldArgs['tuple']['get_last_greeting()string']> & CallOnComplete): AppClientMethodCallParams & CallOnComplete {
    return {
      ...params,
      method: 'get_last_greeting()string' as const,
...
export class HelloWorldClient {
  ...
  readonly params = {
    ...
    /**
     * Makes a call to the HelloWorld smart contract using the `get_last_greeting()string` ABI method.
     * 
     ...
     * @returns The call params
     */
    getLastGreeting: (params: CallParams<HelloWorldArgs['obj']['get_last_greeting()string'] | HelloWorldArgs['tuple']['get_last_greeting()string']> & {onComplete?: OnApplicationComplete.NoOpOC} = {args: []}) => {
      return this.appClient.params.call(HelloWorldParamsFactory.getLastGreeting(params))
    },
  ...
  readonly createTransaction = {
     ...
     */
    getLastGreeting: (params: CallParams<HelloWorldArgs['obj']['get_last_greeting()string'] | HelloWorldArgs['tuple']['get_last_greeting()string']> & {onComplete?: OnApplicationComplete.NoOpOC} = {args: []}) => {
      return this.appClient.createTransaction.call(HelloWorldParamsFactory.getLastGreeting(params))
    },
  ...
  readonly send = {
     ...
     * @returns The call result
     */
    getLastGreeting: async (params: CallParams<HelloWorldArgs['obj']['get_last_greeting()string'] | HelloWorldArgs['tuple']['get_last_greeting()string']> & SendParams & {onComplete?: OnApplicationComplete.NoOpOC} = {args: []}) => {
      const result = await this.appClient.send.call(HelloWorldParamsFactory.getLastGreeting(params))
      return {...result, return: result.return as unknown as (undefined | HelloWorldReturns['get_last_greeting()string'])}
    },
  ...
  /**
   * Makes a readonly (simulated) call to the HelloWorld smart contract using the `get_last_greeting()string` ABI method.
   * 
   * This method is a readonly method; calling it with onComplete of NoOp will result in a simulated transaction rather than a real transaction.
   *
   * @param params The params for the smart contract call
   * @returns The call result
   */
  async getLastGreeting(params: CallParams<HelloWorldArgs['obj']['get_last_greeting()string'] | HelloWorldArgs['tuple']['get_last_greeting()string']> = {args: []}) {
    const result = await this.appClient.send.call(HelloWorldParamsFactory.getLastGreeting(params))
    return result.return as unknown as HelloWorldReturns['get_last_greeting()string']
  }
  ...
  state = {
    ...
    box: {
      ...
      getAll: async (): Promise<Partial<Expand<BoxKeysState>>> => {
        ...
        return {
          greetingBox: result.greeting_box,
        }
      },
      /**
       * Get the current value of the greeting_box key in box state
       */
      greetingBox: async (): Promise<string | undefined> => { return (await this.appClient.state.box.getValue("greeting_box")) as string | undefined },
    },
  }
  ...
  public newGroup(): HelloWorldComposer {
    ...
    return {
      ...
      /**
       * Add a get_last_greeting()string method call against the HelloWorld contract
       */
      getLastGreeting(params: CallParams<HelloWorldArgs['obj']['get_last_greeting()string'] | HelloWorldArgs['tuple']['get_last_greeting()string']> & {onComplete?: OnApplicationComplete.NoOpOC}) {
        promiseChain = promiseChain.then(async () => composer.addAppCallMethodCall(await client.params.getLastGreeting(params)))
        resultMappers.push((v) => client.decodeReturnValue('get_last_greeting()string', v))
        return this
      },
      /**
...
export type HelloWorldComposer<TReturns extends [...any[]] = []> = {
  ...
  /**
   * Calls the get_last_greeting()string ABI method.
   *
   * @param args The arguments for the contract call
   * @param params Any additional parameters for the call
   * @returns The typed transaction composer so you can fluently chain multiple calls or call execute to execute all queued up transactions
   */
  getLastGreeting(params?: CallParams<HelloWorldArgs['obj']['get_last_greeting()string'] | HelloWorldArgs['tuple']['get_last_greeting()string']>): HelloWorldComposer<[...TReturns, HelloWorldReturns['get_last_greeting()string'] | undefined]>
