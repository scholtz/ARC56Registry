...
```bash
pip install arc56-generated-satishccy-asa-arc-62-upgrader
```
...
from arc56_generated_satishccy_asa_arc_62_upgrader import CirculatingSupply_8508983c

algorand = AlgorandClient.mainnet()
client = CirculatingSupply_8508983c.CirculatingSupplyClient(
    algorand=algorand,
    app_id=123456789,
)
