...
```bash
npm install arc56-generated-satishccy-asa-arc-62-upgrader @algorandfoundation/algokit-utils algosdk
```
...
import { CirculatingSupply_8508983c } from "arc56-generated-satishccy-asa-arc-62-upgrader";

const algorand = AlgorandClient.mainNet();
const client = new CirculatingSupply_8508983c.CirculatingSupplyClient({
  algorand,
  appId: 123456789n,
});
