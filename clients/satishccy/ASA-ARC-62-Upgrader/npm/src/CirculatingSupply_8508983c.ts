...
export class CirculatingSupplyClient {
  ...
  state = {
    ...
    global: {
       ...
       */
      notCirculatingLabel_1: async (): Promise<string | undefined> => { return (await this.appClient.state.global.getValue("not_circulating_label_1")) as string | undefined },
      /**
       * Get the current value of the not_circulating_label_2 key in global state
       */
      notCirculatingLabel_2: async (): Promise<string | undefined> => { return (await this.appClient.state.global.getValue("not_circulating_label_2")) as string | undefined },
      /**
       * Get the current value of the not_circulating_label_3 key in global state
       */
      notCirculatingLabel_3: async (): Promise<string | undefined> => { return (await this.appClient.state.global.getValue("not_circulating_label_3")) as string | undefined },
    },
  }
