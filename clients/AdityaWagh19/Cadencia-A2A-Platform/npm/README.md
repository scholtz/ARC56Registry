...
```bash
npm install arc56-generated-adityawagh19-cadencia-a2a-platform @algorandfoundation/algokit-utils algosdk
```
...
import { ContractName_hash } from "arc56-generated-adityawagh19-cadencia-a2a-platform";
