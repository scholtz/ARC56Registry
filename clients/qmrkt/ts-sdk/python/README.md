...
```bash
pip install arc56-generated-qmrkt-ts-sdk
```
...
from arc56_generated_qmrkt_ts_sdk import MarketFactory_e688c11b

algorand = AlgorandClient.mainnet()
client = MarketFactory_e688c11b.MarketFactoryClient(
    algorand=algorand,
    app_id=123456789,
)
