...
```bash
pip install arc56-generated-qmrkt-contracts
```
...
from arc56_generated_qmrkt_contracts import MarketFactory_b54b6f78

algorand = AlgorandClient.mainnet()
client = MarketFactory_b54b6f78.MarketFactoryClient(
    algorand=algorand,
    app_id=123456789,
)
