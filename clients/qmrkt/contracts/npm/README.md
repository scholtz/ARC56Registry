...
```bash
npm install arc56-generated-qmrkt-contracts @algorandfoundation/algokit-utils algosdk
```
...
import { MarketFactory_b54b6f78 } from "arc56-generated-qmrkt-contracts";

const algorand = AlgorandClient.mainNet();
const client = new MarketFactory_b54b6f78.MarketFactoryClient({
  algorand,
  appId: 123456789n,
});
...
| --- | --- | --- |
| `MarketFactory_b54b6f78` | `MarketFactoryClient` | [https://raw.githubusercontent.com/qmrkt/contracts/HEAD/smart_contracts/artifacts/market_factory/MarketFactory.arc56.json](https://raw.githubusercontent.com/qmrkt/contracts/HEAD/smart_contracts/artifacts/market_factory/MarketFactory.arc56.json) |
| `ProtocolConfig_39f385e6` | `ProtocolConfigClient` | [https://raw.githubusercontent.com/qmrkt/contracts/HEAD/smart_contracts/artifacts/protocol_config/ProtocolConfig.arc56.json](https://raw.githubusercontent.com/qmrkt/contracts/HEAD/smart_contracts/artifacts/protocol_config/ProtocolConfig.arc56.json) |
