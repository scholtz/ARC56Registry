...
```bash
npm install arc56-generated-tycots-voivotingv-2 @algorandfoundation/algokit-utils algosdk
```
...
import { VoiGovernance_aed8ea64 } from "arc56-generated-tycots-voivotingv-2";

const algorand = AlgorandClient.mainNet();
const client = new VoiGovernance_aed8ea64.VoiGovernanceClient({
  algorand,
  appId: 123456789n,
});
...
| --- | --- | --- |
| `VoiGovernance_aed8ea64` | `VoiGovernanceClient` | [https://raw.githubusercontent.com/Tycots/VoiVotingV.2/HEAD/VoiGovernance/build/VoiGovernance/VoiGovernance.arc56.json](https://raw.githubusercontent.com/Tycots/VoiVotingV.2/HEAD/VoiGovernance/build/VoiGovernance/VoiGovernance.arc56.json) |
