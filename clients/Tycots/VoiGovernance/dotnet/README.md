# Arc56.Generated.Tycots.VoiGovernance

Auto-generated typed Algorand smart-contract clients for **[Tycots/VoiGovernance](https://github.com/Tycots/VoiGovernance)**,
...
```bash
dotnet add package Arc56.Generated.Tycots.VoiGovernance
```
