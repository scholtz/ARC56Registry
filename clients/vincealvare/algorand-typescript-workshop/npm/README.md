...
```bash
npm install arc56-generated-vincealvare-algorand-typescript-workshop @algorandfoundation/algokit-utils algosdk
```
...
import { PersonalBank_77a3fab3 } from "arc56-generated-vincealvare-algorand-typescript-workshop";

const algorand = AlgorandClient.mainNet();
const client = new PersonalBank_77a3fab3.PersonalBankClient({
  algorand,
  appId: 123456789n,
});
