...
```bash
pip install arc56-generated-vincealvare-algorand-typescript-workshop
```
...
from arc56_generated_vincealvare_algorand_typescript_workshop import PersonalBank_77a3fab3

algorand = AlgorandClient.mainnet()
client = PersonalBank_77a3fab3.PersonalBankClient(
    algorand=algorand,
    app_id=123456789,
)
