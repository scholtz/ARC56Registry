...
```bash
npm install arc56-generated-dysenterycrypto-staking @algorandfoundation/algokit-utils algosdk
```
...
import { ASAStakingContract_5e56f62b } from "arc56-generated-dysenterycrypto-staking";

const algorand = AlgorandClient.mainNet();
const client = new ASAStakingContract_5e56f62b.AsaStakingContractClient({
  algorand,
  appId: 123456789n,
});
