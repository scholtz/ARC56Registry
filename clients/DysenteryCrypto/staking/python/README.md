...
```bash
pip install arc56-generated-dysenterycrypto-staking
```
...
from arc56_generated_dysenterycrypto_staking import ASAStakingContract_5e56f62b

algorand = AlgorandClient.mainnet()
client = ASAStakingContract_5e56f62b.AsaStakingContractClient(
    algorand=algorand,
    app_id=123456789,
)
