...
```bash
pip install arc56-generated-adityanik-algoswap
```
...
from arc56_generated_adityanik_algoswap import AMMContract_83c9aedb

algorand = AlgorandClient.mainnet()
client = AMMContract_83c9aedb.AmmContractClient(
    algorand=algorand,
    app_id=123456789,
)
