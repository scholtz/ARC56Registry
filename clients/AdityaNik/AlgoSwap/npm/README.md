...
```bash
npm install arc56-generated-adityanik-algoswap @algorandfoundation/algokit-utils algosdk
```
...
import { AMMContract_83c9aedb } from "arc56-generated-adityanik-algoswap";

const algorand = AlgorandClient.mainNet();
const client = new AMMContract_83c9aedb.AmmContractClient({
  algorand,
  appId: 123456789n,
});
