...
```bash
pip install arc56-generated-uroojchaudhary-algorand-typescript-workshop-submission
```
...
from arc56_generated_uroojchaudhary_algorand_typescript_workshop_submission import PersonalBank_b237e3ef

algorand = AlgorandClient.mainnet()
client = PersonalBank_b237e3ef.PersonalBankClient(
    algorand=algorand,
    app_id=123456789,
)
