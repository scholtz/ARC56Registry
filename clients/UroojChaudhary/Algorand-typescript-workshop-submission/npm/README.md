...
```bash
npm install arc56-generated-uroojchaudhary-algorand-typescript-workshop-submission @algorandfoundation/algokit-utils algosdk
```
...
import { PersonalBank_b237e3ef } from "arc56-generated-uroojchaudhary-algorand-typescript-workshop-submission";

const algorand = AlgorandClient.mainNet();
const client = new PersonalBank_b237e3ef.PersonalBankClient({
  algorand,
  appId: 123456789n,
});
