...
```bash
npm install arc56-generated-atsoc1993-on-chain-petitions-v2 @algorandfoundation/algokit-utils algosdk
```
...
import { Petition_f12fa825 } from "arc56-generated-atsoc1993-on-chain-petitions-v2";

const algorand = AlgorandClient.mainNet();
const client = new Petition_f12fa825.PetitionClient({
  algorand,
  appId: 123456789n,
});
