...
```bash
pip install arc56-generated-atsoc1993-on-chain-petitions-v2
```
...
from arc56_generated_atsoc1993_on_chain_petitions_v2 import Petition_f12fa825

algorand = AlgorandClient.mainnet()
client = Petition_f12fa825.PetitionClient(
    algorand=algorand,
    app_id=123456789,
)
