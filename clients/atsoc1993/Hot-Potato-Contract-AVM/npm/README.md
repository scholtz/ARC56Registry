...
```bash
npm install arc56-generated-atsoc1993-hot-potato-contract-avm @algorandfoundation/algokit-utils algosdk
```
...
import { AlgoPotato_90bbe12c } from "arc56-generated-atsoc1993-hot-potato-contract-avm";

const algorand = AlgorandClient.mainNet();
const client = new AlgoPotato_90bbe12c.AlgoPotatoClient({
  algorand,
  appId: 123456789n,
});
...
| --- | --- | --- |
| `AlgoPotato_90bbe12c` | `AlgoPotatoClient` | [https://raw.githubusercontent.com/atsoc1993/Hot-Potato-Contract-AVM/HEAD/AlgoPotato.arc56.json](https://raw.githubusercontent.com/atsoc1993/Hot-Potato-Contract-AVM/HEAD/AlgoPotato.arc56.json) |
