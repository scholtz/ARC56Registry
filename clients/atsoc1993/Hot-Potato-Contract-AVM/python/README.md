...
```bash
pip install arc56-generated-atsoc1993-hot-potato-contract-avm
```
...
from arc56_generated_atsoc1993_hot_potato_contract_avm import AlgoPotato_90bbe12c

algorand = AlgorandClient.mainnet()
client = AlgoPotato_90bbe12c.AlgoPotatoClient(
    algorand=algorand,
    app_id=123456789,
)
