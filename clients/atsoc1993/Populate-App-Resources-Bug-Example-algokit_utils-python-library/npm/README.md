...
```bash
npm install arc56-generated-atsoc1993-populate-app-resources-bug-example-algokit-utils-python-library @algorandfoundation/algokit-utils algosdk
```
...
import { TestPopResources_95a87b69 } from "arc56-generated-atsoc1993-populate-app-resources-bug-example-algokit-utils-python-library";

const algorand = AlgorandClient.mainNet();
const client = new TestPopResources_95a87b69.TestPopResourcesClient({
  algorand,
  appId: 123456789n,
});
