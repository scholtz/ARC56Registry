...
```bash
npm install arc56-generated-eggsleggs-algobounty @algorandfoundation/algokit-utils algosdk
```
...
import { BountyEscrow_b97dfcf7 } from "arc56-generated-eggsleggs-algobounty";

const algorand = AlgorandClient.mainNet();
const client = new BountyEscrow_b97dfcf7.BountyEscrowClient({
  algorand,
  appId: 123456789n,
});
