...
```bash
pip install arc56-generated-eggsleggs-algobounty
```
...
from arc56_generated_eggsleggs_algobounty import BountyEscrow_b97dfcf7

algorand = AlgorandClient.mainnet()
client = BountyEscrow_b97dfcf7.BountyEscrowClient(
    algorand=algorand,
    app_id=123456789,
)
