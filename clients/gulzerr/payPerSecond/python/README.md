...
```bash
pip install arc56-generated-gulzerr-paypersecond
```
...
from arc56_generated_gulzerr_paypersecond import TapToStream_b2aebc82

algorand = AlgorandClient.mainnet()
client = TapToStream_b2aebc82.TapToStreamClient(
    algorand=algorand,
    app_id=123456789,
)
