...
```bash
npm install arc56-generated-gulzerr-paypersecond @algorandfoundation/algokit-utils algosdk
```
...
import { TapToStream_b2aebc82 } from "arc56-generated-gulzerr-paypersecond";

const algorand = AlgorandClient.mainNet();
const client = new TapToStream_b2aebc82.TapToStreamClient({
  algorand,
  appId: 123456789n,
});
