...
```bash
pip install arc56-generated-abdorhl-algorand-blockchain-testing
```
...
from arc56_generated_abdorhl_algorand_blockchain_testing import HelloWorld_236b33ae

algorand = AlgorandClient.mainnet()
client = HelloWorld_236b33ae.HelloWorldClient(
    algorand=algorand,
    app_id=123456789,
)
