...
```bash
pip install arc56-generated-musabyk-ownershiptransfer
```
...
from arc56_generated_musabyk_ownershiptransfer import OwnershipTransfer_6322dfb3

algorand = AlgorandClient.mainnet()
client = OwnershipTransfer_6322dfb3.OwnershipTransferClient(
    algorand=algorand,
    app_id=123456789,
)
