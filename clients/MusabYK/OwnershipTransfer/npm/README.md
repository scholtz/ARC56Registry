...
```bash
npm install arc56-generated-musabyk-ownershiptransfer @algorandfoundation/algokit-utils algosdk
```
...
import { OwnershipTransfer_6322dfb3 } from "arc56-generated-musabyk-ownershiptransfer";

const algorand = AlgorandClient.mainNet();
const client = new OwnershipTransfer_6322dfb3.OwnershipTransferClient({
  algorand,
  appId: 123456789n,
});
