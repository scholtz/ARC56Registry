...
```bash
npm install arc56-generated-prasanna-kuracha-fractalvault @algorandfoundation/algokit-utils algosdk
```
...
import { PropertyRegistry_e04c0649 } from "arc56-generated-prasanna-kuracha-fractalvault";

const algorand = AlgorandClient.mainNet();
const client = new PropertyRegistry_e04c0649.PropertyRegistryClient({
  algorand,
  appId: 123456789n,
});
