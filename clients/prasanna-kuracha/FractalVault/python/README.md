...
```bash
pip install arc56-generated-prasanna-kuracha-fractalvault
```
...
from arc56_generated_prasanna_kuracha_fractalvault import PropertyRegistry_e04c0649

algorand = AlgorandClient.mainnet()
client = PropertyRegistry_e04c0649.PropertyRegistryClient(
    algorand=algorand,
    app_id=123456789,
)
