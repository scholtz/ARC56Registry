...
```bash
pip install arc56-generated-algorand-devrel-algorand-typescript-workshop
```
...
from arc56_generated_algorand_devrel_algorand_typescript_workshop import PersonalBank_6ca10977

algorand = AlgorandClient.mainnet()
client = PersonalBank_6ca10977.PersonalBankClient(
    algorand=algorand,
    app_id=123456789,
)
