...
```bash
pip install arc56-generated-algorand-devrel-fractional-realestate-ts
```
...
from arc56_generated_algorand_devrel_fractional_realestate_ts import FractionalRealEstate_78ba7f7d

algorand = AlgorandClient.mainnet()
client = FractionalRealEstate_78ba7f7d.FractionalRealEstateClient(
    algorand=algorand,
    app_id=123456789,
)
