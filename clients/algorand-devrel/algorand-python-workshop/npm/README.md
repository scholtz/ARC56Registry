...
```bash
npm install arc56-generated-algorand-devrel-algorand-python-workshop @algorandfoundation/algokit-utils algosdk
```
...
import { PersonalBank_58208c3c } from "arc56-generated-algorand-devrel-algorand-python-workshop";

const algorand = AlgorandClient.mainNet();
const client = new PersonalBank_58208c3c.PersonalBankClient({
  algorand,
  appId: 123456789n,
});
