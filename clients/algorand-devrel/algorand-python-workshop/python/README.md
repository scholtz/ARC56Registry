...
```bash
pip install arc56-generated-algorand-devrel-algorand-python-workshop
```
...
from arc56_generated_algorand_devrel_algorand_python_workshop import PersonalBank_58208c3c

algorand = AlgorandClient.mainnet()
client = PersonalBank_58208c3c.PersonalBankClient(
    algorand=algorand,
    app_id=123456789,
)
