...
```bash
pip install arc56-generated-blockmaker-ai-algorand-soft-staking
```
...
from arc56_generated_blockmaker_ai_algorand_soft_staking import StakingPool_e8fea172

algorand = AlgorandClient.mainnet()
client = StakingPool_e8fea172.StakingPoolClient(
    algorand=algorand,
    app_id=123456789,
)
