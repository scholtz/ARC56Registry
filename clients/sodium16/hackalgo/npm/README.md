...
```bash
npm install arc56-generated-sodium16-hackalgo @algorandfoundation/algokit-utils algosdk
```
...
import { Algomint_16706bd0 } from "arc56-generated-sodium16-hackalgo";

const algorand = AlgorandClient.mainNet();
const client = new Algomint_16706bd0.AlgomintClient({
  algorand,
  appId: 123456789n,
});
