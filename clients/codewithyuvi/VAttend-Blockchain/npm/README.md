...
```bash
npm install arc56-generated-codewithyuvi-vattend-blockchain @algorandfoundation/algokit-utils algosdk
```
...
import { AttendenceTracker_030235b2 } from "arc56-generated-codewithyuvi-vattend-blockchain";

const algorand = AlgorandClient.mainNet();
const client = new AttendenceTracker_030235b2.AttendenceTrackerClient({
  algorand,
  appId: 123456789n,
});
