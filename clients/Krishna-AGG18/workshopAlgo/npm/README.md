...
```bash
npm install arc56-generated-krishna-agg18-workshopalgo @algorandfoundation/algokit-utils algosdk
```
...
import { HelloWorld_52a310ae } from "arc56-generated-krishna-agg18-workshopalgo";

const algorand = AlgorandClient.mainNet();
const client = new HelloWorld_52a310ae.HelloWorldClient({
  algorand,
  appId: 123456789n,
});
