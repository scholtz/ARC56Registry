...
```bash
pip install arc56-generated-krishna-agg18-workshopalgo
```
...
from arc56_generated_krishna_agg18_workshopalgo import HelloWorld_52a310ae

algorand = AlgorandClient.mainnet()
client = HelloWorld_52a310ae.HelloWorldClient(
    algorand=algorand,
    app_id=123456789,
)
