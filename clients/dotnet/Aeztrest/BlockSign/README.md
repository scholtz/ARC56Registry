# Arc56.Generated.Aeztrest.BlockSign

Auto-generated typed Algorand smart-contract clients for **[Aeztrest/BlockSign](https://github.com/Aeztrest/BlockSign)**,
...
```bash
dotnet add package Arc56.Generated.Aeztrest.BlockSign
```
