# Arc56.Generated.jvanyom.demochain

Auto-generated typed Algorand smart-contract clients for **[jvanyom/demochain](https://github.com/jvanyom/demochain)**,
...
```bash
dotnet add package Arc56.Generated.jvanyom.demochain
```
...
using Arc56.Generated.jvanyom.demochain.Demochain_d81a46aa;

var algod = new DefaultApi(httpClient); // configure with your algod endpoint
var client = new DemochainProxy(algod, appId: 123456789);
...
| --- | --- | --- |
| `Arc56.Generated.jvanyom.demochain.Demochain_d81a46aa` | `DemochainProxy` | [https://raw.githubusercontent.com/jvanyom/demochain/HEAD/client/src/algorand/Demochain.arc56.json](https://raw.githubusercontent.com/jvanyom/demochain/HEAD/client/src/algorand/Demochain.arc56.json) |
