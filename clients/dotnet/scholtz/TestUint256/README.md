...
```bash
dotnet add package Arc56.Generated.scholtz.TestUint256
```
...
using Arc56.Generated.scholtz.TestUint256.TestUint_792cb349;

var algod = new DefaultApi(httpClient); // configure with your algod endpoint
var client = new TestUintProxy(algod, appId: 123456789);
...
| --- | --- | --- |
| `Arc56.Generated.scholtz.TestUint256.TestUint_792cb349` | `TestUintProxy` | [https://raw.githubusercontent.com/scholtz/TestUint256/HEAD/projects/TestUint256/smart_contracts/artifacts/test_uint/TestUint.arc56.json](https://raw.githubusercontent.com/scholtz/TestUint256/HEAD/projects/TestUint256/smart_contracts/artifacts/test_uint/TestUint.arc56.json) |
