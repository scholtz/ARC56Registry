...
```bash
npm install arc56-generated-ajboni-algorand-typescript-workshop @algorandfoundation/algokit-utils algosdk
```
...
import { PersonalBank_c6363f86 } from "arc56-generated-ajboni-algorand-typescript-workshop";

const algorand = AlgorandClient.mainNet();
const client = new PersonalBank_c6363f86.PersonalBankClient({
  algorand,
  appId: 123456789n,
});
