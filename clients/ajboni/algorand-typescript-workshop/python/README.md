...
```bash
pip install arc56-generated-ajboni-algorand-typescript-workshop
```
...
from arc56_generated_ajboni_algorand_typescript_workshop import PersonalBank_c6363f86

algorand = AlgorandClient.mainnet()
client = PersonalBank_c6363f86.PersonalBankClient(
    algorand=algorand,
    app_id=123456789,
)
