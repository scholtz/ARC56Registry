...
class _BoxState:
    ...
    @property
    def github_box(self) -> str:
        """Get the current value of the githubBox key in box state"""
        value = self.app_client.state.box.get_value("githubBox")
