...
```bash
npm install arc56-generated-ganainmtech-algorand-dapp-quick-start-template-typescript @algorandfoundation/algokit-utils algosdk
```
...
import { HelloWorld_4e3f05e8 } from "arc56-generated-ganainmtech-algorand-dapp-quick-start-template-typescript";

const algorand = AlgorandClient.mainNet();
const client = new HelloWorld_4e3f05e8.HelloWorldClient({
  algorand,
  appId: 123456789n,
});
