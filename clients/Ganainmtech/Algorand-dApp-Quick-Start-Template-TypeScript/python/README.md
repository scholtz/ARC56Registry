...
```bash
pip install arc56-generated-ganainmtech-algorand-dapp-quick-start-template-typescript
```
...
from arc56_generated_ganainmtech_algorand_dapp_quick_start_template_typescript import HelloWorld_4e3f05e8

algorand = AlgorandClient.mainnet()
client = HelloWorld_4e3f05e8.HelloWorldClient(
    algorand=algorand,
    app_id=123456789,
)
