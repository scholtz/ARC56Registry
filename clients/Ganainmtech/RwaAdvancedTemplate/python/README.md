...
```bash
pip install arc56-generated-ganainmtech-rwaadvancedtemplate
```
...
from arc56_generated_ganainmtech_rwaadvancedtemplate import HelloWorld_0a19044e

algorand = AlgorandClient.mainnet()
client = HelloWorld_0a19044e.HelloWorldClient(
    algorand=algorand,
    app_id=123456789,
)
