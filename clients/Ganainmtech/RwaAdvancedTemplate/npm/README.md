...
```bash
npm install arc56-generated-ganainmtech-rwaadvancedtemplate @algorandfoundation/algokit-utils algosdk
```
...
import { HelloWorld_0a19044e } from "arc56-generated-ganainmtech-rwaadvancedtemplate";

const algorand = AlgorandClient.mainNet();
const client = new HelloWorld_0a19044e.HelloWorldClient({
  algorand,
  appId: 123456789n,
});
