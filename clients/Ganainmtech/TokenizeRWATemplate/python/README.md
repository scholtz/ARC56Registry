...
```bash
pip install arc56-generated-ganainmtech-tokenizerwatemplate
```
...
from arc56_generated_ganainmtech_tokenizerwatemplate import HelloWorld_776d5c13

algorand = AlgorandClient.mainnet()
client = HelloWorld_776d5c13.HelloWorldClient(
    algorand=algorand,
    app_id=123456789,
)
