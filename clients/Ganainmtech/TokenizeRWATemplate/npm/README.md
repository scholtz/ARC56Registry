...
```bash
npm install arc56-generated-ganainmtech-tokenizerwatemplate @algorandfoundation/algokit-utils algosdk
```
...
import { HelloWorld_776d5c13 } from "arc56-generated-ganainmtech-tokenizerwatemplate";

const algorand = AlgorandClient.mainNet();
const client = new HelloWorld_776d5c13.HelloWorldClient({
  algorand,
  appId: 123456789n,
});
