...
```bash
npm install arc56-generated-shivajijamadar-hackspiration @algorandfoundation/algokit-utils algosdk
```
...
import { ScholarStream_9b4a544d } from "arc56-generated-shivajijamadar-hackspiration";

const algorand = AlgorandClient.mainNet();
const client = new ScholarStream_9b4a544d.ScholarStreamClient({
  algorand,
  appId: 123456789n,
});
...
| --- | --- | --- |
| `ScholarStream_9b4a544d` | `ScholarStreamClient` | [https://raw.githubusercontent.com/SHIVAJIJAMADAR/Hackspiration/HEAD/scholar-frontend/src/contracts/ScholarStream.arc56.json](https://raw.githubusercontent.com/SHIVAJIJAMADAR/Hackspiration/HEAD/scholar-frontend/src/contracts/ScholarStream.arc56.json) |
