...
```bash
pip install arc56-generated-shivajijamadar-hackspiration
```
...
from arc56_generated_shivajijamadar_hackspiration import ScholarStream_9b4a544d

algorand = AlgorandClient.mainnet()
client = ScholarStream_9b4a544d.ScholarStreamClient(
    algorand=algorand,
    app_id=123456789,
)
