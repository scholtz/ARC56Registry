...
```bash
pip install arc56-generated-lakshmihasini-sai-ram
```
...
from arc56_generated_lakshmihasini_sai_ram import CampusVoting_354b687f

algorand = AlgorandClient.mainnet()
client = CampusVoting_354b687f.CampusVotingClient(
    algorand=algorand,
    app_id=123456789,
)
