...
```bash
pip install arc56-generated-nautilusoss-algovoi
```
...
from arc56_generated_nautilusoss_algovoi import SpendingCapVault_0325c2ba

algorand = AlgorandClient.mainnet()
client = SpendingCapVault_0325c2ba.SpendingCapVaultClient(
    algorand=algorand,
    app_id=123456789,
)
