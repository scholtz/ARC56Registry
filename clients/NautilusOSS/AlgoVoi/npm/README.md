...
```bash
npm install arc56-generated-nautilusoss-algovoi @algorandfoundation/algokit-utils algosdk
```
...
import { SpendingCapVault_0325c2ba } from "arc56-generated-nautilusoss-algovoi";

const algorand = AlgorandClient.mainNet();
const client = new SpendingCapVault_0325c2ba.SpendingCapVaultClient({
  algorand,
  appId: 123456789n,
});
...
| --- | --- | --- |
| `SpendingCapVault_0325c2ba` | `SpendingCapVaultClient` | [https://raw.githubusercontent.com/NautilusOSS/AlgoVoi/HEAD/contracts/SpendingCapVault.arc56.json](https://raw.githubusercontent.com/NautilusOSS/AlgoVoi/HEAD/contracts/SpendingCapVault.arc56.json) |
