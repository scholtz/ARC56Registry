...
```bash
pip install arc56-generated-txnlab-nfd-sdk
```
...
from arc56_generated_txnlab_nfd_sdk import NFDInstance_9b7fcf89

algorand = AlgorandClient.mainnet()
client = NFDInstance_9b7fcf89.NfdInstanceClient(
    algorand=algorand,
    app_id=123456789,
)
