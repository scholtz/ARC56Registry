...
```bash
npm install arc56-generated-txnlab-nfd-sdk @algorandfoundation/algokit-utils algosdk
```
...
import { NFDInstance_9b7fcf89 } from "arc56-generated-txnlab-nfd-sdk";

const algorand = AlgorandClient.mainNet();
const client = new NFDInstance_9b7fcf89.NfdInstanceClient({
  algorand,
  appId: 123456789n,
});
