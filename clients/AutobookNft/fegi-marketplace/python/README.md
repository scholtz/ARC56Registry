...
```bash
pip install arc56-generated-autobooknft-fegi-marketplace
```
...
from arc56_generated_autobooknft_fegi_marketplace import HelloWorld_0f2da4c3

algorand = AlgorandClient.mainnet()
client = HelloWorld_0f2da4c3.HelloWorldClient(
    algorand=algorand,
    app_id=123456789,
)
