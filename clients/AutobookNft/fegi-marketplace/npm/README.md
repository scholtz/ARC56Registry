...
```bash
npm install arc56-generated-autobooknft-fegi-marketplace @algorandfoundation/algokit-utils algosdk
```
...
import { HelloWorld_0f2da4c3 } from "arc56-generated-autobooknft-fegi-marketplace";

const algorand = AlgorandClient.mainNet();
const client = new HelloWorld_0f2da4c3.HelloWorldClient({
  algorand,
  appId: 123456789n,
});
