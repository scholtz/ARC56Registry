...
```bash
pip install arc56-generated-corvidlabs-flock-directory-contract
```
...
from arc56_generated_corvidlabs_flock_directory_contract import FlockDirectory_d15ead8d

algorand = AlgorandClient.mainnet()
client = FlockDirectory_d15ead8d.FlockDirectoryClient(
    algorand=algorand,
    app_id=123456789,
)
