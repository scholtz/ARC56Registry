...
```bash
npm install arc56-generated-corvidlabs-flock-directory-contract @algorandfoundation/algokit-utils algosdk
```
...
import { FlockDirectory_d15ead8d } from "arc56-generated-corvidlabs-flock-directory-contract";

const algorand = AlgorandClient.mainNet();
const client = new FlockDirectory_d15ead8d.FlockDirectoryClient({
  algorand,
  appId: 123456789n,
});
...
| --- | --- | --- |
| `FlockDirectory_d15ead8d` | `FlockDirectoryClient` | [https://raw.githubusercontent.com/CorvidLabs/flock-directory-contract/HEAD/artifacts/FlockDirectory.arc56.json](https://raw.githubusercontent.com/CorvidLabs/flock-directory-contract/HEAD/artifacts/FlockDirectory.arc56.json) |
