# Arc56.Generated.CorvidLabs.arcui

Auto-generated typed Algorand smart-contract clients for **[CorvidLabs/arcui](https://github.com/CorvidLabs/arcui)**,
...
```bash
dotnet add package Arc56.Generated.CorvidLabs.arcui
```
