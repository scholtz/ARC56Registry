...
```bash
pip install arc56-generated-prasun151-certichain
```
...
from arc56_generated_prasun151_certichain import CredentialVerifier_98517b28

algorand = AlgorandClient.mainnet()
client = CredentialVerifier_98517b28.CredentialVerifierClient(
    algorand=algorand,
    app_id=123456789,
)
