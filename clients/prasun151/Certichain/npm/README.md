...
```bash
npm install arc56-generated-prasun151-certichain @algorandfoundation/algokit-utils algosdk
```
...
import { CredentialVerifier_98517b28 } from "arc56-generated-prasun151-certichain";

const algorand = AlgorandClient.mainNet();
const client = new CredentialVerifier_98517b28.CredentialVerifierClient({
  algorand,
  appId: 123456789n,
});
