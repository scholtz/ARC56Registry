...
```bash
pip install arc56-generated-jayaveerr-ipfs-algorand-student-certificate-nft-system
```
...
from arc56_generated_jayaveerr_ipfs_algorand_student_certificate_nft_system import Student_c6341a2b

algorand = AlgorandClient.mainnet()
client = Student_c6341a2b.StudentClient(
    algorand=algorand,
    app_id=123456789,
)
