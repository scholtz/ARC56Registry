...
```bash
npm install arc56-generated-jayaveerr-ipfs-algorand-student-certificate-nft-system @algorandfoundation/algokit-utils algosdk
```
...
import { Student_c6341a2b } from "arc56-generated-jayaveerr-ipfs-algorand-student-certificate-nft-system";

const algorand = AlgorandClient.mainNet();
const client = new Student_c6341a2b.StudentClient({
  algorand,
  appId: 123456789n,
});
