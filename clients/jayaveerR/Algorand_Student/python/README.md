...
```bash
pip install arc56-generated-jayaveerr-algorand-student
```
...
from arc56_generated_jayaveerr_algorand_student import Student_6fa68a37

algorand = AlgorandClient.mainnet()
client = Student_6fa68a37.StudentClient(
    algorand=algorand,
    app_id=123456789,
)
