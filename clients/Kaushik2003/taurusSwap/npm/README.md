...
```bash
npm install arc56-generated-kaushik2003-taurusswap @algorandfoundation/algokit-utils algosdk
```
...
import { OrbitalPool_7e7ced89 } from "arc56-generated-kaushik2003-taurusswap";

const algorand = AlgorandClient.mainNet();
const client = new OrbitalPool_7e7ced89.OrbitalPoolClient({
  algorand,
  appId: 123456789n,
});
