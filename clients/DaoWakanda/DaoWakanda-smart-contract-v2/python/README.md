...
```bash
pip install arc56-generated-daowakanda-daowakanda-smart-contract-v2
```
...
from arc56_generated_daowakanda_daowakanda_smart_contract_v2 import Bounty_619a29e1

algorand = AlgorandClient.mainnet()
client = Bounty_619a29e1.BountyClient(
    algorand=algorand,
    app_id=123456789,
)
