...
```bash
npm install arc56-generated-daowakanda-daowakanda-smart-contract-v2 @algorandfoundation/algokit-utils algosdk
```
...
import { Bounty_619a29e1 } from "arc56-generated-daowakanda-daowakanda-smart-contract-v2";

const algorand = AlgorandClient.mainNet();
const client = new Bounty_619a29e1.BountyClient({
  algorand,
  appId: 123456789n,
});
