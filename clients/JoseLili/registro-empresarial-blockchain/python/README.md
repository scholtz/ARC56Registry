...
```bash
pip install arc56-generated-joselili-registro-empresarial-blockchain
```
...
from arc56_generated_joselili_registro_empresarial_blockchain import RegistroEmpresarial_a1e559cd

algorand = AlgorandClient.mainnet()
client = RegistroEmpresarial_a1e559cd.RegistroEmpresarialClient(
    algorand=algorand,
    app_id=123456789,
)
