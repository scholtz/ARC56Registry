...
```bash
npm install arc56-generated-joselili-registro-empresarial-blockchain @algorandfoundation/algokit-utils algosdk
```
...
import { RegistroEmpresarial_a1e559cd } from "arc56-generated-joselili-registro-empresarial-blockchain";

const algorand = AlgorandClient.mainNet();
const client = new RegistroEmpresarial_a1e559cd.RegistroEmpresarialClient({
  algorand,
  appId: 123456789n,
});
