...
```bash
pip install arc56-generated-zainab-06-p-citadel
```
...
from arc56_generated_zainab_06_p_citadel import Bank_3ee23fc1

algorand = AlgorandClient.mainnet()
client = Bank_3ee23fc1.BankClient(
    algorand=algorand,
    app_id=123456789,
)
