...
```bash
pip install arc56-generated-gegetxt-algorand
```
...
from arc56_generated_gegetxt_algorand import HelloWorld_66b1cd42

algorand = AlgorandClient.mainnet()
client = HelloWorld_66b1cd42.HelloWorldClient(
    algorand=algorand,
    app_id=123456789,
)
