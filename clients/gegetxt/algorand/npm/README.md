...
```bash
npm install arc56-generated-gegetxt-algorand @algorandfoundation/algokit-utils algosdk
```
...
import { HelloWorld_66b1cd42 } from "arc56-generated-gegetxt-algorand";

const algorand = AlgorandClient.mainNet();
const client = new HelloWorld_66b1cd42.HelloWorldClient({
  algorand,
  appId: 123456789n,
});
