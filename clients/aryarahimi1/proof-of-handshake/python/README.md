...
```bash
pip install arc56-generated-aryarahimi1-proof-of-handshake
```
...
from arc56_generated_aryarahimi1_proof_of_handshake import HandshakeContract_b06dfc88

algorand = AlgorandClient.mainnet()
client = HandshakeContract_b06dfc88.HandshakeContractClient(
    algorand=algorand,
    app_id=123456789,
)
