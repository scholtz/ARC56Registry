...
class VerifyArgs:
    ...
    @property
    def abi_method_signature(self) -> str:
        return "verify(uint64,byte[])bool"


class TrustAnchorParams:
    ...
    def verify(
        self,
        args: tuple[int, bytes | str] | VerifyArgs,
        params: algokit_utils.CommonAppCallParams | None = None
    ) -> algokit_utils.AppCallMethodCallParams:
        method_args = _parse_abi_args(args)
        params = params or algokit_utils.CommonAppCallParams()
        return self.app_client.params.call(algokit_utils.AppClientMethodCallParams(**{
            **dataclasses.asdict(params),
            "method": "verify(uint64,byte[])bool",
            "args": method_args,
        }))
...
class TrustAnchorCreateTransactionParams:
    def __init__(self, app_client: algokit_utils.AppClient):
        self.app_client = app_client
...
class TrustAnchorClient:
    ...
    def __init__(
        ...
        *,
        ...
        self.params = TrustAnchorParams(self.app_client)
        self.create_transaction = TrustAnchorCreateTransactionParams(self.app_client)
        self.send = TrustAnchorSend(self.app_client)
        self.state = TrustAnchorState(self.app_client)
    ...
    def new_group(self) -> "TrustAnchorComposer":
        return TrustAnchorComposer(self)
    ...
    def decode_return_value(
        self,
        method: typing.Literal["verify(uint64,byte[])bool"],
        return_value: algokit_utils.ABIReturn | None
    ) -> bool | None: ...
    @typing.overload
    def decode_return_value(
...
class TrustAnchorComposer:
    """Composer for creating transaction groups for TrustAnchor contract calls"""

    def __init__(self, client: "TrustAnchorClient"):
        self.client = client
