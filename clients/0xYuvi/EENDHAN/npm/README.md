...
```bash
npm install arc56-generated-0xyuvi-eendhan @algorandfoundation/algokit-utils algosdk
```
...
import { Eendhan_17054c6f } from "arc56-generated-0xyuvi-eendhan";

const algorand = AlgorandClient.mainNet();
const client = new Eendhan_17054c6f.EendhanClient({
  algorand,
  appId: 123456789n,
});
