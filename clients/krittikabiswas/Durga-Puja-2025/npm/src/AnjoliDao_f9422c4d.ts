...
export type AnjoliDaoTypes = {
  ...
  methods:
    & Record<'hello(string)string' | 'hello', {
      argsObj: AnjoliDaoArgs['obj']['hello(string)string']
      argsTuple: AnjoliDaoArgs['tuple']['hello(string)string']
      returns: AnjoliDaoReturns['hello(string)string']
    }>
}
...
export abstract class AnjoliDaoParamsFactory {
   ...
   */
  static hello(params: CallParams<AnjoliDaoArgs['obj']['hello(string)string'] | AnjoliDaoArgs['tuple']['hello(string)string']> & CallOnComplete): AppClientMethodCallParams & CallOnComplete {
    return {
      ...params,
...
export class AnjoliDaoClient {
  ...
  readonly params = {
    ...
    /**
     * Makes a call to the AnjoliDao smart contract using the `hello(string)string` ABI method.
     *
     * @param params The params for the smart contract call
     * @returns The call params
     */
    hello: (params: CallParams<AnjoliDaoArgs['obj']['hello(string)string'] | AnjoliDaoArgs['tuple']['hello(string)string']> & {onComplete?: OnApplicationComplete.NoOpOC}) => {
      return this.appClient.params.call(AnjoliDaoParamsFactory.hello(params))
    },
  ...
  readonly createTransaction = {
     ...
     */
    hello: (params: CallParams<AnjoliDaoArgs['obj']['hello(string)string'] | AnjoliDaoArgs['tuple']['hello(string)string']> & {onComplete?: OnApplicationComplete.NoOpOC}) => {
      return this.appClient.createTransaction.call(AnjoliDaoParamsFactory.hello(params))
    },
  ...
  readonly send = {
     ...
     */
    hello: async (params: CallParams<AnjoliDaoArgs['obj']['hello(string)string'] | AnjoliDaoArgs['tuple']['hello(string)string']> & SendParams & {onComplete?: OnApplicationComplete.NoOpOC}) => {
      const result = await this.appClient.send.call(AnjoliDaoParamsFactory.hello(params))
      return {...result, return: result.return as unknown as (undefined | AnjoliDaoReturns['hello(string)string'])}
    },
  ...
  public newGroup(): AnjoliDaoComposer {
    ...
    return {
      /**
       * Add a hello(string)string method call against the AnjoliDao contract
       */
      hello(params: CallParams<AnjoliDaoArgs['obj']['hello(string)string'] | AnjoliDaoArgs['tuple']['hello(string)string']> & {onComplete?: OnApplicationComplete.NoOpOC}) {
...
export type AnjoliDaoComposer<TReturns extends [...any[]] = []> = {
   ...
   */
  hello(params?: CallParams<AnjoliDaoArgs['obj']['hello(string)string'] | AnjoliDaoArgs['tuple']['hello(string)string']>): AnjoliDaoComposer<[...TReturns, AnjoliDaoReturns['hello(string)string'] | undefined]>
   ...
   */
  simulate(): Promise<AnjoliDaoComposerResults<TReturns> & { simulateResponse: modelsv2.SimulateResponse }>
  simulate(options: SkipSignaturesSimulateOptions): Promise<AnjoliDaoComposerResults<TReturns> & { simulateResponse: modelsv2.SimulateResponse }>
  simulate(options: RawSimulateOptions): Promise<AnjoliDaoComposerResults<TReturns> & { simulateResponse: modelsv2.SimulateResponse }>
  /**
