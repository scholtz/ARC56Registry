...
```bash
pip install arc56-generated-krittikabiswas-durga-puja-2025
```
...
from arc56_generated_krittikabiswas_durga_puja_2025 import AnjoliDAO_4032bf59

algorand = AlgorandClient.mainnet()
client = AnjoliDAO_4032bf59.AnjoliDaoClient(
    algorand=algorand,
    app_id=123456789,
)
