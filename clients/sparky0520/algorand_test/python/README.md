...
```bash
pip install arc56-generated-sparky0520-algorand-test
```
...
from arc56_generated_sparky0520_algorand_test import HelloWorld_8b9a192b

algorand = AlgorandClient.mainnet()
client = HelloWorld_8b9a192b.HelloWorldClient(
    algorand=algorand,
    app_id=123456789,
)
