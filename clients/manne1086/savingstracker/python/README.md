...
```bash
pip install arc56-generated-manne1086-savingstracker
```
...
from arc56_generated_manne1086_savingstracker import SavingsVault_9ab2601e

algorand = AlgorandClient.mainnet()
client = SavingsVault_9ab2601e.SavingsVaultClient(
    algorand=algorand,
    app_id=123456789,
)
