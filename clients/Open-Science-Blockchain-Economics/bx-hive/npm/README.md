...
```bash
npm install arc56-generated-open-science-blockchain-economics-bx-hive @algorandfoundation/algokit-utils algosdk
```
...
import { BxHiveRegistry_f2f3efda } from "arc56-generated-open-science-blockchain-economics-bx-hive";

const algorand = AlgorandClient.mainNet();
const client = new BxHiveRegistry_f2f3efda.BxHiveRegistryClient({
  algorand,
  appId: 123456789n,
});
