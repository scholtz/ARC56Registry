...
```bash
npm install arc56-generated-anirudhpratapsinghyadav-team-bharat-sit-hackathon-supplychainalgorand @algorandfoundation/algokit-utils algosdk
```
...
import { AgriSupplyChainEscrow_1abb5092 } from "arc56-generated-anirudhpratapsinghyadav-team-bharat-sit-hackathon-supplychainalgorand";

const algorand = AlgorandClient.mainNet();
const client = new AgriSupplyChainEscrow_1abb5092.AgriSupplyChainEscrowClient({
  algorand,
  appId: 123456789n,
});
