...
```bash
pip install arc56-generated-anirudhpratapsinghyadav-team-bharat-sit-hackathon-supplychainalgorand
```
...
from arc56_generated_anirudhpratapsinghyadav_team_bharat_sit_hackathon_supplychainalgorand import AgriSupplyChainEscrow_1abb5092

algorand = AlgorandClient.mainnet()
client = AgriSupplyChainEscrow_1abb5092.AgriSupplyChainEscrowClient(
    algorand=algorand,
    app_id=123456789,
)
