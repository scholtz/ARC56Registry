...
```bash
pip install arc56-generated-anirudhpratapsinghyadav-bharat-algorand-supplychain
```
...
from arc56_generated_anirudhpratapsinghyadav_bharat_algorand_supplychain import NaviTrust_78fa960f

algorand = AlgorandClient.mainnet()
client = NaviTrust_78fa960f.NaviTrustClient(
    algorand=algorand,
    app_id=123456789,
)
