...
```bash
npm install arc56-generated-keerthan-17-algo-lancer @algorandfoundation/algokit-utils algosdk
```
...
import { HelloWorld_797c2481 } from "arc56-generated-keerthan-17-algo-lancer";

const algorand = AlgorandClient.mainNet();
const client = new HelloWorld_797c2481.HelloWorldClient({
  algorand,
  appId: 123456789n,
});
