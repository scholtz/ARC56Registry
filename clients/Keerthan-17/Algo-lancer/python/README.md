...
```bash
pip install arc56-generated-keerthan-17-algo-lancer
```
...
from arc56_generated_keerthan_17_algo_lancer import HelloWorld_797c2481

algorand = AlgorandClient.mainnet()
client = HelloWorld_797c2481.HelloWorldClient(
    algorand=algorand,
    app_id=123456789,
)
