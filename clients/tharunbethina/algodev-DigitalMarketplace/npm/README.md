...
```bash
npm install arc56-generated-tharunbethina-algodev-digitalmarketplace @algorandfoundation/algokit-utils algosdk
```
...
import { DigitalMarketplace_d8cb4191 } from "arc56-generated-tharunbethina-algodev-digitalmarketplace";

const algorand = AlgorandClient.mainNet();
const client = new DigitalMarketplace_d8cb4191.DigitalMarketplaceClient({
  algorand,
  appId: 123456789n,
});
