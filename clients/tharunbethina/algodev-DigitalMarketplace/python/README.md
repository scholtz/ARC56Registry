...
```bash
pip install arc56-generated-tharunbethina-algodev-digitalmarketplace
```
...
from arc56_generated_tharunbethina_algodev_digitalmarketplace import DigitalMarketplace_d8cb4191

algorand = AlgorandClient.mainnet()
client = DigitalMarketplace_d8cb4191.DigitalMarketplaceClient(
    algorand=algorand,
    app_id=123456789,
)
