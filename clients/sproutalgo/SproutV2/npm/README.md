...
```bash
npm install arc56-generated-sproutalgo-sproutv2 @algorandfoundation/algokit-utils algosdk
```
...
import { Crowdfund_a68b7771 } from "arc56-generated-sproutalgo-sproutv2";

const algorand = AlgorandClient.mainNet();
const client = new Crowdfund_a68b7771.CrowdfundClient({
  algorand,
  appId: 123456789n,
});
...
| --- | --- | --- |
| `Crowdfund_a68b7771` | `CrowdfundClient` | [https://raw.githubusercontent.com/sproutalgo/SproutV2/HEAD/contracts/Crowdfund.arc56.json](https://raw.githubusercontent.com/sproutalgo/SproutV2/HEAD/contracts/Crowdfund.arc56.json) |
