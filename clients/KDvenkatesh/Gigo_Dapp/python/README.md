...
```bash
pip install arc56-generated-kdvenkatesh-gigo-dapp
```
...
from arc56_generated_kdvenkatesh_gigo_dapp import RideContract_dcd64bf2

algorand = AlgorandClient.mainnet()
client = RideContract_dcd64bf2.RideContractClient(
    algorand=algorand,
    app_id=123456789,
)
