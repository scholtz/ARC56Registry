...
```bash
pip install arc56-generated-kdvenkatesh-mygameshub
```
...
from arc56_generated_kdvenkatesh_mygameshub import GamesHub_3579016c

algorand = AlgorandClient.mainnet()
client = GamesHub_3579016c.GamesHubClient(
    algorand=algorand,
    app_id=123456789,
)
