...
```bash
npm install arc56-generated-kdvenkatesh-mygameshub @algorandfoundation/algokit-utils algosdk
```
...
import { GamesHub_3579016c } from "arc56-generated-kdvenkatesh-mygameshub";

const algorand = AlgorandClient.mainNet();
const client = new GamesHub_3579016c.GamesHubClient({
  algorand,
  appId: 123456789n,
});
...
| --- | --- | --- |
| `GamesHub_3579016c` | `GamesHubClient` | [https://raw.githubusercontent.com/KDvenkatesh/myGameshub/HEAD/gameshub-contracts/smart_contracts/artifacts/gameshub/GamesHub.arc56.json](https://raw.githubusercontent.com/KDvenkatesh/myGameshub/HEAD/gameshub-contracts/smart_contracts/artifacts/gameshub/GamesHub.arc56.json) |
