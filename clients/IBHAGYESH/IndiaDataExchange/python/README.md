...
```bash
pip install arc56-generated-ibhagyesh-indiadataexchange
```
...
from arc56_generated_ibhagyesh_indiadataexchange import BountyEscrow_414c307e

algorand = AlgorandClient.mainnet()
client = BountyEscrow_414c307e.BountyEscrowClient(
    algorand=algorand,
    app_id=123456789,
)
