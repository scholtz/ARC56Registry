...
```bash
npm install arc56-generated-ibhagyesh-indiadataexchange @algorandfoundation/algokit-utils algosdk
```
...
import { BountyEscrow_414c307e } from "arc56-generated-ibhagyesh-indiadataexchange";

const algorand = AlgorandClient.mainNet();
const client = new BountyEscrow_414c307e.BountyEscrowClient({
  algorand,
  appId: 123456789n,
});
