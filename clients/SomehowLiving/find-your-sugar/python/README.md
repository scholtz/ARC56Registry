...
```bash
pip install arc56-generated-somehowliving-find-your-sugar
```
...
from arc56_generated_somehowliving_find_your_sugar import SugarDaddyPlatform_0e4387a2

algorand = AlgorandClient.mainnet()
client = SugarDaddyPlatform_0e4387a2.SugarDaddyPlatformClient(
    algorand=algorand,
    app_id=123456789,
)
