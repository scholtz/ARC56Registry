...
```bash
npm install arc56-generated-somehowliving-find-your-sugar @algorandfoundation/algokit-utils algosdk
```
...
import { SugarDaddyPlatform_0e4387a2 } from "arc56-generated-somehowliving-find-your-sugar";

const algorand = AlgorandClient.mainNet();
const client = new SugarDaddyPlatform_0e4387a2.SugarDaddyPlatformClient({
  algorand,
  appId: 123456789n,
});
