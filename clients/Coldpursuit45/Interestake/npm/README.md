...
```bash
npm install arc56-generated-coldpursuit45-interestake @algorandfoundation/algokit-utils algosdk
```
...
import { IstakeContract_b035cb62 } from "arc56-generated-coldpursuit45-interestake";

const algorand = AlgorandClient.mainNet();
const client = new IstakeContract_b035cb62.IstakeContractClient({
  algorand,
  appId: 123456789n,
});
...
| --- | --- | --- |
| `IstakeContract_b035cb62` | `IstakeContractClient` | [https://raw.githubusercontent.com/Coldpursuit45/Interestake/HEAD/smart_contracts/istake_contract/IstakeContract.arc56.json](https://raw.githubusercontent.com/Coldpursuit45/Interestake/HEAD/smart_contracts/istake_contract/IstakeContract.arc56.json) |
