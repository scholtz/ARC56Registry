...
```bash
pip install arc56-generated-younus-younus-codex2-0
```
...
from arc56_generated_younus_younus_codex2_0 import Web3SocialContract_ec007303

algorand = AlgorandClient.mainnet()
client = Web3SocialContract_ec007303.Web3SocialContractClient(
    algorand=algorand,
    app_id=123456789,
)
