...
```bash
npm install arc56-generated-younus-younus-codex2-0 @algorandfoundation/algokit-utils algosdk
```
...
import { Web3SocialContract_ec007303 } from "arc56-generated-younus-younus-codex2-0";

const algorand = AlgorandClient.mainNet();
const client = new Web3SocialContract_ec007303.Web3SocialContractClient({
  algorand,
  appId: 123456789n,
});
