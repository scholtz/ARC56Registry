...
```bash
pip install arc56-generated-vkappakv-vibecheck
```
...
from arc56_generated_vkappakv_vibecheck import Vibecheck_8cf13562

algorand = AlgorandClient.mainnet()
client = Vibecheck_8cf13562.VibecheckClient(
    algorand=algorand,
    app_id=123456789,
)
