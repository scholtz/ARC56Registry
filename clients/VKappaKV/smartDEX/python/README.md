...
```bash
pip install arc56-generated-vkappakv-smartdex
```
...
from arc56_generated_vkappakv_smartdex import PuppetAddress_30868fad

algorand = AlgorandClient.mainnet()
client = PuppetAddress_30868fad.PuppetAddressClient(
    algorand=algorand,
    app_id=123456789,
)
