...
export type PuppetAddressComposer<TReturns extends [...any[]] = []> = {
   ...
   */
  simulate(): Promise<PuppetAddressComposerResults<TReturns> & { simulateResponse: modelsv2.SimulateResponse }>
  simulate(options: SkipSignaturesSimulateOptions): Promise<PuppetAddressComposerResults<TReturns> & { simulateResponse: modelsv2.SimulateResponse }>
  simulate(options: RawSimulateOptions): Promise<PuppetAddressComposerResults<TReturns> & { simulateResponse: modelsv2.SimulateResponse }>
  /**
