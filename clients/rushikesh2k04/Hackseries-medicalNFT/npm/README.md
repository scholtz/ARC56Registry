...
```bash
npm install arc56-generated-rushikesh2k04-hackseries-medicalnft @algorandfoundation/algokit-utils algosdk
```
...
import { NftTransfer_1fc9523b } from "arc56-generated-rushikesh2k04-hackseries-medicalnft";

const algorand = AlgorandClient.mainNet();
const client = new NftTransfer_1fc9523b.NftTransferClient({
  algorand,
  appId: 123456789n,
});
