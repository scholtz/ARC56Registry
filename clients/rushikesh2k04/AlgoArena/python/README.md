...
```bash
pip install arc56-generated-rushikesh2k04-algoarena
```
...
from arc56_generated_rushikesh2k04_algoarena import AlgoArenaReward_5d297e73

algorand = AlgorandClient.mainnet()
client = AlgoArenaReward_5d297e73.AlgoArenaRewardClient(
    algorand=algorand,
    app_id=123456789,
)
