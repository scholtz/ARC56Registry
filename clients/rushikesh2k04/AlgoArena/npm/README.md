...
```bash
npm install arc56-generated-rushikesh2k04-algoarena @algorandfoundation/algokit-utils algosdk
```
...
import { AlgoArenaReward_5d297e73 } from "arc56-generated-rushikesh2k04-algoarena";

const algorand = AlgorandClient.mainNet();
const client = new AlgoArenaReward_5d297e73.AlgoArenaRewardClient({
  algorand,
  appId: 123456789n,
});
