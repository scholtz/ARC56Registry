...
```bash
pip install arc56-generated-rushikesh2k04-medialgo
```
...
from arc56_generated_rushikesh2k04_medialgo import NFTContract_c2e45bec

algorand = AlgorandClient.mainnet()
client = NFTContract_c2e45bec.NftContractClient(
    algorand=algorand,
    app_id=123456789,
)
