...
```bash
npm install arc56-generated-rushikesh2k04-medialgo @algorandfoundation/algokit-utils algosdk
```
...
import { NFTContract_c2e45bec } from "arc56-generated-rushikesh2k04-medialgo";

const algorand = AlgorandClient.mainNet();
const client = new NFTContract_c2e45bec.NftContractClient({
  algorand,
  appId: 123456789n,
});
