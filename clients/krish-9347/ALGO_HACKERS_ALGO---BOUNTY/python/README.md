...
```bash
pip install arc56-generated-krish-9347-algo-hackers-algo---bounty
```
...
from arc56_generated_krish_9347_algo_hackers_algo___bounty import TaskBounty_13b9f12c

algorand = AlgorandClient.mainnet()
client = TaskBounty_13b9f12c.TaskBountyClient(
    algorand=algorand,
    app_id=123456789,
)
