...
```bash
pip install arc56-generated-ayush-rudani-percival
```
...
from arc56_generated_ayush_rudani_percival import PercivalSc_409e83b5

algorand = AlgorandClient.mainnet()
client = PercivalSc_409e83b5.PercivalScClient(
    algorand=algorand,
    app_id=123456789,
)
