...
```bash
npm install arc56-generated-ayush-rudani-percival @algorandfoundation/algokit-utils algosdk
```
...
import { PercivalSc_409e83b5 } from "arc56-generated-ayush-rudani-percival";

const algorand = AlgorandClient.mainNet();
const client = new PercivalSc_409e83b5.PercivalScClient({
  algorand,
  appId: 123456789n,
});
