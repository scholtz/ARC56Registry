...
export const APP_SPEC: Arc56Contract = {"name":"ARC56Test","desc":"","methods":[{"name":"customStructMethod","args":[{"name":"input","type":"(uint64)","struct":"AnotherCustomStruct"}],"returns":{"type":"(uint64)","struct":"AnotherCustomStruct"},"actions":{"create":[],"call":["NoOp"]}},{"name":"foo","args":[{"name":"inputs","type":"((uint64,uint64),(uint64,uint64))","struct":"Inputs"}],"returns":{"type":"(uint64,uint64)","struct":"Outputs"},"actions":{"create":[],"call":["NoOp"]}},{"name":"optInToApplication","args":[],"returns":{"type":"void"},"actions":{"create":[],"call":["OptIn"]}},{"name":"customType","args":[{"name":"input","type":"(uint64)","struct":"CustomStructAsName"}],"returns":{"type":"(uint64)","struct":"CustomStructAsName"},"actions":{"create":[],"call":["NoOp"]}},{"name":"createApplication","args":[],"returns":{"type":"void"},"actions":{"create":["NoOp"],"call":[]}}],"arcs":[4,56],"structs":{"{ foo: uint16; bar: uint16 }":[{"name":"foo","type":"uint16"},{"name":"bar","type":"uint16"}],"Outputs":[{"name":"sum","type":"uint64"},{"name":"difference","type":"uint64"}],"Inputs":[{"name":"add","type":[{"name":"a","type":"uint64"},{"name":"b","type":"uint64"}]},{"name":"subtract","type":[{"name":"a","type":"uint64"},{"name":"b","type":"uint64"}]}],"AnotherCustomStruct":[{"name":"b","type":"uint64"}],"CustomStructAsName":[{"name":"a","type":"uint64"}]},"state":{"schema":{"global":{"bytes":37,"ints":1},"local":{"bytes":13,"ints":1}},"keys":{"global":{"globalKey":{"key":"Z2xvYmFsS2V5","keyType":"AVMBytes","valueType":"uint64"}},"local":{"localKey":{"key":"bG9jYWxLZXk=","keyType":"AVMBytes","valueType":"uint64"}},"box":{"boxKey":{"key":"Ym94S2V5","keyType":"AVMBytes","valueType":"string"}}},"maps":{"global":{"globalMap":{"keyType":"string","valueType":"{ foo: uint16; bar: uint16 }","prefix":"cA=="}},"local":{"localMap":{"keyType":"AVMBytes","valueType":"string","prefix":"cA=="}},"box":{"boxMap":{"keyType":"Inputs","valueType":"Outputs","prefix":"cA=="}}}},"bareActions":{"create":[],"call":[]},"sourceInfo":{"approval":{"sourceInfo":[{"pc":[36],"errorMessage":"The requested action is not implemented in this contract. Are you using the correct OnComplete? Did you set your app ID?","teal":25},{"pc":[45],"errorMessage":"argument 0 (input) for customStructMethod must be a (uint64)","teal":40},{"pc":[68],"errorMessage":"argument 0 (inputs) for foo must be a ((uint64,uint64),(uint64,uint64))","teal":71},{"pc":[95],"errorMessage":"subtract.a must be greater than subtract.b","teal":98},{"pc":[267],"errorMessage":"argument 0 (input) for customType must be a (uint64)","teal":191},{"pc":[296],"errorMessage":"this contract does not implement the given ABI method for create NoOp","teal":219},{"pc":[326],"errorMessage":"this contract does not implement the given ABI method for call NoOp","teal":229},{"pc":[340],"errorMessage":"this contract does not implement the given ABI method for call OptIn","teal":237}],"pcOffsetMethod":"cblocks"},"clear":{"sourceInfo":[],"pcOffsetMethod":"none"}}} as unknown as Arc56Contract
...
export type CustomStructAsName = {
  a: bigint
}


/**
 * Converts the ABI tuple representation of a CustomStructAsName to the struct representation
 */
export function CustomStructAsNameFromTuple(abiTuple: [bigint]) {
  return getABIStructFromABITuple(abiTuple, APP_SPEC.structs.CustomStructAsName, APP_SPEC.structs) as CustomStructAsName
}
...
export type Arc56TestArgs = {
  ...
  tuple: {
    ...
    'customType((uint64))(uint64)': [input: CustomStructAsName]
...
export type Arc56TestReturns = {
  ...
  'customType((uint64))(uint64)': CustomStructAsName
...
export type Arc56TestTypes = {
  ...
  methods:
    & Record<'customStructMethod((uint64))(uint64)' | 'customStructMethod', {
      argsObj: Arc56TestArgs['obj']['customStructMethod((uint64))(uint64)']
      argsTuple: Arc56TestArgs['tuple']['customStructMethod((uint64))(uint64)']
      returns: Arc56TestReturns['customStructMethod((uint64))(uint64)']
    }>
    ...
    & Record<'customType((uint64))(uint64)' | 'customType', {
      argsObj: Arc56TestArgs['obj']['customType((uint64))(uint64)']
      argsTuple: Arc56TestArgs['tuple']['customType((uint64))(uint64)']
      returns: Arc56TestReturns['customType((uint64))(uint64)']
    }>
...
export abstract class Arc56TestParamsFactory {
   ...
   * @returns An `AppClientMethodCallParams` object for the call
   */
  static customStructMethod(params: CallParams<Arc56TestArgs['obj']['customStructMethod((uint64))(uint64)'] | Arc56TestArgs['tuple']['customStructMethod((uint64))(uint64)']> & CallOnComplete): AppClientMethodCallParams & CallOnComplete {
    return {
      ...params,
  ...
  /**
   * Constructs a no op call for the customType((uint64))(uint64) ABI method
   *
   * @param params Parameters for the call
   * @returns An `AppClientMethodCallParams` object for the call
   */
  static customType(params: CallParams<Arc56TestArgs['obj']['customType((uint64))(uint64)'] | Arc56TestArgs['tuple']['customType((uint64))(uint64)']> & CallOnComplete): AppClientMethodCallParams & CallOnComplete {
    return {
      ...params,
      method: 'customType((uint64))(uint64)' as const,
      args: Array.isArray(params.args) ? params.args : [params.args.input],
    }
  }
}
...
export class Arc56TestClient {
  ...
  readonly params = {
    ...
    /**
     * Makes a call to the ARC56Test smart contract using the `customStructMethod((uint64))(uint64)` ABI method.
     *
     * @param params The params for the smart contract call
     * @returns The call params
     */
    customStructMethod: (params: CallParams<Arc56TestArgs['obj']['customStructMethod((uint64))(uint64)'] | Arc56TestArgs['tuple']['customStructMethod((uint64))(uint64)']> & {onComplete?: OnApplicationComplete.NoOpOC}) => {
      return this.appClient.params.call(Arc56TestParamsFactory.customStructMethod(params))
    },
    ...
    /**
     * Makes a call to the ARC56Test smart contract using the `customType((uint64))(uint64)` ABI method.
     *
     * @param params The params for the smart contract call
     * @returns The call params
     */
    customType: (params: CallParams<Arc56TestArgs['obj']['customType((uint64))(uint64)'] | Arc56TestArgs['tuple']['customType((uint64))(uint64)']> & {onComplete?: OnApplicationComplete.NoOpOC}) => {
      return this.appClient.params.call(Arc56TestParamsFactory.customType(params))
    },
  ...
  readonly createTransaction = {
     ...
     */
    customStructMethod: (params: CallParams<Arc56TestArgs['obj']['customStructMethod((uint64))(uint64)'] | Arc56TestArgs['tuple']['customStructMethod((uint64))(uint64)']> & {onComplete?: OnApplicationComplete.NoOpOC}) => {
      return this.appClient.createTransaction.call(Arc56TestParamsFactory.customStructMethod(params))
    },
     ...
     */
    customType: (params: CallParams<Arc56TestArgs['obj']['customType((uint64))(uint64)'] | Arc56TestArgs['tuple']['customType((uint64))(uint64)']> & {onComplete?: OnApplicationComplete.NoOpOC}) => {
      return this.appClient.createTransaction.call(Arc56TestParamsFactory.customType(params))
    },
  ...
  readonly send = {
     ...
     */
    customStructMethod: async (params: CallParams<Arc56TestArgs['obj']['customStructMethod((uint64))(uint64)'] | Arc56TestArgs['tuple']['customStructMethod((uint64))(uint64)']> & SendParams & {onComplete?: OnApplicationComplete.NoOpOC}) => {
      const result = await this.appClient.send.call(Arc56TestParamsFactory.customStructMethod(params))
      return {...result, return: result.return as unknown as (undefined | Arc56TestReturns['customStructMethod((uint64))(uint64)'])}
    },
     ...
     * @returns The call result
     */
    customType: async (params: CallParams<Arc56TestArgs['obj']['customType((uint64))(uint64)'] | Arc56TestArgs['tuple']['customType((uint64))(uint64)']> & SendParams & {onComplete?: OnApplicationComplete.NoOpOC}) => {
      const result = await this.appClient.send.call(Arc56TestParamsFactory.customType(params))
      return {...result, return: result.return as unknown as (undefined | Arc56TestReturns['customType((uint64))(uint64)'])}
    },
  ...
  public newGroup(): Arc56TestComposer {
    ...
    return {
      /**
       * Add a customStructMethod((uint64))(uint64) method call against the ARC56Test contract
       */
      customStructMethod(params: CallParams<Arc56TestArgs['obj']['customStructMethod((uint64))(uint64)'] | Arc56TestArgs['tuple']['customStructMethod((uint64))(uint64)']> & {onComplete?: OnApplicationComplete.NoOpOC}) {
      ...
      /**
       * Add a customType((uint64))(uint64) method call against the ARC56Test contract
       */
      customType(params: CallParams<Arc56TestArgs['obj']['customType((uint64))(uint64)'] | Arc56TestArgs['tuple']['customType((uint64))(uint64)']> & {onComplete?: OnApplicationComplete.NoOpOC}) {
        promiseChain = promiseChain.then(async () => composer.addAppCallMethodCall(await client.params.customType(params)))
        resultMappers.push((v) => client.decodeReturnValue('customType((uint64))(uint64)', v))
        return this
      },
      get optIn() {
        return {
...
export type Arc56TestComposer<TReturns extends [...any[]] = []> = {
   ...
   */
  customStructMethod(params?: CallParams<Arc56TestArgs['obj']['customStructMethod((uint64))(uint64)'] | Arc56TestArgs['tuple']['customStructMethod((uint64))(uint64)']>): Arc56TestComposer<[...TReturns, Arc56TestReturns['customStructMethod((uint64))(uint64)'] | undefined]>
  ...
  /**
   * Calls the customType((uint64))(uint64) ABI method.
   *
   * @param args The arguments for the contract call
   * @param params Any additional parameters for the call
   * @returns The typed transaction composer so you can fluently chain multiple calls or call execute to execute all queued up transactions
   */
  customType(params?: CallParams<Arc56TestArgs['obj']['customType((uint64))(uint64)'] | Arc56TestArgs['tuple']['customType((uint64))(uint64)']>): Arc56TestComposer<[...TReturns, Arc56TestReturns['customType((uint64))(uint64)'] | undefined]>
