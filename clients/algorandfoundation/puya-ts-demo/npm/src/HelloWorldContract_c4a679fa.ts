...
export type HelloWorldContractArgs = {
   ...
   */
  tuple: {
    'sayHello(string)string': [name: string]
  }
}
...
export type HelloWorldContractTypes = {
  ...
  methods:
    & Record<'sayHello(string)string' | 'sayHello', {
      argsObj: HelloWorldContractArgs['obj']['sayHello(string)string']
      argsTuple: HelloWorldContractArgs['tuple']['sayHello(string)string']
      returns: HelloWorldContractReturns['sayHello(string)string']
    }>
}
...
export abstract class HelloWorldContractParamsFactory {
   ...
   */
  static sayHello(params: CallParams<HelloWorldContractArgs['obj']['sayHello(string)string'] | HelloWorldContractArgs['tuple']['sayHello(string)string']> & CallOnComplete): AppClientMethodCallParams & CallOnComplete {
    return {
      ...params,
...
export class HelloWorldContractClient {
  ...
  readonly params = {
    ...
    /**
     * Makes a call to the HelloWorldContract smart contract using the `sayHello(string)string` ABI method.
     *
     * @param params The params for the smart contract call
     * @returns The call params
     */
    sayHello: (params: CallParams<HelloWorldContractArgs['obj']['sayHello(string)string'] | HelloWorldContractArgs['tuple']['sayHello(string)string']> & {onComplete?: OnApplicationComplete.NoOpOC}) => {
  ...
  readonly send = {
     ...
     */
    sayHello: async (params: CallParams<HelloWorldContractArgs['obj']['sayHello(string)string'] | HelloWorldContractArgs['tuple']['sayHello(string)string']> & SendParams & {onComplete?: OnApplicationComplete.NoOpOC}) => {
      const result = await this.appClient.send.call(HelloWorldContractParamsFactory.sayHello(params))
      return {...result, return: result.return as unknown as (undefined | HelloWorldContractReturns['sayHello(string)string'])}
    },
  ...
  public newGroup(): HelloWorldContractComposer {
    ...
    return {
      /**
       * Add a sayHello(string)string method call against the HelloWorldContract contract
       */
      sayHello(params: CallParams<HelloWorldContractArgs['obj']['sayHello(string)string'] | HelloWorldContractArgs['tuple']['sayHello(string)string']> & {onComplete?: OnApplicationComplete.NoOpOC}) {
        promiseChain = promiseChain.then(async () => composer.addAppCallMethodCall(await client.params.sayHello(params)))
        resultMappers.push((v) => client.decodeReturnValue('sayHello(string)string', v))
        return this
      },
      /**
...
export type HelloWorldContractComposer<TReturns extends [...any[]] = []> = {
   ...
   */
  sayHello(params?: CallParams<HelloWorldContractArgs['obj']['sayHello(string)string'] | HelloWorldContractArgs['tuple']['sayHello(string)string']>): HelloWorldContractComposer<[...TReturns, HelloWorldContractReturns['sayHello(string)string'] | undefined]>
   ...
   */
  simulate(): Promise<HelloWorldContractComposerResults<TReturns> & { simulateResponse: modelsv2.SimulateResponse }>
  simulate(options: SkipSignaturesSimulateOptions): Promise<HelloWorldContractComposerResults<TReturns> & { simulateResponse: modelsv2.SimulateResponse }>
  simulate(options: RawSimulateOptions): Promise<HelloWorldContractComposerResults<TReturns> & { simulateResponse: modelsv2.SimulateResponse }>
  /**
