...
export class TuplesContractClient {
   ...
   */
  decodeReturnValue<TSignature extends TuplesContractNonVoidMethodSignatures>(method: TSignature, returnValue: ABIReturn | undefined) {
  ...
  readonly params = {
     ...
     */
    testTupleWithPrimitiveType: (params: CallParams<TuplesContractArgs['obj']['test_tuple_with_primitive_type()(uint64,bool)'] | TuplesContractArgs['tuple']['test_tuple_with_primitive_type()(uint64,bool)']> & {onComplete?: OnApplicationComplete.NoOpOC} = {args: []}) => {
  ...
  readonly send = {
     ...
     */
    testTupleWithPrimitiveType: async (params: CallParams<TuplesContractArgs['obj']['test_tuple_with_primitive_type()(uint64,bool)'] | TuplesContractArgs['tuple']['test_tuple_with_primitive_type()(uint64,bool)']> & SendParams & {onComplete?: OnApplicationComplete.NoOpOC} = {args: []}) => {
  ...
  public newGroup(): TuplesContractComposer {
    const client = this
    ...
    return {
       ...
       */
      testTupleWithPrimitiveType(params: CallParams<TuplesContractArgs['obj']['test_tuple_with_primitive_type()(uint64,bool)'] | TuplesContractArgs['tuple']['test_tuple_with_primitive_type()(uint64,bool)']> & {onComplete?: OnApplicationComplete.NoOpOC}) {
        promiseChain = promiseChain.then(async () => composer.addAppCallMethodCall(await client.params.testTupleWithPrimitiveType(params)))
        resultMappers.push((v) => client.decodeReturnValue('test_tuple_with_primitive_type()(uint64,bool)', v))
        return this
      },
      /**
...
export type TuplesContractComposer<TReturns extends [...any[]] = []> = {
   ...
   */
  simulate(): Promise<TuplesContractComposerResults<TReturns> & { simulateResponse: modelsv2.SimulateResponse }>
  simulate(options: SkipSignaturesSimulateOptions): Promise<TuplesContractComposerResults<TReturns> & { simulateResponse: modelsv2.SimulateResponse }>
  simulate(options: RawSimulateOptions): Promise<TuplesContractComposerResults<TReturns> & { simulateResponse: modelsv2.SimulateResponse }>
  /**
   * Sends the transaction group to the network and returns the results
   */
  send(params?: SendParams): Promise<TuplesContractComposerResults<TReturns>>
}
export type TuplesContractComposerResults<TReturns extends [...any[]]> = Expand<SendAtomicTransactionComposerResults & {
  returns: TReturns
}>
