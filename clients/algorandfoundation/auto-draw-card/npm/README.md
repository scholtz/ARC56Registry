...
```bash
npm install arc56-generated-algorandfoundation-auto-draw-card @algorandfoundation/algokit-utils algosdk
```
...
import { Killswitch_bf1cdefb } from "arc56-generated-algorandfoundation-auto-draw-card";

const algorand = AlgorandClient.mainNet();
const client = new Killswitch_bf1cdefb.KillswitchClient({
  algorand,
  appId: 123456789n,
});
