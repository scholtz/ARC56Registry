...
```bash
npm install arc56-generated-algorandfoundation-arc89 @algorandfoundation/algokit-utils algosdk
```
...
import { AsaMetadataRegistry_295a41b6 } from "arc56-generated-algorandfoundation-arc89";

const algorand = AlgorandClient.mainNet();
const client = new AsaMetadataRegistry_295a41b6.AsaMetadataRegistryClient({
  algorand,
  appId: 123456789n,
});
