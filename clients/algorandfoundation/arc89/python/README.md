...
```bash
pip install arc56-generated-algorandfoundation-arc89
```
...
from arc56_generated_algorandfoundation_arc89 import AsaMetadataRegistry_295a41b6

algorand = AlgorandClient.mainnet()
client = AsaMetadataRegistry_295a41b6.AsaMetadataRegistryClient(
    algorand=algorand,
    app_id=123456789,
)
