...
export const APP_SPEC: Arc56Contract = {"name":"MerkleTree","structs":{},"methods":[{"name":"create","args":[{"type":"byte[32]","name":"root"}],"returns":{"type":"void"},"actions":{"create":["NoOp"],"call":[]},"readonly":false,"events":[],"recommendations":{}},{"name":"verify","args":[{"type":"byte[32][]","name":"proof"},{"type":"byte[32]","name":"leaf"}],"returns":{"type":"bool"},"actions":{"create":[],"call":["NoOp"]},"readonly":false,"events":[],"recommendations":{}}],"arcs":[22,28],"networks":{},"state":{"schema":{"global":{"ints":0,"bytes":1},"local":{"ints":0,"bytes":0}},"keys":{"global":{"root":{"keyType":"AVMString","valueType":"AVMBytes","key":"cm9vdA=="}},"local":{},"box":{}},"maps":{"global":{},"local":{},"box":{}}},"bareActions":{"create":[],"call":[]},"sourceInfo":{"approval":{"sourceInfo":[{"pc":[96],"errorMessage":"check self.root exists"},{"pc":[115],"errorMessage":"index access is out of bounds"},{"pc":[69],"errorMessage":"invalid array length header"},{"pc":[81],"errorMessage":"invalid number of bytes for arc4.dynamic_array<arc4.static_array<arc4.uint8, 32>>"},{"pc":[57,89],"errorMessage":"invalid number of bytes for arc4.static_array<arc4.uint8, 32>"}],"pcOffsetMethod":"none"},"clear":{"sourceInfo":[],"pcOffsetMethod":"none"}},"events":[]} as unknown as Arc56Contract
...
export type MerkleTreeArgs = {
   ...
   */
  tuple: {
    'create(byte[32])void': [root: Uint8Array]
    'verify(byte[32][],byte[32])bool': [proof: Uint8Array[], leaf: Uint8Array]
  }
}
...
export type MerkleTreeReturns = {
  'create(byte[32])void': void
  'verify(byte[32][],byte[32])bool': boolean
}
...
export type MerkleTreeTypes = {
   ...
   */
  methods:
    & Record<'create(byte[32])void' | 'create', {
      argsObj: MerkleTreeArgs['obj']['create(byte[32])void']
      argsTuple: MerkleTreeArgs['tuple']['create(byte[32])void']
      returns: MerkleTreeReturns['create(byte[32])void']
    }>
    & Record<'verify(byte[32][],byte[32])bool' | 'verify', {
      argsObj: MerkleTreeArgs['obj']['verify(byte[32][],byte[32])bool']
      argsTuple: MerkleTreeArgs['tuple']['verify(byte[32][],byte[32])bool']
      returns: MerkleTreeReturns['verify(byte[32][],byte[32])bool']
    }>
  /**
...
export abstract class MerkleTreeParamsFactory {
  /**
   * Constructs a no op call for the verify(byte[32][],byte[32])bool ABI method
   *
   * @param params Parameters for the call
   * @returns An `AppClientMethodCallParams` object for the call
   */
  static verify(params: CallParams<MerkleTreeArgs['obj']['verify(byte[32][],byte[32])bool'] | MerkleTreeArgs['tuple']['verify(byte[32][],byte[32])bool']> & CallOnComplete): AppClientMethodCallParams & CallOnComplete {
    return {
      ...params,
      method: 'verify(byte[32][],byte[32])bool' as const,
      args: Array.isArray(params.args) ? params.args : [params.args.proof, params.args.leaf],
    }
  }
}
...
export class MerkleTreeClient {
  ...
  readonly params = {
    ...
    /**
     * Makes a call to the MerkleTree smart contract using the `verify(byte[32][],byte[32])bool` ABI method.
     *
     * @param params The params for the smart contract call
     * @returns The call params
     */
    verify: (params: CallParams<MerkleTreeArgs['obj']['verify(byte[32][],byte[32])bool'] | MerkleTreeArgs['tuple']['verify(byte[32][],byte[32])bool']> & {onComplete?: OnApplicationComplete.NoOpOC}) => {
  ...
  readonly send = {
     ...
     */
    verify: async (params: CallParams<MerkleTreeArgs['obj']['verify(byte[32][],byte[32])bool'] | MerkleTreeArgs['tuple']['verify(byte[32][],byte[32])bool']> & SendParams & {onComplete?: OnApplicationComplete.NoOpOC}) => {
      const result = await this.appClient.send.call(MerkleTreeParamsFactory.verify(params))
      return {...result, return: result.return as unknown as (undefined | MerkleTreeReturns['verify(byte[32][],byte[32])bool'])}
    },
  ...
  public newGroup(): MerkleTreeComposer {
    ...
    return {
      /**
       * Add a verify(byte[32][],byte[32])bool method call against the MerkleTree contract
       */
      verify(params: CallParams<MerkleTreeArgs['obj']['verify(byte[32][],byte[32])bool'] | MerkleTreeArgs['tuple']['verify(byte[32][],byte[32])bool']> & {onComplete?: OnApplicationComplete.NoOpOC}) {
        promiseChain = promiseChain.then(async () => composer.addAppCallMethodCall(await client.params.verify(params)))
        resultMappers.push((v) => client.decodeReturnValue('verify(byte[32][],byte[32])bool', v))
        return this
      },
      /**
...
export type MerkleTreeComposer<TReturns extends [...any[]] = []> = {
  /**
   * Calls the verify(byte[32][],byte[32])bool ABI method.
   *
   * @param args The arguments for the contract call
   * @param params Any additional parameters for the call
   * @returns The typed transaction composer so you can fluently chain multiple calls or call execute to execute all queued up transactions
   */
  verify(params?: CallParams<MerkleTreeArgs['obj']['verify(byte[32][],byte[32])bool'] | MerkleTreeArgs['tuple']['verify(byte[32][],byte[32])bool']>): MerkleTreeComposer<[...TReturns, MerkleTreeReturns['verify(byte[32][],byte[32])bool'] | undefined]>
