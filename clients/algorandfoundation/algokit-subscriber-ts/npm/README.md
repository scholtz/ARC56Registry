...
```bash
npm install arc56-generated-algorandfoundation-algokit-subscriber-ts @algorandfoundation/algokit-utils algosdk
```
...
import { testing_app_da77ef59 } from "arc56-generated-algorandfoundation-algokit-subscriber-ts";

const algorand = AlgorandClient.mainNet();
const client = new testing_app_da77ef59.TestingAppClient({
  algorand,
  appId: 123456789n,
});
