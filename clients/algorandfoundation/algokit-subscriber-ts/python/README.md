...
```bash
pip install arc56-generated-algorandfoundation-algokit-subscriber-ts
```
...
from arc56_generated_algorandfoundation_algokit_subscriber_ts import testing_app_da77ef59

algorand = AlgorandClient.mainnet()
client = testing_app_da77ef59.TestingAppClient(
    algorand=algorand,
    app_id=123456789,
)
