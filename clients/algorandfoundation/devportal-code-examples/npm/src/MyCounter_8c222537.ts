...
export const APP_SPEC: Arc56Contract = {"name":"MyCounter","structs":{},"methods":[{"name":"opt_in","args":[],"returns":{"type":"void"},"actions":{"create":[],"call":["OptIn"]},"readonly":false,"events":[],"recommendations":{}},{"name":"increment_my_counter","args":[],"returns":{"type":"uint64"},"actions":{"create":[],"call":["NoOp"]},"readonly":false,"events":[],"recommendations":{}}],"arcs":[22,28],"networks":{},"state":{"schema":{"global":{"ints":0,"bytes":0},"local":{"ints":1,"bytes":0}},"keys":{"global":{},"local":{"my_counter":{"keyType":"AVMString","valueType":"AVMUint64","key":"bXlfY291bnRlcg=="}},"box":{}},"maps":{"global":{},"local":{},"box":{}}},"bareActions":{"create":["NoOp"],"call":[]},"sourceInfo":{"approval":{"sourceInfo":[{"pc":[73],"errorMessage":"OnCompletion must be NoOp && can only call when creating"},{"pc":[51],"errorMessage":"OnCompletion must be NoOp && can only call when not creating"},{"pc":[62],"errorMessage":"OnCompletion must be OptIn && can only call when not creating"},{"pc":[93,104],"errorMessage":"check self.my_counter exists for account"}],"pcOffsetMethod":"none"},"clear":{"sourceInfo":[],"pcOffsetMethod":"none"}},"events":[]} as unknown as Arc56Contract
...
export type MyCounterArgs = {
  ...
  obj: {
    ...
    'increment_my_counter()uint64': Record<string, never>
  }
  /**
...
export type MyCounterReturns = {
  'opt_in()void': void
  'increment_my_counter()uint64': bigint
}
...
export type MyCounterTypes = {
  ...
  methods:
    & Record<'opt_in()void' | 'opt_in', {
      argsObj: MyCounterArgs['obj']['opt_in()void']
      argsTuple: MyCounterArgs['tuple']['opt_in()void']
      returns: MyCounterReturns['opt_in()void']
    }>
    & Record<'increment_my_counter()uint64' | 'increment_my_counter', {
      argsObj: MyCounterArgs['obj']['increment_my_counter()uint64']
      argsTuple: MyCounterArgs['tuple']['increment_my_counter()uint64']
      returns: MyCounterReturns['increment_my_counter()uint64']
    }>
  /**
...
export abstract class MyCounterParamsFactory {
  ...
  static get optIn() {
    return {
      /**
       * Constructs opt-in ABI call params for the MyCounter smart contract using the opt_in()void ABI method
       *
       * @param params Parameters for the call
       * @returns An `AppClientMethodCallParams` object for the call
       */
      optIn(params: CallParams<MyCounterArgs['obj']['opt_in()void'] | MyCounterArgs['tuple']['opt_in()void']>): AppClientMethodCallParams {
        return {
          ...params,
   ...
   * @returns An `AppClientMethodCallParams` object for the call
   */
  static incrementMyCounter(params: CallParams<MyCounterArgs['obj']['increment_my_counter()uint64'] | MyCounterArgs['tuple']['increment_my_counter()uint64']> & CallOnComplete): AppClientMethodCallParams & CallOnComplete {
    return {
      ...params,
...
export class MyCounterClient {
  ...
  readonly params = {
    ...
    optIn: {
      /**
       * Opts the user into an existing instance of the MyCounter smart contract using the `opt_in()void` ABI method.
       *
       * @param params The params for the smart contract call
       * @returns The optIn params
       */
      optIn: (params: CallParams<MyCounterArgs['obj']['opt_in()void'] | MyCounterArgs['tuple']['opt_in()void']> = {args: []}) => {
    ...
    /**
     * Makes a call to the MyCounter smart contract using the `increment_my_counter()uint64` ABI method.
     *
     * @param params The params for the smart contract call
     * @returns The call params
     */
    incrementMyCounter: (params: CallParams<MyCounterArgs['obj']['increment_my_counter()uint64'] | MyCounterArgs['tuple']['increment_my_counter()uint64']> & {onComplete?: OnApplicationComplete.NoOpOC} = {args: []}) => {
  ...
  readonly send = {
    ...
    optIn: {
       ...
       */
      optIn: async (params: CallParams<MyCounterArgs['obj']['opt_in()void'] | MyCounterArgs['tuple']['opt_in()void']> & SendParams = {args: []}) => {
        const result = await this.appClient.send.optIn(MyCounterParamsFactory.optIn.optIn(params))
        return {...result, return: result.return as unknown as (undefined | MyCounterReturns['opt_in()void'])}
      },
     ...
     */
    incrementMyCounter: async (params: CallParams<MyCounterArgs['obj']['increment_my_counter()uint64'] | MyCounterArgs['tuple']['increment_my_counter()uint64']> & SendParams & {onComplete?: OnApplicationComplete.NoOpOC} = {args: []}) => {
      const result = await this.appClient.send.call(MyCounterParamsFactory.incrementMyCounter(params))
      return {...result, return: result.return as unknown as (undefined | MyCounterReturns['increment_my_counter()uint64'])}
    },
    ...
    local: (address: string | Address) => {
      ...
      return {
        ...
        getAll: async (): Promise<Partial<Expand<LocalKeysState>>> => {
          ...
          return {
            myCounter: result.my_counter,
          }
        },
        /**
         * Get the current value of the my_counter key in local state
         */
        myCounter: async (): Promise<bigint | undefined> => { return (await this.appClient.state.local(encodedAddress).getValue("my_counter")) as bigint | undefined },
      }
    },
  }
  ...
  public newGroup(): MyCounterComposer {
    ...
    return {
      /**
       * Add a increment_my_counter()uint64 method call against the MyCounter contract
       */
      incrementMyCounter(params: CallParams<MyCounterArgs['obj']['increment_my_counter()uint64'] | MyCounterArgs['tuple']['increment_my_counter()uint64']> & {onComplete?: OnApplicationComplete.NoOpOC}) {
        promiseChain = promiseChain.then(async () => composer.addAppCallMethodCall(await client.params.incrementMyCounter(params)))
        resultMappers.push((v) => client.decodeReturnValue('increment_my_counter()uint64', v))
        return this
      },
      get optIn() {
        return {
          optIn: (params: CallParams<MyCounterArgs['obj']['opt_in()void'] | MyCounterArgs['tuple']['opt_in()void']>) => {
...
export type MyCounterComposer<TReturns extends [...any[]] = []> = {
   ...
   */
  incrementMyCounter(params?: CallParams<MyCounterArgs['obj']['increment_my_counter()uint64'] | MyCounterArgs['tuple']['increment_my_counter()uint64']>): MyCounterComposer<[...TReturns, MyCounterReturns['increment_my_counter()uint64'] | undefined]>
  ...
  readonly optIn: {
     ...
     * @returns The typed transaction composer so you can fluently chain multiple calls or call execute to execute all queued up transactions
     */
    optIn(params?: CallParams<MyCounterArgs['obj']['opt_in()void'] | MyCounterArgs['tuple']['opt_in()void']>): MyCounterComposer<[...TReturns, MyCounterReturns['opt_in()void'] | undefined]>
  }
