...
export const APP_SPEC: Arc56Contract = {"name":"ReferenceApp","structs":{},"methods":[{"name":"increment_via_inner","args":[],"returns":{"type":"uint64"},"actions":{"create":[],"call":["NoOp"]},"readonly":false,"events":[],"recommendations":{}},{"name":"increment_via_inner_with_arg","args":[{"type":"uint64","name":"app"}],"returns":{"type":"uint64"},"actions":{"create":[],"call":["NoOp"]},"readonly":false,"events":[],"recommendations":{}}],"arcs":[22,28],"desc":"\n    Calls the increment method on another Counter app with a hardcoded app ID\n    @returns The incremented counter value from the inner call\n    ","networks":{},"state":{"schema":{"global":{"ints":0,"bytes":0},"local":{"ints":0,"bytes":0}},"keys":{"global":{},"local":{},"box":{}},"maps":{"global":{},"local":{},"box":{}}},"bareActions":{"create":["NoOp"],"call":[]},"sourceInfo":{"approval":{"sourceInfo":[{"pc":[26],"errorMessage":"OnCompletion must be NoOp"},{"pc":[59],"errorMessage":"OnCompletion must be NoOp && can only call when creating"},{"pc":[88,124],"errorMessage":"application log value is not the result of an ABI return"}],"pcOffsetMethod":"none"},"clear":{"sourceInfo":[],"pcOffsetMethod":"none"}},"events":[]} as unknown as Arc56Contract
...
export type ReferenceAppArgs = {
   ...
   */
  obj: {
    'increment_via_inner()uint64': Record<string, never>
    'increment_via_inner_with_arg(uint64)uint64': {
      app: bigint | number
    }
  }
  /**
  ...
  tuple: {
    ...
    'increment_via_inner_with_arg(uint64)uint64': [app: bigint | number]
  }
}
...
export type ReferenceAppReturns = {
  'increment_via_inner()uint64': bigint
  'increment_via_inner_with_arg(uint64)uint64': bigint
}
...
export type ReferenceAppTypes = {
  ...
  methods:
    & Record<'increment_via_inner()uint64' | 'increment_via_inner', {
      argsObj: ReferenceAppArgs['obj']['increment_via_inner()uint64']
      argsTuple: ReferenceAppArgs['tuple']['increment_via_inner()uint64']
      returns: ReferenceAppReturns['increment_via_inner()uint64']
    }>
    & Record<'increment_via_inner_with_arg(uint64)uint64' | 'increment_via_inner_with_arg', {
      argsObj: ReferenceAppArgs['obj']['increment_via_inner_with_arg(uint64)uint64']
      argsTuple: ReferenceAppArgs['tuple']['increment_via_inner_with_arg(uint64)uint64']
      returns: ReferenceAppReturns['increment_via_inner_with_arg(uint64)uint64']
    }>
}
...
export abstract class ReferenceAppParamsFactory {
   ...
   */
  static incrementViaInner(params: CallParams<ReferenceAppArgs['obj']['increment_via_inner()uint64'] | ReferenceAppArgs['tuple']['increment_via_inner()uint64']> & CallOnComplete): AppClientMethodCallParams & CallOnComplete {
    return {
      ...params,
  ...
  /**
   * Constructs a no op call for the increment_via_inner_with_arg(uint64)uint64 ABI method
   *
   * @param params Parameters for the call
   * @returns An `AppClientMethodCallParams` object for the call
   */
  static incrementViaInnerWithArg(params: CallParams<ReferenceAppArgs['obj']['increment_via_inner_with_arg(uint64)uint64'] | ReferenceAppArgs['tuple']['increment_via_inner_with_arg(uint64)uint64']> & CallOnComplete): AppClientMethodCallParams & CallOnComplete {
    return {
      ...params,
      method: 'increment_via_inner_with_arg(uint64)uint64' as const,
...
export class ReferenceAppClient {
  ...
  readonly params = {
    ...
    /**
     * Makes a call to the ReferenceApp smart contract using the `increment_via_inner()uint64` ABI method.
     *
     * @param params The params for the smart contract call
     * @returns The call params
     */
    incrementViaInner: (params: CallParams<ReferenceAppArgs['obj']['increment_via_inner()uint64'] | ReferenceAppArgs['tuple']['increment_via_inner()uint64']> & {onComplete?: OnApplicationComplete.NoOpOC} = {args: []}) => {
      return this.appClient.params.call(ReferenceAppParamsFactory.incrementViaInner(params))
    },

    /**
     * Makes a call to the ReferenceApp smart contract using the `increment_via_inner_with_arg(uint64)uint64` ABI method.
     *
     * @param params The params for the smart contract call
     * @returns The call params
     */
    incrementViaInnerWithArg: (params: CallParams<ReferenceAppArgs['obj']['increment_via_inner_with_arg(uint64)uint64'] | ReferenceAppArgs['tuple']['increment_via_inner_with_arg(uint64)uint64']> & {onComplete?: OnApplicationComplete.NoOpOC}) => {
  ...
  readonly send = {
     ...
     */
    incrementViaInner: async (params: CallParams<ReferenceAppArgs['obj']['increment_via_inner()uint64'] | ReferenceAppArgs['tuple']['increment_via_inner()uint64']> & SendParams & {onComplete?: OnApplicationComplete.NoOpOC} = {args: []}) => {
      const result = await this.appClient.send.call(ReferenceAppParamsFactory.incrementViaInner(params))
      return {...result, return: result.return as unknown as (undefined | ReferenceAppReturns['increment_via_inner()uint64'])}
    },
     ...
     * @returns The call result
     */
    incrementViaInnerWithArg: async (params: CallParams<ReferenceAppArgs['obj']['increment_via_inner_with_arg(uint64)uint64'] | ReferenceAppArgs['tuple']['increment_via_inner_with_arg(uint64)uint64']> & SendParams & {onComplete?: OnApplicationComplete.NoOpOC}) => {
      const result = await this.appClient.send.call(ReferenceAppParamsFactory.incrementViaInnerWithArg(params))
      return {...result, return: result.return as unknown as (undefined | ReferenceAppReturns['increment_via_inner_with_arg(uint64)uint64'])}
    },
  ...
  public newGroup(): ReferenceAppComposer {
    ...
    return {
      /**
       * Add a increment_via_inner()uint64 method call against the ReferenceApp contract
       */
      incrementViaInner(params: CallParams<ReferenceAppArgs['obj']['increment_via_inner()uint64'] | ReferenceAppArgs['tuple']['increment_via_inner()uint64']> & {onComplete?: OnApplicationComplete.NoOpOC}) {
        promiseChain = promiseChain.then(async () => composer.addAppCallMethodCall(await client.params.incrementViaInner(params)))
        resultMappers.push((v) => client.decodeReturnValue('increment_via_inner()uint64', v))
        return this
      },
      /**
       * Add a increment_via_inner_with_arg(uint64)uint64 method call against the ReferenceApp contract
       */
      incrementViaInnerWithArg(params: CallParams<ReferenceAppArgs['obj']['increment_via_inner_with_arg(uint64)uint64'] | ReferenceAppArgs['tuple']['increment_via_inner_with_arg(uint64)uint64']> & {onComplete?: OnApplicationComplete.NoOpOC}) {
        promiseChain = promiseChain.then(async () => composer.addAppCallMethodCall(await client.params.incrementViaInnerWithArg(params)))
        resultMappers.push((v) => client.decodeReturnValue('increment_via_inner_with_arg(uint64)uint64', v))
        return this
      },
      /**
...
export type ReferenceAppComposer<TReturns extends [...any[]] = []> = {
   ...
   */
  incrementViaInner(params?: CallParams<ReferenceAppArgs['obj']['increment_via_inner()uint64'] | ReferenceAppArgs['tuple']['increment_via_inner()uint64']>): ReferenceAppComposer<[...TReturns, ReferenceAppReturns['increment_via_inner()uint64'] | undefined]>

  /**
   * Calls the increment_via_inner_with_arg(uint64)uint64 ABI method.
   *
   * @param args The arguments for the contract call
   * @param params Any additional parameters for the call
   * @returns The typed transaction composer so you can fluently chain multiple calls or call execute to execute all queued up transactions
   */
  incrementViaInnerWithArg(params?: CallParams<ReferenceAppArgs['obj']['increment_via_inner_with_arg(uint64)uint64'] | ReferenceAppArgs['tuple']['increment_via_inner_with_arg(uint64)uint64']>): ReferenceAppComposer<[...TReturns, ReferenceAppReturns['increment_via_inner_with_arg(uint64)uint64'] | undefined]>
