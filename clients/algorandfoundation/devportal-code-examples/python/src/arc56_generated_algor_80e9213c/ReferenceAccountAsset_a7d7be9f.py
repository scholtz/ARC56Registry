...
_APP_SPEC_JSON = r"""{"arcs": [22, 28], "bareActions": {"call": [], "create": ["NoOp"]}, "methods": [{"actions": {"call": ["NoOp"], "create": []}, "args": [], "name": "getAssetBalance", "returns": {"type": "uint64", "desc": "The asset balance of the account"}, "desc": "Returns the balance of a specific asset in a hardcoded account", "events": [], "readonly": true, "recommendations": {}}, {"actions": {"call": ["NoOp"], "create": []}, "args": [{"type": "address", "desc": "The account to check the asset balance for", "name": "account"}, {"type": "uint64", "desc": "The asset to check the balance of", "name": "asset"}], "name": "getAssetBalanceWithArg", "returns": {"type": "uint64", "desc": "The asset balance of the account"}, "desc": "Returns the balance of a specific asset in a provided account", "events": [], "readonly": true, "recommendations": {}}], "name": "ReferenceAccountAsset", "state": {"keys": {"box": {}, "global": {}, "local": {}}, "maps": {"box": {}, "global": {}, "local": {}}, "schema": {"global": {"bytes": 0, "ints": 0}, "local": {"bytes": 0, "ints": 0}}}, "structs": {}, "desc": "A contract that demonstrates how to reference both accounts and assets in a smart contract", "events": [], "networks": {}, "sourceInfo": {"approval": {"pcOffsetMethod": "none", "sourceInfo": [{"pc": [94, 119], "errorMessage": "Account is not opted in to the asset"}, {"pc": [54], "errorMessage": "OnCompletion must be NoOp"}, {"pc": [87], "errorMessage": "OnCompletion must be NoOp && can only call when creating"}, {"pc": [99, 122], "errorMessage": "account opted into asset"}]}, "clear": {"pcOffsetMethod": "none", "sourceInfo": []}}}"""
...
class GetAssetBalanceWithArgArgs:
    ...
    def abi_method_signature(self) -> str:
        return "getAssetBalanceWithArg(address,uint64)uint64"
...
class ReferenceAccountAssetClient:
    ...
    def decode_return_value(
        self,
        method: typing.Literal["getAssetBalance()uint64"],
        return_value: algokit_utils.ABIReturn | None
    ) -> int | None: ...
    @typing.overload
    def decode_return_value(
        self,
        method: typing.Literal["getAssetBalanceWithArg(address,uint64)uint64"],
        return_value: algokit_utils.ABIReturn | None
    ) -> int | None: ...
    @typing.overload
    def decode_return_value(
...
class ReferenceAccountAssetComposer:
    ...
    def get_asset_balance_with_arg(
        ...
        self._result_mappers.append(
            lambda v: self.client.decode_return_value(
                "getAssetBalanceWithArg(address,uint64)uint64", v
            )
        )
        return self
