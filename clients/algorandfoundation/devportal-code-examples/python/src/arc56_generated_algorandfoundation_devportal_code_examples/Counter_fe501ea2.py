...
_APP_SPEC_JSON = r"""{"arcs": [22, 28], "bareActions": {"call": [], "create": ["NoOp"]}, "methods": [{"actions": {"call": ["NoOp"], "create": []}, "args": [], "name": "increment", "returns": {"type": "uint64", "desc": "The new counter value"}, "desc": "Increments the counter and returns the new value", "events": [], "readonly": false, "recommendations": {}}], "name": "Counter", "state": {"keys": {"box": {}, "global": {"counter": {"key": "Y291bnRlcg==", "keyType": "AVMString", "valueType": "AVMUint64"}}, "local": {}}, "maps": {"box": {}, "global": {}, "local": {}}, "schema": {"global": {"bytes": 0, "ints": 1}, "local": {"bytes": 0, "ints": 0}}}, "structs": {}, "desc": "A contract that increments a counter", "events": [], "networks": {}, "sourceInfo": {"approval": {"pcOffsetMethod": "none", "sourceInfo": [{"pc": [59], "errorMessage": "OnCompletion must be NoOp && can only call when creating"}, {"pc": [48], "errorMessage": "OnCompletion must be NoOp && can only call when not creating"}, {"pc": [63], "errorMessage": "check GlobalState exists"}]}, "clear": {"pcOffsetMethod": "none", "sourceInfo": []}}}"""
