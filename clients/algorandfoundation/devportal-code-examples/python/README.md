...
```bash
pip install arc56-generated-algorandfoundation-devportal-code-examples
```
...
from arc56_generated_algorandfoundation_devportal_code_examples import Arc4DynamicArray_82c0c5a1
