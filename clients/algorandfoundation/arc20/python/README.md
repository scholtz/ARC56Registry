...
```bash
pip install arc56-generated-algorandfoundation-arc20
```
...
from arc56_generated_algorandfoundation_arc20 import Arc89SmartAsa_2d1fd6fc

algorand = AlgorandClient.mainnet()
client = Arc89SmartAsa_2d1fd6fc.Arc89SmartAsaClient(
    algorand=algorand,
    app_id=123456789,
)
