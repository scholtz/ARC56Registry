...
class StateComposer:
    ...
    def call_with_references(
        ...
        self._result_mappers.append(
            lambda v: self.client.decode_return_value(
                "call_with_references(uint64,address,uint64)uint64", v
            )
        )
        return self
