...
```bash
pip install arc56-generated-algorandfoundation-algokit-cli
```
...
from arc56_generated_algorandfoundation_algokit_cli import app_c90dc0c6

algorand = AlgorandClient.mainnet()
client = app_c90dc0c6.HelloWorldAppClient(
    algorand=algorand,
    app_id=123456789,
)
