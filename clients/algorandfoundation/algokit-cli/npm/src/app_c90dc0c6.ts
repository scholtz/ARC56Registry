...
export type HelloWorldAppComposer<TReturns extends [...any[]] = []> = {
   ...
   */
  simulate(): Promise<HelloWorldAppComposerResults<TReturns> & { simulateResponse: modelsv2.SimulateResponse }>
  simulate(options: SkipSignaturesSimulateOptions): Promise<HelloWorldAppComposerResults<TReturns> & { simulateResponse: modelsv2.SimulateResponse }>
  simulate(options: RawSimulateOptions): Promise<HelloWorldAppComposerResults<TReturns> & { simulateResponse: modelsv2.SimulateResponse }>
  /**
