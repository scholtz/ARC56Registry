...
```bash
npm install arc56-generated-algorandfoundation-algokit-cli @algorandfoundation/algokit-utils algosdk
```
...
import { app_c90dc0c6 } from "arc56-generated-algorandfoundation-algokit-cli";

const algorand = AlgorandClient.mainNet();
const client = new app_c90dc0c6.HelloWorldAppClient({
  algorand,
  appId: 123456789n,
});
...
| --- | --- | --- |
| `app_c90dc0c6` | `HelloWorldAppClient` | [https://raw.githubusercontent.com/algorandfoundation/algokit-cli/HEAD/tests/generate/app.arc56.json](https://raw.githubusercontent.com/algorandfoundation/algokit-cli/HEAD/tests/generate/app.arc56.json) |
