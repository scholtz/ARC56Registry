...
```bash
npm install arc56-generated-algorandfoundation-intermezzo @algorandfoundation/algokit-utils algosdk
```
...
import { DIDAlgoStorage_91035a23 } from "arc56-generated-algorandfoundation-intermezzo";

const algorand = AlgorandClient.mainNet();
const client = new DIDAlgoStorage_91035a23.DidAlgoStorageClient({
  algorand,
  appId: 123456789n,
});
...
| --- | --- | --- |
| `DIDAlgoStorage_91035a23` | `DidAlgoStorageClient` | [https://raw.githubusercontent.com/algorandfoundation/intermezzo/HEAD/libs/did-algo/contracts/DIDAlgoStorage.arc56.json](https://raw.githubusercontent.com/algorandfoundation/intermezzo/HEAD/libs/did-algo/contracts/DIDAlgoStorage.arc56.json) |
