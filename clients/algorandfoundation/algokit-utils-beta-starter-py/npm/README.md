...
```bash
npm install arc56-generated-algorandfoundation-algokit-utils-beta-starter-py @algorandfoundation/algokit-utils algosdk
```
...
import { HelloWorld_579521c7 } from "arc56-generated-algorandfoundation-algokit-utils-beta-starter-py";

const algorand = AlgorandClient.mainNet();
const client = new HelloWorld_579521c7.HelloWorldClient({
  algorand,
  appId: 123456789n,
});
...
| --- | --- | --- |
| `HelloWorld_579521c7` | `HelloWorldClient` | [https://raw.githubusercontent.com/algorandfoundation/algokit-utils-beta-starter-py/HEAD/artifacts/HelloWorld.arc56.json](https://raw.githubusercontent.com/algorandfoundation/algokit-utils-beta-starter-py/HEAD/artifacts/HelloWorld.arc56.json) |
