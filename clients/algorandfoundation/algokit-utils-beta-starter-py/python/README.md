...
```bash
pip install arc56-generated-algorandfoundation-algokit-utils-beta-starter-py
```
...
from arc56_generated_algorandfoundation_algokit_utils_beta_starter_py import HelloWorld_579521c7

algorand = AlgorandClient.mainnet()
client = HelloWorld_579521c7.HelloWorldClient(
    algorand=algorand,
    app_id=123456789,
)
