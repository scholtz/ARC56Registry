...
```bash
pip install arc56-generated-algorandfoundation-algokit-client-generator-py
```
...
from arc56_generated_algorandfoundation_algokit_client_generator_py import Arc56Test_45cfb5f2
