...
```bash
npm install arc56-generated-algorandfoundation-arc62 @algorandfoundation/algokit-utils algosdk
```
...
import { CirculatingSupply_6bd32a8f } from "arc56-generated-algorandfoundation-arc62";

const algorand = AlgorandClient.mainNet();
const client = new CirculatingSupply_6bd32a8f.CirculatingSupplyClient({
  algorand,
  appId: 123456789n,
});
