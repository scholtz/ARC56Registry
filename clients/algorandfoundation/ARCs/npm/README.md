...
```bash
npm install arc56-generated-algorandfoundation-arcs @algorandfoundation/algokit-utils algosdk
```
...
import { SmartAsa_d8ff2065 } from "arc56-generated-algorandfoundation-arcs";

const algorand = AlgorandClient.mainNet();
const client = new SmartAsa_d8ff2065.SmartAsaClient({
  algorand,
  appId: 123456789n,
});
...
| --- | --- | --- |
| `SmartAsa_d8ff2065` | `SmartAsaClient` | [https://raw.githubusercontent.com/algorandfoundation/ARCs/HEAD/assets/arc-0020/smart_contracts/artifacts/smart_asa/SmartAsa.arc56.json](https://raw.githubusercontent.com/algorandfoundation/ARCs/HEAD/assets/arc-0020/smart_contracts/artifacts/smart_asa/SmartAsa.arc56.json) |
| `CirculatingSupply_a401f625` | `CirculatingSupplyClient` | [https://raw.githubusercontent.com/algorandfoundation/ARCs/HEAD/assets/arc-0062/smart_contracts/artifacts/circulating_supply/CirculatingSupply.arc56.json](https://raw.githubusercontent.com/algorandfoundation/ARCs/HEAD/assets/arc-0062/smart_contracts/artifacts/circulating_supply/CirculatingSupply.arc56.json) |
