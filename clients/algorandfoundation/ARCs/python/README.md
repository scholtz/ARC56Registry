...
```bash
pip install arc56-generated-algorandfoundation-arcs
```
...
from arc56_generated_algorandfoundation_arcs import SmartAsa_d8ff2065

algorand = AlgorandClient.mainnet()
client = SmartAsa_d8ff2065.SmartAsaClient(
    algorand=algorand,
    app_id=123456789,
)
