...
```bash
pip install arc56-generated-algorandfoundation-algokit-utils-beta-starter-ts
```
...
from arc56_generated_algorandfoundation_algokit_utils_beta_starter_ts import HelloWorld_33840950

algorand = AlgorandClient.mainnet()
client = HelloWorld_33840950.HelloWorldClient(
    algorand=algorand,
    app_id=123456789,
)
