...
```bash
npm install arc56-generated-algorandfoundation-algokit-utils-beta-starter-ts @algorandfoundation/algokit-utils algosdk
```
...
import { HelloWorld_33840950 } from "arc56-generated-algorandfoundation-algokit-utils-beta-starter-ts";

const algorand = AlgorandClient.mainNet();
const client = new HelloWorld_33840950.HelloWorldClient({
  algorand,
  appId: 123456789n,
});
...
| --- | --- | --- |
| `HelloWorld_33840950` | `HelloWorldClient` | [https://raw.githubusercontent.com/algorandfoundation/algokit-utils-beta-starter-ts/HEAD/artifacts/HelloWorld.arc56.json](https://raw.githubusercontent.com/algorandfoundation/algokit-utils-beta-starter-ts/HEAD/artifacts/HelloWorld.arc56.json) |
