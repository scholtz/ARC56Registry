...
```bash
pip install arc56-generated-algorandfoundation-algokit-subscriber-py
```
...
from arc56_generated_algorandfoundation_algokit_subscriber_py import testing_app_4bf00bef

algorand = AlgorandClient.mainnet()
client = testing_app_4bf00bef.TestingAppClient(
    algorand=algorand,
    app_id=123456789,
)
