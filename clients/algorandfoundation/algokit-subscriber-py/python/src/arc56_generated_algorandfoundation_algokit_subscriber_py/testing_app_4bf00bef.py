...
_APP_SPEC_JSON = r"""{"arcs": [22, 28], "bareActions": {"call": ["DeleteApplication", "UpdateApplication"], "create": ["NoOp", "OptIn"]}, "methods": [{"actions": {"call": ["OptIn"], "create": []}, "args": [], "name": "opt_in", "returns": {"type": "void"}, "events": [], "readonly": false, "recommendations": {}}, {"actions": {"call": ["NoOp"], "create": []}, "args": [{"type": "string", "name": "value"}], "name": "call_abi", "returns": {"type": "string"}, "events": [], "readonly": true, "recommendations": {}}, {"actions": {"call": ["NoOp"], "create": []}, "args": [], "name": "call_abi_foreign_refs", "returns": {"type": "string"}, "events": [], "readonly": true, "recommendations": {}}, {"actions": {"call": ["NoOp"], "create": []}, "args": [{"type": "uint64", "name": "int1"}, {"type": "uint64", "name": "int2"}, {"type": "string", "name": "bytes1"}, {"type": "byte[4]", "name": "bytes2"}], "name": "set_global", "returns": {"type": "void"}, "events": [], "readonly": false, "recommendations": {}}, {"actions": {"call": ["NoOp"], "create": []}, "args": [{"type": "uint64", "name": "int1"}, {"type": "uint64", "name": "int2"}, {"type": "string", "name": "bytes1"}, {"type": "byte[4]", "name": "bytes2"}], "name": "set_local", "returns": {"type": "void"}, "events": [], "readonly": false, "recommendations": {}}, {"actions": {"call": ["NoOp"], "create": []}, "args": [{"type": "uint64", "name": "amount"}], "name": "issue_transfer_to_sender", "returns": {"type": "void"}, "events": [], "readonly": false, "recommendations": {}}, {"actions": {"call": ["NoOp"], "create": []}, "args": [{"type": "byte[4]", "name": "name"}, {"type": "string", "name": "value"}], "name": "set_box", "returns": {"type": "void"}, "events": [], "readonly": false, "recommendations": {}}, {"actions": {"call": ["NoOp"], "create": []}, "args": [], "name": "error", "returns": {"type": "void"}, "events": [], "readonly": true, "recommendations": {}}, {"actions": {"call": ["NoOp"], "create": []}, "args": [{"type": "uint64", "name": "a"}, {"type": "uint64", "name": "b"}], "name": "emitSwapped", "returns": {"type": "void"}, "events": [{"args": [{"type": "uint64", "name": "field1"}, {"type": "uint64", "name": "field2"}], "name": "Swapped"}], "readonly": false, "recommendations": {}}, {"actions": {"call": ["NoOp"], "create": []}, "args": [{"type": "uint64", "name": "a"}, {"type": "uint64", "name": "b"}], "name": "emitSwappedTwice", "returns": {"type": "void"}, "events": [{"args": [{"type": "uint64", "name": "field1"}, {"type": "uint64", "name": "field2"}], "name": "Swapped"}], "readonly": false, "recommendations": {}}, {"actions": {"call": ["NoOp"], "create": []}, "args": [{"type": "uint64", "name": "a"}, {"type": "uint64", "name": "b"}, {"type": "uint32[]", "name": "array"}], "name": "emitComplex", "returns": {"type": "void"}, "events": [{"args": [{"type": "uint64", "name": "field1"}, {"type": "uint64", "name": "field2"}], "name": "Swapped"}, {"args": [{"type": "uint32[]", "name": "field1"}, {"type": "uint64", "name": "field2"}], "name": "Complex"}], "readonly": false, "recommendations": {}}], "name": "TestingApp", "state": {"keys": {"box": {}, "global": {"value": {"key": "dmFsdWU=", "keyType": "AVMString", "valueType": "AVMUint64"}, "bytes1": {"key": "Ynl0ZXMx", "keyType": "AVMString", "valueType": "AVMBytes"}, "bytes2": {"key": "Ynl0ZXMy", "keyType": "AVMString", "valueType": "AVMBytes"}, "int1": {"key": "aW50MQ==", "keyType": "AVMString", "valueType": "AVMUint64"}, "int2": {"key": "aW50Mg==", "keyType": "AVMString", "valueType": "AVMUint64"}}, "local": {"local_bytes1": {"key": "bG9jYWxfYnl0ZXMx", "keyType": "AVMString", "valueType": "AVMBytes"}, "local_bytes2": {"key": "bG9jYWxfYnl0ZXMy", "keyType": "AVMString", "valueType": "AVMBytes"}, "local_int1": {"key": "bG9jYWxfaW50MQ==", "keyType": "AVMString", "valueType": "AVMUint64"}, "local_int2": {"key": "bG9jYWxfaW50Mg==", "keyType": "AVMString", "valueType": "AVMUint64"}}}, "maps": {"box": {"box": {"keyType": "byte[4]", "valueType": "string", "prefix": ""}}, "global": {}, "local": {}}, "schema": {"global": {"bytes": 2, "ints": 3}, "local": {"bytes": 2, "ints": 2}}}, "structs": {}, "events": [{"args": [{"type": "uint64", "name": "field1"}, {"type": "uint64", "name": "field2"}], "name": "Swapped"}, {"args": [{"type": "uint32[]", "name": "field1"}, {"type": "uint64", "name": "field2"}], "name": "Complex"}], "networks": {}, "sourceInfo": {"approval": {"pcOffsetMethod": "none", "sourceInfo": [{"pc": [174], "errorMessage": "Deliberate error"}, {"pc": [113, 134, 152, 170, 178, 196, 211, 240, 269, 293], "errorMessage": "OnCompletion is not NoOp"}, {"pc": [324], "errorMessage": "OnCompletion is not OptIn"}, {"pc": [368], "errorMessage": "can only call when creating"}, {"pc": [116, 137, 155, 173, 181, 199, 214, 243, 272, 296, 327, 351, 359], "errorMessage": "can only call when not creating"}, {"pc": [376], "errorMessage": "unauthorized"}]}, "clear": {"pcOffsetMethod": "none", "sourceInfo": []}}}"""
...
@dataclasses.dataclass(frozen=True, kw_only=True)
class IssueTransferToSenderArgs:
    """Dataclass for issue_transfer_to_sender arguments"""
    amount: int
...
@dataclasses.dataclass(frozen=True, kw_only=True)
class EmitSwappedTwiceArgs:
    """Dataclass for emit_swapped_twice arguments"""
    a: int
    b: int
...
@dataclasses.dataclass(frozen=True, kw_only=True)
class EmitComplexArgs:
    """Dataclass for emit_complex arguments"""
    a: int
    b: int
    array: list[int]
...
class TestingAppParams:
    def __init__(self, app_client: algokit_utils.AppClient):
        self.app_client = app_client

    @property
    def opt_in(self) -> "_TestingAppOptIn":
        return _TestingAppOptIn(self.app_client)
    ...
    def call_abi_foreign_refs(
        ...
        return self.app_client.params.call(algokit_utils.AppClientMethodCallParams(**{
            **dataclasses.asdict(params),
            "method": "call_abi_foreign_refs()string",
        }))
    ...
    def issue_transfer_to_sender(
        self,
        args: tuple[int] | IssueTransferToSenderArgs,
        params: algokit_utils.CommonAppCallParams | None = None
    ) -> algokit_utils.AppCallMethodCallParams:
        method_args = _parse_abi_args(args)
        params = params or algokit_utils.CommonAppCallParams()
    ...
    def emit_swapped_twice(
        self,
        args: tuple[int, int] | EmitSwappedTwiceArgs,
        params: algokit_utils.CommonAppCallParams | None = None
    ) -> algokit_utils.AppCallMethodCallParams:
        method_args = _parse_abi_args(args)
        params = params or algokit_utils.CommonAppCallParams()
    ...
    def emit_complex(
        self,
        args: tuple[int, int, list[int]] | EmitComplexArgs,
        params: algokit_utils.CommonAppCallParams | None = None
    ) -> algokit_utils.AppCallMethodCallParams:
        method_args = _parse_abi_args(args)
        params = params or algokit_utils.CommonAppCallParams()
...
class _TestingAppOptInTransaction:
    def __init__(self, app_client: algokit_utils.AppClient):
        self.app_client = app_client
...
class TestingAppCreateTransactionParams:
    def __init__(self, app_client: algokit_utils.AppClient):
        self.app_client = app_client

    @property
    def opt_in(self) -> "_TestingAppOptInTransaction":
        return _TestingAppOptInTransaction(self.app_client)
...
class TestingAppSend:
    def __init__(self, app_client: algokit_utils.AppClient):
        self.app_client = app_client

    @property
    def opt_in(self) -> "_TestingAppOptInSend":
        return _TestingAppOptInSend(self.app_client)
...
class TestingAppClient:
    """Client for interacting with TestingApp smart contract"""
    ...
    def __init__(
        ...
        *,
        ...
        self.params = TestingAppParams(self.app_client)
        self.create_transaction = TestingAppCreateTransactionParams(self.app_client)
        self.send = TestingAppSend(self.app_client)
        self.state = TestingAppState(self.app_client)
    ...
    def new_group(self) -> "TestingAppComposer":
        return TestingAppComposer(self)
    ...
    def decode_return_value(
        self,
        method: typing.Literal["call_abi_foreign_refs()string"],
        return_value: algokit_utils.ABIReturn | None
    ) -> str | None: ...
    @typing.overload
    def decode_return_value(
    ...
    def decode_return_value(
        self,
        method: typing.Literal["issue_transfer_to_sender(uint64)void"],
        return_value: algokit_utils.ABIReturn | None
    ) -> None: ...
    @typing.overload
    def decode_return_value(
    ...
    def decode_return_value(
        self,
        method: typing.Literal["emitSwapped(uint64,uint64)void"],
        return_value: algokit_utils.ABIReturn | None
    ) -> None: ...
    @typing.overload
    def decode_return_value(
        self,
        method: typing.Literal["emitSwappedTwice(uint64,uint64)void"],
        return_value: algokit_utils.ABIReturn | None
    ) -> None: ...
    @typing.overload
    def decode_return_value(
        self,
        method: typing.Literal["emitComplex(uint64,uint64,uint32[])void"],
        return_value: algokit_utils.ABIReturn | None
    ) -> None: ...
    @typing.overload
    def decode_return_value(
...
class _TestingAppOptInComposer:
    def __init__(self, composer: "TestingAppComposer"):
...
class TestingAppComposer:
    """Composer for creating transaction groups for TestingApp contract calls"""

    def __init__(self, client: "TestingAppClient"):
        self.client = client
        self._composer = client.algorand.new_group()
        self._result_mappers: list[typing.Callable[[algokit_utils.ABIReturn | None], object] | None] = []

    @property
    def opt_in(self) -> "_TestingAppOptInComposer":
        return _TestingAppOptInComposer(self)
    ...
    def call_abi_foreign_refs(
        ...
        self._composer.add_app_call_method_call(
            self.client.params.call_abi_foreign_refs(
        ...
        self._result_mappers.append(
            lambda v: self.client.decode_return_value(
                "call_abi_foreign_refs()string", v
            )
        )
        return self
    ...
    def issue_transfer_to_sender(
        ...
        self._composer.add_app_call_method_call(
            self.client.params.issue_transfer_to_sender(
                args=args,
                params=params,
            )
        )
        self._result_mappers.append(
            lambda v: self.client.decode_return_value(
                "issue_transfer_to_sender(uint64)void", v
            )
        )
        return self
    ...
    def emit_swapped(
        ...
        self._result_mappers.append(
            lambda v: self.client.decode_return_value(
                "emitSwapped(uint64,uint64)void", v
            )
        )
        return self
    ...
    def emit_swapped_twice(
        ...
        self._composer.add_app_call_method_call(
            self.client.params.emit_swapped_twice(
                args=args,
                params=params,
            )
        )
        self._result_mappers.append(
            lambda v: self.client.decode_return_value(
                "emitSwappedTwice(uint64,uint64)void", v
            )
        )
        return self
    ...
    def emit_complex(
        ...
        self._composer.add_app_call_method_call(
            self.client.params.emit_complex(
                args=args,
                params=params,
            )
        )
        self._result_mappers.append(
            lambda v: self.client.decode_return_value(
                "emitComplex(uint64,uint64,uint32[])void", v
            )
        )
        return self
