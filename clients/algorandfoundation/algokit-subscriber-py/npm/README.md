...
```bash
npm install arc56-generated-algorandfoundation-algokit-subscriber-py @algorandfoundation/algokit-utils algosdk
```
...
import { testing_app_4bf00bef } from "arc56-generated-algorandfoundation-algokit-subscriber-py";

const algorand = AlgorandClient.mainNet();
const client = new testing_app_4bf00bef.TestingAppClient({
  algorand,
  appId: 123456789n,
});
