...
```bash
pip install arc56-generated-anandbobba-rift-web3
```
...
from arc56_generated_anandbobba_rift_web3 import VeritasRegistry_b1e87c06

algorand = AlgorandClient.mainnet()
client = VeritasRegistry_b1e87c06.VeritasRegistryClient(
    algorand=algorand,
    app_id=123456789,
)
