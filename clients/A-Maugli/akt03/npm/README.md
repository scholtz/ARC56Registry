...
```bash
npm install arc56-generated-a-maugli-akt03 @algorandfoundation/algokit-utils algosdk
```
...
import { BizKor_8ff1c2fb } from "arc56-generated-a-maugli-akt03";

const algorand = AlgorandClient.mainNet();
const client = new BizKor_8ff1c2fb.BizKorClient({
  algorand,
  appId: 123456789n,
});
