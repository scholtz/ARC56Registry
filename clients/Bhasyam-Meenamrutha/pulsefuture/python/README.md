...
```bash
pip install arc56-generated-bhasyam-meenamrutha-pulsefuture
```
...
from arc56_generated_bhasyam_meenamrutha_pulsefuture import Pulsefuture_865d268d

algorand = AlgorandClient.mainnet()
client = Pulsefuture_865d268d.PulsefutureClient(
    algorand=algorand,
    app_id=123456789,
)
