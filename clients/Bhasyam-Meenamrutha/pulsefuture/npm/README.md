...
```bash
npm install arc56-generated-bhasyam-meenamrutha-pulsefuture @algorandfoundation/algokit-utils algosdk
```
...
import { Pulsefuture_865d268d } from "arc56-generated-bhasyam-meenamrutha-pulsefuture";

const algorand = AlgorandClient.mainNet();
const client = new Pulsefuture_865d268d.PulsefutureClient({
  algorand,
  appId: 123456789n,
});
