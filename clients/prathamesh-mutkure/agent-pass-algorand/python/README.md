...
```bash
pip install arc56-generated-prathamesh-mutkure-agent-pass-algorand
```
...
from arc56_generated_prathamesh_mutkure_agent_pass_algorand import AgentPass_f3e11c19

algorand = AlgorandClient.mainnet()
client = AgentPass_f3e11c19.AgentPassClient(
    algorand=algorand,
    app_id=123456789,
)
