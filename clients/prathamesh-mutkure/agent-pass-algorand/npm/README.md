...
```bash
npm install arc56-generated-prathamesh-mutkure-agent-pass-algorand @algorandfoundation/algokit-utils algosdk
```
...
import { AgentPass_f3e11c19 } from "arc56-generated-prathamesh-mutkure-agent-pass-algorand";

const algorand = AlgorandClient.mainNet();
const client = new AgentPass_f3e11c19.AgentPassClient({
  algorand,
  appId: 123456789n,
});
