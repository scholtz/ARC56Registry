...
```bash
npm install arc56-generated-mekalakaveri18-project-2 @algorandfoundation/algokit-utils algosdk
```
...
import { MedicineLendingPlatform_33e367c1 } from "arc56-generated-mekalakaveri18-project-2";

const algorand = AlgorandClient.mainNet();
const client = new MedicineLendingPlatform_33e367c1.MedicineLendingPlatformClient({
  algorand,
  appId: 123456789n,
});
