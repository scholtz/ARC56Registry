...
```bash
pip install arc56-generated-mekalakaveri18-medi-setu
```
...
from arc56_generated_mekalakaveri18_medi_setu import MedicineLendingPlatform_41c1041a

algorand = AlgorandClient.mainnet()
client = MedicineLendingPlatform_41c1041a.MedicineLendingPlatformClient(
    algorand=algorand,
    app_id=123456789,
)
