...
```bash
pip install arc56-generated-kvrancic-defacto
```
...
from arc56_generated_kvrancic_defacto import HelloWorld_b1f9fb8b

algorand = AlgorandClient.mainnet()
client = HelloWorld_b1f9fb8b.HelloWorldClient(
    algorand=algorand,
    app_id=123456789,
)
