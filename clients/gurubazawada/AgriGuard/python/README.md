...
```bash
pip install arc56-generated-gurubazawada-agriguard
```
...
from arc56_generated_gurubazawada_agriguard import AgriGuardDispute_21ec0d4e

algorand = AlgorandClient.mainnet()
client = AgriGuardDispute_21ec0d4e.AgriGuardDisputeClient(
    algorand=algorand,
    app_id=123456789,
)
