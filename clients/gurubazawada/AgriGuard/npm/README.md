...
```bash
npm install arc56-generated-gurubazawada-agriguard @algorandfoundation/algokit-utils algosdk
```
...
import { AgriGuardDispute_21ec0d4e } from "arc56-generated-gurubazawada-agriguard";

const algorand = AlgorandClient.mainNet();
const client = new AgriGuardDispute_21ec0d4e.AgriGuardDisputeClient({
  algorand,
  appId: 123456789n,
});
