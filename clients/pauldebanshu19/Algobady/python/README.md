...
```bash
pip install arc56-generated-pauldebanshu19-algobady
```
...
from arc56_generated_pauldebanshu19_algobady import HelloWorld_0c9894d2

algorand = AlgorandClient.mainnet()
client = HelloWorld_0c9894d2.HelloWorldClient(
    algorand=algorand,
    app_id=123456789,
)
