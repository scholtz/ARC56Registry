...
```bash
npm install arc56-generated-jake-loranger-algodevshop @algorandfoundation/algokit-utils algosdk
```
...
import { BetOnAlgoPrice_20946e07 } from "arc56-generated-jake-loranger-algodevshop";

const algorand = AlgorandClient.mainNet();
const client = new BetOnAlgoPrice_20946e07.BetOnAlgoPriceClient({
  algorand,
  appId: 123456789n,
});
