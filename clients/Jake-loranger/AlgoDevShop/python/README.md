...
```bash
pip install arc56-generated-jake-loranger-algodevshop
```
...
from arc56_generated_jake_loranger_algodevshop import BetOnAlgoPrice_20946e07

algorand = AlgorandClient.mainnet()
client = BetOnAlgoPrice_20946e07.BetOnAlgoPriceClient(
    algorand=algorand,
    app_id=123456789,
)
