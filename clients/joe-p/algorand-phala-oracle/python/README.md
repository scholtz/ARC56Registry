...
```bash
pip install arc56-generated-joe-p-algorand-phala-oracle
```
...
from arc56_generated_joe_p_algorand_phala_oracle import CatFactsOracle_3875cad1

algorand = AlgorandClient.mainnet()
client = CatFactsOracle_3875cad1.CatFactsOracleClient(
    algorand=algorand,
    app_id=123456789,
)
