...
```bash
pip install arc56-generated-joe-p-arc58
```
...
from arc56_generated_joe_p_arc58 import AbstractedAccount_9616adf0

algorand = AlgorandClient.mainnet()
client = AbstractedAccount_9616adf0.AbstractedAccountClient(
    algorand=algorand,
    app_id=123456789,
)
