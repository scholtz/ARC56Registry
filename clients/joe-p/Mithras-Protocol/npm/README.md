# arc56-generated-joe-p-mithras-protocol

Auto-generated typed Algorand smart-contract clients for **[joe-p/Mithras-Protocol](https://github.com/joe-p/Mithras-Protocol)**,
...
```bash
npm install arc56-generated-joe-p-mithras-protocol @algorandfoundation/algokit-utils algosdk
```
...
import { Mithras_e3b8ed3e } from "arc56-generated-joe-p-mithras-protocol";

const algorand = AlgorandClient.mainNet();
const client = new Mithras_e3b8ed3e.MithrasClient({
  algorand,
  appId: 123456789n,
});
...
| --- | --- | --- |
| `Mithras_e3b8ed3e` | `MithrasClient` | [https://raw.githubusercontent.com/joe-p/Mithras-Protocol/HEAD/packages/mithras-contracts-and-circuits/contracts/out/Mithras.arc56.json](https://raw.githubusercontent.com/joe-p/Mithras-Protocol/HEAD/packages/mithras-contracts-and-circuits/contracts/out/Mithras.arc56.json) |
