...
```bash
pip install arc56-generated-joe-p-mithras-protocol
```
...
from arc56_generated_joe_p_mithras_protocol import Mithras_e3b8ed3e

algorand = AlgorandClient.mainnet()
client = Mithras_e3b8ed3e.MithrasClient(
    algorand=algorand,
    app_id=123456789,
)
