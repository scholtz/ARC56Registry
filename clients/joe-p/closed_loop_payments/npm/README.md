# arc56-generated-joe-p-closed-loop-payments
...
```bash
npm install arc56-generated-joe-p-closed-loop-payments @algorandfoundation/algokit-utils algosdk
```
...
import { Payments_6654a7c3 } from "arc56-generated-joe-p-closed-loop-payments";

const algorand = AlgorandClient.mainNet();
const client = new Payments_6654a7c3.PaymentsClient({
  algorand,
  appId: 123456789n,
});
...
| --- | --- | --- |
| `Payments_6654a7c3` | `PaymentsClient` | [https://raw.githubusercontent.com/joe-p/closed_loop_payments/HEAD/contracts/out/Payments.arc56.json](https://raw.githubusercontent.com/joe-p/closed_loop_payments/HEAD/contracts/out/Payments.arc56.json) |
