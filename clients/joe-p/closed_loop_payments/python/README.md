...
```bash
pip install arc56-generated-joe-p-closed-loop-payments
```
...
from arc56_generated_joe_p_closed_loop_payments import Payments_6654a7c3

algorand = AlgorandClient.mainnet()
client = Payments_6654a7c3.PaymentsClient(
    algorand=algorand,
    app_id=123456789,
)
