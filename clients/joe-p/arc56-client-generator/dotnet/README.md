...
```bash
dotnet add package Arc56.Generated.joe-p.arc56-client-generator
```
...
| --- | --- | --- |
| `Arc56.Generated.joe_p.arc56_client_generator.ARC56Test_918f5396` | _(generation failed - see state.json)_ | [https://raw.githubusercontent.com/joe-p/arc56-client-generator/HEAD/example/arc56_test/ARC56Test.arc56.json](https://raw.githubusercontent.com/joe-p/arc56-client-generator/HEAD/example/arc56_test/ARC56Test.arc56.json) |
