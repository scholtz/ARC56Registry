...
```bash
npm install arc56-generated-riagma-voto3 @algorandfoundation/algokit-utils algosdk
```
...
import { Voto3_abb9c5e8 } from "arc56-generated-riagma-voto3";

const algorand = AlgorandClient.mainNet();
const client = new Voto3_abb9c5e8.Voto3Client({
  algorand,
  appId: 123456789n,
});
