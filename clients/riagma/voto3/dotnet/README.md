...
```bash
dotnet add package Arc56.Generated.riagma.voto3
```
...
using Arc56.Generated.riagma.voto3.Voto3_abb9c5e8;

var algod = new DefaultApi(httpClient); // configure with your algod endpoint
var client = new Voto3Proxy(algod, appId: 123456789);
...
| --- | --- | --- |
| `Arc56.Generated.riagma.voto3.Voto3_abb9c5e8` | `Voto3Proxy` | [https://raw.githubusercontent.com/riagma/voto3/HEAD/algorand/smart_contracts/artifacts/voto3/Voto3.arc56.json](https://raw.githubusercontent.com/riagma/voto3/HEAD/algorand/smart_contracts/artifacts/voto3/Voto3.arc56.json) |
