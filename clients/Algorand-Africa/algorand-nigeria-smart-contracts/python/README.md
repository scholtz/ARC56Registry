...
```bash
pip install arc56-generated-algorand-africa-algorand-nigeria-smart-contracts
```
...
from arc56_generated_algorand_africa_algorand_nigeria_smart_contracts import EventAssetClaimer_8ef02381

algorand = AlgorandClient.mainnet()
client = EventAssetClaimer_8ef02381.EventAssetClaimerClient(
    algorand=algorand,
    app_id=123456789,
)
