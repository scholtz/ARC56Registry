...
```bash
pip install arc56-generated-caesar4321-confio
```
...
from arc56_generated_caesar4321_confio import ConfioAyudaHumanitaria_11722f10

algorand = AlgorandClient.mainnet()
client = ConfioAyudaHumanitaria_11722f10.ConfioAyudaHumanitariaClient(
    algorand=algorand,
    app_id=123456789,
)
