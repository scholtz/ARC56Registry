...
```bash
npm install arc56-generated-caesar4321-confio @algorandfoundation/algokit-utils algosdk
```
...
import { ConfioAyudaHumanitaria_11722f10 } from "arc56-generated-caesar4321-confio";

const algorand = AlgorandClient.mainNet();
const client = new ConfioAyudaHumanitaria_11722f10.ConfioAyudaHumanitariaClient({
  algorand,
  appId: 123456789n,
});
