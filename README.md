...
| Metric | Count |
| --- | ---: |
| ARC-56 links found | 17,516 |
| Repositories containing ARC-56 links | 562 |
| NuGet packages published | 562 |
| npm packages published | 546 |
| PyPI packages published | 157 |

_Last updated 2026-09-08 08:51 UTC by `scripts/update_arc56_links.py`. Historical snapshots (for charting growth over time): [arc56_stats_history.csv](arc56_stats_history.csv)._
<!-- LIVE-STATS:END -->
