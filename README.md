...
| Metric | Count |
| --- | ---: |
| ARC-56 links found | 4,414 |
| Repositories containing ARC-56 links | 524 |
| NuGet packages published | 522 |
| npm packages published | 120 |
| PyPI packages published | 45 |

_Last updated 2026-08-03 07:08 UTC by `scripts/update_arc56_links.py`. Historical snapshots (for charting growth over time): [arc56_stats_history.csv](arc56_stats_history.csv)._
<!-- LIVE-STATS:END -->
