...
| Metric | Count |
| --- | ---: |
| ARC-56 links found | 10,352 |
| Repositories containing ARC-56 links | 546 |
| NuGet packages published | 543 |
| npm packages published | 527 |
| PyPI packages published | 105 |

_Last updated 2026-08-23 04:45 UTC by `scripts/update_arc56_links.py`. Historical snapshots (for charting growth over time): [arc56_stats_history.csv](arc56_stats_history.csv)._
<!-- LIVE-STATS:END -->
