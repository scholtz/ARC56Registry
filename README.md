...
| NuGet packages published | 564 |
| npm packages published | 548 |
| PyPI packages published | 169 |

_Last updated 2026-09-13 09:27 UTC by `scripts/update_arc56_links.py`. Historical snapshots (for charting growth over time): [arc56_stats_history.csv](arc56_stats_history.csv)._
<!-- LIVE-STATS:END -->
