...
| Metric | Count |
| --- | ---: |
| ARC-56 links found | 17,515 |
| Repositories containing ARC-56 links | 561 |
| NuGet packages published | 560 |
| npm packages published | 544 |
| PyPI packages published | 149 |

_Last updated 2026-09-06 08:37 UTC by `scripts/update_arc56_links.py`. Historical snapshots (for charting growth over time): [arc56_stats_history.csv](arc56_stats_history.csv)._
<!-- LIVE-STATS:END -->
