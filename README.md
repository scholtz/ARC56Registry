...
| Metric | Count |
| --- | ---: |
| ARC-56 links found | 17,490 |
| Repositories containing ARC-56 links | 560 |
| NuGet packages published | 559 |
| npm packages published | 543 |
| PyPI packages published | 145 |

_Last updated 2026-09-04 09:06 UTC by `scripts/update_arc56_links.py`. Historical snapshots (for charting growth over time): [arc56_stats_history.csv](arc56_stats_history.csv)._
<!-- LIVE-STATS:END -->
