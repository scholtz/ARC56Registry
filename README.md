...
| Metric | Count |
| --- | ---: |
| ARC-56 links found | 4,410 |
| Repositories containing ARC-56 links | 522 |
| NuGet packages published | 521 |
| npm packages published | 120 |
| PyPI packages published | 45 |

_Last updated 2026-08-02 06:44 UTC by `scripts/update_arc56_links.py`. Historical snapshots (for charting growth over time): [arc56_stats_history.csv](arc56_stats_history.csv)._
<!-- LIVE-STATS:END -->
