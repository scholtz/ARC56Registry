...
| Metric | Count |
| --- | ---: |
| ARC-56 links found | 4,452 |
| Repositories containing ARC-56 links | 540 |
| NuGet packages published | 538 |
| npm packages published | 522 |
| PyPI packages published | 81 |

_Last updated 2026-08-15 04:23 UTC by `scripts/update_arc56_links.py`. Historical snapshots (for charting growth over time): [arc56_stats_history.csv](arc56_stats_history.csv)._
<!-- LIVE-STATS:END -->
