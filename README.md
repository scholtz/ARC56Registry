...
| Metric | Count |
| --- | ---: |
| ARC-56 links found | 17,488 |
| Repositories containing ARC-56 links | 559 |
| NuGet packages published | 556 |
| npm packages published | 540 |
| PyPI packages published | 141 |

_Last updated 2026-09-03 09:15 UTC by `scripts/update_arc56_links.py`. Historical snapshots (for charting growth over time): [arc56_stats_history.csv](arc56_stats_history.csv)._
<!-- LIVE-STATS:END -->
